...
#ifndef HNS_CHROMIUM_SRC_SERVICES_NETWORK_COOKIE_SETTINGS_H_
#define HNS_CHROMIUM_SRC_SERVICES_NETWORK_COOKIE_SETTINGS_H_
...
#endif  // HNS_CHROMIUM_SRC_SERVICES_NETWORK_COOKIE_SETTINGS_H_
