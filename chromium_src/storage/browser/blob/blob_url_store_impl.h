...
#ifndef HNS_CHROMIUM_SRC_STORAGE_BROWSER_BLOB_BLOB_URL_STORE_IMPL_H_
#define HNS_CHROMIUM_SRC_STORAGE_BROWSER_BLOB_BLOB_URL_STORE_IMPL_H_

namespace storage {
class BlobURLStoreImpl;
using BlobURLStoreImpl_HnsImpl = BlobURLStoreImpl;
}  // namespace storage

#define BlobURLStoreImpl BlobURLStoreImpl_ChromiumImpl
#define BlobUrlIsValid               \
  NotUsed() const;                   \
  friend BlobURLStoreImpl_HnsImpl; \
  bool BlobUrlIsValid
...
#endif  // HNS_CHROMIUM_SRC_STORAGE_BROWSER_BLOB_BLOB_URL_STORE_IMPL_H_
