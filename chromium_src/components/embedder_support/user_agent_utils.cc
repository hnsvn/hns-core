...
constexpr char kHnsBrandNameForCHUA[] = "Hns";
...
// IDS_PRODUCT_NAME from app/chromium_strings.grd (hns_strings.grd) in
// constructing the UA in hns/browser/hns_content_browser_client.cc, but we
// can't use it here in the //components.
#define HNS_GET_USER_AGENT_BRAND_LIST brand = kHnsBrandNameForCHUA;
...
#undef HNS_GET_USER_AGENT_BRAND_LIST
