...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_CRX_FILE_CRX_CREATOR_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_CRX_FILE_CRX_CREATOR_H_
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_CRX_FILE_CRX_CREATOR_H_
