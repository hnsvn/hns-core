...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
...
// Widevine plugin must be fetched from Google servers. Hns's update server
...
// components in one request, which in Hns's case is a mix of Google and Hns
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_UPDATE_CLIENT_UPDATE_CHECKER_H_
