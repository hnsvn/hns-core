...
#define HNS_KEY_STORAGE_LINUX                             \
  const char KeyStorageLinux::kFolderName[] = "Hns Keys"; \
  const char KeyStorageLinux::kKey[] = "Hns Safe Storage";

#define HNS_KEY_STORAGE_LINUX_CREATE_SERVICE                          \
...
// clang-format off
#define HNS_KEY_STORAGE_LINUX_CREATE_SERVICE_INTERNAL                       \
  static const base::NoDestructor<std::string> kDefaultApplicationName("hns");
// clang-format on

#include "src/components/os_crypt/sync/key_storage_linux.cc"
#undef HNS_KEY_STORAGE_LINUX_CREATE_SERVICE_INTERNAL
#undef HNS_KEY_STORAGE_LINUX_CREATE_SERVICE
#undef HNS_KEY_STORAGE_LINUX
