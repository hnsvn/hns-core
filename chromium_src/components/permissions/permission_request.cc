...
// Hns Ethereum/Solana permission has its own permission request prompt.
#define HNS_ENUM_ITEMS_FOR_SWITCH \
...
#define HNS_ENUM_ITEMS_FOR_SWITCH_DESKTOP                \
  HNS_ENUM_ITEMS_FOR_SWITCH                              \
...
#define HNS_ENUM_ITEMS_FOR_SWITCH_ANDROID          \
  HNS_ENUM_ITEMS_FOR_SWITCH                        \
  case RequestType::kHnsGoogleSignInPermission:    \
...
#define IDS_VR_INFOBAR_TEXT     \
  ...
  break;                        \
  HNS_ENUM_ITEMS_FOR_SWITCH_ANDROID
#else
...
#define IDS_VR_PERMISSION_FRAGMENT     \
  ...
  break;                               \
  HNS_ENUM_ITEMS_FOR_SWITCH_DESKTOP
#endif
