...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_PERMISSION_CONTEXT_BASE_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_PERMISSION_CONTEXT_BASE_H_

#include "base/functional/callback.h"

namespace permissions {
class PermissionContextBase;
using PermissionContextBase_HnsImpl = PermissionContextBase;
...
#define HNS_PERMISSION_CONTEXT_BASE_H_              \
  friend PermissionContextBase_HnsImpl;             \
                                                      \
 protected:                                           \
...
#undef HNS_PERMISSION_CONTEXT_BASE_H_
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_PERMISSION_CONTEXT_BASE_H_
