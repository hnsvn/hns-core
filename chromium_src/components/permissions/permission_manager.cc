...
#define HNS_GET_PERMISSION_RESULT_FOR_CURRENT_DOCUMENT \
  !forced_requesting_origin_.is_empty() ? forced_requesting_origin_:

#define HNS_REQUEST_PERMISSION_FROM_CURRENT_DOCUMENT                 \
...
#undef HNS_GET_PERMISSION_RESULT_FOR_CURRENT_DOCUMENT
#undef HNS_REQUEST_PERMISSION_FROM_CURRENT_DOCUMENT
