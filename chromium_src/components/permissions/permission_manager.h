...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_PERMISSION_MANAGER_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_PERMISSION_MANAGER_H_
...
#define subscription_type_counts_      \
  ...
  friend class HnsPermissionManager; \
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_PERMISSIONS_PERMISSION_MANAGER_H_
