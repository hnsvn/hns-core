...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_PREFS_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_PREFS_H_
...
class TranslatePrefs : public TranslatePrefs_ChromiumImpl {
 public:
  ...
  // Override to control by Hns features. No virtual because TranslatePrefs
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_PREFS_H_
