...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_SCRIPT_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_SCRIPT_H_

namespace translate {
class TranslateScript;
using HnsTranslateScript = TranslateScript;
}  // namespace translate
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_TRANSLATE_CORE_BROWSER_TRANSLATE_SCRIPT_H_
