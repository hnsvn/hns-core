...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_VIZ_HOST_GPU_HOST_IMPL_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_VIZ_HOST_GPU_HOST_IMPL_H_
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_VIZ_HOST_GPU_HOST_IMPL_H_
