...
class HnsInterceptNavigationDelegate : public InterceptNavigationDelegate {
 public:
  HnsInterceptNavigationDelegate(JNIEnv* env,
                                   jobject jdelegate,
...
static void JNI_InterceptNavigationDelegateImpl_AssociateWithWebContents(
  ...
  InterceptNavigationDelegate::Associate(
      web_contents,
      std::make_unique<HnsInterceptNavigationDelegate>(
          env, jdelegate,
