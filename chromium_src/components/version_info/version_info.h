...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_VERSION_INFO_VERSION_INFO_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_VERSION_INFO_VERSION_INFO_H_
...
constexpr std::string GetProductNameAndVersionForUserAgent() {
  return "Chrome/" + std::string(constants::kHnsChromiumVersion);
}
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_VERSION_INFO_VERSION_INFO_H_
