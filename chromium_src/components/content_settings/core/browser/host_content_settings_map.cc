...
#define PrefProvider HnsPrefProvider
#endif

namespace content_settings {
namespace {

bool IsMorePermissive_HnsImpl(ContentSettingsType content_type,
...
#define IsMorePermissive(a, b) IsMorePermissive_HnsImpl(content_type, a, b)
