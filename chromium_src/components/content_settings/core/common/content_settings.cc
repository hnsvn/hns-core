...
bool RendererContentSettingRules::IsRendererContentSetting(
  ...
  return RendererContentSettingRules_ChromiumImpl::IsRendererContentSetting(
         ...
         content_type == ContentSettingsType::HNS_COSMETIC_FILTERING ||
         content_type == ContentSettingsType::HNS_FINGERPRINTING_V2 ||
         content_type == ContentSettingsType::HNS_GOOGLE_SIGN_IN ||
         content_type == ContentSettingsType::HNS_LOCALHOST_ACCESS ||
...
void RendererContentSettingRules::FilterRulesByOutermostMainFrameURL(
  ...
  FilterRulesForType(hns_shields_rules, outermost_main_frame_url);
