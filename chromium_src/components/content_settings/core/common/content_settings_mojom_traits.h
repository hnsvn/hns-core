...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_CONTENT_SETTINGS_MOJOM_TRAITS_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_CONTENT_SETTINGS_MOJOM_TRAITS_H_
...
struct StructTraits<
  ...
  static const std::vector<ContentSettingPatternSource>& hns_shields_rules(
      const RendererContentSettingRules& r) {
    return r.hns_shields_rules;
  }
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_CONTENT_SETTINGS_MOJOM_TRAITS_H_
