...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_COOKIE_SETTINGS_BASE_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_COOKIE_SETTINGS_BASE_H_
...
// accessors.
struct CookieSettingWithHnsMetadata {
  CookieSettingWithHnsMetadata();
  CookieSettingWithHnsMetadata(const CookieSettingWithHnsMetadata&);
  CookieSettingWithHnsMetadata(CookieSettingWithHnsMetadata&&);
  CookieSettingWithHnsMetadata& operator=(
      const CookieSettingWithHnsMetadata&);
  CookieSettingWithHnsMetadata& operator=(CookieSettingWithHnsMetadata&&);
  ~CookieSettingWithHnsMetadata();
...
#define IsCookieSessionOnly                                                \
  ...
  CookieSettingWithHnsMetadata GetCookieSettingWithHnsMetadata(        \
      const GURL& url, const GURL& first_party_url,                        \
      net::CookieSettingOverrides overrides) const;                        \
  static CookieSettingWithHnsMetadata*                                   \
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_CONTENT_SETTINGS_CORE_COMMON_COOKIE_SETTINGS_BASE_H_
