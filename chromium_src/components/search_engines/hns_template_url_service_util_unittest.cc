...
extern void LocalizeEngineList(int country_id,
                               std::vector<HnsPrepopulatedEngineID>* engines);
}
...
class HnsTemplateURLServiceUtilTest : public testing::Test {
 public:
  void SetUp() override {
...
TEST_F(HnsTemplateURLServiceUtilTest, GetSearchProvidersUsingKeywordResult) {
...
TEST_F(HnsTemplateURLServiceUtilTest,
