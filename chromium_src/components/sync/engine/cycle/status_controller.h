...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_CYCLE_STATUS_CONTROLLER_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_CYCLE_STATUS_CONTROLLER_H_
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_CYCLE_STATUS_CONTROLLER_H_
