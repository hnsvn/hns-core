...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_SYNC_MANAGER_IMPL_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_SYNC_MANAGER_IMPL_H_
...
#define ShutdownOnSyncThread         \
  Unused() {}                        \
  friend class HnsSyncManagerImpl; \
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_SYNC_ENGINE_SYNC_MANAGER_IMPL_H_
