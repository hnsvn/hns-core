...
#ifndef HNS_CHROMIUM_SRC_COMPONENTS_SYNC_SERVICE_SYNC_INTERNALS_UTIL_H_
#define HNS_CHROMIUM_SRC_COMPONENTS_SYNC_SERVICE_SYNC_INTERNALS_UTIL_H_
...
#endif  // HNS_CHROMIUM_SRC_COMPONENTS_SYNC_SERVICE_SYNC_INTERNALS_UTIL_H_
