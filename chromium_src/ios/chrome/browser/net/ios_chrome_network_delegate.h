...
#ifndef HNS_CHROMIUM_SRC_IOS_CHROME_BROWSER_NET_IOS_CHROME_NETWORK_DELEGATE_H__
#define HNS_CHROMIUM_SRC_IOS_CHROME_BROWSER_NET_IOS_CHROME_NETWORK_DELEGATE_H__

class IOSChromeNetworkDelegate;
using IOSChromeNetworkDelegate_HnsImpl = IOSChromeNetworkDelegate;

#define IOSChromeNetworkDelegate IOSChromeNetworkDelegate_ChromiumImpl
#define HNS_IOS_CHROME_NETWORK_DELEGATE_H \
  friend IOSChromeNetworkDelegate_HnsImpl;
#include "src/ios/chrome/browser/net/ios_chrome_network_delegate.h"  // IWYU pragma: export
#undef IOSChromeNetworkDelegate
#undef HNS_IOS_CHROME_NETWORK_DELEGATE_H
...
#endif  // HNS_CHROMIUM_SRC_IOS_CHROME_BROWSER_NET_IOS_CHROME_NETWORK_DELEGATE_H__
