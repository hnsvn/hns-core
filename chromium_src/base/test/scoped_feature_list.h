...
#ifndef HNS_CHROMIUM_SRC_BASE_TEST_SCOPED_FEATURE_LIST_H_
#define HNS_CHROMIUM_SRC_BASE_TEST_SCOPED_FEATURE_LIST_H_
...
#endif  // HNS_CHROMIUM_SRC_BASE_TEST_SCOPED_FEATURE_LIST_H_
