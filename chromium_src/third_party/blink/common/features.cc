...
BASE_FEATURE(kHnsWebBluetoothAPI,
             "HnsWebBluetoothAPI",
             base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kHnsWebSerialAPI,
             "HnsWebSerialAPI",
             base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kHnsBlockScreenFingerprinting,
             "HnsBlockScreenFingerprinting",
             base::FEATURE_DISABLED_BY_DEFAULT);

// Enables protection against fingerprinting via high-resolution time stamps.
BASE_FEATURE(kHnsRoundTimeStamps,
             "HnsRoundTimeStamps",
             base::FEATURE_ENABLED_BY_DEFAULT);

// Enables the Global Privacy Control header and navigator APIs.
BASE_FEATURE(kHnsGlobalPrivacyControl,
             "HnsGlobalPrivacyControl",
             base::FEATURE_ENABLED_BY_DEFAULT);
