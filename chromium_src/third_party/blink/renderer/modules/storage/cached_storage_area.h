...
#ifndef HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_MODULES_STORAGE_CACHED_STORAGE_AREA_H_
#define HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_MODULES_STORAGE_CACHED_STORAGE_AREA_H_

#include "third_party/blink/renderer/modules/storage/storage_namespace.h"

namespace blink {
class CachedStorageArea;
using CachedStorageArea_HnsImpl = CachedStorageArea;
}  // namespace blink

#define CachedStorageArea CachedStorageArea_ChromiumImpl
#define EnsureLoaded                  \
  NotUsed() {}                        \
  friend CachedStorageArea_HnsImpl; \
...
#endif  // HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_MODULES_STORAGE_CACHED_STORAGE_AREA_H_
