...
#define HNS_REFERRER_SCRIPT_INFO_IS_DEFAULT_VALUE \
  (dom_node_id_ == kInvalidDOMNodeId && parent_script_id_ == 0)
#else
#define HNS_REFERRER_SCRIPT_INFO_IS_DEFAULT_VALUE true
...
static constexpr size_t kHnsAddedFieldsCount = 2;

static_assert(ReferrerScriptInfo::HostDefinedOptionsIndex::kLength ==
                  HostDefinedOptionsIndex::kLength + kHnsAddedFieldsCount,
