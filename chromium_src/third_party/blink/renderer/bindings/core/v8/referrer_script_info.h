...
#ifndef HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_REFERRER_SCRIPT_INFO_H_
#define HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_REFERRER_SCRIPT_INFO_H_

#include "hns/components/hns_page_graph/common/buildflags.h"
#include "third_party/blink/renderer/platform/graphics/dom_node_id.h"
#include "v8/include/v8.h"

#define HNS_REFERRER_SCRIPT_INFO_CONSTRUCTOR       \
...
#endif  // BUILDFLAG(ENABLE_HNS_PAGE_GRAPH)
#undef HNS_REFERRER_SCRIPT_INFO_CONSTRUCTOR

#endif  // HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_REFERRER_SCRIPT_INFO_H_
