...
#ifndef HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_DOM_NODE_H_
#define HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_DOM_NODE_H_
...
#define MarkAncestorsWithChildNeedsStyleInvalidation             \
  NotUsed();                                                     \
  IF_BUILDFLAG(ENABLE_HNS_PAGE_GRAPH, void NodeConstructed();) \
...
#endif  // HNS_CHROMIUM_SRC_THIRD_PARTY_BLINK_RENDERER_CORE_DOM_NODE_H_
