...
#define HNS_EVENT_TARGET_ADD_EVENT_LISTENER_INTERNAL             \
  IF_BUILDFLAG(ENABLE_HNS_PAGE_GRAPH, {                          \
    probe::RegisterPageGraphEventListenerAdd(this, event_type,     \
                                             registered_listener); \
  })

#define HNS_EVENT_TARGET_REMOVE_EVENT_LISTENER_INTERNAL             \
  IF_BUILDFLAG(ENABLE_HNS_PAGE_GRAPH, {                             \
...
#undef HNS_EVENT_TARGET_REMOVE_EVENT_LISTENER_INTERNAL
#undef HNS_EVENT_TARGET_ADD_EVENT_LISTENER_INTERNAL
