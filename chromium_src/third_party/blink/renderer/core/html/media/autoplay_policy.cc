...
#define HNS_AUTOPLAY_POLICY_IS_GESTURE_NEEDED_FOR_PLAYBACK \
  if (!IsAutoplayAllowedForElement(element_))                \
    return true;

#define HNS_GET_AUTOPLAY_POLICY_FOR_DOCUMENT \
...
#undef HNS_AUTOPLAY_POLICY_IS_GESTURE_NEEDED_FOR_PLAYBACK
#undef HNS_GET_AUTOPLAY_POLICY_FOR_DOCUMENT
