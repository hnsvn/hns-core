...
#define HNS_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_EXTRACT_AUTH_INFO \
  base::StringPiece username, password;                                \
  ParseAuthInfoAndHostname(&host, &username, &password);

#define HNS_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_RETURN_HOST_PORT_PAIR     \
  return ProxyServer(                                                          \
...
#undef HNS_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_RETURN_HOST_PORT_PAIR
#undef HNS_PROXY_SERVER_FROM_SCHEME_HOST_AND_PORT_EXTRACT_AUTH_INFO
