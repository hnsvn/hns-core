...
#ifndef HNS_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_
#define HNS_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_

#include <string>

// Nudges HostPortPair past Chromium's style
// threshold for in-line constructors and destructors.
#define HNS_HOST_PORT_PAIR_H_                                        \
...
#undef HNS_HOST_PORT_PAIR_H_

#endif  // HNS_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_
