...
#ifndef HNS_CHROMIUM_SRC_NET_HTTP_TRANSPORT_SECURITY_STATE_H_
#define HNS_CHROMIUM_SRC_NET_HTTP_TRANSPORT_SECURITY_STATE_H_

#include "hns/net/http/partitioned_host_state_map.h"
#include "net/base/isolation_info.h"

namespace net {
class TransportSecurityState;
using TransportSecurityState_HnsImpl = TransportSecurityState;
}  // namespace net
...
#define enabled_sts_hosts_                 \
  ...
  friend TransportSecurityState_HnsImpl; \
...
#endif  // HNS_CHROMIUM_SRC_NET_HTTP_TRANSPORT_SECURITY_STATE_H_
