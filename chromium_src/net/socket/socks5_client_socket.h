...
#ifndef HNS_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
#define HNS_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_

#include "src/net/socket/socks5_client_socket.h"  // IWYU pragma: export
...
#endif  // HNS_CHROMIUM_SRC_NET_SOCKET_SOCKS5_CLIENT_SOCKET_H_
