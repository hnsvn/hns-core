...
#ifndef HNS_CHROMIUM_SRC_NET_COOKIES_COOKIE_ACCESS_DELEGATE_H_
#define HNS_CHROMIUM_SRC_NET_COOKIES_COOKIE_ACCESS_DELEGATE_H_
...
#endif  // HNS_CHROMIUM_SRC_NET_COOKIES_COOKIE_ACCESS_DELEGATE_H_
