...
#ifndef HNS_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
#define HNS_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
...
#endif  // HNS_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
