...
TEST(HnsCanonicalCookieTest, SetMaxExpiration) {
...
TEST(HnsCanonicalCookieTest, AllowShorterThanMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(HnsCanonicalCookieTest, SetHTTPOnlyMaxExpiration) {
  GURL url("https://www.example.com/test");
...
TEST(HnsCanonicalCookieTest, NoExpirationCookie) {
  GURL url("https://www.example.com/test");
