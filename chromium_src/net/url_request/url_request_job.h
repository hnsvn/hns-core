...
#ifndef HNS_CHROMIUM_SRC_NET_URL_REQUEST_URL_REQUEST_JOB_H_
#define HNS_CHROMIUM_SRC_NET_URL_REQUEST_URL_REQUEST_JOB_H_
...
#endif  // HNS_CHROMIUM_SRC_NET_URL_REQUEST_URL_REQUEST_JOB_H_
