...
#ifndef HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_SANDBOX_POLICY_BASE_H_
#define HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_SANDBOX_POLICY_BASE_H_
...
#endif  // HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_SANDBOX_POLICY_BASE_H_
