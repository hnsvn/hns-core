...
#ifndef HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_64_H_
#define HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_64_H_
...
#endif  // HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_64_H_
