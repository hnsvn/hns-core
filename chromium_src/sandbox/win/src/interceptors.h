...
#ifndef HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_H_
#define HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_H_
...
#endif  // HNS_CHROMIUM_SRC_SANDBOX_WIN_SRC_INTERCEPTORS_H_
