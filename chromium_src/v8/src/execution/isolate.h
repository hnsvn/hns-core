...
#ifndef HNS_CHROMIUM_SRC_V8_SRC_EXECUTION_ISOLATE_H_
#define HNS_CHROMIUM_SRC_V8_SRC_EXECUTION_ISOLATE_H_
...
#endif  // HNS_CHROMIUM_SRC_V8_SRC_EXECUTION_ISOLATE_H_
