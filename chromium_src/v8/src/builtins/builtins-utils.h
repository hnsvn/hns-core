...
#ifndef HNS_CHROMIUM_SRC_V8_SRC_BUILTINS_BUILTINS_UTILS_H_
#define HNS_CHROMIUM_SRC_V8_SRC_BUILTINS_BUILTINS_UTILS_H_
...
#endif  // HNS_CHROMIUM_SRC_V8_SRC_BUILTINS_BUILTINS_UTILS_H_
