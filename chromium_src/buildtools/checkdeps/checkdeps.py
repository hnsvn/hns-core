...
"""Modifies DEPS checker to support `hns/chromium_src` overrides."""
...
class HnsDepsChecker(DepsChecker):
    def _ApplyDirectoryRules(self, existing_rules, dir_path_local_abs):
        ...
        if '/hns/chromium_src' in dir_path_norm:
