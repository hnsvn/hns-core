...
#ifndef HNS_CHROMIUM_SRC_CHROME_COMMON_PROFILER_THREAD_PROFILER_CONFIGURATION_H_
#define HNS_CHROMIUM_SRC_CHROME_COMMON_PROFILER_THREAD_PROFILER_CONFIGURATION_H_
...
#endif  //  HNS_CHROMIUM_SRC_CHROME_COMMON_PROFILER_THREAD_PROFILER_CONFIGURATION_H_
