...
#if BUILDFLAG(IS_MAC)
#define PRODUCT_STRING HNS_PRODUCT_STRING
...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("hns");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif BUILDFLAG(IS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("hns");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("hns");
#elif BUILDFLAG(IS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("hns");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("hns");
#endif  // OS_*
