...
#ifndef HNS_CHROMIUM_SRC_CHROME_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
#define HNS_CHROMIUM_SRC_CHROME_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
...
#endif  // HNS_CHROMIUM_SRC_CHROME_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
