...
class HnsCheckClientDownloadRequestBaseBrowserTest
    : public InProcessBrowserTest {
 public:
  HnsCheckClientDownloadRequestBaseBrowserTest()
...
IN_PROC_BROWSER_TEST_F(HnsCheckClientDownloadRequestBaseBrowserTest,
                       FilterRequest) {
