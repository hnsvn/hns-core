...
#ifndef HNS_CHROMIUM_SRC_CHROME_BROWSER_FAVICON_FAVICON_UTILS_H_
#define HNS_CHROMIUM_SRC_CHROME_BROWSER_FAVICON_FAVICON_UTILS_H_
...
#endif  // HNS_CHROMIUM_SRC_CHROME_BROWSER_FAVICON_FAVICON_UTILS_H_
