...
BASE_DECLARE_FEATURE(kHnsWidevineArm64DllFix);
constexpr base::FeatureParam<std::string> kHnsWidevineArm64DllUrl{
    &kHnsWidevineArm64DllFix, "widevine_arm64_dll_url",
    "https://dl.google.com/widevine-cdm/4.10.2710.0-win-arm64.zip"};
BASE_FEATURE(kHnsWidevineArm64DllFix,
             "HnsWidevineArm64DllFix",
...
void WidevineArm64DllInstaller::Start(
  ...
  resource_request->url = GURL(kHnsWidevineArm64DllUrl.Get());
