...
#include "hns/components/hns_shields/browser/ad_block_subscription_download_client.h"
...
std::unique_ptr<download::Client> CreateAdBlockSubscriptionDownloadClient(
    Profile* profile) {
  return std::make_unique<hns_shields::AdBlockSubscriptionDownloadClient>(
