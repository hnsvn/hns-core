...
class HnsSaveCardBubbleControllerImplTest : public InProcessBrowserTest {
 public:
  HnsSaveCardBubbleControllerImplTest() {}

  HnsSaveCardBubbleControllerImplTest(
      const HnsSaveCardBubbleControllerImplTest&) = delete;
  HnsSaveCardBubbleControllerImplTest& operator=(
      const HnsSaveCardBubbleControllerImplTest&) = delete;
...
// bubble being shown.
IN_PROC_BROWSER_TEST_F(HnsSaveCardBubbleControllerImplTest, NoSignInPromo) {
  ShowUi();
