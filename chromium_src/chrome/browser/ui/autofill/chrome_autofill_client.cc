...
class HnsChromeAutofillClient : public ChromeAutofillClient {
 public:
  ...
  bool IsAutocompleteEnabled() const override {
    ...
    enabled = enabled && GetPrefs()->GetBoolean(kHnsAutofillPrivateWindows);
    return enabled;
  }
};
...
#define WrapUnique WrapUnique(new autofill::HnsChromeAutofillClient(web_contents))); \
