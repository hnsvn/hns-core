...
#define IDS_SETTINGS_ENABLE_LOGGING_PREF IDS_HNS_DIAGNOSTIC_REPORTS_PREF
#define IDS_SETTINGS_ENABLE_LOGGING_PREF_DESC \
  IDS_HNS_DIAGNOSTIC_REPORTS_PREF_DESC

// Sync types labels
#undef IDS_SETTINGS_AUTOFILL_CHECKBOX_LABEL
#define IDS_SETTINGS_AUTOFILL_CHECKBOX_LABEL \
  IDS_SETTINGS_HNS_AUTOFILL_CHECKBOX_LABEL

#undef IDS_SETTINGS_APPS_CHECKBOX_LABEL
#define IDS_SETTINGS_APPS_CHECKBOX_LABEL IDS_SETTINGS_HNS_APPS_CHECKBOX_LABEL
