...
void TabHoverCardBubbleView_ChromiumImpl::HnsUpdateCardContent(
    const Tab* tab) {
  ...
  // Replace chrome:// with hns://. Since this is purely in the UI we can
