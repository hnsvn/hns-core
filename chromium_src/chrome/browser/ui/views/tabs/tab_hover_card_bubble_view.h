...
#ifndef HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
#define HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#define HNS_TAB_HOVER_CARD_BUBBLE_VIEW_H_             \
  bool has_thumbnail_view() { return thumbnail_view_; } \
                                                        \
 protected:                                             \
  void HnsUpdateCardContent(const Tab* tab);
...
#undef HNS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
...
#endif  // HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_HOVER_CARD_BUBBLE_VIEW_H_
