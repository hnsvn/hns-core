...
#ifndef HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_DRAG_CONTROLLER_H_
#define HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_DRAG_CONTROLLER_H_

// In order to replace TabDragController with ours easily, rename upstream's
// implementation. Ours is in hns/browser/ui/views/tabs/tab_drag_controller.h
// and the file will be included at the end of this file.
class TabDragController;
using TabDragControllerHns = TabDragController;
...
#include "hns/browser/ui/views/tabs/tab_drag_controller.h"

#endif  // HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_VIEWS_TABS_TAB_DRAG_CONTROLLER_H_
