...
#define HNS_UI_VIEWS_TABS_TAB_ALERT_INDICATOR_POSITION           \
...
#define HNS_UI_VIEWS_TABS_TAB_UPDATE_ICON_VISIBILITY \
  showing_close_button_ &= mouse_hovered();

#include "src/chrome/browser/ui/views/tabs/tab.cc"
#undef HNS_UI_VIEWS_TABS_TAB_UPDATE_ICON_VISIBILITY
#undef HNS_UI_VIEWS_TABS_TAB_ALERT_INDICATOR_POSITION
