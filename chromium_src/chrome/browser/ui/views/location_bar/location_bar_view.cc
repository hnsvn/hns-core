...
#define HNS_LAYOUT_TRAILING_DECORATIONS                                    \
...
#define OmniboxViewViews HnsOmniboxViewViews
#define ChromeOmniboxClient HnsOmniboxClientImpl
#define PageActionIconContainerView HnsPageActionIconContainerView
...
#undef HNS_LAYOUT_TRAILING_DECORATIONS
