...
#include "hns/browser/ui/views/dialog_footnote_utils.h"
...
#include "hns/browser/widevine/widevine_permission_request.h"
#endif
...
DontAskAgainCheckbox::DontAskAgainCheckbox(WidevinePermissionRequest* request)
    : views::Checkbox(hns_l10n::GetLocalizedResourceUTF16String(
...
void AddWidevineFootnoteView(
    views::BubbleDialogDelegateView* dialog_delegate_view,
    Browser* browser) {
  const std::u16string footnote = hns_l10n::GetLocalizedResourceUTF16String(
...
void AddFootnoteViewIfNeeded(
  ...
  const std::vector<std::u16string> replacements{
      ...
      hns_l10n::GetLocalizedResourceUTF16String(IDS_LEARN_MORE)};
...
#define HNS_PERMISSION_PROMPT_BUBBLE_BASE_VIEW                         \
...
#define IDS_PERMISSIONS_BUBBLE_PROMPT IDS_HNS_PERMISSIONS_BUBBLE_PROMPT
#include "src/chrome/browser/ui/views/permissions/permission_prompt_bubble_base_view.cc"
#undef HNS_PERMISSION_PROMPT_BUBBLE_BASE_VIEW
#undef IDS_PERMISSIONS_BUBBLE_PROMPT
