...
// Hns has its own side panel navigation in the form of the SideBar, so
// hide the Chromium combobox-style header.
#define HNS_SIDE_PANEL_COORDINATOR_CREATE_HEADER header->SetVisible(false);

// Choose Hns's own default, and exclude items that user has removed
// from sidebar. If none are enabled, do nothing.
#define HNS_SIDE_PANEL_COORDINATOR_SHOW                      \
...
#undef IDS_TOOLTIP_SIDE_PANEL_HIDE
#undef IDS_TOOLTIP_SIDE_PANEL_SHOW
#undef HNS_SIDE_PANEL_COORDINATOR_CREATE_HEADER
#undef HNS_SIDE_PANEL_COORDINATOR_SHOW
