...
// unintentional redefinitions of Button into HnsDownloadItemViewButton.
...
// and relays them to HnsDownloadItemView to make decisions on when to hide
// the download item's URL (i.e. default) and when to show it (i.e. on hover).
class HnsDownloadItemViewButton : public Button {
 public:
  using Button::Button;
...
#define Button HnsDownloadItemViewButton
