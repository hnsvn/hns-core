...
#ifndef HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_HATS_HATS_SERVICE_H_
#define HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_HATS_HATS_SERVICE_H_
...
#endif  // HNS_CHROMIUM_SRC_CHROME_BROWSER_UI_HATS_HATS_SERVICE_H_
