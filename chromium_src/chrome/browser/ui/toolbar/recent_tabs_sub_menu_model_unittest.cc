...
// Disabling these tests because they refer g_hns_browser_process which is not
...
#define HNS_RECENT_TABS_SUB_MENU_MODEL_TEST           \
...
#undef HNS_RECENT_TABS_SUB_MENU_MODEL_TEST
