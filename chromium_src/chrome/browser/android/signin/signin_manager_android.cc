...
#include "hns/build/android/jni_headers/HnsSigninManager_jni.h"
...
#define Java_SigninManagerImpl_create Java_HnsSigninManager_create
#define Java_SigninManagerImpl_destroy Java_HnsSigninManager_destroy
