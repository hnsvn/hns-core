...
#define HnsBookmarkBridge BookmarkBridge
#include "hns/build/android/jni_headers/HnsBookmarkBridge_jni.h"
#undef HnsBookmarkBridge
...
class FileBookmarksExportObserver : public BookmarksExportObserver {
 public:
  ...
  void OnExportFinished(Result result) override {
    ...
    Java_HnsBookmarkBridge_bookmarksExported(env, obj_,
...
void BookmarkBridge::ImportBookmarksImpl(
  ...
  Java_HnsBookmarkBridge_bookmarksImported(env, obj, !bookmarks.empty());
}
