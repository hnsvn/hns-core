...
#ifndef HNS_CHROMIUM_SRC_CHROME_BROWSER_PERMISSIONS_CHROME_PERMISSIONS_CLIENT_H_
#define HNS_CHROMIUM_SRC_CHROME_BROWSER_PERMISSIONS_CHROME_PERMISSIONS_CLIENT_H_

#include "components/permissions/permissions_client.h"

#define CanBypassEmbeddingOriginCheck                                    \
  HnsCanBypassEmbeddingOriginCheck(const GURL& requesting_origin,      \
...
#endif  // HNS_CHROMIUM_SRC_CHROME_BROWSER_PERMISSIONS_CHROME_PERMISSIONS_CLIENT_H_
