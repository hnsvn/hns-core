...
#ifndef HNS_CHROMIUM_SRC_CHROME_BROWSER_EXTENSIONS_EXTENSION_UTIL_H_
#define HNS_CHROMIUM_SRC_CHROME_BROWSER_EXTENSIONS_EXTENSION_UTIL_H_
...
#endif  // HNS_CHROMIUM_SRC_CHROME_BROWSER_EXTENSIONS_EXTENSION_UTIL_H_
