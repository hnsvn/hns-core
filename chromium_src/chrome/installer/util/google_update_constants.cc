...
const wchar_t kGoogleUpdateSetupExe[] = L"HnsUpdateSetup.exe";
const wchar_t kRegPathClients[] = L"Software\\HnsSoftware\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\HnsSoftware\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\HnsSoftware\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\HnsSoftware\\Update";
