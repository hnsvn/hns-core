...
// Brand-specific constants and install modes for Hns.
...
const wchar_t kCompanyPathName[] = L"HnsSoftware";

#if defined(OFFICIAL_BUILD)
const wchar_t kProductPathName[] = L"Hns-Browser";
#else
const wchar_t kProductPathName[] = L"Hns-Browser-Development";
#endif
...
const InstallConstants kInstallModes[] = {
    // The primary install mode for stable Hns.
    {
        ...
        .base_app_name = L"Hns",               // A distinct base_app_name.
        .base_app_id = L"Hns",                 // A distinct base_app_id.
        .browser_prog_id_prefix = L"HnsHTML",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Hns HTML Document",         // Browser ProgID description.
        .pdf_prog_id_prefix = L"HnsPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Hns PDF Document",  // PDF ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Hns Beta
    {
        .size = sizeof(kInstallModes[0]),
        ...
        .base_app_name = L"Hns Beta",           // A distinct base_app_name.
        .base_app_id = L"HnsBeta",              // A distinct base_app_id.
        .browser_prog_id_prefix = L"HnsBHTML",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Hns Beta HTML Document",     // Browser ProgID description.
        .pdf_prog_id_prefix = L"HnsBPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Hns Beta PDF Document",  // PDF ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Hns Dev
    {
        .size = sizeof(kInstallModes[0]),
        ...
        .base_app_name = L"Hns Dev",            // A distinct base_app_name.
        .base_app_id = L"HnsDev",               // A distinct base_app_id.
        .browser_prog_id_prefix = L"HnsDHTML",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Hns Dev HTML Document",      // Browser ProgID description.
        .pdf_prog_id_prefix = L"HnsDPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Hns Dev PDF Document",  // PDF ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Hns SxS (canary).
    {
        .size = sizeof(kInstallModes[0]),
        .index =
        ...
        .base_app_name = L"Hns Nightly",        // A distinct base_app_name.
        .base_app_id = L"HnsNightly",           // A distinct base_app_id.
        .browser_prog_id_prefix = L"HnsSSHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Hns Nightly HTML Document",   // Browser ProgID description.
        .pdf_prog_id_prefix = L"HnsSSPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Hns Nightly PDF Document",  // PDF ProgID description.
        .active_setup_guid =
...
#else
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Hns developer build.
    {
        .size = sizeof(kInstallModes[0]),
        ...
        .logo_suffix = L"",  // No logo suffix for the primary install mode.
        .app_guid =
            L"",  // Empty app_guid since no integraion with Hns Update.
        .base_app_name = L"Hns Development",     // A distinct base_app_name.
        .base_app_id = L"HnsDevelopment",        // A distinct base_app_id.
        .browser_prog_id_prefix = L"HnsDevHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Hns Development HTML Document",  // Browser ProgID description.
        .pdf_prog_id_prefix = L"HnsDevPDF",    // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Hns Development PDF Document",  // PDF ProgID description.
        .active_setup_guid =
