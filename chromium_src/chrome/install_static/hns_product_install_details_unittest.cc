...
constexpr TestData kTestData[] = {
    {
        L"C:\\Program Files (x86)\\HnsSoftware\\Hns-Browser\\Application"
        L"\\hns.exe",
        STABLE_INDEX, true, L"",
    },
    {
        L"C:\\Users\\user\\AppData\\Local\\HnsSoftware\\Hns-Browser"
        L"\\Application\\hns.exe",
        STABLE_INDEX, false, L"",
    },
    {
        L"C:\\Program Files (x86)\\HnsSoftware\\Hns-Browser-Beta"
        L"\\Application\\hns.exe",
        BETA_INDEX, true, L"beta",
    },
    {
        L"C:\\Users\\user\\AppData\\Local\\HnsSoftware\\Hns-Browser-Beta"
        L"\\Application\\hns.exe",
        BETA_INDEX, false, L"beta",
    },
    {
        L"C:\\Program Files (x86)\\HnsSoftware\\Hns-Browser-Dev"
        L"\\Application\\hns.exe",
        DEV_INDEX, true, L"dev",
    },
    {
        L"C:\\Users\\user\\AppData\\Local\\HnsSoftware\\Hns-Browser-Dev"
        L"\\Application\\hns.exe",
        DEV_INDEX, false, L"dev",
    },
    {
        L"C:\\Users\\user\\AppData\\Local\\HnsSoftware\\Hns-Browser-Nightly"
        L"\\Application\\hns.exe",
...
constexpr TestData kTestData[] = {
    {
        L"C:\\Program Files (x86)\\HnsSoftware\\Hns-Browser-Development"
        L"\\Application\\hns.exe",
        DEVELOPER_INDEX,
        true,
        L"",
    ...
    {
        L"C:\\Users\\user\\AppData\\Local\\HnsSoftware\\Hns-Browser-"
        L"Development\\Application\\hns.exe",
        DEVELOPER_INDEX,
        false,
        L"",
    },
