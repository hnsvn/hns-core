...
const int kHnsActionGraphicSize = 18;
const int kHnsActionLeftMarginExtra = -2;

const char hns_extension_id[] = "mnojpmjdmbbfmejpflffifhffcmidifd";
...
const char hns_webtorrent_extension_id[] = "lgjmpdmojkpocjcopdikifhejkkjglho";
const char hns_webtorrent_extension_filename[] = "hns_webtorrent.html";
const char hns_webtorrent_extension_filename2[] = "hns_webtorrent2.html";
