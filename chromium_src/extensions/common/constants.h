...
#ifndef HNS_CHROMIUM_SRC_EXTENSIONS_COMMON_CONSTANTS_H_
#define HNS_CHROMIUM_SRC_EXTENSIONS_COMMON_CONSTANTS_H_

#include "src/extensions/common/constants.h"  // IWYU pragma: export

EXTENSIONS_EXPORT extern const int kHnsActionGraphicSize;
EXTENSIONS_EXPORT extern const int kHnsActionLeftMarginExtra;

EXTENSIONS_EXPORT extern const char hns_extension_id[];
EXTENSIONS_EXPORT extern const char hangouts_extension_id[];
EXTENSIONS_EXPORT extern const char crl_set_extension_id[];

EXTENSIONS_EXPORT extern const char hns_webtorrent_extension_id[];
EXTENSIONS_EXPORT extern const char hns_webtorrent_extension_filename[];
EXTENSIONS_EXPORT extern const char hns_webtorrent_extension_filename2[];
...
#endif  // HNS_CHROMIUM_SRC_EXTENSIONS_COMMON_CONSTANTS_H_
