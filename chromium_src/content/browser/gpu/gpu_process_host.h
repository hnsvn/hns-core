...
#ifndef HNS_CHROMIUM_SRC_CONTENT_BROWSER_GPU_GPU_PROCESS_HOST_H_
#define HNS_CHROMIUM_SRC_CONTENT_BROWSER_GPU_GPU_PROCESS_HOST_H_
...
#endif  // HNS_CHROMIUM_SRC_CONTENT_BROWSER_GPU_GPU_PROCESS_HOST_H_
