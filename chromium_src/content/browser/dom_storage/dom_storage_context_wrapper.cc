...
// Hns uses opaque origins to access ephemeral localStorage areas. This block
// allows these origins to be treated as valid ones.
#define HNS_DOM_STORAGE_CONTEXT_WRAPPER_IS_REQUEST_VALID                 \
...
#undef HNS_DOM_STORAGE_CONTEXT_WRAPPER_IS_REQUEST_VALID
