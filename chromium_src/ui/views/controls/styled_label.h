...
#ifndef HNS_CHROMIUM_SRC_UI_VIEWS_CONTROLS_STYLED_LABEL_H_
#define HNS_CHROMIUM_SRC_UI_VIEWS_CONTROLS_STYLED_LABEL_H_
...
#endif  // HNS_CHROMIUM_SRC_UI_VIEWS_CONTROLS_STYLED_LABEL_H_
