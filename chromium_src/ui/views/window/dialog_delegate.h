...
#ifndef HNS_CHROMIUM_SRC_UI_VIEWS_WINDOW_DIALOG_DELEGATE_H_
#define HNS_CHROMIUM_SRC_UI_VIEWS_WINDOW_DIALOG_DELEGATE_H_
...
#endif  // HNS_CHROMIUM_SRC_UI_VIEWS_WINDOW_DIALOG_DELEGATE_H_
