...
#ifndef HNS_CHROMIUM_SRC_UI_NATIVE_THEME_NATIVE_THEME_WIN_H_
#define HNS_CHROMIUM_SRC_UI_NATIVE_THEME_NATIVE_THEME_WIN_H_

#define HNS_UI_NATIVE_THEME_NATIVE_THEME_WIN_H_ \
 private: \
  friend void UpdateDarkModeStatus();

#include "src/ui/native_theme/native_theme_win.h"  // IWYU pragma: export
#undef HNS_UI_NATIVE_THEME_NATIVE_THEME_WIN_H_
...
#endif  // HNS_CHROMIUM_SRC_UI_NATIVE_THEME_NATIVE_THEME_WIN_H_
