...
#include "hns/ios/browser/api/web_image/image_downloader.h"
#include "hns/ios/browser/svg/svg_image.h"
...
@interface WebImageDownloader () {
  std::unique_ptr<hns::ImageDownloader> image_fetcher_;
}
@end
...
- (instancetype)initWithBrowserState:(ChromeBrowserState*)browserState {
  if ((self = [super init])) {
    image_fetcher_ = std::make_unique<hns::ImageDownloader>(
