...
#include "hns/ios/browser/api/url/url_utils.h"
...
- (NSString*)hns_domainAndRegistryExcludingPrivateRegistries {
  std::string domain = net::registry_controlled_domains::GetDomainAndRegistry(
      net::GURLWithNSURL(self),
...
- (NSURL*)hns_addingQueryParameter:(NSString*)key value:(NSString*)value {
...
- (NSURL*)hns_replacingQueryParameter:(NSString*)key value:(NSString*)value {
...
- (bool)hns_hasScheme:(NSString*)scheme {
