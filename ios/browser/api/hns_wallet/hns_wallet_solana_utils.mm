...
#include "hns/ios/browser/api/hns_wallet/hns_wallet_solana_utils.h"
...
- (NSString*)base58EncodedString {
  ...
  const auto base58String = hns_wallet::Base58Encode(bytes);
...
- (bool)isBase58EncodedSolanaPubkey {
  return hns_wallet::IsBase58EncodedSolanaPubkey(
