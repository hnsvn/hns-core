...
#ifndef HNS_IOS_BROWSER_API_HNS_SHIELDS_ADBLOCK_ENGINE_H_
#define HNS_IOS_BROWSER_API_HNS_SHIELDS_ADBLOCK_ENGINE_H_
...
#endif  // HNS_IOS_BROWSER_API_HNS_SHIELDS_ADBLOCK_ENGINE_H_
