...
#include "hns/ios/browser/api/p3a/hns_histograms_controller+private.h"
...
- (HnsHistogramsController*)histogramsController {
  return [[HnsHistogramsController alloc] initWithBrowserState:_browserState];
}
