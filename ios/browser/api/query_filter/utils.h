...
#ifndef HNS_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
#define HNS_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
...
- (nullable NSURL*)
    hns_applyingQueryStringFilterWithInitiatorURL:
...
#endif  // HNS_IOS_BROWSER_API_QUERY_FILTER_UTILS_H_
