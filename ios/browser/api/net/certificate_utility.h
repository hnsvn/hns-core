...
#ifndef HNS_IOS_BROWSER_API_NET_CERTIFICATE_UTILITY_H_
#define HNS_IOS_BROWSER_API_NET_CERTIFICATE_UTILITY_H_
...
OBJC_EXPORT
@interface HnsCertificateUtility : NSObject
...
#endif  // HNS_IOS_BROWSER_API_NET_CERTIFICATE_UTILITY_H_
