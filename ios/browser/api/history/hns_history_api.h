...
#ifndef HNS_IOS_BROWSER_API_HISTORY_HNS_HISTORY_API_H_
#define HNS_IOS_BROWSER_API_HISTORY_HNS_HISTORY_API_H_
...
NS_SWIFT_NAME(HnsHistoryAPI)
OBJC_EXPORT
@interface HnsHistoryAPI : NSObject
...
#endif  // HNS_IOS_BROWSER_API_HISTORY_HNS_HISTORY_API_H_
