...
#import "hns/ios/browser/api/favicon/favicon_driver.h"
...
- (instancetype)initWithWebState:(WebState*)webState {
  if ((self = [super init])) {
    ...
    hns_favicon::HnsIOSWebFaviconDriver::CreateForWebState(
        real_web_state,
...
- (void)dealloc {
  ...
  hns_favicon::HnsIOSWebFaviconDriver* driver =
      hns_favicon::HnsIOSWebFaviconDriver::FromWebState(real_web_state);
  DCHECK(driver);
