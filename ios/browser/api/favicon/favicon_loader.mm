...
#include "hns/ios/browser/api/favicon/favicon_loader.h"
#include <memory>
...
@interface FaviconLoader () {
  base::raw_ptr<hns_favicon::HnsFaviconLoader> favicon_loader_;
}
@end
...
- (instancetype)initWithBrowserState:(ChromeBrowserState*)browserState {
  if ((self = [super init])) {
    favicon_loader_ =
        hns_favicon::HnsIOSFaviconLoaderFactory::GetForBrowserState(
            browserState);
