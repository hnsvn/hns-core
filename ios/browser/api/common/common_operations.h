...
#ifndef HNS_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
#define HNS_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
...
OBJC_EXPORT
@interface HnsCommonOperations : NSObject
...
#endif  // HNS_IOS_BROWSER_API_COMMON_COMMON_OPERATIONS_H_
