...
#ifndef HNS_IOS_BROWSER_API_HNS_REWARDS_REWARDS_CLIENT_IOS_H_
#define HNS_IOS_BROWSER_API_HNS_REWARDS_REWARDS_CLIENT_IOS_H_
...
class RewardsClientIOS : public hns_rewards::mojom::RewardsEngineClient {
 public:
  explicit RewardsClientIOS(id<RewardsClientBridge> bridge);
  ~RewardsClientIOS() override;

  mojo::PendingAssociatedRemote<hns_rewards::mojom::RewardsEngineClient>
  MakeRemote();

 private:
  __unsafe_unretained id<RewardsClientBridge> bridge_;
  mojo::AssociatedReceiver<hns_rewards::mojom::RewardsEngineClient> receiver_;
  ...
  void OnReconcileComplete(
      hns_rewards::mojom::Result result,
      hns_rewards::mojom::ContributionInfoPtr contribution) override;
...
#endif  // HNS_IOS_BROWSER_API_HNS_REWARDS_REWARDS_CLIENT_IOS_H_
