...
void AdsClientIOS::AddObserver(hns_ads::AdsClientNotifierObserver* observer) {
...
void AdsClientIOS::ShowNotificationAd(const hns_ads::NotificationAdInfo& ad) {
...
void AdsClientIOS::ShowReminder(const hns_ads::mojom::ReminderType type) {
...
void AdsClientIOS::UrlRequest(hns_ads::mojom::UrlRequestInfoPtr url_request,
