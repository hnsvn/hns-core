...
#ifndef HNS_IOS_BROWSER_API_ADS_HNS_ADS_H_
#define HNS_IOS_BROWSER_API_ADS_HNS_ADS_H_

#import <Foundation/Foundation.h>
#import <UserNotifications/UserNotifications.h>
#import "hns_ads.mojom.objc.h"
...
OBJC_EXPORT
@protocol HnsAdsNotificationHandler
@required
...
OBJC_EXPORT
@interface HnsAds : NSObject

/// The notifications handler.
///
/// @see HnsAdsNotificationHandler
@property(nonatomic, weak, nullable) id<HnsAdsNotificationHandler>
    notificationsHandler;

/// An object to handle adaptive captcha requests
///
/// @see HnsAdsCaptchaHandler
@property(nonatomic, weak, nullable) id<HnsAdsCaptchaHandler> captchaHandler;
...
/// Whether or not Hns Ads is enabled and the user should receive
...
#endif  // HNS_IOS_BROWSER_API_ADS_HNS_ADS_H_
