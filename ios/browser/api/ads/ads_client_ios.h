...
#ifndef HNS_IOS_BROWSER_API_ADS_ADS_CLIENT_IOS_H_
#define HNS_IOS_BROWSER_API_ADS_ADS_CLIENT_IOS_H_
...
class AdsClientIOS : public hns_ads::AdsClient {
 public:
 ...
 private:
  ...
  void ShowReminder(const hns_ads::mojom::ReminderType type) override;
...
#endif  // HNS_IOS_BROWSER_API_ADS_ADS_CLIENT_IOS_H_
