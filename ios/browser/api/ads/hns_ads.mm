...
#import "hns/build/ios/mojom/cpp_transformations.h"
...
#include "hns/components/hns_ads/core/public/client/ads_client_notifier.h"
...
#import "hns/ios/browser/api/ads/hns_ads.mojom.objc+private.h"
...
#define BATClassAdsBridge(__type, __objc_getter, __objc_setter, __cpp_var) \
  +(__type)__objc_getter {                                                 \
    return hns_ads::__cpp_var;                                           \
  }                                                                        \
  +(void)__objc_setter : (__type)newValue {                                \
    hns_ads::__cpp_var = newValue;                                       \
  }
...
static NSString* const kOptedInToNotificationAdsPrefKey =
    base::SysUTF8ToNSString(hns_ads::prefs::kOptedInToNotificationAds);
static NSString* const kRewardsEnabledPrefKey =
    base::SysUTF8ToNSString(hns_rewards::prefs::kEnabled);
static NSString* const kMaximumNotificationAdsPerHourPrefKey =
    base::SysUTF8ToNSString(hns_ads::prefs::kMaximumNotificationAdsPerHour);
static NSString* const kShouldAllowSubdivisionTargetingPrefKey =
    base::SysUTF8ToNSString(hns_ads::prefs::kShouldAllowSubdivisionTargeting);
static NSString* const kSubdivisionTargetingSubdivisionPrefKey =
    base::SysUTF8ToNSString(hns_ads::prefs::kSubdivisionTargetingSubdivision);
...
hns_ads::mojom::DBCommandResponseInfoPtr RunDBTransactionOnTaskRunner(
    hns_ads::mojom::DBTransactionInfoPtr transaction,
    hns_ads::Database* database) {
  auto response = hns_ads::mojom::DBCommandResponseInfo::New();
  if (!database) {
    response->status =
        hns_ads::mojom::DBCommandResponseInfo::StatusType::RESPONSE_ERROR;
  } else {
...
- (instancetype)initWithNotificationInfo:
    (const hns_ads::NotificationAdInfo&)info;
@end

@interface InlineContentAdIOS ()
- (instancetype)initWithInlineContentAdInfo:
    (const hns_ads::InlineContentAdInfo&)info;
@end

@interface HnsAds () <AdsClientBridge> {
  AdsClientIOS* adsClient;
  hns_ads::AdsClientNotifier* adsClientNotifier;
  hns_ads::Ads* ads;
  hns_ads::Database* adsDatabase;
  hns_ads::AdEventHistory* adEventHistory;
...
@implementation HnsAds

- (instancetype)initWithStateStoragePath:(NSString*)path {
  if ((self = [super init])) {
    self.storagePath = path;
    self.commonOps = [[HnsCommonOperations alloc] initWithStoragePath:path];
    adsDatabase = nullptr;
    ...
    adsDatabase = new hns_ads::Database(base::FilePath(dbPath));

    adEventHistory = new hns_ads::AdEventHistory();
...
- (void)initializeWithSysInfo:(HnsAdsSysInfo*)sysInfo
             buildChannelInfo:(HnsAdsBuildChannelInfo*)buildChannelInfo
                   walletInfo:(nullable HnsAdsWalletInfo*)walletInfo
  ...
  adsClientNotifier = new hns_ads::AdsClientNotifier();
  ads = hns_ads::Ads::CreateInstance(adsClient);

  auto cppSysInfo =
      sysInfo ? sysInfo.cppObjPtr : hns_ads::mojom::SysInfo::New();
  ads->SetSysInfo(std::move(cppSysInfo));
  auto cppBuildChannelInfo = buildChannelInfo
                                 ? buildChannelInfo.cppObjPtr
                                 : hns_ads::mojom::BuildChannelInfo::New();
  ads->SetBuildChannel(std::move(cppBuildChannelInfo));
  ads->SetFlags(hns_ads::BuildFlags());

  auto cppWalletInfo =
      walletInfo ? walletInfo.cppObjPtr : hns_ads::mojom::WalletInfoPtr();
...
- (void)resetAdsDatabase {
  ...
  [NSFileManager.defaultManager
      removeItemAtPath:[dbPath stringByAppendingString:@"-journal"]
                 error:nil];
  adsDatabase =
      new hns_ads::Database(base::FilePath(base::SysNSStringToUTF8(dbPath)));
}
      ...
      self->ads->Shutdown(base::BindOnce(^(bool) {
        ...
        if (self->adsDatabase != nil) {
          self->databaseQueue->PostTask(
              FROM_HERE,
              base::BindOnce(
                  [](hns_ads::Database* database) { delete database; },
                  self->adsDatabase));
        }
...
- (void)addObserver:(hns_ads::AdsClientNotifierObserver*)observer {
  if (adsClientNotifier != nil) {
    adsClientNotifier->AddObserver(observer);
  }
}

- (void)removeObserver:(hns_ads::AdsClientNotifierObserver*)observer {
  if (adsClientNotifier != nil) {
...
- (NSArray<NSDate*>*)getAdsHistoryDates {
  ...
  const auto history_items = ads->GetHistory(
      hns_ads::HistoryFilterType::kNone, hns_ads::HistorySortType::kNone,
...
- (void)reportNotificationAdEvent:(NSString*)placementId
                        eventType:(HnsAdsNotificationAdEventType)eventType
  ...
  ads->TriggerNotificationAdEvent(
      ...
      static_cast<hns_ads::mojom::NotificationAdEventType>(eventType),
      base::BindOnce(^(const bool success) {
        completion(success);
      }));
}
...
- (void)reportNewTabPageAdEvent:(NSString*)wallpaperId
             creativeInstanceId:(NSString*)creativeInstanceId
                      eventType:(HnsAdsNewTabPageAdEventType)eventType
                     completion:(void (^)(BOOL success))completion {
  if (![self isAdsServiceRunning]) {
    return;
  }
  ads->TriggerNewTabPageAdEvent(
      ...
      static_cast<hns_ads::mojom::NewTabPageAdEventType>(eventType),
      base::BindOnce(^(const bool success) {
        completion(success);
      }));
}
...
- (void)reportInlineContentAdEvent:(NSString*)placementId
                creativeInstanceId:(NSString*)creativeInstanceId
                         eventType:(HnsAdsInlineContentAdEventType)eventType
                        completion:(void (^)(BOOL success))completion {
  if (![self isAdsServiceRunning]) {
    return;
  }
  ads->TriggerInlineContentAdEvent(
      base::SysNSStringToUTF8(placementId),
      base::SysNSStringToUTF8(creativeInstanceId),
      static_cast<hns_ads::mojom::InlineContentAdEventType>(eventType),
      base::BindOnce(^(const bool success) {
        completion(success);
      }));
}
...
- (void)reportPromotedContentAdEvent:(NSString*)placementId
                  creativeInstanceId:(NSString*)creativeInstanceId
                           eventType:
                               (HnsAdsPromotedContentAdEventType)eventType
                          completion:(void (^)(BOOL success))completion {
  if (![self isAdsServiceRunning]) {
    return;
  }
  ads->TriggerPromotedContentAdEvent(
      base::SysNSStringToUTF8(placementId),
      base::SysNSStringToUTF8(creativeInstanceId),
      static_cast<hns_ads::mojom::PromotedContentAdEventType>(eventType),
      base::BindOnce(^(const bool success) {
        completion(success);
      }));
}

- (void)purgeOrphanedAdEvents:(HnsAdsAdType)adType
                   completion:(void (^)(BOOL success))completion {
  if (![self isAdsServiceRunning]) {
    return;
  }
  ads->PurgeOrphanedAdEventsForType(
      static_cast<hns_ads::mojom::AdType>(adType),
      base::BindOnce(^(const bool success) {
        completion(success);
      }));
}
...
- (void)detailsForCurrentCycle:(void (^)(NSInteger adsReceived,
  ...
  ads->GetStatementOfAccounts(
      base::BindOnce(^(hns_ads::mojom::StatementInfoPtr statement) {
        if (!statement) {
          completion(0, 0, nil);
          return;
        }
...
- (void)toggleThumbsUpForAd:(NSString*)creativeInstanceId
  ...
  hns_ads::AdContentInfo ad_content;
  ad_content.type = hns_ads::AdType::kNotificationAd;
  ...
  ads->ToggleLikeAd(hns_ads::AdContentToValue(ad_content));
}
...
- (void)toggleThumbsDownForAd:(NSString*)creativeInstanceId
  ...
  ad_content.advertiser_id = base::SysNSStringToUTF8(advertiserId);
  ad_content.segment = base::SysNSStringToUTF8(segment);
  ads->ToggleDislikeAd(hns_ads::AdContentToValue(ad_content));
}
...
- (void)UrlRequest:(hns_ads::mojom::UrlRequestInfoPtr)url_request
          callback:(hns_ads::UrlRequestCallback)callback {
  std::map<hns_ads::mojom::UrlRequestMethodType, std::string> methodMap{
      {hns_ads::mojom::UrlRequestMethodType::kGet, "GET"},
      {hns_ads::mojom::UrlRequestMethodType::kPost, "POST"},
      {hns_ads::mojom::UrlRequestMethodType::kPut, "PUT"}};
      ...
      loadURLRequest:url_request->url.spec()
        ...
        content_type:url_request->content_type
            ...
            callback:^(
              ...
              hns_ads::mojom::UrlResponseInfo url_response;
...
- (BOOL)registerAdsResourcesForLanguageCode:(NSString*)languageCode {
  ...
  BLOG(1, @"Registering Hns Ads Resources Installer (%@) with id %@",
...
- (void)downloadAdsResource:(NSString*)folderName
  ...
  NSString* baseUrl = @"https://hns-user-model-installer-input.s3.hns.com";
  const auto flags = hns_rewards::RewardsFlags::ForCurrentProcess();
  if (flags.environment) {
    switch (*flags.environment) {
      ...
      case hns_rewards::RewardsFlags::Environment::kStaging:
        baseUrl = @"https://"
                  @"hns-user-model-installer-input-dev.s3.hnssoftware.com";
        break;
...
- (void)getBrowsingHistory:(const int)max_count
                  ...
                  callback:(hns_ads::GetBrowsingHistoryCallback)callback {
  // To be implemented https://github.com/hnsvn/hns-ios/issues/3499
  std::move(callback).Run({});
}

- (void)loadFileResource:(const std::string&)id
                 version:(const int)version
                callback:(hns_ads::LoadFileCallback)callback {
...
- (void)getScheduledCaptcha:(const std::string&)payment_id
                   callback:(hns_ads::GetScheduledCaptchaCallback)callback {
...
- (void)load:(const std::string&)name
    callback:(hns_ads::LoadCallback)callback {
...
- (const std::string)loadDataResource:(const std::string&)name {
  const auto bundle = [NSBundle bundleForClass:[HnsAds class]];
...
- (void)save:(const std::string&)name
    ...
    callback:(hns_ads::SaveCallback)callback {
...
- (void)showNotificationAd:(const hns_ads::NotificationAdInfo&)info {
...
- (void)showReminder:(const hns_ads::mojom::ReminderType)type {
  // Not needed on iOS
}
...
- (void)runDBTransaction:(hns_ads::mojom::DBTransactionInfoPtr)transaction
                callback:(hns_ads::RunDBTransactionCallback)completion {
  __weak HnsAds* weakSelf = self;
  databaseQueue->PostTaskAndReplyWithResult(
      FROM_HERE,
      base::BindOnce(&RunDBTransactionOnTaskRunner, std::move(transaction),
                     adsDatabase),
      base::BindOnce(
          ^(hns_ads::RunDBTransactionCallback callback,
            hns_ads::mojom::DBCommandResponseInfoPtr response) {
            const auto strongSelf = weakSelf;
            if (!strongSelf || ![strongSelf isAdsServiceRunning]) {
              return;
            }
...
- (bool)getBooleanPref:(const std::string&)path {
  // TODO(https://github.com/hnsvn/hns-browser/issues/32112): Remove the
  // code that permanently sets values for preferences when the issue is
  // resolved.
  if (path == hns_news::prefs::kHnsNewsOptedIn ||
...
- (int)getIntegerPref:(const std::string&)path {
  ...
  // code that permanently sets values for preferences when the issue is
  // resolved.
  if (path == hns_ads::prefs::kIssuerPing && ![self hasPrefPath:path]) {
    return 7'200'000;
  }
...
- (std::string)getStringPref:(const std::string&)path {
  ...
  // code that permanently sets values for preferences when the issue is
  // resolved.
  if (path == hns_ads::prefs::kSubdivisionTargetingSubdivision) {
    return "AUTO";
  }
