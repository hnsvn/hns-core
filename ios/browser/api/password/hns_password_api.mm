...
#include "hns/ios/browser/api/password/password_store_listener_ios.h"
...
#pragma mark - HnsPasswordAPI

@interface HnsPasswordAPI () {
  scoped_refptr<password_manager::PasswordStoreInterface> password_store_;
}
@end

@implementation HnsPasswordAPI
...
- (void)getSavedLogins:
  ...
  __weak HnsPasswordAPI* weakSelf = self;
...
- (void)getSavedLoginsForURL:(NSURL*)url
  ...
  password_manager::PasswordFormDigest form_digest_args =
      password_manager::PasswordFormDigest(
          /*scheme*/ hns::ios::PasswordManagerSchemeFromPasswordFormScheme(
              formScheme),
