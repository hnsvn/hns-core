...
#include "hns/ios/browser/api/opentabs/sendtab_model_listener_ios.h"
...
@interface SendTabToSelfModelListenerImpl () {
  std::unique_ptr<hns::ios::SendTabToSelfModelListenerIOS> observer_;
...
- (instancetype)init:(id<SendTabToSelfModelStateObserver>)observer
  ...
  if ((self = [super init])) {
    observer_ = std::make_unique<hns::ios::SendTabToSelfModelListenerIOS>(
