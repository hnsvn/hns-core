...
#ifndef HNS_IOS_BROWSER_API_OPENTABS_HNS_OPENTABS_API_H_
#define HNS_IOS_BROWSER_API_OPENTABS_HNS_OPENTABS_API_H_
...
NS_SWIFT_NAME(HnsOpenTabsAPI)
OBJC_EXPORT
@interface HnsOpenTabsAPI : NSObject
...
#endif  // HNS_IOS_BROWSER_API_OPENTABS_HNS_OPENTABS_API_H_
