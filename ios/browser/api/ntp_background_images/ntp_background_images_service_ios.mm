...
#include "hns/ios/browser/api/ntp_background_images/ntp_background_image+private.h"
#include "hns/ios/browser/api/ntp_background_images/ntp_sponsored_image+private.h"
