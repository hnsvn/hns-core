...
#ifndef HNS_IOS_BROWSER_API_BOOKMARKS_HNS_BOOKMARKS_API_H_
#define HNS_IOS_BROWSER_API_BOOKMARKS_HNS_BOOKMARKS_API_H_
...
NS_SWIFT_NAME(HnsBookmarksAPI)
OBJC_EXPORT
@interface HnsBookmarksAPI : NSObject
...
#endif  // HNS_IOS_BROWSER_API_BOOKMARKS_HNS_BOOKMARKS_API_H_
