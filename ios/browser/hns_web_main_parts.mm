...
HnsWebMainParts::HnsWebMainParts() {}

HnsWebMainParts::~HnsWebMainParts() {}

void HnsWebMainParts::PreCreateMainMessageLoop() {
  ...
  base::FilePath hns_pack_path;
  base::PathService::Get(base::DIR_ASSETS, &hns_pack_path);
  hns_pack_path = hns_pack_path.AppendASCII("hns_resources.pak");
  ui::ResourceBundle::GetSharedInstance().AddDataPackFromPath(
      hns_pack_path, ui::kScaleFactorNone);
}

void HnsWebMainParts::PreCreateThreads() {
  ...
  application_context_.reset(new HnsApplicationContextImpl(
...
void HnsWebMainParts::SetupMetrics() {
...
void HnsWebMainParts::SetupFieldTrials() {
...
void HnsWebMainParts::PreMainMessageLoopRun() {
  ...
  hns::EnsureBrowserStateKeyedServiceFactoriesBuilt();
  ...
  // Start the hns services
  application_context_->StartHnsServices();
}

void HnsWebMainParts::PostMainMessageLoopRun() {
  application_context_->StartTearDown();
}

void HnsWebMainParts::PostDestroyThreads() {
  application_context_->PostDestroyThreads();
}

void HnsWebMainParts::PostCreateThreads() {
