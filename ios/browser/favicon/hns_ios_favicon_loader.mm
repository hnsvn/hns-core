...
HnsFaviconLoader::HnsFaviconLoader(favicon::FaviconService* favicon_service)
    : favicon_service_(favicon_service) {}
HnsFaviconLoader::~HnsFaviconLoader() {}

void HnsFaviconLoader::FaviconForPageUrlOrHost(
    const GURL& page_url,
...
void HnsFaviconLoader::CancellAllRequests() {
  cancelable_task_tracker_.TryCancelAll();
}

base::WeakPtr<HnsFaviconLoader> HnsFaviconLoader::AsWeakPtr() {
