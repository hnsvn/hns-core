...
#ifndef HNS_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_HNS_CONTENT_SETTINGS_PREF_PROVIDER_H_
#define HNS_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_HNS_CONTENT_SETTINGS_PREF_PROVIDER_H_
...
class HnsPrefProvider : public PrefProvider,
                          public Observer {
 public:
  HnsPrefProvider(PrefService* prefs,
                    bool off_the_record,
                    bool store_last_modified,
                    bool restore_session);
  HnsPrefProvider(const HnsPrefProvider&) = delete;
  HnsPrefProvider& operator=(const HnsPrefProvider&) = delete;
  ~HnsPrefProvider() override;
 ...
 private:
  friend class HnsPrefProviderTest;
  FRIEND_TEST_ALL_PREFIXES(HnsPrefProviderTest, TestShieldsSettingsMigration);
  FRIEND_TEST_ALL_PREFIXES(HnsPrefProviderTest,
  ...
  FRIEND_TEST_ALL_PREFIXES(HnsPrefProviderTest, EnsureNoWildcardEntries);
  FRIEND_TEST_ALL_PREFIXES(HnsPrefProviderTest, MigrateFPShieldsSettings);
  ...
  base::WeakPtrFactory<HnsPrefProvider> weak_factory_;
};

}  //  namespace content_settings

#endif  // HNS_COMPONENTS_CONTENT_SETTINGS_CORE_BROWSER_HNS_CONTENT_SETTINGS_PREF_PROVIDER_H_
