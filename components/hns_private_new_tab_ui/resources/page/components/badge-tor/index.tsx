...
import getPageHandlerInstance, { ConnectionStatus } from '../../api/hns_page_handler'
...
function contactHnsSupport () {
  getPageHandlerInstance().pageHandler.goToHnsSupport()
}
...
function BadgeTor (props: Props) {
  ...
  if (props.isConnected || props.connectionStatus === ConnectionStatus.kConnected) {
    ...
    helpElement = (<p>
      ...
      {or}
      <a onClick={contactHnsSupport}>{contactSupport}</a>
      {rest}
    </p>)
