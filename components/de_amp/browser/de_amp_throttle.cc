...
#include "hns/components/de_amp/browser/de_amp_url_loader.h"
...
constexpr char kDeAmpHeaderName[] = "X-Hns-De-AMP";
...
std::unique_ptr<DeAmpThrottle> DeAmpThrottle::MaybeCreateThrottleFor(
  ...
  if (!base::FeatureList::IsEnabled(de_amp::features::kHnsDeAMP) ||
...
bool DeAmpThrottle::OpenCanonicalURL(const GURL& new_url,
  ...
  // https://github.com/hnsvn/hns-browser/issues/22610
