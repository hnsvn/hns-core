 ...
 public:
  DeAmpBrowserTest() {
    ...
    feature_list_.InitWithFeatures(
        /*enabled_features*/ {de_amp::features::kHnsDeAMP},
        disabled_features);
  }
...
std::unique_ptr<net::test_server::HttpResponse> HandleRedirect(
  ...
  if (request.headers.find("X-Hns-De-AMP") != request.headers.end()) {
...
class DeAmpBrowserTestBaseFeatureDisabled : public DeAmpBrowserTest {
 public:
  DeAmpBrowserTestBaseFeatureDisabled() {
    feature_list_.Reset();
    feature_list_.InitAndDisableFeature(de_amp::features::kHnsDeAMP);
  }
};
