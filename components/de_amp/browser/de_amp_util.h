...
#ifndef HNS_COMPONENTS_DE_AMP_BROWSER_DE_AMP_UTIL_H_
#define HNS_COMPONENTS_DE_AMP_BROWSER_DE_AMP_UTIL_H_
...
#endif  // HNS_COMPONENTS_DE_AMP_BROWSER_DE_AMP_UTIL_H_
