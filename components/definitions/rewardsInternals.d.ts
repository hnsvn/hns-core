...
declare namespace RewardsInternals {
  ...
  export interface State {
    balance: import(
      'gen/hns/components/hns_rewards/common/mojom/rewards_types.mojom.m.js'
    ).Balance
    info: {
  ...
  type WalletStatus = import('gen/hns/components/hns_rewards/common/mojom/rewards_types.mojom.m.js').WalletStatus
  ...
  type Environment = import('gen/hns/components/hns_rewards/common/mojom/rewards_types.mojom.m.js').Environment
}
