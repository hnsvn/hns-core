...
document.addEventListener('DOMContentLoaded', function () {
  [$('channel-promo-beta'), $('channel-promo-dev')].forEach((node, index) => {
    const text1 = document.createTextNode('Interested in cool new Hns features? Try our ')
    ...
    if (index === 0) {
      link.setAttribute('href', 'https://hns.com/download-beta/')
      link.textContent = 'beta channel'
    } else {
      link.setAttribute('href', 'https://hns.com/download-nightly/')
