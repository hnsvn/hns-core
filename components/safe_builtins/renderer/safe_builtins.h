...
#ifndef HNS_COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
#define HNS_COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
...
class SafeBuiltins {
 public:
  ...
  // //hns/components/hns_wallt/resources for now.
...
#endif  // HNS_COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
