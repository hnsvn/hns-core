...
public class HnsSiteSettingsPreferencesBase extends SiteSettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SettingsUtils.addPreferencesFromResource(this, R.xml.hns_site_settings_preferences);
        configureHnsPreferences();
        updateHnsPreferenceStates();
    }
