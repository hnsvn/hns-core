...
public class HnsContentSettingsResources extends ContentSettingsResources {
    // Placeholder class
    ...
    protected static ResourceItem getResourceItem(int contentType, SiteSettingsDelegate delegate) {
        ...
        return (ResourceItem) HnsReflectionUtil.InvokeMethod(ContentSettingsResources.class, null,
