...
public class HnsFourStateCookieSettingsPreferenceBase extends Preference {
    private Context mContext;
    private RadioButtonWithDescription mBlockThirdPartyIncognitoButton;

    public HnsFourStateCookieSettingsPreferenceBase(Context context, AttributeSet attrs) {
        super(context, attrs);
