...
const char kWalletDataFilesDisplayName[] = "Hns Wallet data files";
...
// <profile>\AppData\Local\Google\Chrome\User Data\HnsWallet\.
...
void RegisterWalletDataFilesComponent(
  ...
  bool should_register_component =
      IsNativeWalletEnabled() && IsHnsWalletConfiguredOnAndroid();
#else
