...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_TX_META_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_TX_META_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_TX_META_H_
