...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
