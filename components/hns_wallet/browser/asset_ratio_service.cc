...
net::NetworkTrafficAnnotationTag GetNetworkTrafficAnnotationTag() {
  return net::DefineNetworkTrafficAnnotation("asset_ratio_service", R"(
      semantics {
        ...
        description:
          "This service is used to obtain asset prices for the Hns wallet."
        trigger:
...
std::string TimeFrameKeyToString(
    hns_wallet::mojom::AssetPriceTimeframe timeframe) {
  std::string timeframe_key;
  switch (timeframe) {
    case hns_wallet::mojom::AssetPriceTimeframe::Live:
      timeframe_key = "live";
      break;
    case hns_wallet::mojom::AssetPriceTimeframe::OneDay:
      timeframe_key = "1d";
      break;
    case hns_wallet::mojom::AssetPriceTimeframe::OneWeek:
      timeframe_key = "1w";
      break;
    case hns_wallet::mojom::AssetPriceTimeframe::OneMonth:
      timeframe_key = "1m";
      break;
    case hns_wallet::mojom::AssetPriceTimeframe::ThreeMonths:
      timeframe_key = "3m";
      break;
    case hns_wallet::mojom::AssetPriceTimeframe::OneYear:
      timeframe_key = "1y";
      break;
    case hns_wallet::mojom::AssetPriceTimeframe::All:
      timeframe_key = "all";
      break;
  }
...
absl::optional<std::string> ChainIdToStripeChainId(
  ...
  static base::NoDestructor<base::flat_map<std::string, std::string>>
      chain_id_lookup(
          {{hns_wallet::mojom::kMainnetChainId, "ethereum"},
           {hns_wallet::mojom::kSolanaMainnet, "solana"},
           {hns_wallet::mojom::kPolygonMainnetChainId, "polygon"}});
...
void AssetRatioService::GetPrice(
  ...
  api_request_helper_->Request(
      ...
      std::move(internal_callback), MakeHnsServicesKeyHeader(),
...
void AssetRatioService::OnGetPrice(std::vector<std::string> from_assets,
                                   ...
                                   GetPriceCallback callback,
                                   APIRequestResult api_request_result) {
  std::vector<hns_wallet::mojom::AssetPricePtr> prices;
  if (!api_request_result.Is2XXResponseCode()) {
