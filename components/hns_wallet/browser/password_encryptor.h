...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
