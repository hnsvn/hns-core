...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_SWAP_SERVICE_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_SWAP_SERVICE_H_
...
class SwapService : public KeyedService, public mojom::SwapService {
 public:
  ...
  void GetHnsFee(mojom::HnsSwapFeeParamsPtr params,
                   GetHnsFeeCallback callback) override;
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_SWAP_SERVICE_H_
