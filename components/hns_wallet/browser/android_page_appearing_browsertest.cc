...
class AndroidPageAppearingBrowserTest : public PlatformBrowserTest {
 ...
 protected:
  ...
  void InitWallet() {
    ...
    json_rpc_service_ =
        hns_wallet::JsonRpcServiceFactory::GetServiceForContext(GetProfile());
    json_rpc_service_->SetAPIRequestHelperForTesting(
        shared_url_loader_factory_);
    asset_ratio_service_ =
        hns_wallet::AssetRatioServiceFactory::GetServiceForContext(
            GetProfile());
    ...
    keyring_service_->RestoreWallet(
        kMnemonicDivideCruise, kPasswordHns, false,
  ...
  raw_ptr<hns_wallet::AssetRatioService> asset_ratio_service_;
  raw_ptr<hns_wallet::KeyringService> keyring_service_;
  raw_ptr<hns_wallet::JsonRpcService> json_rpc_service_;
  raw_ptr<hns_wallet::HnsWalletService> wallet_service_;
