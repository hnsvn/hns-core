...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_HNS_WALLET_UTILS_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_HNS_WALLET_UTILS_H_
...
// This is mainly used for restoring legacy hns crypto wallet
...
// Append chain value to kHnsWalletCustomNetworks dictionary pref.
...
// Get/Set the current chain ID for coin from kHnsWalletSelectedNetworks pref
// when origin is not presetned. If origin is presented,
// kHnsWalletSelectedNetworksPerOrigin will be used. In addition, if origin is
// opaque, we will also fallback to kHnsWalletSelectedNetworks but it will be
...
// HnsWallet/v[chromium-version]. Note that we expose only the Chromium
// version and not the Hns version because that way no extra entropy
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_HNS_WALLET_UTILS_H_
