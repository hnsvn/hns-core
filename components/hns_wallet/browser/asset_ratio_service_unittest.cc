...
void OnGetPrice(bool* callback_run,
                ...
                std::vector<hns_wallet::mojom::AssetPricePtr> expected_values,
                bool success,
                std::vector<hns_wallet::mojom::AssetPricePtr> values) {
...
void OnGetPriceHistory(
    bool* callback_run,
    bool expected_success,
    std::vector<hns_wallet::mojom::AssetTimePricePtr> expected_values,
    bool success,
    std::vector<hns_wallet::mojom::AssetTimePricePtr> values) {
  EXPECT_EQ(expected_success, success);
  EXPECT_EQ(expected_values, values);
  *callback_run = true;
}
...
void OnGetCoinMarkets(
    bool* callback_run,
    bool expected_success,
    std::vector<hns_wallet::mojom::CoinMarketPtr> expected_values,
    bool success,
    std::vector<hns_wallet::mojom::CoinMarketPtr> values) {
  EXPECT_EQ(expected_success, success);
  EXPECT_EQ(expected_values, values);
  *callback_run = true;
}
...
TEST_F(AssetRatioServiceUnitTest, GetPrice) {
  ...
  std::vector<hns_wallet::mojom::AssetPricePtr> expected_prices_response;
  auto asset_price = hns_wallet::mojom::AssetPrice::New();
  ...
  asset_price = hns_wallet::mojom::AssetPrice::New();
  asset_price->from_asset = "bat";
  ...
  asset_ratio_service_->GetPrice(
      {"bat", "link"}, {"btc", "usd"},
      hns_wallet::mojom::AssetPriceTimeframe::OneDay,
...
TEST_F(AssetRatioServiceUnitTest, GetPriceUppercase) {
  ...
  bool callback_run = false;
  asset_ratio_service_->GetPrice(
      {"BAT"}, {"BTC"}, hns_wallet::mojom::AssetPriceTimeframe::OneDay,
      base::BindOnce(&OnGetPrice, &callback_run, true,
                     std::move(expected_prices_response)));
...
TEST_F(AssetRatioServiceUnitTest, GetPriceHistory) {
  ...
  std::vector<hns_wallet::mojom::AssetTimePricePtr>
      expected_price_history_response;

  auto asset_time_price = hns_wallet::mojom::AssetTimePrice::New();
  ...
  asset_time_price = hns_wallet::mojom::AssetTimePrice::New();
  ...
  asset_ratio_service_->GetPriceHistory(
      "bat", "usd", hns_wallet::mojom::AssetPriceTimeframe::OneDay,
...
TEST_F(AssetRatioServiceUnitTest, GetPriceHistoryURL) {
  ...
  EXPECT_EQ("/v2/history/coingecko/eth/cad/live",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", hns_wallet::mojom::AssetPriceTimeframe::Live)
                .path());
  EXPECT_EQ("/v2/history/coingecko/eth/cad/1w",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", hns_wallet::mojom::AssetPriceTimeframe::OneWeek)
                .path());
  EXPECT_EQ(
      "/v2/history/coingecko/eth/cad/1m",
      AssetRatioService::GetPriceHistoryURL(
          "eth", "cad", hns_wallet::mojom::AssetPriceTimeframe::OneMonth)
          .path());
  EXPECT_EQ(
      "/v2/history/coingecko/eth/cad/3m",
      AssetRatioService::GetPriceHistoryURL(
          "eth", "cad", hns_wallet::mojom::AssetPriceTimeframe::ThreeMonths)
          .path());
  EXPECT_EQ("/v2/history/coingecko/eth/cad/1y",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", hns_wallet::mojom::AssetPriceTimeframe::OneYear)
                .path());
  EXPECT_EQ("/v2/history/coingecko/eth/cad/all",
            AssetRatioService::GetPriceHistoryURL(
                "eth", "cad", hns_wallet::mojom::AssetPriceTimeframe::All)
                .path());
}
...
TEST_F(AssetRatioServiceUnitTest, GetCoinMarkets) {
  ...
  std::vector<hns_wallet::mojom::CoinMarketPtr>
      expected_coin_markets_response;

  auto coin_market = hns_wallet::mojom::CoinMarket::New();
