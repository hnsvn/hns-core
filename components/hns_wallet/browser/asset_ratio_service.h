...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_RATIO_SERVICE_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_RATIO_SERVICE_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_RATIO_SERVICE_H_
