...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_TEST_UTILS_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_TEST_UTILS_H_
...
constexpr char kMnemonicDivideCruise[] =
    ...
    "drive";
constexpr char kTestWalletPassword[] = "hns";
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_TEST_UTILS_H_
