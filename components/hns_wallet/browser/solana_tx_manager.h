...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_TX_MANAGER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_TX_MANAGER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_TX_MANAGER_H_
