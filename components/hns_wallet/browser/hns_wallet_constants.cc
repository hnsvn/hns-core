...
const base::flat_map<std::string, std::string>& GetInfuraChainEndpoints() {
  static base::NoDestructor<base::flat_map<std::string, std::string>> endpoints(
      {{hns_wallet::mojom::kPolygonMainnetChainId,
        "https://mainnet-polygon.hns.com/"},
       {hns_wallet::mojom::kOptimismMainnetChainId,
        "https://mainnet-optimism.hns.com/"},
       {hns_wallet::mojom::kAuroraMainnetChainId,
        "https://mainnet-aurora.hns.com/"},
       {hns_wallet::mojom::kAvalancheMainnetChainId,
        "https://mainnet-avalanche.wallet.hns.com/"}});
...
const std::string GetAssetRatioBaseURL() {
  ...
  if (ratios_url.empty()) {
    ratios_url = "https://ratios.wallet.hns.com";
  }
