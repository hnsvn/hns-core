...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_NFT_METADATA_FETCHER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_NFT_METADATA_FETCHER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_NFT_METADATA_FETCHER_H_
