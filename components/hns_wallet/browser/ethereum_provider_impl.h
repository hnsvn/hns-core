...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_ETHEREUM_PROVIDER_IMPL_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_ETHEREUM_PROVIDER_IMPL_H_
...
#include "hns/components/hns_wallet/browser/eth_logs_tracker.h"
...
class EthereumProviderImpl final : public mojom::EthereumProvider,
 ...
 private:
  ...
  std::unique_ptr<HnsWalletProviderDelegate> delegate_;
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_ETHEREUM_PROVIDER_IMPL_H_
