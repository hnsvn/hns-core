...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
