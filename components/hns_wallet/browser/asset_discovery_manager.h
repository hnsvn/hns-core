...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_DISCOVERY_MANAGER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_DISCOVERY_MANAGER_H_
...
class AssetDiscoveryManager : public KeyringServiceObserverBase {
 public:
  ...
  AssetDiscoveryManager(
      ...
      HnsWalletService* wallet_service,
  ...
  // Called by frontend via HnsWalletService and when new accounts are added
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_ASSET_DISCOVERY_MANAGER_H_
