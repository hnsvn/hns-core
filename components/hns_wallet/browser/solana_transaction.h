...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_TRANSACTION_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_TRANSACTION_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_TRANSACTION_H_
