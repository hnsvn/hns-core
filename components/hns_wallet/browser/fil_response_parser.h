...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_FIL_RESPONSE_PARSER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_FIL_RESPONSE_PARSER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_FIL_RESPONSE_PARSER_H_
