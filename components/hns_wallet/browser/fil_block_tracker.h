...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_FIL_BLOCK_TRACKER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_FIL_BLOCK_TRACKER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_FIL_BLOCK_TRACKER_H_
