...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_BLOCKCHAIN_LIST_PARSER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_BLOCKCHAIN_LIST_PARSER_H_
...
using DappListMap =
    base::flat_map<std::string, std::vector<hns_wallet::mojom::DappPtr>>;
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_BLOCKCHAIN_LIST_PARSER_H_
