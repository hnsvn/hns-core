...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_INTERNAL_HD_KEY_BASE_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_INTERNAL_HD_KEY_BASE_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_INTERNAL_HD_KEY_BASE_H_
