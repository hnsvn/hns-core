...
#include "hns/components/hns_wallet/browser/simple_hash_client.h"
...
#include "hns/components/hns_wallet/common/string_utils.h"
...
GetSimpleHashClientNetworkTrafficAnnotationTag() {
  return net::DefineNetworkTrafficAnnotation("hns_wallet_service", R"(
      semantics {
        sender: "SimpleHash Client"
        description:
          "This client is used to make requests to SimpleHash "
          "of the user interacting with the native Hns wallet."
        trigger:
...
absl::optional<std::string> ChainIdToSimpleHashChainId(
  ...
  static base::NoDestructor<base::flat_map<std::string, std::string>>
      chain_id_lookup({
          {hns_wallet::mojom::kMainnetChainId, kEthereum},
          {hns_wallet::mojom::kSolanaMainnet, kSolana},
          {hns_wallet::mojom::kPolygonMainnetChainId, kPolygon},
          {hns_wallet::mojom::kArbitrumMainnetChainId, kArbitrum},
          {hns_wallet::mojom::kOptimismMainnetChainId, kOptimism},
          {hns_wallet::mojom::kAvalancheMainnetChainId, kAvalanche},
          {hns_wallet::mojom::kBinanceSmartChainMainnetChainId, kBsc},
          {hns_wallet::mojom::kGoerliChainId, kEthereumGoerli},
          {hns_wallet::mojom::kSolanaTestnet, kSolanaTestnet},
          {hns_wallet::mojom::kSolanaDevnet, kSolanaDevnet},
          {hns_wallet::mojom::kArbitrumNovaChainId, kArbitrumNova},
          {hns_wallet::mojom::kGnosisChainId, kGnosis},
          {hns_wallet::mojom::kGodwokenChainId, kGodwoken},
          {hns_wallet::mojom::kPalmChainId, kPalm},
          {hns_wallet::mojom::kPolygonZKEVMChainId, kPolygonZkEvm},
          {hns_wallet::mojom::kZkSyncEraChainId, kZkSyncEra},
      });
...
absl::optional<std::string> SimpleHashChainIdToChainId(
  ...
  static base::NoDestructor<base::flat_map<std::string, std::string>>
      simple_hash_chain_id_lookup({
          {kEthereum, hns_wallet::mojom::kMainnetChainId},
          {kSolana, hns_wallet::mojom::kSolanaMainnet},
          {kPolygon, hns_wallet::mojom::kPolygonMainnetChainId},
          {kArbitrum, hns_wallet::mojom::kArbitrumMainnetChainId},
          {kOptimism, hns_wallet::mojom::kOptimismMainnetChainId},
          {kAvalanche, hns_wallet::mojom::kAvalancheMainnetChainId},
          {kBsc, hns_wallet::mojom::kBinanceSmartChainMainnetChainId},
          {kEthereumGoerli, hns_wallet::mojom::kGoerliChainId},
          {kSolanaTestnet, hns_wallet::mojom::kSolanaTestnet},
          {kSolanaDevnet, hns_wallet::mojom::kSolanaDevnet},
          {kArbitrumNova, hns_wallet::mojom::kArbitrumNovaChainId},
          {kGnosis, hns_wallet::mojom::kGnosisChainId},
          {kGodwoken, hns_wallet::mojom::kGodwokenChainId},
          {kPalm, hns_wallet::mojom::kPalmChainId},
          {kPolygonZkEvm, hns_wallet::mojom::kPolygonZKEVMChainId},
          {kZkSyncEra, hns_wallet::mojom::kZkSyncEraChainId},
      });
...
base::flat_map<std::string, std::string> MakeHnsServicesKeyHeader() {
  ...
  request_headers["x-hns-key"] = std::move(hns_key);
...
// Calls
// https://simplehash.wallet.hns.com/api/v0/nfts/owners?chains={chains}&wallet_addresses={wallet_addresses}
...
SimpleHashClient::ParseNFTsFromSimpleHash(const base::Value& json_value,
  ...
  for (const auto& nft_value : *nfts) {
    ...
    // https://github.com/hnsvn/hns-browser/issues/29304
...
GURL SimpleHashClient::GetSimpleHashNftsByWalletUrl(
  ...
  std::string urlStr =
      base::StrCat({kSimpleHashHnsProxyUrl, "/api/v0/nfts/owners"});
