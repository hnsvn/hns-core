...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_ALLOWANCE_MANAGER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_ALLOWANCE_MANAGER_H_
...
class EthAllowanceManager {
 public:
  ...
  using ResultCallback =
      mojom::HnsWalletService::DiscoverEthAllowancesCallback;
 ...
 private:
  ...
  struct EthAllowanceTask {
    ...
    hns_wallet::uint256_t latest_block_number_;
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_ALLOWANCE_MANAGER_H_
