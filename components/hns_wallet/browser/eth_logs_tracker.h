...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_LOGS_TRACKER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_LOGS_TRACKER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_LOGS_TRACKER_H_
