...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_PROVIDER_IMPL_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_PROVIDER_IMPL_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_SOLANA_PROVIDER_IMPL_H_
