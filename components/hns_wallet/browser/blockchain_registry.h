...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_BLOCKCHAIN_REGISTRY_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_BLOCKCHAIN_REGISTRY_H_
...
class BlockchainRegistry : public mojom::BlockchainRegistry {
 ...
 private:
  ...
  std::vector<hns_wallet::mojom::BlockchainTokenPtr> GetBuyTokens(
      const std::vector<mojom::OnRampProvider>& providers,
      const std::string& chain_id);
};
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_BLOCKCHAIN_REGISTRY_H_
