...
#include "hns/components/hns_wallet/browser/solana_tx_manager.h"
...
#include "hns/components/hns_wallet/browser/solana_block_tracker.h"
...
#include "hns/components/hns_wallet/browser/solana_tx_meta.h"
#include "hns/components/hns_wallet/browser/solana_tx_state_manager.h"
...
class SolanaTxManagerUnitTest : public testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    hns_wallet::RegisterLocalStatePrefs(local_state_.registry());
  ...
  void AddUnapprovedTransaction(const std::string& chain_id,
    ...
    AddUnapprovedTransaction(chain_id, std::move(solana_tx_data), from,
                             GetOrigin(), meta_id, absl::nullopt);
  }
