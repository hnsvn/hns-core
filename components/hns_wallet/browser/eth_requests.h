...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_REQUESTS_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_REQUESTS_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_ETH_REQUESTS_H_
