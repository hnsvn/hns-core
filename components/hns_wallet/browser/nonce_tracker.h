...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_NONCE_TRACKER_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_NONCE_TRACKER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_NONCE_TRACKER_H_
