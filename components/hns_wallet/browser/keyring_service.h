...
#ifndef HNS_COMPONENTS_HNS_WALLET_BROWSER_KEYRING_SERVICE_H_
#define HNS_COMPONENTS_HNS_WALLET_BROWSER_KEYRING_SERVICE_H_
...
#include "hns/components/hns_wallet/browser/account_discovery_manager.h"
#include "hns/components/hns_wallet/browser/hd_keyring.h"
#include "hns/components/hns_wallet/browser/password_encryptor.h"
...
class KeyringService : public KeyedService, public mojom::KeyringService {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(KeyringServiceUnitTest, RestoreLegacyHnsWallet);
...
#endif  // HNS_COMPONENTS_HNS_WALLET_BROWSER_KEYRING_SERVICE_H_
