...
TEST(HnsWalletResponseHelpersTest, GetProviderErrorDictionary) {
...
TEST(HnsWalletResponseHelpersTest,
...
TEST(HnsWalletResponseHelpersTest, ToProviderResponseEmpty) {
...
TEST(HnsWalletResponseHelpersTest, ToProviderResponseSuccess) {
...
TEST(HnsWalletResponseHelpersTest, ToProviderResponseError) {
  base::Value value("test");
