...
#ifndef HNS_COMPONENTS_HNS_WALLET_RENDERER_V8_HELPER_H_
#define HNS_COMPONENTS_HNS_WALLET_RENDERER_V8_HELPER_H_
...
// but if the user goes into settings and explicitly selects to use Hns Wallet
...
#endif  // HNS_COMPONENTS_HNS_WALLET_RENDERER_V8_HELPER_H_
