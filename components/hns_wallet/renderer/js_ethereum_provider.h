...
#ifndef HNS_COMPONENTS_HNS_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
#define HNS_COMPONENTS_HNS_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
...
class JSEthereumProvider final : public gin::Wrappable<JSEthereumProvider>,
 ...
 private:
  ...
  const std::string& GetHnsWalletImage();
  ...
  std::string uuid_;
  absl::optional<std::string> hns_wallet_image_;
  base::WeakPtrFactory<JSEthereumProvider> weak_ptr_factory_{this};
};

}  // namespace hns_wallet

#endif  // HNS_COMPONENTS_HNS_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
