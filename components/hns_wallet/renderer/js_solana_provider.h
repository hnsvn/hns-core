...
#ifndef HNS_COMPONENTS_HNS_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
#define HNS_COMPONENTS_HNS_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
...
class JSSolanaProvider final : public gin::Wrappable<JSSolanaProvider>,
 ...
 private:
  ...
  bool GetIsHnsWallet(gin::Arguments* arguments);
...
#endif  // HNS_COMPONENTS_HNS_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
