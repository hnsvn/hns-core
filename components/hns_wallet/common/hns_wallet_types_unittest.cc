...
TEST(HnsWalletTypesTest, OverflowWorksAsExpected) {
...
TEST(HnsWalletTypesTest, SolanaSignatureStatusFromValue) {
...
TEST(HnsWalletTypesTest, SolanaSignatureStatusToValue) {
...
TEST(HnsWalletTypesTest, ValidSolidityBits) {
...
TEST(HnsWalletTypesTest, MaxSolidityUint) {
...
TEST(HnsWalletTypesTest, MaxSolidityInt) {
...
TEST(HnsWalletTypesTest, MinSolidityInt) {
