...
#ifndef HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_REQUEST_HELPER_H_
#define HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_REQUEST_HELPER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_REQUEST_HELPER_H_
