...
#ifndef HNS_COMPONENTS_HNS_WALLET_COMMON_BITCOIN_UTILS_H_
#define HNS_COMPONENTS_HNS_WALLET_COMMON_BITCOIN_UTILS_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_COMMON_BITCOIN_UTILS_H_
