...
#ifndef HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_SIGN_TYPED_DATA_HELPER_H_
#define HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_SIGN_TYPED_DATA_HELPER_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_SIGN_TYPED_DATA_HELPER_H_
