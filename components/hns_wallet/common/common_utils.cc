...
bool IsNativeWalletEnabled() {
  return base::FeatureList::IsEnabled(features::kNativeHnsWalletFeature);
}

bool IsFilecoinEnabled() {
  return base::FeatureList::IsEnabled(features::kHnsWalletFilecoinFeature);
}

bool IsDappsSupportEnabled() {
  return base::FeatureList::IsEnabled(
      features::kHnsWalletDappsSupportFeature);
}

bool IsSolanaEnabled() {
  return base::FeatureList::IsEnabled(features::kHnsWalletSolanaFeature);
}

bool IsNftPinningEnabled() {
  return base::FeatureList::IsEnabled(features::kHnsWalletNftPinningFeature);
}

bool IsPanelV2Enabled() {
  return base::FeatureList::IsEnabled(features::kHnsWalletPanelV2Feature);
}
...
bool IsBitcoinEnabled() {
  return base::FeatureList::IsEnabled(features::kHnsWalletBitcoinFeature);
}
