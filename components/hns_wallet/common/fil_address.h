...
#ifndef HNS_COMPONENTS_HNS_WALLET_COMMON_FIL_ADDRESS_H_
#define HNS_COMPONENTS_HNS_WALLET_COMMON_FIL_ADDRESS_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_COMMON_FIL_ADDRESS_H_
