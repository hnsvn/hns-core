...
#ifndef HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_ABI_UTILS_H_
#define HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_ABI_UTILS_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_COMMON_ETH_ABI_UTILS_H_
