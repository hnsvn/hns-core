...
#ifndef HNS_COMPONENTS_HNS_WALLET_COMMON_SOLANA_ADDRESS_H_
#define HNS_COMPONENTS_HNS_WALLET_COMMON_SOLANA_ADDRESS_H_
...
#endif  // HNS_COMPONENTS_HNS_WALLET_COMMON_SOLANA_ADDRESS_H_
