...
#ifndef HNS_COMPONENTS_P3A_UPLOADER_H_
#define HNS_COMPONENTS_P3A_UPLOADER_H_
...
// Handles uploading of JSON and Constellation metrics to Hns servers.
...
#endif  // HNS_COMPONENTS_P3A_UPLOADER_H_
