...
#include "hns/components/p3a/nitro_utils/attestation.h"
...
constexpr char kCurrentPKPrefName[] = "hns.p3a.current_pk";
constexpr char kCurrentEpochPrefName[] = "hns.p3a.current_epoch";
constexpr char kNextEpochTimePrefName[] = "hns.p3a.next_epoch_time";
constexpr char kApprovedCertFPPrefName[] = "hns.p3a.approved_cert_fp";
