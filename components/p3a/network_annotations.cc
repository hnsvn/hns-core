...
#include "hns/components/p3a/network_annotations.h"

#include "hns/components/p3a/uploader.h"
...
net::NetworkTrafficAnnotationTag GetRandomnessRequestAnnotation() {
  return net::DefineNetworkTrafficAnnotation("p3a_star_randomness", R"(
    semantics {
      sender: "Hns Privacy-Preserving Product Analytics STAR Randomness Request"
      description:
    ...
    policy {
      cookies_allowed: NO
      setting:
        "Users can enable or disable it in hns://settings/privacy"
...
net::NetworkTrafficAnnotationTag GetRandomnessServerInfoAnnotation() {
  return net::DefineNetworkTrafficAnnotation("p3a_star_server_info", R"(
    semantics {
      sender: "Hns Privacy-Preserving Product Analytics STAR Randomness Server Info"
      description:
  ...
  if (is_constellation) {
    if (upload_type == kP3ACreativeUploadType ||
      ...
      return net::DefineNetworkTrafficAnnotation("p3a", R"(
          semantics {
            sender: "Hns Privacy-Preserving Product Analytics Uploader"
            description:
    ...
    return net::DefineNetworkTrafficAnnotation("p2a", R"(
        semantics {
          sender: "Hns Privacy-Preserving Ad Analytics Uploader"
          description:
            "Report of anonymized usage statistics. For more info, see "
            "https://github.com/hnsvn/hns-browser/wiki/"
        ...
        policy {
          cookies_allowed: NO
          setting:
            "Users can enable or disable it by enabling or disabling Hns "
            "rewards or ads in hns://rewards."
           policy_exception_justification:
             "Not implemented."
        })");
  } else {
