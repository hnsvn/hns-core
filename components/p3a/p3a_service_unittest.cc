...
#include "hns/components/p3a/metric_names.h"
...
constexpr char kP2APrefix[] = "Hns.P2A";
...
constexpr char kTestExpressMetric[] = "Hns.Core.UsageDaily";
constexpr char kTestExampleMetric[] = "Hns.Core.TestMetric";
      ...
      if (histogram_name.rfind(kP2APrefix, 0) == 0) {
        if (p2a_i < p2a_count) {
          ...
          p2a_i++;
                 ...
                 base::StartsWith(histogram_name, "Hns.Core")) {
        result.push_back(std::string(histogram_name));
        p3a_i++;
      }
