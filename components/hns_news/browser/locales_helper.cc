...
// list of matches for enabling Hns News on the NTP and prompting the user
// to opt-in.
constexpr auto kEnabledLanguages =
    base::MakeFixedFlatSet<base::StringPiece>({"en", "ja"});
// We can add to this list as new locales become available to have Hns News
...
bool IsUserInDefaultEnabledLocale() {
  // Only default Hns News to be shown for
