...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_HNS_NEWS_CONTROLLER_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_HNS_NEWS_CONTROLLER_H_
...
#include "hns/components/hns_news/browser/feed_controller.h"
...
// Browser-side handler for Hns News mojom API, 1 per profile
...
class HnsNewsController : public KeyedService,
                            public mojom::HnsNewsController,
 ...
 public:
  ...
  ~HnsNewsController() override;
  HnsNewsController(const HnsNewsController&) = delete;
  HnsNewsController& operator=(const HnsNewsController&) = delete;

  mojo::PendingRemote<mojom::HnsNewsController> MakeRemote();
  void Bind(mojo::PendingReceiver<mojom::HnsNewsController> receiver);
  ...
  void OnPublishersUpdated(hns_news::PublishersController*) override;
 ...
 private:
  ...
  hns_private_cdn::PrivateCDNRequestHelper private_cdn_request_helper_;
  ...
  mojo::ReceiverSet<mojom::HnsNewsController> receivers_;
  mojo::RemoteSet<mojom::PublishersListener> publishers_listeners_;
  base::WeakPtrFactory<HnsNewsController> weak_ptr_factory_;
};

}  // namespace hns_news

#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_HNS_NEWS_CONTROLLER_H_
