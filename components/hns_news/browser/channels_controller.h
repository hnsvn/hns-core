...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_CHANNELS_CONTROLLER_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_CHANNELS_CONTROLLER_H_
...
class ChannelsController : public PublishersController::Observer {
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(HnsNewsFeedBuildingTest, BuildFeed);
  FRIEND_TEST_ALL_PREFIXES(HnsNewsFeedBuildingTest,
...
#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_CHANNELS_CONTROLLER_H_
