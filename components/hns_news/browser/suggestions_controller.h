...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_SUGGESTIONS_CONTROLLER_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_SUGGESTIONS_CONTROLLER_H_
...
using GetSuggestedPublisherIdsCallback =
    mojom::HnsNewsController::GetSuggestedPublisherIdsCallback;
...
#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_SUGGESTIONS_CONTROLLER_H_
