...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_DIRECT_FEED_CONTROLLER_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_DIRECT_FEED_CONTROLLER_H_
...
class DirectFeedController {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(HnsNewsDirectFeed, ParseToArticle);
  FRIEND_TEST_ALL_PREFIXES(HnsNewsDirectFeed, ParseOnlyAllowsHTTPLinks);
...
#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_DIRECT_FEED_CONTROLLER_H_
