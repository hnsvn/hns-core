...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_FEED_CONTROLLER_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_FEED_CONTROLLER_H_
...
using GetFeedCallback = mojom::HnsNewsController::GetFeedCallback;
...
#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_FEED_CONTROLLER_H_
