...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_UNSUPPORTED_PUBLISHER_MIGRATOR_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_UNSUPPORTED_PUBLISHER_MIGRATOR_H_
...
#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_UNSUPPORTED_PUBLISHER_MIGRATOR_H_
