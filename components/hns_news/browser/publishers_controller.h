...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_PUBLISHERS_CONTROLLER_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_PUBLISHERS_CONTROLLER_H_
...
using GetPublishersCallback = mojom::HnsNewsController::GetPublishersCallback;
...
class PublishersController {
 public:
  ...
  void GetLocale(mojom::HnsNewsController::GetLocaleCallback);
...
#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_PUBLISHERS_CONTROLLER_H_
