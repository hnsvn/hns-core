...
#ifndef HNS_COMPONENTS_HNS_NEWS_BROWSER_FEED_FETCHER_H_
#define HNS_COMPONENTS_HNS_NEWS_BROWSER_FEED_FETCHER_H_
...
#endif  // HNS_COMPONENTS_HNS_NEWS_BROWSER_FEED_FETCHER_H_
