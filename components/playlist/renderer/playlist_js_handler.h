...
#ifndef HNS_COMPONENTS_PLAYLIST_RENDERER_PLAYLIST_JS_HANDLER_H_
#define HNS_COMPONENTS_PLAYLIST_RENDERER_PLAYLIST_JS_HANDLER_H_
...
#endif  // HNS_COMPONENTS_PLAYLIST_RENDERER_PLAYLIST_JS_HANDLER_H_
