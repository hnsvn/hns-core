...
#include "hns/components/playlist/renderer/playlist_js_handler.h"
...
void PlaylistRenderFrameObserver::HideMediaSourceAPI() {
  ...
  // This script is from
  // https://github.com/hnsvn/hns-ios/blob/development/Client/Frontend/UserContent/UserScripts/PlaylistSwizzler.js
