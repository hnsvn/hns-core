...
const char kLastUsageTimeHistogramName[] = "Hns.Playlist.LastUsageTime";
const char kFirstTimeOffsetHistogramName[] = "Hns.Playlist.FirstTimeOffset";
const char kUsageDaysInWeekHistogramName[] = "Hns.Playlist.UsageDaysInWeek";
const char kNewUserReturningHistogramName[] = "Hns.Playlist.NewUserReturning";
