...
#ifndef HNS_COMPONENTS_PLAYLIST_BROWSER_TYPE_CONVERTER_H_
#define HNS_COMPONENTS_PLAYLIST_BROWSER_TYPE_CONVERTER_H_
...
#endif  // HNS_COMPONENTS_PLAYLIST_BROWSER_TYPE_CONVERTER_H_
