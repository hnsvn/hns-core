...
#ifndef HNS_COMPONENTS_PLAYLIST_BROWSER_PLAYLIST_RENDER_FRAME_BROWSER_CLIENT_H_
#define HNS_COMPONENTS_PLAYLIST_BROWSER_PLAYLIST_RENDER_FRAME_BROWSER_CLIENT_H_
...
#endif  // HNS_COMPONENTS_PLAYLIST_BROWSER_PLAYLIST_RENDER_FRAME_BROWSER_CLIENT_H_
