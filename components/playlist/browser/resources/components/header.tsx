...
import { color, font, radius, spacing } from '@hns/leo/tokens/css'
import LeoButton from '@hns/leo/react/button'
...
function PlaylistHeader ({ playlistId }: { playlistId: string }) {
  ...
  if (playlist?.items.length) {
    contextualMenuItems.push({
      name: getLocalizedString('hnsPlaylistContextMenuEdit'),
  ...
  if (contextualMenuItems && !isDefaultPlaylist) {
    contextualMenuItems.unshift({
      name: getLocalizedString('hnsPlaylistContextMenuRenamePlaylist'),
      iconName: 'edit-box',
      onClick: () => {
    ...
    contextualMenuItems.push({
      name: getLocalizedString('hnsPlaylistContextMenuDeletePlaylist'),
      iconName: 'trash',
      onClick: () => {
  ...
  return (
    <>
      ...
      <ProductNameContainer>
        <ColoredSpan color={color.text.secondary}>Hns</ColoredSpan>
