...
import { App } from 'gen/hns/web-discovery-project'
...
function onCommitted (details: chrome.webNavigation.WebNavigationTransitionCallbackDetails) {
  ...
  // devtools://, hns://, etc.). We also make sure to only inject if we
...
if (!chrome.extension.inIncognitoContext) {
  ...
  const WEB_DISCOVERY_PREF_KEY = 'hns.web_discovery_enabled'
