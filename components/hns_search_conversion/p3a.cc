...
const char kSearchPromoButtonHistogramName[] = "Hns.Search.Promo.Button";
const char kSearchPromoBannerAHistogramName[] = "Hns.Search.Promo.BannerA";
const char kSearchPromoBannerBHistogramName[] = "Hns.Search.Promo.BannerB";
const char kSearchPromoBannerCHistogramName[] = "Hns.Search.Promo.BannerC";
const char kSearchPromoBannerDHistogramName[] = "Hns.Search.Promo.BannerD";
const char kSearchPromoNTPHistogramName[] = "Hns.Search.Promo.NewTabPage";
...
const char kSwitchSearchEngineMetric[] = "Hns.Search.SwitchEngine";
...
void UpdateHistograms(PrefService* prefs) {
  ...
  for (const auto type : types) {
    ...
    // 0 = have not triggered promo, have not made Hns default via SERP
    // 1 = have triggered promo, have not made Hns default via SERP
    int answer = promo_triggered;

    if (default_engine_triggered) {
      // 2 = have not triggered promo, have made Hns default via SERP
      // 3 = have triggered promo, have made Hns default via SERP
      answer += 2;
    }
