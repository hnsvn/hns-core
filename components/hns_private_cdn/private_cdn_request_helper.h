...
#ifndef HNS_COMPONENTS_HNS_PRIVATE_CDN_PRIVATE_CDN_REQUEST_HELPER_H_
#define HNS_COMPONENTS_HNS_PRIVATE_CDN_PRIVATE_CDN_REQUEST_HELPER_H_
...
#endif  // HNS_COMPONENTS_HNS_PRIVATE_CDN_PRIVATE_CDN_REQUEST_HELPER_H_
