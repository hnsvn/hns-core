...
#ifndef HNS_COMPONENTS_GREASELION_BROWSER_GREASELION_DOWNLOAD_SERVICE_H_
#define HNS_COMPONENTS_GREASELION_BROWSER_GREASELION_DOWNLOAD_SERVICE_H_
...
struct GreaselionPreconditions {
  ...
  GreaselionPreconditionValue supports_minimum_hns_version = kAny;
};
...
class GreaselionRule {
 ...
 private:
  ...
  std::string run_at_;
  std::string minimum_hns_version_;
...
#endif  // HNS_COMPONENTS_GREASELION_BROWSER_GREASELION_DOWNLOAD_SERVICE_H_
