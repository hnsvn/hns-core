...
#include "hns/components/greaselion/browser/greaselion_service_impl.h"
...
ConvertGreaselionRuleToExtensionOnTaskRunner(
  ...
  // rule name to a known Hns domain and hash the result to create a
  // public key.
...
GreaselionServiceImpl::GreaselionServiceImpl(
  ...
  state_[GreaselionFeature::SUPPORTS_MINIMUM_HNS_VERSION] = true;
}
