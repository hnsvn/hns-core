...
#ifndef HNS_COMPONENTS_HNS_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
#define HNS_COMPONENTS_HNS_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
...
const char kLocalDataFilesComponentName[] = "Hns Local Data Updater";
...
class LocalDataFilesService : public HnsComponent {
 public:
  explicit LocalDataFilesService(HnsComponent::Delegate* delegate);
...
LocalDataFilesServiceFactory(HnsComponent::Delegate* delegate);

}  // namespace hns_component_updater

#endif  // HNS_COMPONENTS_HNS_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_SERVICE_H_
