...
#ifndef HNS_COMPONENTS_HNS_COMPONENT_UPDATER_BROWSER_HNS_COMPONENT_H_
#define HNS_COMPONENTS_HNS_COMPONENT_UPDATER_BROWSER_HNS_COMPONENT_H_
...
class HnsComponent {
 public:
  ...
  explicit HnsComponent(Delegate* delegate);
  HnsComponent(const HnsComponent&) = delete;
  HnsComponent& operator=(const HnsComponent&) = delete;
  virtual ~HnsComponent();
 ...
 private:
  ...
  base::WeakPtrFactory<HnsComponent> weak_factory_;
};

}  // namespace hns_component_updater

#endif  // HNS_COMPONENTS_HNS_COMPONENT_UPDATER_BROWSER_HNS_COMPONENT_H_
