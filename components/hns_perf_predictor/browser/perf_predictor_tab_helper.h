...
#ifndef HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_PERF_PREDICTOR_TAB_HELPER_H_
#define HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_PERF_PREDICTOR_TAB_HELPER_H_

#include <memory>
#include <string>

#include "hns/components/hns_perf_predictor/browser/bandwidth_savings_predictor.h"
...
#endif  // HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_PERF_PREDICTOR_TAB_HELPER_H_
