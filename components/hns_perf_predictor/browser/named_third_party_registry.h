...
#ifndef HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_NAMED_THIRD_PARTY_REGISTRY_H_
#define HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_NAMED_THIRD_PARTY_REGISTRY_H_
...
#endif  // HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_NAMED_THIRD_PARTY_REGISTRY_H_
