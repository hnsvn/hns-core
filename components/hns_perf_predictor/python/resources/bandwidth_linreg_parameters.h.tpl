...
#ifndef HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_BANDWIDTH_LINREG_PARAMETERS_H_
#define HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_BANDWIDTH_LINREG_PARAMETERS_H_
...
#endif  // HNS_COMPONENTS_HNS_PERF_PREDICTOR_BROWSER_BANDWIDTH_LINREG_PARAMETERS_H_
