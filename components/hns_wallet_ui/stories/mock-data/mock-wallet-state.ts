...
// types
import { HnsWallet, WalletState } from '../../constants/types'
...
const mockAccount: HnsWallet.AccountInfo = {
...
const mockAccount2: HnsWallet.AccountInfo = {
...
const mockAccount3: HnsWallet.AccountInfo = {
...
const mockCurrency: HnsWallet.OnRampCurrency = {
  currencyCode: 'USD',
  currencyName: 'United States Dollar',
  providers: []
}

const mockCurrencies: HnsWallet.OnRampCurrency[] = [
  mockCurrency,
  {
    currencyCode: 'EUR',
    currencyName: 'Euro',
...
const mockCoinMarketData: HnsWallet.CoinMarket[] = [
  {
    id: 'bitcoin',
    symbol: 'btc',
    name: 'Bitcoin',
    image: 'https://assets.cgproxy.hns.com/coins/images/1/large/bitcoin.png?1547033579',
  ...
  },
  {
    ...
    symbol: 'eth',
    name: 'Ethereum',
    image: 'https://assets.cgproxy.hns.com/coins/images/279/large/ethereum.png?1595348880',
  ...
  },
  {
    ...
    symbol: 'usdt',
    name: 'Tether',
    image: 'https://assets.cgproxy.hns.com/coins/images/325/large/Tether-logo.png?1598003707',
  ...
  },
  {
    ...
    symbol: 'bnb',
    name: 'BNB',
    image: 'https://assets.cgproxy.hns.com/coins/images/825/large/bnb-icon2_2x.png?1644979850',
    currentPrice: 400.1,
...
export const mockWalletState: WalletState = {
  ...
  selectedPortfolioTimeline: HnsWallet.AssetPriceTimeframe.OneDay,
