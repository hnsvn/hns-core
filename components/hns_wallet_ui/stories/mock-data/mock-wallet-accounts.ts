...
export const mockBitcoinAccount = {
  ...
  accountId: {
    coin: 0,
    keyringId: HnsWallet.KeyringId.kBitcoin84,
    kind: HnsWallet.AccountKind.kDerived,
    address: '',
    bitcoinAccountIndex: 0,
  ...
  nativeBalanceRegistry: {
    [HnsWallet.BITCOIN_MAINNET]: '123456789',
  },
  hardware: undefined
}

export const mockAccounts: HnsWallet.AccountInfo[] = [
  mockEthAccount,
  {
    name: 'Account 2',
...
export const mockedTransactionAccounts: HnsWallet.AccountInfo[] = [
  {
    name: 'Account 1',
    address: '1',
    accountId: {
