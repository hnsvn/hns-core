...
export const mockSolanaTransactionInfo: SerializableTransactionInfo = {
  ...
  txDataUnion: {
    ...
    solanaTxData: {
      ...
      txType: HnsWallet.TransactionType.SolanaSPLTokenTransfer,
      version: 1,
    },
    filTxData: undefined
  },
...
export const mockFilSendTransaction: FileCoinTransactionInfo = {
  chainId: HnsWallet.FILECOIN_MAINNET,
  ...
  txHash: 'fil-send-tx',
  txParams: [],
  txStatus: HnsWallet.TransactionStatus.Confirmed,
...
export const createMockTransactionInfo = (arg: {
  toAddress: string
  fromAccount: HnsWallet.AccountInfo,
  ...
  const txBase = coinType === HnsWallet.CoinType.FIL
    ? mockFilSendTransaction
    : deserializeTransaction(
      coinType === HnsWallet.CoinType.ETH
        ? mockTransactionInfo
        : coinType === HnsWallet.CoinType.SOL
