...
import {
  HnsRewardsProxyOverrides,
  getMockedHnsRewardsProxy
} from '../common/async/__mocks__/hns_rewards_api_proxy'
import {
...
export const createMockStore = (
  ...
  rewardsApiOverrides?: HnsRewardsProxyOverrides
) => {
  // api reset
  resetMockedAPIProxy()
  resetCache() // clear base query cache
  const mockedApiProxy = getMockedAPIProxy()
  const mockedRewardsApiProxy = getMockedHnsRewardsProxy()
  ...
  setRewardsProxyFetcher(getMockedHnsRewardsProxy)
