...
describe('getNetworkInfo', () => {
  ...
  it('should return network object with default values if network with chainId is not found', () => {
    ...
    const coin = HnsWallet.CoinType.ETH
...
describe('filterNetworksForAccount', () => {
  it('CoinType ETH, should return all ETH networks', () => {
    ...
    ).toEqual(mockNetworks.filter((n) => n.coin === HnsWallet.CoinType.ETH))
  })
...
describe('getCoinFromTxDataUnion', () => {
  it('Filecoin transaction', () => {
    expect(getCoinFromTxDataUnion({
      filTxData: {} as HnsWallet.FilTxData,
      ethTxData: undefined,
      ethTxData1559: undefined,
      solanaTxData: undefined
    })).toEqual(HnsWallet.CoinType.FIL)
  })
  it('Ethereum transaction', () => {
    expect(getCoinFromTxDataUnion({
      filTxData: undefined,
      ethTxData: {} as HnsWallet.TxData,
      ethTxData1559: undefined,
      solanaTxData: undefined
    })).toEqual(HnsWallet.CoinType.ETH)
  })
  it('Ethereum1559 transaction', () => {
    expect(getCoinFromTxDataUnion({
      filTxData: undefined,
      ethTxData: undefined,
      ethTxData1559: {} as HnsWallet.TxData1559,
      solanaTxData: undefined
    })).toEqual(HnsWallet.CoinType.ETH)
  })
  it('Solana transaction', () => {
    expect(getCoinFromTxDataUnion({
      ...
      ethTxData: undefined,
      ethTxData1559: undefined,
      solanaTxData: {} as HnsWallet.SolanaTxData
    })).toEqual(HnsWallet.CoinType.SOL)
  })
})
