...
describe('Check Transaction Status Strings Value', () => {
  test('Transaction ID 0 should return Unapproved', () => {
    expect(getTransactionStatusString(0)).toEqual('hnsWalletTransactionStatusUnapproved')
  })
  test('Transaction ID 1 should return Approved', () => {
    expect(getTransactionStatusString(1)).toEqual('hnsWalletTransactionStatusApproved')
  })

  test('Transaction ID 2 should return Rejected', () => {
    expect(getTransactionStatusString(2)).toEqual('hnsWalletTransactionStatusRejected')
  })

  test('Transaction ID 3 should return Submitted', () => {
    expect(getTransactionStatusString(3)).toEqual('hnsWalletTransactionStatusSubmitted')
  })

  test('Transaction ID 4 should return Confirmed', () => {
    expect(getTransactionStatusString(4)).toEqual('hnsWalletTransactionStatusConfirmed')
  })

  test('Transaction ID 5 should return Error', () => {
    expect(getTransactionStatusString(5)).toEqual('hnsWalletTransactionStatusError')
  })

  test('Transaction ID 6 should return Dropped', () => {
    expect(getTransactionStatusString(6)).toEqual('hnsWalletTransactionStatusDropped')
  })

  test('Transaction ID 7 should return Signed', () => {
    expect(getTransactionStatusString(7))
      .toEqual('hnsWalletTransactionStatusSigned')
  })
  ...
  it('should detect the correct but/swap tokens of a transaction', () => {
    ...
    const {
      ...
      tx: {
        ...
        txHash: '123',
        txParams: [],
        txStatus: HnsWallet.TransactionStatus.Unapproved,
        txType: HnsWallet.TransactionType.ETHSwap
      },
...
describe('check for insufficient funds errors', () => {
  describe.each([
    ['ERC20Transfer', HnsWallet.TransactionType.ERC20Transfer],
    ['ERC20Approve', HnsWallet.TransactionType.ERC20Approve],
    ['ERC721TransferFrom', HnsWallet.TransactionType.ERC721TransferFrom],
    [
      'ERC721SafeTransferFrom',
      HnsWallet.TransactionType.ERC721SafeTransferFrom
    ],
    ['ETHSend', HnsWallet.TransactionType.ETHSend],
    ['Other', HnsWallet.TransactionType.Other]
  ])('%s', (_, txType) => {
    ...
    it('should be false when funds are sufficient for gas', () => {
      ...
      const mockTxData: HnsWallet.TxData1559 =
  ...
  describe('ERC20Transfer', () => {
    it('should be true when funds are insufficient for send amount', () => {
      ...
      const transactionInfo: SerializableTransactionInfo = {
        ...
        txType: HnsWallet.TransactionType.ERC20Transfer,
        txDataUnion: {
          ethTxData: {} as any,
          filTxData: undefined,
          solanaTxData: undefined,
