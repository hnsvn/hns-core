...
const hnsWalletLedgerBridgeUrl = loadTimeData.getString('hnsWalletLedgerBridgeUrl')
export const LEDGER_BRIDGE_URL = hnsWalletLedgerBridgeUrl.charAt(hnsWalletLedgerBridgeUrl.length - 1) === '/'
                                 ? hnsWalletLedgerBridgeUrl.slice(0, -1) // Strip off trailing '/' in URL
                                 : hnsWalletLedgerBridgeUrl
