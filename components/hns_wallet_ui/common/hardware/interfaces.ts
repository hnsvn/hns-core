...
import { HnsWallet, FilecoinNetwork, SerializableTransactionInfo } from '../../constants/types'
...
export abstract class HardwareKeyring {
  abstract coin (): HnsWallet.CoinType
  abstract keyringId (network?: string): HnsWallet.KeyringId
