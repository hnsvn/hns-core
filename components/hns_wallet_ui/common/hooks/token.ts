...
export default function useTokenInfo (
  ...
  const [foundTokenInfoByContractAddress, setFoundTokenInfoByContractAddress] = React.useState<HnsWallet.BlockchainToken | undefined>()
  ...
  React.useEffect(() => {
    ...
    if (!checkedLists && selectedNetwork?.chainId === HnsWallet.MAINNET_CHAIN_ID) {
