...
export type AccountInfoEntity = HnsWallet.AccountInfo
...
export const accountInfoEntityAdaptor: AccountInfoEntityAdaptor = {
  ...createEntityAdapter<AccountInfoEntity>({
    selectId: (model: Pick<HnsWallet.AccountInfo, 'accountId'>): EntityId => {
...
type MakeSelectNetworkByIdFromQuery =
  EntityByIdFromRegistryResultSelectorFactory<HnsWallet.NetworkInfo>
