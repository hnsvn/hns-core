...
import { HnsRewardsProxyOverrides } from '../../async/__mocks__/hns_rewards_api_proxy'
import { WalletStatus } from '../../async/hns_rewards_api_proxy'

const mockedRewardsData: HnsRewardsProxyOverrides = {
  externalWallet: {
...
describe('api slice Hns Rewards endpoints', () => {
