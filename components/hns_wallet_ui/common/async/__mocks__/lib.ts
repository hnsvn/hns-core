...
import { HnsWallet, GetBlockchainTokenInfoReturnInfo, GetChecksumEthAddressReturnInfo, GetEthAddrReturnInfo } from '../../../constants/types'
...
export const getIsSwapSupported = (network: HnsWallet.NetworkInfo) => new Promise<boolean>((resolve) => {
