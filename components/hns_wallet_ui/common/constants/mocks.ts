...
type EIP1559SerializableTransactionInfo = SerializableTransactionInfo & {
  txDataUnion: { ethTxData1559: HnsWallet.TxData1559 }
}
...
export const getMockedTransactionInfo =
  (): EIP1559SerializableTransactionInfo => {
    return {
      ...
      txStatus: HnsWallet.TransactionStatus.Approved,
...
export const mockNetwork: HnsWallet.NetworkInfo = {
  chainId: '0x1',
...
export const mockERC20Token: HnsWallet.BlockchainToken = {
...
export const mockErc721Token: HnsWallet.BlockchainToken = {
...
export const mockSplNft: HnsWallet.BlockchainToken = {
  ...
  coingeckoId: '',
  coin: HnsWallet.CoinType.SOL,
  chainId: HnsWallet.SOLANA_MAINNET,

}

export const mockNftPinningStatus: NftsPinningStatusType = {
  [getAssetIdKey(mockErc721Token)]: {
    code: HnsWallet.TokenPinStatusCode.STATUS_PINNED,
    error: undefined
  }
}

export const mockAccount: HnsWallet.AccountInfo = {
...
export const mockEthAccountInfo: HnsWallet.AccountInfo = {
  hardware: undefined,
...
export const mockSolanaAccount: HnsWallet.AccountInfo = {
  name: 'MockSolanaAccount',
  address: '5sDWP4vCRgDrGsmS1RRuWGRWKo5mhP5wKw8RNqK6zRez',
  accountId: {
    coin: HnsWallet.CoinType.SOL,
    keyringId: HnsWallet.KeyringId.kSolana,
    kind: HnsWallet.AccountKind.kDerived,
    address: '5sDWP4vCRgDrGsmS1RRuWGRWKo5mhP5wKw8RNqK6zRez',
    bitcoinAccountIndex: 0,
...
export const mockSolanaAccountInfo: HnsWallet.AccountInfo = {
  name: 'MockSolanaAccount',
...
export const mockFilecoinAccount: HnsWallet.AccountInfo = {
  name: 'MockFilecoinAccount',
  address: 't1alebc2ujfh4kuxs5bvzmx5b2w5ixrqrl3ni5rti',
  accountId: {
    coin: HnsWallet.CoinType.FIL,
    keyringId: HnsWallet.KeyringId.kFilecoinTestnet,
    kind: HnsWallet.AccountKind.kDerived,
    address: 't1alebc2ujfh4kuxs5bvzmx5b2w5ixrqrl3ni5rti',
    bitcoinAccountIndex: 0,
    uniqueKey: 'mockId-3'
...
export const mockFilecoinAccountInfo: HnsWallet.AccountInfo = {
  name: 'MockFilecoinAccount',
  address: 't1alebc2ujfh4kuxs5bvzmx5b2w5ixrqrl3ni5rti',
  accountId: {
    coin: HnsWallet.CoinType.FIL,
...
export const mockSolDappSignTransactionRequest: HnsWallet.SignTransactionRequest = {
  originInfo: {
  ...
  txData: {
    ...
    solanaTxData: {
      ...
      version: HnsWallet.SolanaMessageVersion.kLegacy,
      messageHeader: {
...
// HnsWallet.TransactionInfo (selectedPendingTransaction)
      ...
      instructions: [
        {
          ...
          decodedData: {
            accountParams: [
              {
                localizedName: 'From',
                name: HnsWallet.FROM_ACCOUNT
              },
              {
                localizedName: 'To',
                name: HnsWallet.TO_ACCOUNT
              }
            ],
            instructionType: HnsWallet.SolanaSystemInstruction.kTransfer,
            params: [
              {
                localizedName: 'lamports',
                name: HnsWallet.LAMPORTS,
                value: '1',
                type: HnsWallet.SolanaInstructionParamType.kUint64
              }
            ]
          }
        }
...
export const mockSolDappSignAllTransactionsRequest: HnsWallet.SignAllTransactionsRequest = {
  originInfo: {
    originSpec: 'https://f40y4d.csb.app',
    eTldPlusOne: 'csb.app'
  },
...
// EVM Simulations
//
export const mockBlowfishAssetPrice: HnsWallet.BlowfishPrice = {
