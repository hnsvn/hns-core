...
// routes
import { HnsWallet, WalletRoutes } from '../../../../constants/types'
...
const importantTextParts = splitStringForTag(getLocale('hnsWalletRecoveryPhraseBackupWarningImportant'))
...
export const RecoveryPhraseExplainer = () => {
  ...
  const skipToOnboardingSuccess = () => {
    hnsWalletP3A.reportOnboardingAction(HnsWallet.OnboardingAction.CompleteRecoverySkipped);
    ...
    <CenteredPageLayout>
      <MainWrapper>
        <StyledWrapper>
          ...
          <div>
            <Title>{getLocale('hnsWalletOnboardingRecoveryPhraseBackupIntroTitle')}</Title>
            <Description>{getLocale('hnsWalletOnboardingRecoveryPhraseBackupIntroDescription')}</Description>
            <CenteredRow>
              <ArticleLinkBubble
                icon='key'
                iconBackgroundColor='red200'
                text={getLocale('hnsWalletArticleLinkWhatsARecoveryPhrase')}
                url='https://hns.com/learn/wallet-recovery-phrase/'
              />
            </CenteredRow>
          </div>
          ...
          <NextButtonRow>
            <NavButton
              buttonType='primary'
              text={getLocale('hnsWalletButtonGotIt')}
              url={isOnboarding
