    ...
    <CenteredPageLayout>
      <MainWrapper>
        <StyledWrapper>
          ...
          <TitleAndDescriptionContainer>
            <Title>{getLocale('hnsWalletRecoveryPhraseBackupTitle')}</Title>
            <Description>
              {getLocale('hnsWalletRecoveryPhraseBackupWarning')}
              <LinkText
                href='https://hns.com/learn/wallet-recovery-phrase/#how-should-i-store-my-recovery-phrase'
                target='_blank'
                rel='noreferrer'
                referrerPolicy='no-referrer'
              >
                {getLocale('hnsWalletLearnMore')}
              </LinkText>
            </Description>
          </TitleAndDescriptionContainer>
