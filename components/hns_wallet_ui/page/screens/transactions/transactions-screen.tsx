...
interface Params {
  address?: string | null
  chainId?: string | null
  chainCoinType?: HnsWallet.CoinType | null
}
...
export const TransactionsScreen: React.FC = () => {
  ...
  const {
    ...
    return {
      ...
      chainCoinType:
        Number(searchParams.get('chainCoinType')) || HnsWallet.CoinType.ETH
    }
  ...
  const onSelectAccount = React.useCallback(
    ({ accountId }: HnsWallet.AccountInfo): void => {
      history.push(
        updatePageParams({
  ...
  const onSelectNetwork = React.useCallback(
    ({ chainId, coin }: HnsWallet.NetworkInfo) => {
      history.push(
        updatePageParams({
