...
export const FundWalletScreen = ({ isAndroid }: Props) => {
  ...
  const networksFilterOptions: HnsWallet.NetworkInfo[] = React.useMemo(() => {
  ...
  const onSubmitBuy = React.useCallback((buyOption: HnsWallet.OnRampProvider) => {
  ...
  const checkIsBuyAssetSelected = React.useCallback((asset: HnsWallet.BlockchainToken) => {
    if (selectedAsset) {
      return (
    ...
    <WalletPageWrapper
      ...
      cardHeader={
        <PageTitleHeader
          title={
            selectedAsset
              ? `${getLocale('hnsWalletBuy')} ${selectedAsset.symbol}`
              : getLocale('hnsWalletBuy')
          }
          ...
          <>
            ...
            <NextButtonRow>
              <NavButton
                ...
                text={
                  selectedAsset
                    ? getLocale('hnsWalletBuyContinueButton')
        ...
        {!needsAccount && showBuyOptions && (
          <>
            {!showAccountSearch && (
              <>
                <Title>
                  {getLocale('hnsWalletFundWalletTitle').replace(
                    '$1',
                ...
                <Description>
                  {getLocale('hnsWalletFundWalletDescription')}
                </Description>
                ...
                <Alert>
                  ...
                  <AlertText>{getLocale('hnsWalletBuyDisclaimer')}</AlertText>
                </Alert>
              </>
            )}
