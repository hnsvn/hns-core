...
const TermsOfUseText: React.FC<{}> = () => {
  const text = getLocaleWithTag('hnsWalletTermsOfServiceCheckboxText')
  return <p key={text.duringTag}>
    {text.beforeTag}
    <LinkText
      href='https://hns.com/terms-of-use/'
      target='_blank'
      ...
      <MainWrapper>
        <StyledWrapper>
          ...
          <TitleAndDescriptionContainer style={{ marginLeft: 18 }}>
            <Title>
              {getLocale('hnsWalletDisclosuresTitle')}
            </Title>
            <Description>
              {getLocale('hnsWalletDisclosuresDescription')}
            </Description>
          </TitleAndDescriptionContainer>
          ...
          <div>
            ...
            >
              <CheckboxText>
                <p>
                  {getLocale('hnsWalletSelfCustodyDisclosureCheckboxText')}
                </p>
              </CheckboxText>
            </Checkbox>
          ...
          <NextButtonRow>
            <NavButton
              buttonType='primary'
              text={getLocale('hnsWalletButtonContinue')}
              onSubmit={onNext}
