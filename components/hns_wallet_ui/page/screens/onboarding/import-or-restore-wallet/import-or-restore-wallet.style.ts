...
// assets
import HnsWalletSvg from '../../../../assets/svg-icons/onboarding/hns-wallet.svg'
import HnsWalletSvgDark from '../../../../assets/svg-icons/onboarding/hns-wallet-dark.svg'
...
import LegacyWalletSvg from '../../../../assets/svg-icons/onboarding/reset-to-hns-wallet.svg'
import LegacyWalletSvgDark from '../../../../assets/svg-icons/onboarding/reset-to-hns-wallet-dark.svg'
...
export const HnsWalletIcon = styled.div`
  width: 80px;
  height: 80px;
  background-image: url(${HnsWalletSvg});
  background-repeat: no-repeat;
  background-size: 100%;
  background-position: center;
  @media (prefers-color-scheme: dark) {
    background-image: url(${HnsWalletSvgDark});
  }
`
