...
// types
import { HnsWallet, PageState, WalletRoutes, WalletState } from '../../../constants/types'
...
export const OnboardingRoutes = () => {
  ...
  React.useEffect(() => {
    let action: HnsWallet.OnboardingAction | null = null;
    switch (location.pathname) {
      case WalletRoutes.OnboardingWelcome:
        action = HnsWallet.OnboardingAction.Shown;
        break;
      ...
      case WalletRoutes.OnboardingVerifyRecoveryPhrase:
        action = HnsWallet.OnboardingAction.RecoverySetup;
        break;
    }
    if (action) {
