...
interface Props {
  ...
  selectedSwapSendAccount: HnsWallet.AccountInfo | undefined
  ...
  return (
    <Column columnHeight='dynamic' columnWidth='full'>
      ...
      <Row rowWidth='full' marginBottom={16} horizontalPadding={16}>
        <Row>
          <Text textSize='14px'>{getLocale('hnsSwapSwapAndSend')}</Text>
          <Flash name='flash' size={16} />
          <Text isBold={false} textSize='14px' textColor='text03'>
            {getLocale('hnsSwapNoExtraFees')}
          </Text>
        </Row>
        <StandardSwitch
                    ...
                    toAnotherAddress !== '' && (
                      <>
                        ...
                        <Row rowWidth='full' horizontalAlign='flex-start'>
                          ...
                          <StandardCheckbox
                            id='confirm-address'
                            label={getLocale('hnsSwapConfirmAddress')}
