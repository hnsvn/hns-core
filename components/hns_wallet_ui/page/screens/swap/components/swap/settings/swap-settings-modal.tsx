...
export const SwapSettingsModal = (props: Props) => {
  ...
  const modalTitle: string = React.useMemo(() => {
    return showExchanges
      ? getLocale('hnsSwapExchanges')
      : getLocale('hnsSwapSettings')
    ...
    <Modal>
      ...
      {!showExchanges && (
        <>
          {/* Slippage Tolerance */}
          <ExpandSection
            label={getLocale('hnsSwapSlippageTolerance')}
          ...
          {selectedNetwork?.coin === HnsWallet.CoinType.ETH && (
            <>
              ...
              {/* <ExpandSection
                label={getLocale('hnsSwapExchanges')}
              ...
              {/* Network Fee */}
              <ExpandSection
                label={getLocale('hnsSwapNetworkFee')}
          ...
          {selectedNetwork?.coin === HnsWallet.CoinType.SOL && (
            <>
              ...
              {/* <ToggleSection
                label={getLocale('hnsSwapDirectRouteTitle')}
                description={getLocale('hnsSwapDirectRouteDescription')}
