...
export interface Props {
  ...
  network: HnsWallet.NetworkInfo | undefined
}
...
export const NFTInfoTooltip = (props: Props) => {
  ...
  // Hooks
  const onClickViewOnBlockExplorer = useExplorer(network || new HnsWallet.NetworkInfo())
    ...
    >
      ...
      {active &&
        <Tip>
          ...
          {token.coin !== HnsWallet.CoinType.SOL &&
            <Column marginBottom={18} columnWidth='full' horizontalAlign='flex-start'>
              <Text
                textAlign='left'
                textSize='14px'
                ...
                isBold={true}
              >
                {getLocale('hnsWalletNFTDetailTokenID')}
              </Text>
              <VerticalSpacer size={8} />
              <AddressLink
          ...
          <Column marginBottom={18} columnWidth='full' horizontalAlign='flex-start'>
            <Text
              ...
              isBold={true}
            >
              {getLocale('hnsWalletNFTDetailBlockchain')}
            </Text>
            <VerticalSpacer size={8} />
