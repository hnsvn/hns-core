...
import { AccountModalTypes, HnsWallet } from '../../constants/types'

export interface AccountsTabState {
  selectedAccount: HnsWallet.AccountInfo | undefined
...
export const AccountsTabActions = {
  setSelectedAccount: createAction<HnsWallet.AccountInfo | undefined>(
    'setSelectedAccount'
  ),
...
export const createAccountsTabReducer = (initialState: AccountsTabState) => {
  ...
  reducer.on(
    ...
    (
      ...
      payload: HnsWallet.AccountInfo | undefined
    ): AccountsTabState => {
      return {
        ...state,
