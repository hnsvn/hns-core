...
const defaultState: PageState = {
  ...
  selectedTimeline: HnsWallet.AssetPriceTimeframe.OneDay,
...
export const WalletPageAsyncActions = {
  addHardwareAccounts: createAction<HnsWallet.HardwareWalletAccount[]>('addHardwareAccounts'),
  checkWalletsToImport: createAction('checkWalletsToImport'),
  createWallet: createAction<CreateWalletPayloadType>('createWallet'),
  getNFTMetadata: createAction<HnsWallet.BlockchainToken>('getNFTMetadata'),
  ...
  updateNFTPinStatus: createAction<HnsWallet.TokenPinOverview | undefined>('updateNFTPinStatus'),
  getPinStatus: createAction<HnsWallet.BlockchainToken>('getPinStatus'),
  ...
  getNftsPinningStatus: createAction<HnsWallet.BlockchainToken[]>('getNftsPinningStatus'),
...
export const createPageSlice = (initialState: PageState = defaultState) => {
  return createSlice({
    ...
    reducers: {
      ...
      selectCoinMarket(
        state,
        { payload }: PayloadAction<HnsWallet.CoinMarket | undefined>
      ) {
      ...
      updateSelectedAsset(
        state,
        { payload }: PayloadAction<HnsWallet.BlockchainToken | undefined>
      ) {
      ...
      updateNFTPinStatus(
        state,
        { payload }: PayloadAction<HnsWallet.TokenPinOverview | undefined>
      ) {
