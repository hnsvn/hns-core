...
export const addEthereumChain = createAction<HnsWallet.AddChainRequest>('addEthereumChain')
export const addEthereumChainRequestCompleted = createAction<EthereumChainRequestPayload>('addEthereumChainRequestCompleted')
export const switchEthereumChain = createAction<HnsWallet.SwitchChainRequest>('switchEthereumChain')
...
export const signMessage = createAction<HnsWallet.SignMessageRequest[]>('signMessage')
...
export const cancelConnectHardwareWallet = createAction<HnsWallet.AccountInfo>('cancelConnectHardwareWallet')
export const getEncryptionPublicKey = createAction<HnsWallet.GetEncryptionPublicKeyRequest>('getEncryptionPublicKey')
...
export const decrypt = createAction<HnsWallet.DecryptRequest>('decrypt')
...
export const signTransaction = createAction<HnsWallet.SignTransactionRequest[]>('signTransaction')
...
export const signAllTransactions = createAction<HnsWallet.SignAllTransactionsRequest[]>('signAllTransactions')
