...
import {
  ...
  makeHnsWalletServiceObserver,
  makeHnsWalletPinServiceObserver,
  makeHnsWalletAutoPinServiceObserver,
  makeHnsWalletServiceTokenObserver
...
proxy.addHnsWalletServiceObserver(makeHnsWalletServiceObserver(store))
proxy.addHnsWalletServiceTokenObserver(makeHnsWalletServiceTokenObserver(store))
proxy.addHnsWalletPinServiceObserver(makeHnsWalletPinServiceObserver(store))
proxy.addHnsWalletAutoPinServiceObserver(makeHnsWalletAutoPinServiceObserver(store))
