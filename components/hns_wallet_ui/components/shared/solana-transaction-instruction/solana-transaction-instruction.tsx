    ...
    return (
      <InstructionBox>
        {programId && (
          <>
            <CodeSectionTitle>
              {getLocale('hnsWalletSolanaProgramID')}
            </CodeSectionTitle>
            <CodeSnippet>
              <code>
        ...
        {accountMetas.length > 0 && (
          <>
            ...
            <CodeSectionTitle>
              {getLocale('hnsWalletSolanaAccounts')}
            </CodeSectionTitle>
    ...
    <>
      {lookupTableIndex !== undefined &&
        <AddressText isBold={true}>
          {getLocale('hnsWalletSolanaAddressLookupTableAccount')}
        </AddressText>
      }
      <CopyTooltip
        key={pubkey}
      ...
      </CopyTooltip>
      {
        ...
        <>
          <AddressText isBold={true}>
            {getLocale('hnsWalletSolanaAddressLookupTableIndex')}
          </AddressText>
