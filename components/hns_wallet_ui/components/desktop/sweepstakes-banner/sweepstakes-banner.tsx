...
*/
const STORAGE_KEY_SWAP_SWEEPSTAKES_CLOSED = 'HNS_WALLET_SWAP_SWEEPSTAKES_BANNER_IS_CLOSED'
...
const LEARN_MORE_LINK = 'https://hns.com/sweepstakes/'
            ...
            <VisibleOnlyDuringTimeFrame startDate={startDate} endDate={endDate}>
                <Card>
                    ...
                    <TitleAndCloseRow>
                        <Title>
                            {/* Swap Sweepstakes */}
                            {getLocale('hnsWalletSweepstakesTitle')}
                        </Title>
                    ...
                    <Footer>
                        <FooterLeftColumn>
                            <BodyText>
                                {getLocale('hnsWalletSweepstakesDescription')}
                            </BodyText>
                            <LearnMoreLink href={LEARN_MORE_LINK}>
                                {getLocale('hnsWalletSweepstakesCallToAction')}
                            </LearnMoreLink>
                        </FooterLeftColumn>
