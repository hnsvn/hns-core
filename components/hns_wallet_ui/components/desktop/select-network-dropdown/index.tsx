...
interface Props {
  selectedNetwork: HnsWallet.NetworkInfo | undefined
  showNetworkDropDown: boolean
  onClick: () => void
  onSelectCustomNetwork: (network: HnsWallet.NetworkInfo) => void
  useWithSearch?: boolean
  customNetwork?: HnsWallet.NetworkInfo | undefined
}
    ...
    >
      ...
      >
        <LeftSide>
          ...
          <NetworkText>
            {selectedNetwork?.chainName || getLocale('hnsWalletSelectNetwork')}
          </NetworkText>
        </LeftSide>
