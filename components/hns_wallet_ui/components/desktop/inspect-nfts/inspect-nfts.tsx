    ...
    <InspectNftsWrapper>
      <TopRow>
        <TopRowButton onClick={onClose}>
          <BackIcon />
          {getLocale('hnsWalletNftPinningBackButton')}
        </TopRowButton>
        <TopRowButton onClick={onClose}>
      ...
      <MainContent>
        ...
        >
          <InfoSubHeading>{getLocale('hnsWalletNftPinningWhyNotAvailable')}</InfoSubHeading>
          <InfoIcon/>
          {showTooltip && (
            <InfoTooltip text={getLocale('hnsWalletNftPinningTooltip')} />
          )}
        </Row>
        <Row>
          <SubDivider />
        ...
        <Row margin='32px 0 0'>
          <Description>{getLocale('hnsWalletNftPinningBenefitsHeading')}</Description>
        </Row>
        <Row gap='16px' alignItems='center' justifyContent='center'>
          ...
          >
            {getLocale('hnsWalletNftPinningPinNftsButton')}
          </PinNftsButton>
        </Row>
