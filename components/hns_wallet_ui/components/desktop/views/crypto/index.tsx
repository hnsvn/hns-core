...
export const CryptoView = (props: Props) => {
  ...
  const showBanner = React.useMemo((): boolean => {
    return (
      (defaultEthereumWallet !== HnsWallet.DefaultWallet.HnsWallet ||
        defaultSolanaWallet !== HnsWallet.DefaultWallet.HnsWallet) &&
    ...
    <>
      {showBanner &&
        <WalletBanner
          ...
          bannerType='warning'
          buttonText={getLocale('hnsWalletWalletPopupSettings')}
          description={getLocale('hnsWalletDefaultWalletBanner')}
        />
      }
      {needsBackup && showBackupWarning &&
        <WalletBanner
          ...
          bannerType='danger'
          buttonText={getLocale('hnsWalletBackupButton')}
          description={getLocale('hnsWalletBackupWarningText')}
        />
      }
    </>
  ), [
      ...
      <Switch>
        ...
        <Route path={WalletRoutes.Market} exact={true}>
          <WalletPageWrapper
            wrapContentInBox
            cardHeader={
              <PageTitleHeader title={getLocale('hnsWalletTopNavMarket')} />
            }
          >
            <StyledWrapper>
              {banners}
        ...
        <Route path={WalletRoutes.Activity} exact={true}>
          <WalletPageWrapper
            wrapContentInBox={true}
            cardHeader={
              <PageTitleHeader title={getLocale('hnsWalletActivity')} />
            }
          >
            <StyledWrapper>
              {banners}
