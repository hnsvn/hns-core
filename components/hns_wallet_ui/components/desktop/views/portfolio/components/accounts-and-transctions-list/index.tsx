...
export const AccountsAndTransactionsList = ({
  ...
  const [selectedSellAccount, setSelectedSellAccount] =
    React.useState<HnsWallet.AccountInfo>()
  ...
  const nonRejectedTransactions = React.useMemo(() => {
    return selectedAssetTransactions
      .filter(t => t.txStatus !== HnsWallet.TransactionStatus.Rejected)
  }, [selectedAssetTransactions])
              ...
              {accountsList.length !== 0 ? (
                ...
                >
                  ...
                  <Text
                    ...
                    isBold={true}
                  >
                    {getLocale('hnsWalletNoAccountsWithABalance')}
                  </Text>
                  ...
                  >
                    {
                      getLocale('hnsWalletNoAccountsWithABalanceDescription')
                    }
                  </Text>
                </Column>
              )}
