    ...
    <Popup isOpen={isOpen} ref={popupRef}>
      ...
      {!isTokenHidden && !isTokenSpam && (
        <>
          <PopupButton onClick={onEditNft}>
            ...
            <PopupButtonText>{getLocale('hnsNftsTabEdit')}</PopupButtonText>
          </PopupButton>
          <PopupButton onClick={onHideNft}>
            <ButtonIcon name='eye-off' />
            <PopupButtonText>{getLocale('hnsNftsTabHide')}</PopupButtonText>
          </PopupButton>
        </>
      )}
      ...
      {isTokenSpam && (
        <PopupButton onClick={onUnSpam}>
          ...
          <PopupButtonText>{getLocale('hnsWalletNftUnspam')}</PopupButtonText>
        </PopupButton>
      )}
      ...
      {isTokenHidden && !isTokenSpam ? (
        <PopupButton onClick={onUnHideNft}>
          ...
          <PopupButtonText>{getLocale('hnsNftsTabUnhide')}</PopupButtonText>
        </PopupButton>
      ): null}
      ...
      <PopupButton onClick={onRemoveNft}>
        ...
        <PopupButtonText>{getLocale('hnsNftsTabRemove')}</PopupButtonText>
      </PopupButton>
    </Popup>
  )
}
