...
export const CoinStats = (props: Props) => {
  ...
  return (
    <StyledWrapper>
      <DividerText>{getLocale('hnsWalletInformation')}</DividerText>
      <SubDivider />
      <Row>
        <StatWrapper>
          <StatValue>{marketCapRank}</StatValue>
          <StatLabel>{getLocale('hnsWalletRankStat')}</StatLabel>
        </StatWrapper>
        ...
        <StatWrapper>
          ...
          <StatLabel>{getLocale('hnsWalletVolumeStat')}</StatLabel>
        </StatWrapper>
        ...
        <StatWrapper>
          ...
          <StatLabel>{getLocale('hnsWalletMarketCapStat')}</StatLabel>
        </StatWrapper>
      </Row>
    </StyledWrapper>
  )
