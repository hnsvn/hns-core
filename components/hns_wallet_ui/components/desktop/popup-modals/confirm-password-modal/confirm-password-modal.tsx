...
export const ConfirmPasswordModal = () => {
  ...
  const onConfirmRemoveAccount = React.useCallback(
    (password: string) => {
      ...
      if (
        accountId.kind === HnsWallet.AccountKind.kHardware ||
        accountId.kind === HnsWallet.AccountKind.kImported
      ) {
  ...
  const title = React.useMemo(() => {
    ...
    return getLocale('hnsWalletRemoveAccountModalTitle')
  ...
  return (
    ...
    >
      <StyledWrapper>
        ...
        <Row>
          <PasswordInput
            placeholder={getLocale('hnsWalletEnterYourPassword')}
