...
export const PortfolioFiltersModal = (props: Props) => {
  ...
  const hideSmallBalancesDescription = React.useMemo(() => {
    const minAmount =
      new Amount(HIDE_SMALL_BALANCES_FIAT_THRESHOLD)
        ...
        .split('.')[0]
    return getLocale('hnsWalletHideSmallBalancesDescription')
      .replace('$1', minAmount)
  ...
  return (
    <PopupModal
      onClose={onClose}
      title={showNftFilters ? getLocale('hnsWalletPortfolioNftsFiltersTitle') : getLocale('hnsWalletPortfolioFiltersTitle')}
      width='500px'
      borderRadius={16}
    >
      <ScrollableColumn>
        ...
        >
          {showNftFilters &&
            <>
              <FilterToggleSection
                title={getLocale('hnsWalletShowNetworkLogoOnNftsTitle')}
                description={getLocale('hnsWalletShowNetworkLogoOnNftsDescription')}
                icon='web3'
              ...
              {/* <FilterToggleSection
                title={getLocale('hnsWalletShowSpamNftsTitle')}
                description={getLocale('hnsWalletShowSpamNftsDescription')}
                icon='shield-star'
                isSelected={true}
                setIsSelected={
                  () => {}
          ...
          <FilterDropdownSection
            title={getLocale('hnsWalletPortfolioGroupByTitle')}
            description={getLocale('hnsWalletPortfolioGroupByDescription')}
            icon='stack'
          ...
          {!showNftFilters &&
            <>
              <FilterDropdownSection
                title={getLocale('hnsWalletSortAssets')}
                description={getLocale('hnsWalletSortAssetsDescription')}
                icon='sort-desc'
              ...
              <FilterToggleSection
                title={getLocale('hnsWalletHideSmallBalances')}
