    ...
    <>
      ...
      >
        <Title
          ...
          isBold={true}
        >
          {getLocale('hnsWalletSelectNetworks')}
        </Title>
        <SelectAllButton
        ...
        >
          {
            isSelectAll
              ? getLocale('hnsWalletSelectAll')
              : getLocale('hnsWalletDeselectAll')
          }
        </SelectAllButton>
      </Row>
      ...
      {primaryNetworks.length > 0 &&
        <NetworkCheckboxes
          ...
          title={getLocale('hnsWalletPrimaryNetworks')}
          marginBottom={8}
        />
      }
      ...
      {secondaryNetworks.length > 0 &&
        <NetworkCheckboxes
          ...
          title={getLocale('hnsWalletNetworkFilterSecondary')}
          marginBottom={8}
        />
      }
      ...
      {testNetworks.length > 0 &&
        <NetworkCheckboxes
          ...
          title={getLocale('hnsWalletNetworkFilterTestNetworks')}
          marginBottom={0}
        />
      }
    </>
