...
interface Props {
  ...
  selectedAssetsNetwork: HnsWallet.NetworkInfo | undefined
  sellAmount: string
...
export const SellAssetModal = (props: Props) => {
  ...
  return (
    <PopupModal
      title={`${getLocale('hnsWalletSell')} ${selectedAsset.name}`}
      ...
      <StyledWrapper>
        ...
        >
            ...
            >
              ...
              >
                <PresetButton
                  ...
                  marginRight={4}
                >
                  {getLocale('hnsWalletSendHalf')}
                </PresetButton>
                <PresetButton
                  onClick={() => setPresetAmountValue(1)}
                >
                  {getLocale('hnsWalletSendMax')}
                </PresetButton>
              </Row>
            </Row>
            <Row
          ...
          {insufficientBalance && !isInvalidAmount &&
            <ErrorBox>
              ...
              >
                {
                  getLocale('hnsWalletNotEnoughBalance')
        ...
        <NavButton
          ...
          text={
            ...
            getLocale('hnsWalletSellWithProvider').replace('$1', 'Ramp')
          }
