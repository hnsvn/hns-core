...
interface VirtualizedTokensListProps {
  ...
  isRemovable: (token: HnsWallet.BlockchainToken) => boolean
  onRemoveAsset: (token: HnsWallet.BlockchainToken) => void
  isAssetSelected: (token: HnsWallet.BlockchainToken) => boolean
...
const getListItemKey = (index: number, tokenList: HnsWallet.BlockchainToken[]) => {
      ...
      {isLastIndex &&
        ...
        >
          ...
          <Text
            ...
            textColor='text02'
          >
            {getLocale('hnsWalletDidntFindAssetEndOfList')}
          </Text>
          <VerticalSpace space='14px' />
          <Button
