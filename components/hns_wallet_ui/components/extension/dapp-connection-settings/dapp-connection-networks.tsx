    ...
    <>
      ...
      >
        ...
        <TitleText
          textSize='22px'
        >
          {getLocale('hnsWalletChangeNetwork')}
        </TitleText>
      </Row>
      <ScrollableColumn>
          ...
          <>
            ...
            >
              <DescriptionText
                ...
                isBold={true}
              >
                {getLocale('hnsWalletPrimaryNetworks')}
              </DescriptionText>
            </Row>
            {primaryNetworks.map(
              (network: HnsWallet.NetworkInfo) =>
          ...
          <>
            ...
            >
              <DescriptionText
                ...
                isBold={true}
              >
                {getLocale('hnsWalletNetworkFilterSecondary')}
              </DescriptionText>
            </Row>
          ...
          <>
            ...
            >
              <DescriptionText
                ...
                isBold={true}
              >
                {getLocale('hnsWalletNetworkFilterTestNetworks')}
              </DescriptionText>
            </Row>
            {testNetworks.map(
              (network: HnsWallet.NetworkInfo) =>
