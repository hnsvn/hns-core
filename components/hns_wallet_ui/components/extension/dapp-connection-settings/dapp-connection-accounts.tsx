...
interface Props {
  ...
  getAccountsFiatValue: (account: HnsWallet.AccountInfo) => Amount
}
...
export const DAppConnectionAccounts = (props: Props) => {
  ...
  // Selectors
  const accounts: HnsWallet.AccountInfo[] =
    ...
    <>
      ...
      >
        ...
        <TitleText
          textSize='22px'
        >
          {getLocale('hnsWalletChangeAccount')}
        </TitleText>
      </Row>
          ...
          <>
            ...
            >
              <DescriptionText
                ...
                isBold={true}
              >
                {getLocale('hnsWalletConnectedAccounts')}
              </DescriptionText>
            </Row>
          ...
          <>
            ...
            >
              <DescriptionText
                ...
                isBold={true}
              >
                {getLocale('hnsWalletAvailableAccounts')}
              </DescriptionText>
            </Row>
