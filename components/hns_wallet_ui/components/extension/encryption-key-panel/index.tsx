...
export interface ProvidePubKeyPanelProps {
  payload: HnsWallet.GetEncryptionPublicKeyRequest
...
export function ProvidePubKeyPanel(props: ProvidePubKeyPanelProps) {
  ...
  return (
    <StyledWrapper>
      ...
      <PanelTitle>
        {getLocale('hnsWalletProvideEncryptionKeyTitle')}
      </PanelTitle>
      <TabRow>
        <PanelTab
          isSelected={true}
          text={getLocale('hnsWalletSignTransactionMessageTitle')}
        />
      </TabRow>
      ...
      <ButtonRow>
        ...
        <NavButton
          buttonType='primary'
          text={getLocale('hnsWalletProvideEncryptionKeyButton')}
...
interface DecryptRequestPanelProps {
  payload: HnsWallet.DecryptRequest
...
export function DecryptRequestPanel(props: DecryptRequestPanelProps) {
  ...
  return (
    <StyledWrapper>
      ...
      <PanelTitle>
        {getLocale('hnsWalletReadEncryptedMessageTitle')}
      </PanelTitle>
      <TabRow>
        <PanelTab
          isSelected={true}
      ...
      <MessageBox needsCenterAlignment={!isDecrypted}>
        {!isDecrypted ? (
          <DecryptButton onClick={onDecryptMessage}>
            {getLocale('hnsWalletReadEncryptedMessageDecryptButton')}
          </DecryptButton>
        ) : (
      ...
      <ButtonRow>
        ...
        <NavButton
          buttonType='primary'
          text={getLocale('hnsWalletReadEncryptedMessageButton')}
