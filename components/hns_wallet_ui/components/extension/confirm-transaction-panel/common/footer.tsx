    ...
    <FooterContainer>
      {transactionsQueueLength > 1 && (
        <QueueStepButton needsMargin={false} onClick={rejectAllTransactions}>
          {getLocale('hnsWalletQueueRejectAll').replace('$1', transactionsQueueLength.toString())}
        </QueueStepButton>
      )}
      ...
      <ButtonRow>
        <NavButton
          ...
          text={
            rejectButtonType === 'cancel'
              ...
              : getLocale('hnsWalletAllowSpendRejectButton')
          }
          onSubmit={onReject}
        ...
        {transactionConfirmed ? (
          <ConfirmingButton>
            <ConfirmingButtonText>
              {getLocale('hnsWalletAllowSpendConfirmButton')}
            </ConfirmingButtonText>
            <LoadIcon />
          </ConfirmingButton>
        ) : (
          <NavButton
            buttonType='confirm'
            text={getLocale('hnsWalletAllowSpendConfirmButton')}
