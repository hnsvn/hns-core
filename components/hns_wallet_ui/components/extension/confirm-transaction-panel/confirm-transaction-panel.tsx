    ...
    <StyledWrapper>
      ...
      {isERC20Approve ? (
        <>
          ...
          <PanelTitle>
            {getLocale('hnsWalletAllowSpendTitle').replace(
              '$1',
              foundTokenInfoByContractAddress?.symbol ?? ''
            )}
          </PanelTitle>
          <Description>
            {getLocale('hnsWalletAllowSpendDescription').replace(
              '$1',
              foundTokenInfoByContractAddress?.symbol ?? ''
            )}
          </Description>
            ...
            <WarningBox warningType={'danger'}>
              <WarningBoxTitleRow>
                ...
                <WarningTitle warningType={'danger'}>
                  {getLocale('hnsWalletAllowSpendUnlimitedWarningTitle')}
                </WarningTitle>
              </WarningBoxTitleRow>
            </WarningBox>
          )}
          ...
          <EditButton onClick={onToggleEditAllowance}>
            {getLocale('hnsWalletEditPermissionsButton')}
          </EditButton>
        </>
      ) : (
        <>
