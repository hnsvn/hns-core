    ...
    <>
      {!isFilecoinTransaction && (
        <SectionRow>
          <TransactionTitle>
            {isSolanaTransaction
              ? getLocale('hnsWalletConfirmTransactionTransactionFee')
              : getLocale('hnsWalletConfirmTransactionGasFee')}
          </TransactionTitle>
      ...
      {isFilecoinTransaction && (
        <>
          {transactionDetails.gasPremium && (
            <SectionColumn>
              <TransactionTitle>{getLocale('hnsWalletTransactionGasPremium')}</TransactionTitle>
              <TransactionTypeText>
                {transactionsNetwork &&
          ...
          {transactionDetails.gasLimit && (
            <SectionColumn>
              <TransactionTitle>{getLocale('hnsWalletTransactionGasLimit')}</TransactionTitle>
              <TransactionTypeText>
                {transactionsNetwork &&
          ...
          {transactionDetails.gasFeeCap && (
            <SectionColumn>
              <TransactionTitle>{getLocale('hnsWalletTransactionGasFeeCap')}</TransactionTitle>
              <TransactionTypeText>
                {transactionsNetwork &&
      ...
      {hasFeeEstimatesError ? (
        <TransactionText hasError={true}>
          {getLocale('hnsWalletTransactionHasFeeEstimatesError')}
        </TransactionText>
      ) : isLoadingGasFee ? (
        <Column
          fullHeight
      ...
      <WarningBoxTitleRow>
        <TransactionTitle>
          {getLocale('hnsWalletConfirmTransactionTotal')}{' '}
          {!isFilecoinTransaction && (
            <>
              {isSolanaTransaction
                ? getLocale('hnsWalletConfirmTransactionAmountFee')
                : getLocale('hnsWalletConfirmTransactionAmountGas')}
            </>
          )}
        </TransactionTitle>
      </WarningBoxTitleRow>
      ...
      {!!Number(sendOptions?.maxRetries?.maxRetries) && (
        <>
          <TransactionTitle>
            {getLocale('hnsWalletSolanaMaxRetries')}
          </TransactionTitle>
          <TransactionTypeText>
            {Number(sendOptions?.maxRetries?.maxRetries)}
          </TransactionTypeText>
      ...
      {sendOptions?.preflightCommitment && (
        <>
          <TransactionTitle>
            {getLocale('hnsWalletSolanaPreflightCommitment')}
          </TransactionTitle>
          <TransactionTypeText>
            {sendOptions.preflightCommitment}
          </TransactionTypeText>
      ...
      {sendOptions?.skipPreflight && (
        <>
          <TransactionTitle>
            {getLocale('hnsWalletSolanaSkipPreflight')}
          </TransactionTitle>
          <TransactionTypeText>
