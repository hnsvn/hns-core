...
interface Props {
  ...
  accountsToConnect: HnsWallet.AccountInfo[]
}
...
export const ConnectWithSite = (props: Props) => {
  ...
  const [selectedDuration, setSelectedDuration] =
    React.useState<HnsWallet.PermissionLifetimeOption>(
      HnsWallet.PermissionLifetimeOption.kPageClosed
    )
      ...
      <ScrollContainer ref={scrollRef} onScroll={onScroll}>
          ...
          <>
            <SelectAddressContainer>
              ...
              <Row padding="8px 0px" justifyContent="flex-start">
                <AccountNameText>
                  {getLocale('hnsWalletConnectWithSite')}
                </AccountNameText>
              </Row>
        ...
        {isReadyToConnect && (
          ...
          >
            ...
            >
              <SectionLabel>
                {getLocale('hnsWalletPermissionDuration')}
              </SectionLabel>
              ...
              <SectionLabel>
                {getLocale('hnsWalletConnectPermittedLabel')}
              </SectionLabel>
              ...
              <SectionLabel>
                {getLocale('hnsWalletConnectNotPermittedLabel')}
              </SectionLabel>
      ...
      <ButtonRow padding={16} isReadyToConnect={isReadyToConnect}>
        ...
        >
          {isReadyToConnect
            ...
            : getLocale('hnsWalletConnectWithSiteNext')}
        </NavButton>
      </ButtonRow>
    </StyledWrapper>
  )
