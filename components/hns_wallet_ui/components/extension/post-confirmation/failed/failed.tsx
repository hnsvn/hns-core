...
export const TransactionFailed = (props: Props) => {
  ...
  return (
    <Panel navAction={onClose} title={headerTitle} headerStyle='slim'>
      <ErrorIcon />
      <Title>{getLocale('hnsWalletTransactionFailedTitle')}</Title>
      <TransactionStatusDescription>
        {getLocale('hnsWalletTransactionFailedDescription')}
      </TransactionStatusDescription>
      <ButtonRow>
        {errorDetailContent && (
          <NavButton
            buttonType='secondary'
            text={getLocale('hnsWalletTransactionFailedViewErrorCTA')}
            onSubmit={() => setShowErrorCodeModal(true)}
          />
        )}
        <NavButton
          buttonType='primary'
          text={getLocale('hnsWalletButtonClose')}
...
const ErrorDetail = (props: ModalProps) => {
  ...
  return (
    <PopupModal title={getLocale('hnsWalletTransactionFailedModalTitle')} onClose={onClose}>
