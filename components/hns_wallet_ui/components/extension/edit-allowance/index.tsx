...
import Radio from 'hns-ui/components/formControls/radio'
...
export const EditAllowance = (props: Props) => {
  ...
  return (
    <Panel
      navAction={onCancel}
      title={getLocale('hnsWalletEditPermissionsTitle')}
    >
      <StyledWrapper>
        <Description>
          {getLocale('hnsWalletEditPermissionsDescription').replace('$1', approvalTarget)}
        </Description>
        <FormColumn>
          <Radio
            value={{
          ...
          >
            <div data-value='proposed'>
              <AllowanceOption>
                <AllowanceTitle>
                  {getLocale('hnsWalletEditPermissionsProposedAllowance')}
                </AllowanceTitle>
                <AllowanceContent>
            ...
            <div data-value='custom'>
              <AllowanceOption>
                <AllowanceTitle>
                  {getLocale('hnsWalletEditPermissionsCustomAllowance')}
                </AllowanceTitle>
                <Input
