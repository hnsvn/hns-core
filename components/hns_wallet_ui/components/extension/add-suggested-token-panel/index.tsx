  ...
  return (
    <StyledWrapper>
      <TopWrapper>
        ...
        <Title>{getLocale('hnsWalletAddSuggestedTokenTitle')}</Title>
        <URLText>
          {isFetching ? (
            <LoadingSkeleton height={12} width={'50px'} />
          ) : (
        ...
        <Description>
          {getLocale('hnsWalletAddSuggestedTokenDescription')}
        </Description>
        {isFetching ? (
        ...
        <Tooltip text={getLocale('hnsWalletTransactionExplorer')}>
          <ContractAddress
      ...
      <ButtonWrapper>
        ...
        <NavButton
          disabled={isFetching}
          buttonType='confirm'
          text={getLocale('hnsWalletWatchListAdd')}
          onSubmit={onAddToken}
        />
      </ButtonWrapper>
    </StyledWrapper>
