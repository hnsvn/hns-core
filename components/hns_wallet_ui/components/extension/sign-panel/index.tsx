...
const onClickLearnMore = () => {
  chrome.tabs.create({
    url: 'https://support.hns.com/hc/en-us/articles/4409513799693'
  }, () => {
...
export const SignPanel = (props: Props) => {
  ...
  const [selectedQueueData, setSelectedQueueData] = React.useState<HnsWallet.SignMessageRequest>(signMessageData[0])
    ...
    <StyledWrapper>
      <TopRow>
        ...
        {signMessageQueueInfo.queueLength > 1 &&
          <QueueStepRow>
            <QueueStepText>{signMessageQueueInfo.queueNumber} {getLocale('hnsWalletQueueOf')} {signMessageQueueInfo.queueLength}</QueueStepText>
            <QueueStepButton
        ...
        <>
            ...
            <PanelTab
              ...
              text={
                selectedQueueData.isEip712
                  ? getLocale('hnsWalletSignTransactionEIP712MessageTitle')
                  : getLocale('hnsWalletSignTransactionMessageTitle')
              }
            />
          </TabRow>
            ...
            <WarningBox warningType='warning'>
              <WarningTitleRow>
                ...
                <WarningTitle warningType='warning'>
                  {
                    getLocale('hnsWalletNonAsciiCharactersInMessageWarning')
                  }
                </WarningTitle>
              </WarningTitleRow>
              <LearnMoreButton
              ...
              >
                {
                 renderUnicode
                  ? getLocale('hnsWalletViewDecodedMessage')
                  : getLocale('hnsWalletViewEncodedMessage')
                }
              </LearnMoreButton>
            </WarningBox>
          }
          ...
          {selectedQueueData.isEip712 && (
            <MessageBox height='180px'>
              <MessageHeader>
                {getLocale('hnsWalletSignTransactionEIP712MessageDomain')}:
              </MessageHeader>
              <MessageText>
