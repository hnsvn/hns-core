...
#ifndef HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
#define HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
...
#endif  // HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
