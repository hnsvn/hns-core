...
import * as mojom from 'gen/hns/components/speedreader/common/speedreader_toolbar.mojom.m.js'

// Provide access to all the generated types
export * from 'gen/hns/components/speedreader/common/speedreader_toolbar.mojom.m.js'
