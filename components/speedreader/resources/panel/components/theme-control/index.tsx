...
const themeOptions = [
  {
    id: 'theme-light',
    type: Theme.kLight,
    title: getLocale('hnsReaderModeAppearanceThemeLight')
  },
  {
    id: 'theme-sepia',
    type: Theme.kSepia,
    title: getLocale('hnsReaderModeAppearanceThemeSepia')
  },
  {
    id: 'theme-dark',
    type: Theme.kDark,
    title: getLocale('hnsReaderModeAppearanceThemeDark')
  },
  {
    id: 'theme-system',
    type: Theme.kNone,
    iconName: 'theme-system',
    title: getLocale('hnsReaderModeAppearanceThemeSystem')
  }
]
