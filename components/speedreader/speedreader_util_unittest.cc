...
#include "hns/components/speedreader/common/url_readable_hints.h"
...
TEST(SpeedreaderUtilTest, URLHasHints) {
  EXPECT_FALSE(IsURLLooksReadable(GURL("https://github.com/hnsvn/hns-core")));
  ...
  EXPECT_FALSE(IsURLLooksReadable(
      GURL("https://search.hns.com/news?q=stuff&source=web")));
}
}  // namespace speedreader
