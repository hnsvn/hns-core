...
#ifndef HNS_COMPONENTS_SPEEDREADER_RUST_FFI_SPEEDREADER_FFI_H_
#define HNS_COMPONENTS_SPEEDREADER_RUST_FFI_SPEEDREADER_FFI_H_
...
void rewriter_set_content_style(C_CRewriter* rewriter, const char* style);
...
#endif  // HNS_COMPONENTS_SPEEDREADER_RUST_FFI_SPEEDREADER_FFI_H_
