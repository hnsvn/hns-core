...
#ifndef HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_DELEGATE_H_
#define HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_DELEGATE_H_
...
#endif  // HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_THROTTLE_DELEGATE_H_
