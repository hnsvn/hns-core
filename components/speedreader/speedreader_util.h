...
#ifndef HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_UTIL_H_
#define HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_UTIL_H_
...
#endif  // HNS_COMPONENTS_SPEEDREADER_SPEEDREADER_UTIL_H_
