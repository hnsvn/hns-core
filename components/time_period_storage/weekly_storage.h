...
#ifndef HNS_COMPONENTS_TIME_PERIOD_STORAGE_WEEKLY_STORAGE_H_
#define HNS_COMPONENTS_TIME_PERIOD_STORAGE_WEEKLY_STORAGE_H_
...
#endif  // HNS_COMPONENTS_TIME_PERIOD_STORAGE_WEEKLY_STORAGE_H_
