...
TEST(HnsVersionInfoTest, ChannelStringTest) {
...
TEST(HnsVersionInfoTest, VersionInfoTest) {
  // version_info::GetVersionNumber() and
  // version_info::GetHnsChromiumVersionNumber() should give different string.
  // Ex, 113.1.52.74(hns version) vs. 113.0.5672.53(chromium version).
  EXPECT_NE(version_info::GetVersionNumber(),
            version_info::GetHnsChromiumVersionNumber());
