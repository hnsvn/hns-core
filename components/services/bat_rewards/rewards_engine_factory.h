...
#ifndef HNS_COMPONENTS_SERVICES_BAT_REWARDS_REWARDS_ENGINE_FACTORY_H_
#define HNS_COMPONENTS_SERVICES_BAT_REWARDS_REWARDS_ENGINE_FACTORY_H_
...
#endif  // HNS_COMPONENTS_SERVICES_BAT_REWARDS_REWARDS_ENGINE_FACTORY_H_
