...
#include "hns/components/services/ipfs/ipfs_service_utils.h"
...
void IpfsServiceImpl::Launch(mojom::IpfsConfigPtr config,
  ...
  child_monitor_ = std::make_unique<hns::ChildProcessMonitor>();
  ...
  if (!version.empty() &&
    ...
    args.AppendArg("--agent-version-suffix=hns");
  }
