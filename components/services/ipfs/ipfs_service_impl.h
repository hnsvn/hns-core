...
#ifndef HNS_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
#define HNS_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
...
#endif  // HNS_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_IMPL_H_
