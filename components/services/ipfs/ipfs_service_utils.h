...
#ifndef HNS_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_UTILS_H_
#define HNS_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_UTILS_H_
...
#endif  // HNS_COMPONENTS_SERVICES_IPFS_IPFS_SERVICE_UTILS_H_
