...
#ifndef HNS_COMPONENTS_SERVICES_BAT_ADS_BAT_ADS_CLIENT_NOTIFIER_IMPL_H_
#define HNS_COMPONENTS_SERVICES_BAT_ADS_BAT_ADS_CLIENT_NOTIFIER_IMPL_H_
...
class BatAdsClientNotifierImpl : public bat_ads::mojom::BatAdsClientNotifier {
 public:
  ...
  // Invoked when the Hns Reward wallet did change.
 ...
 private:
  hns_ads::AdsClientNotifier notifier_;
...
#endif  // HNS_COMPONENTS_SERVICES_BAT_ADS_BAT_ADS_CLIENT_NOTIFIER_IMPL_H_
