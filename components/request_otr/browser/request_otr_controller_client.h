...
#ifndef HNS_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_CONTROLLER_CLIENT_H_
#define HNS_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_CONTROLLER_CLIENT_H_
...
#endif  // HNS_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_CONTROLLER_CLIENT_H_
