...
#ifndef HNS_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_RULE_H_
#define HNS_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_RULE_H_
...
#endif  // HNS_COMPONENTS_REQUEST_OTR_BROWSER_REQUEST_OTR_RULE_H_
