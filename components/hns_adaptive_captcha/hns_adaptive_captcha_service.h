...
#ifndef HNS_COMPONENTS_HNS_ADAPTIVE_CAPTCHA_HNS_ADAPTIVE_CAPTCHA_SERVICE_H_
#define HNS_COMPONENTS_HNS_ADAPTIVE_CAPTCHA_HNS_ADAPTIVE_CAPTCHA_SERVICE_H_
...
#include "hns/components/hns_adaptive_captcha/get_adaptive_captcha_challenge.h"
...
class HnsAdaptiveCaptchaService
 ...
 public:
  HnsAdaptiveCaptchaService(
      PrefService* prefs,
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory,
      hns_rewards::RewardsService* rewards_service,
      std::unique_ptr<HnsAdaptiveCaptchaDelegate> delegate);
  ~HnsAdaptiveCaptchaService() override;

  HnsAdaptiveCaptchaService(const HnsAdaptiveCaptchaService&) = delete;
  HnsAdaptiveCaptchaService& operator=(const HnsAdaptiveCaptchaService&) =
      delete;
 ...
 private:
  ...
  raw_ptr<hns_rewards::RewardsService> rewards_service_ =
      nullptr;  // NOT OWNED
  std::unique_ptr<HnsAdaptiveCaptchaDelegate> delegate_;
...
#endif  // HNS_COMPONENTS_HNS_ADAPTIVE_CAPTCHA_HNS_ADAPTIVE_CAPTCHA_SERVICE_H_
