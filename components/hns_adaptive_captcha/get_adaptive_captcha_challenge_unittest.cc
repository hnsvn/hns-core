...
// npm run test -- hns_unit_tests --filter=GetAdaptiveCaptchaChallengeTest.*
  ...
  GetAdaptiveCaptchaChallengeTest()
      : api_request_helper_(TRAFFIC_ANNOTATION_FOR_TESTS,
        ...
        get_challenge_(std::make_unique<GetAdaptiveCaptchaChallenge>(
            &api_request_helper_)) {
    hns_adaptive_captcha::ServerUtil::GetInstance()->SetServerHostForTesting(
        "https://grants.rewards.hns.com");
  }
...
TEST_F(GetAdaptiveCaptchaChallengeTest, ServerOK) {
  test_url_loader_factory_.AddResponse(
      "https://grants.rewards.hns.com/v3/captcha/challenge/payment_id",
