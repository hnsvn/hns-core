...
#ifndef HNS_COMPONENTS_SYNC_DEVICE_INFO_HNS_DEVICE_INFO_H_
#define HNS_COMPONENTS_SYNC_DEVICE_INFO_HNS_DEVICE_INFO_H_
...
class HnsDeviceInfo : public DeviceInfo {
 public:
  HnsDeviceInfo(const std::string& guid,
  ...
  HnsDeviceInfo(const HnsDeviceInfo&) = delete;
  HnsDeviceInfo& operator=(const HnsDeviceInfo&) = delete;
  ~HnsDeviceInfo() override {}
...
#endif  // HNS_COMPONENTS_SYNC_DEVICE_INFO_HNS_DEVICE_INFO_H_
