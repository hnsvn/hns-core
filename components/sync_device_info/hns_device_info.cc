...
bool HnsDeviceInfo::is_self_delete_supported() const {
  return is_self_delete_supported_;
}

void HnsDeviceInfo::set_is_self_delete_supported(
    bool is_self_delete_supported) {
  is_self_delete_supported_ = is_self_delete_supported;
}

std::string HnsDeviceInfo::GetOSString() const {
  switch (os_type()) {
...
std::string HnsDeviceInfo::GetDeviceTypeString() const {
  switch (form_factor()) {
...
base::Value::Dict HnsDeviceInfo::ToValue() const {
