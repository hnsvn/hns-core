...
// npm run test -- hns_unit_tests
// -filter=HnsFederatedOperationalPatternsUtilTest*

namespace hns_federated {

class HnsFederatedOperationalPatternsUtilTest : public testing::Test {
 public:
  HnsFederatedOperationalPatternsUtilTest()
...
TEST_F(HnsFederatedOperationalPatternsUtilTest,
...
TEST_F(HnsFederatedOperationalPatternsUtilTest, BuildCollectionPingPayload) {
  // Arrange
  ...
  const std::string pattern =
      ...
      ")\",\"wiki-link\":\"https://github.com/hnsvn/hns-browser/wiki/"
      "Operational-Patterns\"}";
  EXPECT_TRUE(RE2::FullMatch(payload, pattern));
}

TEST_F(HnsFederatedOperationalPatternsUtilTest, BuildDeletePingPayload) {
  // Arrange
  const std::string collection_id = CreateCollectionId();
  ...
  // Assert
  const std::string pattern =
      "{\"collection_id\":\"(.{32})\",\"wiki-link\":\"https://github.com/hnsvn/"
      "hns-browser/wiki/Operational-Patterns\"}";
  EXPECT_TRUE(RE2::FullMatch(payload, pattern));
}
