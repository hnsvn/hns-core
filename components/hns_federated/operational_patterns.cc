...
#include "hns/components/hns_federated/operational_patterns_util.h"
...
static constexpr char kCollectionEndpoint[] = "https://fl.hns.com/";

constexpr char kLastSentSlotPrefName[] = "hns.federated.last_checked_slot";
constexpr char kCollectionIdPrefName[] = "hns.federated.collection_id";
constexpr char kCollectionIdExpirationPrefName[] =
    "hns.federated.collection_id_expiration";
  ...
  return net::DefineNetworkTrafficAnnotation("operational_pattern", R"(
        semantics {
          ...
          description:
            ...
            "https://github.com/hnsvn/hns-browser/wiki/Operational-Patterns"
          trigger:
            "Reports are automatically generated on startup and at intervals "
            "while Hns is running."
          data:
...
void OperationalPatterns::Start() {
  ...
  const int collection_id_lifetime =
      hns_federated::features::GetCollectionIdLifetimeInSeconds();
  const int collection_slot_size =
      hns_federated::features::GetCollectionSlotSizeInSeconds();
  const int collection_timer_interval =
      hns_federated::features::GetCollectionTimerIntervalInSeconds();
  const int mock_training_duration =
      hns_federated::features::GetMockTaskDurationInSeconds();
...
void OperationalPatterns::SendCollectionPing(int slot) {
  ...
  request->headers.SetHeader("X-Hns-FL-Operational-Patterns", "?1");
  ...
  if (hns_federated::features::MockCollectionRequests()) {
