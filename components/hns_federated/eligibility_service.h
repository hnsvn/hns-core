...
#ifndef HNS_COMPONENTS_HNS_FEDERATED_ELIGIBILITY_SERVICE_H_
#define HNS_COMPONENTS_HNS_FEDERATED_ELIGIBILITY_SERVICE_H_
...
#endif  // HNS_COMPONENTS_HNS_FEDERATED_ELIGIBILITY_SERVICE_H_
