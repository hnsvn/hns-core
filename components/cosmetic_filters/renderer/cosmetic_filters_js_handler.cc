...
#include "hns/components/cosmetic_filters/renderer/cosmetic_filters_js_handler.h"
...
#include "hns/components/cosmetic_filters/resources/grit/cosmetic_filters_generated_map.h"
...
constexpr const char TRACE_CATEGORY[] = "hns.adblock";
...
CosmeticFiltersJSHandler::CosmeticFiltersJSHandler(
  ...
  const bool perf_tracker_enabled = base::FeatureList::IsEnabled(
      hns_shields::features::kCosmeticFilteringExtraPerfMetrics);
...
bool CosmeticFiltersJSHandler::ProcessURL(
  ...
  auto* content_settings =
      static_cast<content_settings::HnsContentSettingsAgentImpl*>(
  ...
  if (callback.has_value()) {
    SCOPED_UMA_HISTOGRAM_TIMER_MICROS(
        "Hns.CosmeticFilters.UrlCosmeticResources");
    TRACE_EVENT1("hns.adblock", "UrlCosmeticResources", "url", url_.spec());
    ...
    TRACE_EVENT1("hns.adblock", "UrlCosmeticResourcesSync", "url",
                 url_.spec());
    SCOPED_UMA_HISTOGRAM_TIMER_MICROS(
        "Hns.CosmeticFilters.UrlCosmeticResourcesSync");
    base::Value result;
    cosmetic_filters_resources_->UrlCosmeticResources(
...
void CosmeticFiltersJSHandler::ApplyRules(bool de_amp_enabled) {
  ...
  SCOPED_UMA_HISTOGRAM_TIMER_MICROS("Hns.CosmeticFilters.ApplyRules");
  TRACE_EVENT1("hns.adblock", "ApplyRules", "url", url_.spec());
  ...
  namespace bf = hns_shields::features;
...
void CosmeticFiltersJSHandler::CSSRulesRoutine(
  ...
  SCOPED_UMA_HISTOGRAM_TIMER_MICROS("Hns.CosmeticFilters.CSSRulesRoutine");
  TRACE_EVENT1("hns.adblock", "CSSRulesRoutine", "url", url_.spec());
...
void CosmeticFiltersJSHandler::OnHiddenClassIdSelectors(
  ...
  SCOPED_UMA_HISTOGRAM_TIMER_MICROS(
      "Hns.CosmeticFilters.OnHiddenClassIdSelectors");
  TRACE_EVENT1("hns.adblock", "OnHiddenClassIdSelectors", "url", url_.spec());
...
void CosmeticFiltersJSHandler::ExecuteObservingBundleEntryPoint() {
  ...
  if (!bundle_injected_) {
    SCOPED_UMA_HISTOGRAM_TIMER_MICROS(
        "Hns.CosmeticFilters.ExecuteObservingBundleEntryPoint");
    TRACE_EVENT1("hns.adblock", "ExecuteObservingBundleEntryPoint", "url",
                 url_.spec());
