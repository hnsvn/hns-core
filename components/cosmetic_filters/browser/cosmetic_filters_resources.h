...
#ifndef HNS_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
#define HNS_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
...
class CosmeticFiltersResources final
 ...
 private:
  raw_ptr<hns_shields::AdBlockService> ad_block_service_ =
      nullptr;  // Not owned
};

}  // namespace cosmetic_filters

#endif  // HNS_COMPONENTS_COSMETIC_FILTERS_BROWSER_COSMETIC_FILTERS_RESOURCES_H_
