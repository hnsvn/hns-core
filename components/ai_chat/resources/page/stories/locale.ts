...
provideStrings({
  ...
  enableQuestionsDesc: 'Hns AI can automatically suggest questions based on the content of the site. You can disable it later in Settings.',
  enableQuestionsButtonLabel: 'Enable',
  noThanksButtonLabel: 'No Thanks',
  aboutTitle: 'Hns AI',
  aboutDescription: 'The Hns AI Chat feature summarizes the content of a webpage you browse and includes a chat interface that allows you to make follow-up inquiries of the summarized content for that page.',
