...
const char kChatCountHistogramName[] = "Hns.AIChat.ChatCount";
const char kAvgPromptCountHistogramName[] = "Hns.AIChat.AvgPromptCount";
const char kEnabledHistogramName[] = "Hns.AIChat.Enabled";
const char kUsageDailyHistogramName[] = "Hns.AIChat.UsageDaily";

AIChatMetrics::AIChatMetrics(PrefService* local_state)
    : chat_count_storage_(local_state,
                          prefs::kHnsChatP3AChatCountWeeklyStorage),
      prompt_count_storage_(local_state,
                            prefs::kHnsChatP3APromptCountWeeklyStorage) {
  ReportCounts();
}
...
void AIChatMetrics::RegisterPrefs(PrefRegistrySimple* registry) {
  registry->RegisterListPref(prefs::kHnsChatP3AChatCountWeeklyStorage);
  registry->RegisterListPref(prefs::kHnsChatP3APromptCountWeeklyStorage);
}
