...
#ifndef HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_TAB_HELPER_H_
#define HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_TAB_HELPER_H_
...
#include "hns/components/ai_chat/browser/ai_chat_api.h"
...
#endif  // HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_TAB_HELPER_H_
