...
#ifndef HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_METRICS_H_
#define HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_METRICS_H_
...
#endif  // HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_METRICS_H_
