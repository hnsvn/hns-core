...
#ifndef HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_API_H_
#define HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_API_H_
...
#endif  // HNS_COMPONENTS_AI_CHAT_BROWSER_AI_CHAT_API_H_
