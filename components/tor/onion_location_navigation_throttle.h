...
#ifndef HNS_COMPONENTS_TOR_ONION_LOCATION_NAVIGATION_THROTTLE_H_
#define HNS_COMPONENTS_TOR_ONION_LOCATION_NAVIGATION_THROTTLE_H_
...
#endif  // HNS_COMPONENTS_TOR_ONION_LOCATION_NAVIGATION_THROTTLE_H_
