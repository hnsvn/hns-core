...
#ifndef HNS_COMPONENTS_TOR_MOCK_TOR_LAUNCHER_FACTORY_H_
#define HNS_COMPONENTS_TOR_MOCK_TOR_LAUNCHER_FACTORY_H_
...
#endif  // HNS_COMPONENTS_TOR_MOCK_TOR_LAUNCHER_FACTORY_H_
