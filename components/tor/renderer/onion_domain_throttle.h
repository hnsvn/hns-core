...
#ifndef HNS_COMPONENTS_TOR_RENDERER_ONION_DOMAIN_THROTTLE_H_
#define HNS_COMPONENTS_TOR_RENDERER_ONION_DOMAIN_THROTTLE_H_
...
#endif  // HNS_COMPONENTS_TOR_RENDERER_ONION_DOMAIN_THROTTLE_H_
