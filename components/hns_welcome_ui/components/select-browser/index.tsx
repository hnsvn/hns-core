    ...
    <S.MainBox>
      <div className="view-header-box">
        <div className="view-details">
          <h1 className="view-title">{getLocale('hnsWelcomeImportSettingsTitle')}</h1>
          <p className="view-desc">{getLocale('hnsWelcomeImportSettingsDesc')}</p>
        </div>
      </div>
      <S.BrowserListBox>
      ...
      <S.ActionBox>
        ...
        >
          ...
          <Button
            ...
            scale="jumbo"
          >
            {getLocale('hnsWelcomeImportButtonLabel')}
          </Button>
      </S.ActionBox>
    </S.MainBox>
  )
