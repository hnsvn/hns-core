    ...
    <S.MainBox>
      <div className="view-header-box">
        <div className="view-header-actions">
          <button className="back-button" onClick={handleBackButton}>
            <LeftArrowSVG />
            <span>{getLocale('hnsWelcomeBackButtonLabel')}</span>
          </button>
        </div>
        <div className="view-details">
          <h1 className="view-title">{getLocale('hnsWelcomeSelectProfileLabel')}</h1>
          <p className="view-desc">{getLocale('hnsWelcomeSelectProfileDesc')}</p>
        </div>
      </div>
      <S.ProfileListBox>
        <div className="profile-list">
          <div className="list-actions">
            <div className="right">
              <button onClick={selectAll}>{getLocale('hnsWelcomeSelectAllButtonLabel')}</button>
            </div>
          </div>
      ...
      <S.ActionBox>
        <Button
          ...
          scale="jumbo"
        >
          {getLocale('hnsWelcomeImportProfilesButtonLabel')}
        </Button>
      </S.ActionBox>
    </S.MainBox>
  )
