...
import hnsLogoUrl from '../../assets/hns_logo_3d@2x.webp'
      ...
      <div className={classnames({ 'view-content': true, 'initial': shouldPlayAnimations })}>
        <div className="view-header-box">
          <div className="view-details">
            <h1 className="view-title">{getLocale('hnsWelcomeTitle')}</h1>
            <p className="view-desc">{getLocale('hnsWelcomeDesc')}</p>
          </div>
        </div>
        <S.ActionBox>
          <Button
            ...
            scale="jumbo"
          >
            {getLocale('hnsWelcomeSetDefaultButtonLabel')}
          </Button>
          <Button
            isTertiary={true}
            onClick={handleSkip}
