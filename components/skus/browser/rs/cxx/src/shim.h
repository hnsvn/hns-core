...
#ifndef HNS_COMPONENTS_SKUS_BROWSER_RS_CXX_SRC_SHIM_H_
#define HNS_COMPONENTS_SKUS_BROWSER_RS_CXX_SRC_SHIM_H_
...
#endif  // HNS_COMPONENTS_SKUS_BROWSER_RS_CXX_SRC_SHIM_H_
