...
#ifndef HNS_COMPONENTS_SKUS_RENDERER_SKUS_JS_HANDLER_H_
#define HNS_COMPONENTS_SKUS_RENDERER_SKUS_JS_HANDLER_H_
...
// into window.chrome.hnsSkus.*
//
// This is only intended to be used on account.hns.com and the dev / staging
...
// will be able to purchase VPN from account.hns.com and the browser can
...
class SkusJSHandler : public gin::Wrappable<SkusJSHandler> {
 ...
 private:
  ...
  // window.chrome.hnsSkus.refresh_order
  ...
  // window.chrome.hnsSkus.fetch_order_credentials
  ...
  // window.chrome.hnsSkus.prepare_credentials_presentation
  ...
  // window.chrome.hnsSkus.credential_summary
...
#endif  // HNS_COMPONENTS_SKUS_RENDERER_SKUS_JS_HANDLER_H_
