...
#ifndef HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_TOOLTIPS_DELEGATE_H_
#define HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_TOOLTIPS_DELEGATE_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_TOOLTIPS_DELEGATE_H_
