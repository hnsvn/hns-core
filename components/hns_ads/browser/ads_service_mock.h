...
#ifndef HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_SERVICE_MOCK_H_
#define HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_SERVICE_MOCK_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_SERVICE_MOCK_H_
