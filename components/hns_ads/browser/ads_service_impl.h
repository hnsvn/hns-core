...
#ifndef HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_SERVICE_IMPL_H_
#define HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_SERVICE_IMPL_H_
...
#include "hns/components/hns_rewards/common/mojom/rewards.mojom-forward.h"
...
class AdsServiceImpl : public AdsService,
 ...
 private:
  ...
  bool UserHasOptedInToHnsRewards() const;
  bool UserHasOptedInToHnsNewsAds() const;
  ...
  void InitializeBatAds(hns_rewards::mojom::RewardsWalletPtr rewards_wallet);
  ...
  void InitializeHnsRewardsPrefChangeRegistrar();
  void InitializeSubdivisionTargetingPrefChangeRegistrar();
  void InitializeHnsNewsAdsPrefChangeRegistrar();
  ...
  // TODO(https://github.com/hnsvn/hns-browser/issues/14666) Decouple idle
  // state business logic.
  void CheckIdleStateAfterDelay();
  void CheckIdleState();
  void ProcessIdleState(ui::IdleState idle_state, base::TimeDelta idle_time);

  // TODO(https://github.com/hnsvn/hns-browser/issues/23974) Decouple
  ...
  // TODO(https://github.com/hnsvn/hns-browser/issues/26192) Decouple new
  // tab page ad business logic.
  void PrefetchNewTabPageAdCallback(absl::optional<base::Value::Dict> dict);

  // TODO(https://github.com/hnsvn/hns-browser/issues/26193) Decouple open
  ...
  // TODO(https://github.com/hnsvn/hns-browser/issues/14676) Decouple URL
  ...
  // TODO(https://github.com/hnsvn/hns-browser/issues/26194) Decouple
  ...
  // TODO(https://github.com/hnsvn/hns-browser/issues/26195) Decouple load
  ...
  // TODO(https://github.com/hnsvn/hns-browser/issues/14666) Decouple P2A
  // business logic.
  ...
  // Hns Ads Service starts count is needed to avoid possible double Hns
  // Ads initialization.
  // TODO(https://github.com/hnsvn/hns-browser/issues/30247): Refactor Hns
  // Ads startup logic.
  ...
  const raw_ptr<hns_adaptive_captcha::HnsAdaptiveCaptchaService>
  ...
  const raw_ptr<NotificationDisplayService> display_service_ =
      nullptr;  // NOT OWNED
  const raw_ptr<hns_rewards::RewardsService> rewards_service_{
      nullptr};  // NOT OWNED

  const raw_ptr<hns_federated::AsyncDataStore>
...
#endif  // HNS_COMPONENTS_HNS_ADS_BROWSER_ADS_SERVICE_IMPL_H_
