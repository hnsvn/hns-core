...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_PREFS_PREF_NAMES_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_PREFS_PREF_NAMES_H_

namespace hns_ads::prefs {

// Hns Ads version pref
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_PREFS_PREF_NAMES_H_
