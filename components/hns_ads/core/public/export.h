...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_EXPORT_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_EXPORT_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_EXPORT_H_
