...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_AD_INFO_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_AD_INFO_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_AD_INFO_H_
