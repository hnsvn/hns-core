...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_CLIENT_ADS_CLIENT_NOTIFIER_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_CLIENT_ADS_CLIENT_NOTIFIER_H_
...
class AdsClientNotifier {
 public:
  ...
  // Invoked when the Hns Rewards wallet did update.
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_CLIENT_ADS_CLIENT_NOTIFIER_H_
