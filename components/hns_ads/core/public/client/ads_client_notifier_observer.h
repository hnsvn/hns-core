...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
...
class AdsClientNotifierObserver : public base::CheckedObserver {
 public:
  ...
  // Called when the Hns Rewards wallet did update.
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_PUBLIC_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
