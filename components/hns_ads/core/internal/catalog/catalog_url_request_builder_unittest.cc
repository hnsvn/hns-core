...
class HnsAdsCatalogUrlRequestBuilderTest : public UnitTestBase {};

TEST_F(HnsAdsCatalogUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_url_request->url =
      GURL("https://static.ads.hnssoftware.com/v9/catalog");
