...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_ADS_AD_UNITTEST_CONSTANTS_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_ADS_AD_UNITTEST_CONSTANTS_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_ADS_AD_UNITTEST_CONSTANTS_H_
