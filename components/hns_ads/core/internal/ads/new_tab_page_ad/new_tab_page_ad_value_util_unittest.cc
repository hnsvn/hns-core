...
constexpr char kJson[] =
    R"({"advertiser_id":"5484a63f-eb99-4ba5-a3b0-8c25d3c0e4b2","alt":"Test Ad Alt","campaign_id":"84197fc8-830a-4a8e-8339-7a70c2bfa104","company_name":"Test Ad Company Name","creative_instance_id":"546fe7b0-5047-4f28-a11c-81f14edcf0f6","creative_set_id":"c2ba3e7d-f688-4bc4-a053-cbe7ac1e6123","image_url":"https://hns.com/image","placement_id":"9bac9ae4-693c-4569-9b3e-300e357780cf","segment":"untargeted","target_url":"https://hns.com/","type":"new_tab_page_ad","wallpapers":[{"focal_point":{"x":1280,"y":720},"image_url":"https://hns.com/wallpaper_image"}]})";

}  // namespace

class HnsAdsNewTabPageAdValueUtilTest : public UnitTestBase {};

TEST_F(HnsAdsNewTabPageAdValueUtilTest, FromValue) {
  // Arrange
...
TEST_F(HnsAdsNewTabPageAdValueUtilTest, ToValue) {
  // Arrange
  const CreativeNewTabPageAdInfo creative_ad =
      BuildCreativeNewTabPageAdForTesting(/*should_use_random_uuids*/ false);
