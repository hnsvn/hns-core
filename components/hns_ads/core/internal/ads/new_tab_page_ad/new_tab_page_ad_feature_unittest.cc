...
TEST(HnsAdsNewTabPageAdFeatureTest, IsEnabled) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdFeatureTest, IsDisabled) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdFeatureTest, GetMaximumAdsPerHour) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdFeatureTest, DefaultMaximumAdsPerHour) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdFeatureTest, DefaultMaximumAdsPerHourWhenDisabled) {
  // Arrange
  const std::vector<base::test::FeatureRefAndParams> enabled_features;
...
TEST(HnsAdsNewTabPageAdFeatureTest, GetMaximumAdsPerDay) {
  // Arrange
  std::vector<base::test::FeatureRefAndParams> enabled_features;
  base::FieldTrialParams params;
...
TEST(HnsAdsNewTabPageAdFeatureTest, DefaultMaximumAdsPerDay) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdFeatureTest, DefaultMaximumAdsPerDayWhenDisabled) {
  // Arrange
  const std::vector<base::test::FeatureRefAndParams> enabled_features;
...
TEST(HnsAdsNewTabPageAdFeatureTest, GetMinimumWaitTime) {
  // Arrange
  std::vector<base::test::FeatureRefAndParams> enabled_features;
  base::FieldTrialParams params;
...
TEST(HnsAdsNewTabPageAdFeatureTest, DefaultMinimumWaitTime) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdFeatureTest, DefaultMinimumWaitTimeWhenDisabled) {
  // Arrange
  const std::vector<base::test::FeatureRefAndParams> enabled_features;
