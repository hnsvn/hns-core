...
class HnsAdsInlineContentAdIntegrationTest : public UnitTestBase {
 protected:
  void SetUp() override {
...
TEST_F(HnsAdsInlineContentAdIntegrationTest, Serve) {
  // Arrange
...
TEST_F(HnsAdsInlineContentAdIntegrationTest, DoNotServe) {
  // Arrange
...
TEST_F(HnsAdsInlineContentAdIntegrationTest, TriggerViewedEvent) {
  // Arrange
  ForcePermissionRulesForTesting();
...
TEST_F(HnsAdsInlineContentAdIntegrationTest, TriggerClickedEvent) {
  // Arrange
  ForcePermissionRulesForTesting();
