...
#include "hns/components/hns_ads/core/public/ads/promoted_content_ad_value_util.h"
...
constexpr char kJson[] =
    R"({"advertiser_id":"5484a63f-eb99-4ba5-a3b0-8c25d3c0e4b2","campaign_id":"84197fc8-830a-4a8e-8339-7a70c2bfa104","creative_instance_id":"546fe7b0-5047-4f28-a11c-81f14edcf0f6","creative_set_id":"c2ba3e7d-f688-4bc4-a053-cbe7ac1e6123","description":"Test Ad Description","segment":"untargeted","target_url":"https://hns.com/","title":"Test Ad Title","type":"promoted_content_ad","uuid":"9bac9ae4-693c-4569-9b3e-300e357780cf"})";

}  // namespace

class HnsAdsPromotedContentAdValueUtilTest : public UnitTestBase {};

TEST_F(HnsAdsPromotedContentAdValueUtilTest, FromValue) {
  // Arrange
...
TEST_F(HnsAdsPromotedContentAdValueUtilTest, ToValue) {
  // Arrange
  const CreativePromotedContentAdInfo creative_ad =
      BuildCreativePromotedContentAdForTesting(
          /*should_use_random_uuids*/ false);
