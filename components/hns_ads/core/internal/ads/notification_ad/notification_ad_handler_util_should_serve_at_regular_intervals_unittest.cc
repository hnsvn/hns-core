...
class HnsAdsNotificationAdHandlerUtilShouldServeAtRegularIntervalsTest
    : public UnitTestBase,
...
TEST_P(HnsAdsNotificationAdHandlerUtilShouldServeAtRegularIntervalsTest,
...
INSTANTIATE_TEST_SUITE_P(
    ,
    HnsAdsNotificationAdHandlerUtilShouldServeAtRegularIntervalsTest,
