...
constexpr char kJson[] =
    R"({"advertiser_id":"5484a63f-eb99-4ba5-a3b0-8c25d3c0e4b2","body":"Test Ad Body","campaign_id":"84197fc8-830a-4a8e-8339-7a70c2bfa104","creative_instance_id":"546fe7b0-5047-4f28-a11c-81f14edcf0f6","creative_set_id":"c2ba3e7d-f688-4bc4-a053-cbe7ac1e6123","segment":"untargeted","target_url":"https://hns.com/","title":"Test Ad Title","type":"ad_notification","uuid":"9bac9ae4-693c-4569-9b3e-300e357780cf"})";
constexpr char kListJson[] =
    R"([{"advertiser_id":"5484a63f-eb99-4ba5-a3b0-8c25d3c0e4b2","body":"Test Ad Body","campaign_id":"84197fc8-830a-4a8e-8339-7a70c2bfa104","creative_instance_id":"546fe7b0-5047-4f28-a11c-81f14edcf0f6","creative_set_id":"c2ba3e7d-f688-4bc4-a053-cbe7ac1e6123","segment":"untargeted","target_url":"https://hns.com/","title":"Test Ad Title","type":"ad_notification","uuid":"9bac9ae4-693c-4569-9b3e-300e357780cf"},{"advertiser_id":"5484a63f-eb99-4ba5-a3b0-8c25d3c0e4b2","body":"Test Ad Body","campaign_id":"84197fc8-830a-4a8e-8339-7a70c2bfa104","creative_instance_id":"546fe7b0-5047-4f28-a11c-81f14edcf0f6","creative_set_id":"c2ba3e7d-f688-4bc4-a053-cbe7ac1e6123","segment":"untargeted","target_url":"https://hns.com/","title":"Test Ad Title","type":"ad_notification","uuid":"9bac9ae4-693c-4569-9b3e-300e357780cf"}])";

}  // namespace

class HnsAdsNotificationAdValueUtilTest : public UnitTestBase {};

TEST_F(HnsAdsNotificationAdValueUtilTest, ToValue) {
  // Arrange
...
TEST_F(HnsAdsNotificationAdValueUtilTest, ToListValue) {
  // Arrange
  const CreativeNotificationAdInfo creative_ad =
      BuildCreativeNotificationAdForTesting(/*should_use_random_uuids*/ false);
  const NotificationAdInfo ad = BuildNotificationAd(creative_ad, kPlacementId);
...
TEST_F(HnsAdsNotificationAdValueUtilTest, FromValue) {
  // Arrange
...
TEST_F(HnsAdsNotificationAdValueUtilTest, FromListValue) {
  // Arrange
