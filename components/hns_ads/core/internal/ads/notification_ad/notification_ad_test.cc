...
class HnsAdsNotificationAdIntegrationTest : public UnitTestBase {
 protected:
  void SetUp() override {
...
TEST_F(HnsAdsNotificationAdIntegrationTest, Serve) {
  // Arrange
...
TEST_F(HnsAdsNotificationAdIntegrationTest, DoNotServe) {
  // Arrange
...
TEST_F(HnsAdsNotificationAdIntegrationTest,
...
TEST_F(HnsAdsNotificationAdIntegrationTest, TriggerViewedEvent) {
  // Arrange
  ForcePermissionRulesForTesting();
...
TEST_F(HnsAdsNotificationAdIntegrationTest, TriggerClickedEvent) {
  // Arrange
  ForcePermissionRulesForTesting();
...
TEST_F(HnsAdsNotificationAdIntegrationTest, TriggerDismissedEvent) {
  // Arrange
  ForcePermissionRulesForTesting();
...
TEST_F(HnsAdsNotificationAdIntegrationTest, TriggerTimedOutEvent) {
  // Arrange
  ForcePermissionRulesForTesting();
