...
class HnsAdsCreativeInlineContentAdsDatabaseTableTest : public UnitTestBase {
 protected:
  CreativeInlineContentAds database_table_;
};

TEST_F(HnsAdsCreativeInlineContentAdsDatabaseTableTest,
...
TEST_F(HnsAdsCreativeInlineContentAdsDatabaseTableTest, TableName) {
  // Arrange
