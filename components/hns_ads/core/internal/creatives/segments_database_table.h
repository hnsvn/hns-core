...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CREATIVES_SEGMENTS_DATABASE_TABLE_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CREATIVES_SEGMENTS_DATABASE_TABLE_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CREATIVES_SEGMENTS_DATABASE_TABLE_H_
