...
class HnsAdsCreativeNewTabPageAdsDatabaseTableTest : public UnitTestBase {
 protected:
  CreativeNewTabPageAds database_table_;
};

TEST_F(HnsAdsCreativeNewTabPageAdsDatabaseTableTest,
...
TEST_F(HnsAdsCreativeNewTabPageAdsDatabaseTableTest, GetForSegments) {
  // Arrange
  CreativeNewTabPageAdList creative_ads;
...
TEST_F(HnsAdsCreativeNewTabPageAdsDatabaseTableTest, TableName) {
  // Arrange
