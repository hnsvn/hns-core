...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CREATIVES_CREATIVE_DAYPART_INFO_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CREATIVES_CREATIVE_DAYPART_INFO_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CREATIVES_CREATIVE_DAYPART_INFO_H_
