...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_SERVING_NEW_TAB_PAGE_AD_SERVING_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_SERVING_NEW_TAB_PAGE_AD_SERVING_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_SERVING_NEW_TAB_PAGE_AD_SERVING_H_
