...
class HnsAdsInlineContentAdServingDelegate
...
class HnsAdsInlineContentAdServingTest : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
  ...
  HnsAdsInlineContentAdServingDelegate serving_delegate_;
};

TEST_F(HnsAdsInlineContentAdServingTest, DoNotServeAdForUnsupportedVersion) {
  // Arrange
  ...
  serving_->MaybeServeAd(
      "200x100",
      base::BindOnce(
          [](HnsAdsInlineContentAdServingDelegate* serving_delegate,
...
TEST_F(HnsAdsInlineContentAdServingTest, ServeAd) {
  // Arrange
...
TEST_F(HnsAdsInlineContentAdServingTest,
