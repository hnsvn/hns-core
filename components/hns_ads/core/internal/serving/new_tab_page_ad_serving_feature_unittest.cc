...
TEST(HnsAdsNewTabPageAdServingFeatureTest, IsEnabled) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdServingFeatureTest, IsDisabled) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdServingFeatureTest, GetServingVersion) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdServingFeatureTest, DefaultServingVersion) {
  // Arrange
...
TEST(HnsAdsNewTabPageAdServingFeatureTest,
