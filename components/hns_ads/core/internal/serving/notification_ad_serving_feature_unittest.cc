...
TEST(HnsAdsNotificationAdServingFeatureTest, IsEnabled) {
  // Arrange
...
TEST(HnsAdsNotificationAdServingFeatureTest, IsDisabled) {
  // Arrange
...
TEST(HnsAdsNotificationAdServingFeatureTest, GetServingVersion) {
  // Arrange
...
TEST(HnsAdsNotificationAdServingFeatureTest, DefaultServingVersion) {
  // Arrange
...
TEST(HnsAdsNotificationAdServingFeatureTest,
