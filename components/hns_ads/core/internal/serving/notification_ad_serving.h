...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_SERVING_NOTIFICATION_AD_SERVING_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_SERVING_NOTIFICATION_AD_SERVING_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_SERVING_NOTIFICATION_AD_SERVING_H_
