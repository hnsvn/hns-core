...
class HnsAdsDaypartExclusionRuleTest : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsDaypartExclusionRuleTest, AllowWhenNoDayparts) {
  // Arrange
...
TEST_F(HnsAdsDaypartExclusionRuleTest, AllowIfMatchesDayOfWeekAndTimeSlot) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = kCreativeSetId;
...
TEST_F(HnsAdsDaypartExclusionRuleTest,
...
TEST_F(HnsAdsDaypartExclusionRuleTest, DisallowForWrongDayOfWeek) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = kCreativeSetId;
