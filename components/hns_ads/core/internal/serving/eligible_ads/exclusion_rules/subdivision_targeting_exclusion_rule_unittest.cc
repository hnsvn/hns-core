...
class HnsAdsSubdivisionTargetingExclusionRuleTest
    : public UnitTestBase,
 ...
 protected:
  void SetUp() override {
    ...
    scoped_default_locale_ =
        std::make_unique<hns_l10n::test::ScopedDefaultLocale>(
...
TEST_P(HnsAdsSubdivisionTargetingExclusionRuleTest,
...
TEST_P(
    HnsAdsSubdivisionTargetingExclusionRuleTest,
