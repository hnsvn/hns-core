...
class HnsAdsMarkedAsInappropriateExclusionRuleTest : public UnitTestBase {
 protected:
  const MarkedAsInappropriateExclusionRule exclusion_rule_;
};

TEST_F(HnsAdsMarkedAsInappropriateExclusionRuleTest, ShouldInclude) {
  // Arrange
...
TEST_F(HnsAdsMarkedAsInappropriateExclusionRuleTest, ShouldExclude) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_instance_id = kCreativeInstanceId;
  creative_ad.creative_set_id = kCreativeSetId;
