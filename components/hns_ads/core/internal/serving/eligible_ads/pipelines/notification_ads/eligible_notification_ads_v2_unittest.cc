...
class HnsAdsEligibleNotificationAdsV2Test : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsEligibleNotificationAdsV2Test, GetAds) {
  // Arrange
...
TEST_F(HnsAdsEligibleNotificationAdsV2Test, GetAdsForNoSegments) {
  // Arrange
  CreativeNotificationAdList creative_ads;
...
TEST_F(HnsAdsEligibleNotificationAdsV2Test, DoNotGetAdsIfNoEligibleAds) {
  // Arrange
