...
class HnsAdsEligibleNotificationAdsV3Test : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsEligibleNotificationAdsV3Test, GetAds) {
  // Arrange
...
TEST_F(HnsAdsEligibleNotificationAdsV3Test, GetAdsForNoStoredTextEmbeddings) {
  // Arrange
  CreativeNotificationAdList creative_ads;
...
TEST_F(HnsAdsEligibleNotificationAdsV3Test,
...
TEST_F(HnsAdsEligibleNotificationAdsV3Test, DoNotGetAdsIfNoEligibleAds) {
  // Arrange
  const TextEmbeddingHtmlEventInfo text_embedding_html_event =
      BuildTextEmbeddingHtmlEvent(ml::pipeline::BuildTextEmbeddingForTesting());
