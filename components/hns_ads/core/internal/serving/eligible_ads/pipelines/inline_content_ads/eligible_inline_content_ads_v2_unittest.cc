...
class HnsAdsEligibleInlineContentAdsV2Test : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsEligibleInlineContentAdsV2Test, GetAds) {
  // Arrange
...
TEST_F(HnsAdsEligibleInlineContentAdsV2Test, GetAdsForNoSegments) {
  // Arrange
  CreativeInlineContentAdList creative_ads;
...
TEST_F(HnsAdsEligibleInlineContentAdsV2Test,
...
TEST_F(HnsAdsEligibleInlineContentAdsV2Test, DoNotGetAdsIfNoEligibleAds) {
  // Arrange
