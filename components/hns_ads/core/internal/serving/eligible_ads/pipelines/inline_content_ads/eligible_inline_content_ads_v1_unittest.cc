...
class HnsAdsEligibleInlineContentAdsV1Test : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, GetAdsForChildSegment) {
  // Arrange
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, GetAdsForParentSegment) {
  // Arrange
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, GetAdsForUntargetedSegment) {
  // Arrange
  CreativeInlineContentAdInfo creative_ad =
      BuildCreativeInlineContentAdForTesting(/*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, GetAdsForMultipleSegments) {
  // Arrange
  CreativeInlineContentAdList creative_ads;
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, GetAdsForNoSegments) {
  // Arrange
  CreativeInlineContentAdInfo creative_ad =
      BuildCreativeInlineContentAdForTesting(/*should_use_random_uuids*/ true);
  creative_ad.segment = "untargeted";
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test,
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, DoNotGetAdsIfAlreadySeen) {
  // Arrange
  CreativeInlineContentAdList creative_ads;
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, DoNotGetPacedAds) {
  // Arrange
  CreativeInlineContentAdList creative_ads;
...
TEST_F(HnsAdsEligibleInlineContentAdsV1Test, GetPrioritizedAds) {
  // Arrange
  CreativeInlineContentAdList creative_ads;
