...
#include "hns/components/hns_ads/core/internal/serving/eligible_ads/pipelines/new_tab_page_ads/eligible_new_tab_page_ads_factory.h"
...
std::unique_ptr<EligibleNewTabPageAdsBase> EligibleAdsFactory::Build(
  ...
  switch (version) {
    case 1: {
      return std::make_unique<EligibleNewTabPageAdsV1>(subdivision_targeting,
