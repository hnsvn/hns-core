...
#include "hns/components/hns_ads/core/internal/serving/eligible_ads/pipelines/new_tab_page_ads/eligible_new_tab_page_ads_v1.h"
...
class HnsAdsEligibleNewTabPageAdsV1Test : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, GetAdsForChildSegment) {
  // Arrange
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, GetAdsForParentSegment) {
  // Arrange
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, GetAdsForUntargetedSegment) {
  // Arrange
  CreativeNewTabPageAdInfo creative_ad =
      BuildCreativeNewTabPageAdForTesting(/*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, GetAdsForMultipleSegments) {
  // Arrange
  CreativeNewTabPageAdList creative_ads;
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, GetAdsForNoSegments) {
  // Arrange
  CreativeNewTabPageAdInfo creative_ad =
      BuildCreativeNewTabPageAdForTesting(/*should_use_random_uuids*/ true);
  creative_ad.segment = "untargeted";
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, DoNotGetAdsForUnmatchedSegments) {
  // Arrange
  CreativeNewTabPageAdInfo creative_ad =
      BuildCreativeNewTabPageAdForTesting(/*should_use_random_uuids*/ true);
  creative_ad.segment = "technology & computing";
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, DoNotGetAdsIfNoEligibleAds) {
  // Arrange
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, DoNotGetAdsIfAlreadySeen) {
  // Arrange
  CreativeNewTabPageAdList creative_ads;
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, DoNotGetPacedAds) {
  // Arrange
  CreativeNewTabPageAdList creative_ads;
...
TEST_F(HnsAdsEligibleNewTabPageAdsV1Test, GetPrioritizedAds) {
  // Arrange
  CreativeNewTabPageAdList creative_ads;
