...
#include "hns/components/hns_ads/core/internal/common/platform/platform_helper_linux.h"
#elif BUILDFLAG(IS_MAC)
#include "hns/components/hns_ads/core/internal/common/platform/platform_helper_mac.h"
