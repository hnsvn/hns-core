...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_PLATFORM_PLATFORM_HELPER_ANDROID_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_PLATFORM_PLATFORM_HELPER_ANDROID_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_PLATFORM_PLATFORM_HELPER_ANDROID_H_
