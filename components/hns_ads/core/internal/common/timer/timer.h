...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_TIMER_TIMER_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_TIMER_TIMER_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_TIMER_TIMER_H_
