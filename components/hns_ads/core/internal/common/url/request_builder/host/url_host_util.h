...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_URL_REQUEST_BUILDER_HOST_URL_HOST_UTIL_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_URL_REQUEST_BUILDER_HOST_URL_HOST_UTIL_H_
...
// Use for requests that must not include the wallet ID or allow Hns to link
// the request to a wallet in any other way.
std::string GetAnonymousUrlHost();

// Use for search requests that must not include the wallet ID or allow Hns to
// link the request to a wallet in any other way.
std::string GetAnonymousSearchUrlHost();

}  // namespace hns_ads

#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_URL_REQUEST_BUILDER_HOST_URL_HOST_UTIL_H_
