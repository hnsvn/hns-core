...
TEST(HnsAdsCryptoUtilTest, Sha256) {
  // Arrange
...
TEST(HnsAdsCryptoUtilTest, Sha256WithEmptyString) {
  // Arrange
...
TEST(HnsAdsCryptoUtilTest, GenerateSignKeyPairFromSeed) {
  // Arrange
...
TEST(HnsAdsCryptoUtilTest, GenerateBoxKeyPair) {
  // Arrange
...
TEST(HnsAdsCryptoUtilTest, GenerateRandomNonce) {
  // Arrange
...
TEST(HnsAdsCryptoUtilTest, Sign) {
  // Arrange
...
TEST(HnsAdsCryptoUtilTest, Encrypt) {
  // Arrange
  const KeyPairInfo key_pair = GenerateBoxKeyPair();
