...
Mocked responses for URL requests can be defined inline or read from a text file. You should store test data files at `hns/components/hns_ads/core/test/data/`. Inline filenames should begin with a forward slash, i.e.
