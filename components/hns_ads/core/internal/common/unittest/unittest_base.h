...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_UNITTEST_UNITTEST_BASE_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_UNITTEST_UNITTEST_BASE_H_
...
class UnitTestBase : public AdsClientNotifier, public ::testing::Test {
 ...
 private:
  ...
  hns_l10n::test::ScopedDefaultLocale scoped_default_locale_;
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_COMMON_UNITTEST_UNITTEST_BASE_H_
