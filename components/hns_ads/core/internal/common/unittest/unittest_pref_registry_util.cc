...
#include "hns/components/hns_ads/core/internal/common/unittest/unittest_pref_registry.h"

#include "base/containers/contains.h"
#include "base/time/time.h"
#include "base/values.h"
#include "hns/components/hns_ads/core/internal/common/unittest/unittest_current_test_util.h"
#include "hns/components/hns_ads/core/internal/common/unittest/unittest_pref.h"
#include "hns/components/hns_ads/core/internal/common/unittest/unittest_pref_registry_util.h"
...
void RegisterPrefs() {
  RegisterBooleanPref(hns_rewards::prefs::kEnabled, true);

  RegisterStringPref(prefs::kDiagnosticId, "");

  RegisterBooleanPref(hns_news::prefs::kHnsNewsOptedIn, true);
  RegisterBooleanPref(hns_news::prefs::kNewTabPageShowToday, true);
