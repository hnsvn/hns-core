...
#include "hns/components/hns_ads/core/internal/common/search_engine/search_engine_constants.h"

#include "base/no_destructor.h"
#include "hns/components/hns_ads/core/internal/common/search_engine/search_engine_info.h"
#include "hns/components/hns_ads/core/internal/common/search_engine/search_engine_results_page_url_pattern_constants.h"
...
const std::vector<SearchEngineInfo>& GetSearchEngines() {
  static const base::NoDestructor<std::vector<SearchEngineInfo>> kSearchEngines(
      {{"https://ask.com/", "https://ask.com/web", "q"},
       ...
       {"https://search.hns.com/", "https://search.hns.com/search", "q"},
