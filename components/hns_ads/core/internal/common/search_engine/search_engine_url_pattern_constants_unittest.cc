...
#include "hns/components/hns_ads/core/internal/common/search_engine/search_engine_url_pattern_constants.h"
...
TEST(HnsAdsSearchEngineUrlPatternConstantsTest, GetAmazonUrlPattern) {
  // Arrange
...
TEST(HnsAdsSearchEngineUrlPatternConstantsTest, GetGoogleUrlPattern) {
  // Arrange
...
TEST(HnsAdsSearchEngineUrlPatternConstantsTest, GetMojeekUrlPattern) {
  // Arrange
...
TEST(HnsAdsSearchEngineUrlPatternConstantsTest, GetWikipediaUrlPattern) {
  // Arrange
...
TEST(HnsAdsSearchEngineUrlPatternConstantsTest, GetYahooUrlPattern) {
  // Arrange
