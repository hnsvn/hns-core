...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_BROWSER_BROWSER_MANAGER_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_BROWSER_BROWSER_MANAGER_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_BROWSER_BROWSER_MANAGER_H_
