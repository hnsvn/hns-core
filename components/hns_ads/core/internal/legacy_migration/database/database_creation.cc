...
#include "hns/components/hns_ads/core/internal/legacy_migration/database/database_creation.h"
...
void Create(mojom::DBTransactionInfo* transaction) {
  ...
  text_embedding_html_events_database_table.Create(transaction);
  ...
  embeddings_database_table.Create(transaction);
