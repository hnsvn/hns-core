...
class HnsAdsDatabaseMigrationIssue17231Test : public UnitTestBase {
 protected:
...
TEST_F(HnsAdsDatabaseMigrationIssue17231Test, ConversionQueueDatabase) {
  // Arrange
...
TEST_F(HnsAdsDatabaseMigrationIssue17231Test,
  ...
  database_table.GetAll(base::BindOnce([](const bool success,
    ...
    const std::vector<std::string> url_patterns = {
        ...
        R"(https://www.delta.exchange/offers/?_target=hns*)",
        ...
        R"(https://marsgenesis.com/?ref=hns*)",
        ...
        R"(https://app.cakedefi.com/*)",
        R"(https://app.cakedefi.com/*)",
        R"(https://bitbuy.ca/en/sign-up/?c=Hns)",
        ...
        R"(https://hns.com/search/thank-you/)",
        ...
        R"(https://om.elvenar.com/ox/us/?ref=hns_us_us)",
        R"(https://om.elvenar.com/ox/us/?ref=hns_us_us)",
        R"(https://om.elvenar.com/ox/us/?ref=hns_us_us)",
        R"(https://om.elvenar.com/ox/us/?ref=hns_us_us)",
        R"(https://om.elvenar.com/ox/us/?ref=hns_us_us)",
        ...
        R"(https://portal.axion.network/?utm_source=hns&utm_medium=pushnotification&utm_campaign=HnsConversion)",
