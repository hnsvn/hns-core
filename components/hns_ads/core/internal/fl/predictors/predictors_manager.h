...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_FL_PREDICTORS_PREDICTORS_MANAGER_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_FL_PREDICTORS_PREDICTORS_MANAGER_H_
...
// different data types defined in |hns_federated::mojom::CovariateInfoPtr|.
...
class PredictorsManager final {
 public:
  ...
  std::vector<hns_federated::mojom::CovariateInfoPtr> GetTrainingSample()
      const;

  void AddTrainingSample() const;

 private:
  base::flat_map<hns_federated::mojom::CovariateType,
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_FL_PREDICTORS_PREDICTORS_MANAGER_H_
