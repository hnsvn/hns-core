...
class HnsAdsAdPreferencesInfoTest : public UnitTestBase {};

TEST_F(HnsAdsAdPreferencesInfoTest, SerializeSampleAdPreferencesInfo) {
  // Arrange
  AdPreferencesInfo ad_preferences;
...
TEST_F(HnsAdsAdPreferencesInfoTest, ParseSampleAdPreferencesInfoJson) {
  const AdPreferencesInfo ad_preferences;
  ParseJsonAndCompareWithSampleAdPreferencesInfo(kSampleAdPreferencesInfoJson);
}

TEST_F(HnsAdsAdPreferencesInfoTest, ParseEmptyJson) {
  // Arrange
  AdPreferencesInfo ad_preferences;
...
TEST_F(HnsAdsAdPreferencesInfoTest, ParsePreferencesWithNotValidMembers) {
  // Arrange
  AdPreferencesInfo ad_preferences;
