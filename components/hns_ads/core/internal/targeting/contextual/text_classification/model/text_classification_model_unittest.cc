...
class HnsAdsTextClassificationModelTest : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsTextClassificationModelTest,
...
TEST_F(HnsAdsTextClassificationModelTest, DoNotGetSegmentsForEmptyText) {
  // Arrange
...
TEST_F(HnsAdsTextClassificationModelTest, DoNotGetSegmentsIfNeverProcessed) {
  // Arrange
  ASSERT_TRUE(LoadResource());
