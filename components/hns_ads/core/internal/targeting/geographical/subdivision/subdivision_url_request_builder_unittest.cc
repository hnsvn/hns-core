...
class HnsAdsSubdivisionUrlRequestBuilderTest : public UnitTestBase {};

TEST_F(HnsAdsSubdivisionUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_url_request->url =
      GURL("https://geo.ads.hnssoftware.com/v1/getstate");
