...
#include "hns/components/hns_ads/core/internal/common/database/database_record_util.h"
...
void Database::ErrorCallback(const int error, sql::Statement* statement) {
...

  {
    ...
    SCOPED_CRASH_KEY_NUMBER("HnsAdsSqlVersionInfo", "value",
                            database::kVersion);
    SCOPED_CRASH_KEY_STRING1024("HnsAdsSqlDiagnosticInfo", "value",
