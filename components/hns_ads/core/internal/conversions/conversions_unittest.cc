...
#include "hns/components/hns_ads/core/internal/conversions/conversions.h"
...
#include "hns/components/hns_ads/core/internal/conversions/conversions_observer.h"
...
class HnsAdsConversionsTest : public ConversionsObserver,
                                public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsConversionsTest,
       DoNotConvertViewedInlineContentAdIfHnsNewsAdsAreDisabled) {
  // Arrange
...
TEST_F(HnsAdsConversionsTest,
       ConvertViewedInlineContentAdIfHnsNewsAdsAreEnabled) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kInlineContentAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest,
       DoNotConvertClickedInlineContentAdIfHnsNewsAdsAreDisabled) {
  // Arrange
  DisableHnsNewsAdsForTesting();
...
TEST_F(HnsAdsConversionsTest,
       ConvertClickedInlineContentAdIfHnsNewsAdsAreEnabled) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kInlineContentAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest,
       DoNotConvertViewedPromotedContentAdIfHnsNewsAdsAreDisabled) {
  // Arrange
  DisableHnsNewsAdsForTesting();
...
TEST_F(HnsAdsConversionsTest,
       ConvertViewedPromotedContentAdIfHnsNewsAdsAreEnabled) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kPromotedContentAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest,
       DoNotConvertClickedPromotedContentAdIfHnsNewsAdsAreDisabled) {
  // Arrange
  DisableHnsNewsAdsForTesting();
...
TEST_F(HnsAdsConversionsTest,
       ConvertClickedPromotedContentAdIfHnsNewsAdsAreEnabled) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kPromotedContentAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest, ConvertViewedSearchResultAdIfAdsAreDisabled) {
  // Arrange
  DisableHnsNewsAdsForTesting();
  DisableNotificationAdsForTesting();
  DisableNewTabPageAdsForTesting();
...
TEST_F(HnsAdsConversionsTest, ConvertViewedSearchResultAdIfAdsAreEnabled) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kSearchResultAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest, ConvertClickedSearchResultAdIfAdsAreDisabled) {
  // Arrange
  DisableHnsNewsAdsForTesting();
  DisableNotificationAdsForTesting();
  DisableNewTabPageAdsForTesting();
...
TEST_F(HnsAdsConversionsTest, ConvertClickedSearchResultAdIfAdsAreEnabled) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kSearchResultAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest, MultipleAdConversions) {
  // Arrange
...
TEST_F(HnsAdsConversionsTest, ConvertViewedAdAfterTheSameAdWasDismissed) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kNotificationAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest, DoNotConvertAdsIfTheRedirectChainIsEmpty) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kNotificationAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest, DoNotConvertNonViewedOrClickedAds) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kNotificationAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest, DoNotConvertAdIfUrlPatternDoesNotMatch) {
  // Arrange
  const AdInfo ad = BuildAdForTesting(AdType::kNotificationAd,
                                      /*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsConversionsTest, ConvertAdIfVerifiableUrlConversionIdExists) {
  // Arrange
  LoadConversionResource();
...
TEST_F(HnsAdsConversionsTest, ConvertAdIfVerifiableHtmlConversionIdExists) {
  // Arrange
  LoadConversionResource();
