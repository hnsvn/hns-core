...
#include "hns/components/hns_ads/core/internal/common/database/database_bind_util.h"
#include "hns/components/hns_ads/core/internal/common/database/database_column_util.h"
#include "hns/components/hns_ads/core/internal/common/database/database_table_util.h"
...
#include "hns/components/hns_ads/core/internal/conversions/actions/conversion_action_types_constants.h"
...
void GetCallback(GetConversionQueueCallback callback,
  ...
  for (const auto& record : command_response->result->get_records()) {
    ...
    // TODO(https://github.com/hnsvn/hns-browser/issues/33239): Validate all
    // Hns Ads data when loading from database
    if (!conversion_queue_item.IsValid()) {
      SCOPED_CRASH_KEY_STRING256(
          "HnsAdsConversion", "invalidFieldsNames",
