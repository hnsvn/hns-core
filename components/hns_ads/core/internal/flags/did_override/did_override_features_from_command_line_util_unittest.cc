...
class HnsAdsDidOverrideFeaturesFromCommandLineUtilTest
    : public UnitTestBase,
...
TEST_P(HnsAdsDidOverrideFeaturesFromCommandLineUtilTest,
...
INSTANTIATE_TEST_SUITE_P(,
                         HnsAdsDidOverrideFeaturesFromCommandLineUtilTest,
