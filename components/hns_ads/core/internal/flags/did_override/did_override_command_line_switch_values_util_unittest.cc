...
class HnsAdsDidOverrideCommandLineSwitchValuesUtilTest
    : public UnitTestBase,
...
TEST_P(HnsAdsDidOverrideCommandLineSwitchValuesUtilTest,
...
INSTANTIATE_TEST_SUITE_P(,
                         HnsAdsDidOverrideCommandLineSwitchValuesUtilTest,
