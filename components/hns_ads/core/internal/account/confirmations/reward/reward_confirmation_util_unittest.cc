...
class HnsAdsRewardConfirmationUtilTest : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsRewardConfirmationUtilTest, BuildRewardCredential) {
  // Arrange
...
TEST_F(HnsAdsRewardConfirmationUtilTest, BuildRewardConfirmation) {
  // Arrange
  MockTokenGenerator(token_generator_mock_, /*count*/ 1);
...
TEST_F(HnsAdsRewardConfirmationUtilTest,
