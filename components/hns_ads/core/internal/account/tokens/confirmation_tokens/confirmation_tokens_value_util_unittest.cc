...
#include "hns/components/hns_ads/core/internal/account/tokens/confirmation_tokens/confirmation_tokens_value_util.h"
...
class HnsAdsConfirmationTokenValueUtilTest : public UnitTestBase {};

TEST_F(HnsAdsConfirmationTokenValueUtilTest, ToValue) {
  // Arrange
...
TEST_F(HnsAdsConfirmationTokenValueUtilTest, ToEmptyValue) {
  // Arrange
...
TEST_F(HnsAdsConfirmationTokenValueUtilTest, FromValue) {
  // Arrange
...
TEST_F(HnsAdsConfirmationTokenValueUtilTest, FromEmptyValue) {
  // Arrange
