...
#include "hns/components/hns_ads/core/internal/account/tokens/payment_tokens/payment_token_value_util.h"
...
class HnsAdsPaymentTokenValueUtilTest : public UnitTestBase {};

TEST_F(HnsAdsPaymentTokenValueUtilTest, ToValue) {
  // Arrange
...
TEST_F(HnsAdsPaymentTokenValueUtilTest, ToEmptyValue) {
  // Arrange
...
TEST_F(HnsAdsPaymentTokenValueUtilTest, FromValue) {
  // Arrange
...
TEST_F(HnsAdsPaymentTokenValueUtilTest, FromEmptyValue) {
  // Arrange
