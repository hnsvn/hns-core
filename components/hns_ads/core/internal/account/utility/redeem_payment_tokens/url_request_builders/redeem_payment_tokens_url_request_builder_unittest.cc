...
class HnsAdsRedeemPaymentTokensUrlRequestBuilderTest : public UnitTestBase {};

TEST_F(HnsAdsRedeemPaymentTokensUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  EXPECT_CALL(callback, Run)
      .WillOnce([&payment_tokens](base::Value::Dict user_data) {
        ...
        expected_url_request->url = GURL(
            R"(https://mywallet.ads.hnssoftware.com/v3/confirmation/payment/27a39b2f-9b2e-4eb0-bbb2-2f84447496e7)");
