...
#include "hns/components/hns_ads/core/internal/account/utility/refill_confirmation_tokens/refill_confirmation_tokens_delegate_mock.h"
...
class HnsAdsRefillConfirmationTokensTest : public UnitTestBase {
 protected:
  void SetUp() override {
    UnitTestBase::SetUp();
...
TEST_F(HnsAdsRefillConfirmationTokensTest, RefillConfirmationTokens) {
  // Arrange
...
TEST_F(HnsAdsRefillConfirmationTokensTest,
...
TEST_F(HnsAdsRefillConfirmationTokensTest, IssuersPublicKeyMismatch) {
  // Arrange
  MockTokenGenerator(token_generator_mock_, /*count*/ 50);
...
TEST_F(HnsAdsRefillConfirmationTokensTest, RequestSignedTokensMissingNonce) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsRefillConfirmationTokensTest, GetSignedTokensInvalidResponse) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsRefillConfirmationTokensTest, GetSignedTokensMissingPublicKey) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsRefillConfirmationTokensTest, GetInvalidSignedTokens) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsRefillConfirmationTokensTest, RefillIfBelowTheMinimumThreshold) {
  // Arrange
  BuildAndSetIssuersForTesting();
