...
class HnsAdsRequestSignedTokensUrlRequestBuilderTest : public UnitTestBase {};

TEST_F(HnsAdsRequestSignedTokensUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_url_request->url = GURL(
      "https://mywallet.ads.hnssoftware.com/v3/confirmation/token/"
