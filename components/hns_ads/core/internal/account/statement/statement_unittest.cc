...
#include "hns/components/hns_ads/core/internal/account/statement/statement.h"
...
class HnsAdsStatementTest : public UnitTestBase {};

TEST_F(HnsAdsStatementTest, GetForTransactionsThisMonth) {
  // Arrange
...
TEST_F(HnsAdsStatementTest, GetForTransactionsSplitOverTwoYears) {
  // Arrange
  TransactionList transactions;
...
TEST_F(HnsAdsStatementTest, GetForNoTransactions) {
  // Arrange
  AdvanceClockTo(TimeFromString("18 November 2020", /*is_local*/ true));
...
TEST_F(HnsAdsStatementTest, GetWithFilteredTransactions) {
  // Arrange
