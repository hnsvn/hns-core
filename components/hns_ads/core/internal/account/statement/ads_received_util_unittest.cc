...
class HnsAdsAdsReceivedUtilTest : public UnitTestBase {};

TEST_F(HnsAdsAdsReceivedUtilTest, GetAdTypesReceivedForDateRange) {
  // Arrange
...
TEST_F(HnsAdsAdsReceivedUtilTest, DoNotGetAdsReceivedForDateRange) {
  // Arrange
  AdvanceClockTo(TimeFromString("5 November 2020", /*is_local*/ true));
...
TEST_F(HnsAdsAdsReceivedUtilTest, GetAdTypesReceivedForNoTransactions) {
  // Arrange
