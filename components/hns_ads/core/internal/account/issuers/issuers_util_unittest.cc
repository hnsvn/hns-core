...
class HnsAdsIssuersUtilTest : public UnitTestBase {};

TEST_F(HnsAdsIssuersUtilTest, HasIssuersChanged) {
  // Arrange
...
TEST_F(HnsAdsIssuersUtilTest, HasIssuersChangedOnInitialFetch) {
  // Arrange
...
TEST_F(HnsAdsIssuersUtilTest, HasIssuersNotChanged) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsIssuersUtilTest, IssuerDoesExistForConfirmationsType) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsIssuersUtilTest, IssuerDoesNotExistForConfirmationsType) {
  // Arrange
  const IssuersInfo issuers = BuildIssuersForTesting(
      7'200'000, {},
      {{"JiwFR2EU/Adf1lgox+xqOVPuc6a/rxdy/LguFG5eaXg=", 0.0},
...
TEST_F(HnsAdsIssuersUtilTest, IssuerDoesExistForPaymentsType) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsIssuersUtilTest, IssuerDoesNotExistForPaymentsType) {
  // Arrange
  const IssuersInfo issuers = BuildIssuersForTesting(
      7'200'000,
      {{"bCKwI6tx5LWrZKxWbW5CxaVIGe2N0qGYLfFE+38urCg=", 0.0},
...
TEST_F(HnsAdsIssuersUtilTest, PublicKeyDoesExistForConfirmationsType) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsIssuersUtilTest, PublicKeyDoesNotExistForConfirmationsType) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsIssuersUtilTest, PublicKeyDoesExistForPaymentsType) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsIssuersUtilTest, PublicKeyDoesNotExistForPaymentsType) {
  // Arrange
  BuildAndSetIssuersForTesting();
...
TEST_F(HnsAdsIssuersUtilTest, GetIssuersForType) {
  // Arrange
  const IssuersInfo issuers = BuildIssuersForTesting(
      7'200'000,
      {{"bCKwI6tx5LWrZKxWbW5CxaVIGe2N0qGYLfFE+38urCg=", 0.0},
...
TEST_F(HnsAdsIssuersUtilTest, DoNotGetIssuersForMissingType) {
  // Arrange
  const IssuersInfo issuers = BuildIssuersForTesting(
      7'200'000,
      {{"bCKwI6tx5LWrZKxWbW5CxaVIGe2N0qGYLfFE+38urCg=", 0.0},
...
TEST_F(HnsAdsIssuersUtilTest, IsIssuersValid) {
  // Arrange
  const IssuersInfo issuers = BuildIssuersForTesting(
      7'200'000,
      {{"bCKwI6tx5LWrZKxWbW5CxaVIGe2N0qGYLfFE+38urCg=", 0.0},
...
TEST_F(HnsAdsIssuersUtilTest, IsIssuersInvalid) {
  // Arrange
  const IssuersInfo issuers = BuildIssuersForTesting(
      7'200'000,
      {{"bCKwI6tx5LWrZKxWbW5CxaVIGe2N0qGYLfFE+38urCg=", 0.0},
