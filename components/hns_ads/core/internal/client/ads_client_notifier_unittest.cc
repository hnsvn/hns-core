...
#include "hns/components/hns_ads/core/internal/client/ads_client_notifier_observer_mock.h"
...
TEST(HnsAdsAdsClientNotifierTest, FireQueuedNotifications) {
  // Arrange
...
TEST(HnsAdsAdsClientNotifierTest, NotificationsNotFiredIfWereQueued) {
  // Arrange
  ::testing::StrictMock<AdsClientNotifierObserverMock> observer;
  ExpectNotifierCalls(observer, /*expected_calls_count*/ 0);
...
TEST(HnsAdsAdsClientNotifierTest, ShouldNotQueueNotifications) {
  // Arrange
  ::testing::StrictMock<AdsClientNotifierObserverMock> observer;
  ExpectNotifierCalls(observer, /*expected_calls_count*/ 1);
