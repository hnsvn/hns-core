...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CLIENT_ADS_CLIENT_MOCK_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CLIENT_ADS_CLIENT_MOCK_H_
...
class AdsClientMock : public AdsClient {
 public:
  ...
  MOCK_METHOD1(AddTrainingSample,
               void(const std::vector<hns_federated::mojom::CovariateInfoPtr>
                        training_sample));
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CLIENT_ADS_CLIENT_MOCK_H_
