...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CLIENT_ADS_CLIENT_NOTIFIER_QUEUE_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CLIENT_ADS_CLIENT_NOTIFIER_QUEUE_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_CLIENT_ADS_CLIENT_NOTIFIER_QUEUE_H_
