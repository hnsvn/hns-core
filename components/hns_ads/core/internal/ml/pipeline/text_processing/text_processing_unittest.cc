...
#include "hns/components/hns_ads/core/internal/ml/pipeline/text_processing/text_processing.h"
...
class HnsAdsTextProcessingTest : public UnitTestBase {};

TEST_F(HnsAdsTextProcessingTest, BuildSimplePipeline) {
  // Arrange
...
TEST_F(HnsAdsTextProcessingTest, TestLoadFromValue) {
  // Arrange
...
TEST_F(HnsAdsTextProcessingTest, InitValidModelTest) {
  // Arrange
  const absl::optional<std::string> json =
...
TEST_F(HnsAdsTextProcessingTest, EmptySegmentModelTest) {
  // Arrange
  const absl::optional<std::string> json =
...
TEST_F(HnsAdsTextProcessingTest, EmptyTransformationsModelTest) {
  // Arrange
...
TEST_F(HnsAdsTextProcessingTest, WrongTransformationsOrderModelTest) {
  // Arrange
...
TEST_F(HnsAdsTextProcessingTest, EmptyModelTest) {
  // Arrange
  // Act
  pipeline::TextProcessing text_processing_pipeline;
  const bool success =
...
TEST_F(HnsAdsTextProcessingTest, TopPredUnitTest) {
  // Arrange
...
TEST_F(HnsAdsTextProcessingTest, TextCMCCrashTest) {
  // Arrange
