...
class HnsAdsMLPredictionUtilTest : public UnitTestBase {};

TEST_F(HnsAdsMLPredictionUtilTest, SoftmaxTest) {
  // Arrange
...
TEST_F(HnsAdsMLPredictionUtilTest, ExtendedSoftmaxTest) {
  // Arrange
  constexpr double kTolerance = 1e-8;
