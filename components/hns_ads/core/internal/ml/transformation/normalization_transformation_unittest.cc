...
class HnsAdsNormalizationTransformationTest : public UnitTestBase {};

TEST_F(HnsAdsNormalizationTransformationTest, WrongInputDataTest) {
  // Arrange
...
TEST_F(HnsAdsNormalizationTransformationTest, NormalizationTest) {
  // Arrange
...
TEST_F(HnsAdsNormalizationTransformationTest, ChainingTest) {
  // Arrange
