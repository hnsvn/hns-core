...
#ifndef HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_HISTORY_HISTORY_MANAGER_OBSERVER_H_
#define HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_HISTORY_HISTORY_MANAGER_OBSERVER_H_
...
#endif  // HNS_COMPONENTS_HNS_ADS_CORE_INTERNAL_HISTORY_HISTORY_MANAGER_OBSERVER_H_
