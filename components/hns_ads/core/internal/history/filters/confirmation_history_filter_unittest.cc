...
#include "hns/components/hns_ads/core/internal/history/filters/confirmation_history_filter.h"
...
TEST(HnsAdsConfirmationHistoryFilterTest, FilterActions) {
  // Arrange
...
TEST(HnsAdsConfirmationHistoryFilterTest, FilterUnsupportedActions) {
  // Arrange
