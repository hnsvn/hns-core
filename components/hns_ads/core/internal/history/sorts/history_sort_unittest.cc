...
TEST(HnsAdsHistorySortTest, NoSortOrder) {
  // Arrange
...
TEST(HnsAdsHistorySortTest, DescendingSortOrder) {
  // Arrange
  const auto sort =
...
TEST(HnsAdsHistorySortTest, DescendingSortOrderForEmptyHistory) {
  // Arrange
  const auto sort =
      HistorySortFactory::Build(HistorySortType::kDescendingOrder);
...
TEST(HnsAdsHistorySortTest, AscendingSortOrder) {
  // Arrange
...
TEST(HnsAdsHistorySortTest, AscendingSortOrderForEmptyHistory) {
  // Arrange
  const auto sort = HistorySortFactory::Build(HistorySortType::kAscendingOrder);
