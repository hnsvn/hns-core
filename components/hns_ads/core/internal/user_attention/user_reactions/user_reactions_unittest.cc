...
class HnsAdsUserReactionsTest : public AccountObserver,
...
TEST_F(HnsAdsUserReactionsTest, LikeAd) {
  // Arrange
  AddHistoryItem();
...
TEST_F(HnsAdsUserReactionsTest, DislikeAd) {
  // Arrange
  AddHistoryItem();
...
TEST_F(HnsAdsUserReactionsTest, MarkAdAsInappropriate) {
  // Arrange
  AddHistoryItem();
...
TEST_F(HnsAdsUserReactionsTest, SaveAd) {
  // Arrange
  AddHistoryItem();
