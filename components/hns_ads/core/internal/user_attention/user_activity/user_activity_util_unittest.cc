...
class HnsAdsUserActivityUtilTest : public UnitTestBase {};

TEST_F(HnsAdsUserActivityUtilTest, GetNumberOfUserActivityEvents) {
  // Arrange
...
TEST_F(HnsAdsUserActivityUtilTest,
...
TEST_F(HnsAdsUserActivityUtilTest, GetTimeSinceLastUserActivityEvent) {
  // Arrange
  UserActivityManager::GetInstance().RecordEvent(
      UserActivityEventType::kOpenedNewTab);
  UserActivityManager::GetInstance().RecordEvent(
...
TEST_F(HnsAdsUserActivityUtilTest, ToUserActivityTriggers) {
  // Arrange
...
TEST_F(HnsAdsUserActivityUtilTest, ToUserActivityTriggersForInvalidTrigger) {
  // Arrange
...
TEST_F(HnsAdsUserActivityUtilTest, ToUserActivityTriggersForEmptyTrigger) {
  // Arrange
