...
TEST(HnsAdsUserActivityFeatureTest, IsEnabled) {
  // Arrange
...
TEST(HnsAdsUserActivityFeatureTest, IsDisabled) {
  // Arrange
...
TEST(HnsAdsUserActivityFeatureTest, GetTriggers) {
  // Arrange
...
TEST(HnsAdsUserActivityFeatureTest, DefaultTriggers) {
  // Arrange
...
TEST(HnsAdsUserActivityFeatureTest, DefaultTriggersWhenDisabled) {
  // Arrange
  const std::vector<base::test::FeatureRefAndParams> enabled_features;
...
TEST(HnsAdsUserActivityFeatureTest, GetTimeWindow) {
  // Arrange
  base::FieldTrialParams params;
...
TEST(HnsAdsUserActivityFeatureTest, DefaultTimeWindow) {
  // Arrange
...
TEST(HnsAdsUserActivityFeatureTest, DefaultTimeWindowWhenDisabled) {
  // Arrange
  const std::vector<base::test::FeatureRefAndParams> enabled_features;
...
TEST(HnsAdsUserActivityFeatureTest, GetThreshold) {
  // Arrange
  base::FieldTrialParams params;
...
TEST(HnsAdsUserActivityFeatureTest, DefaultThreshold) {
  // Arrange
...
TEST(HnsAdsUserActivityFeatureTest, DefaultThresholdWhenDisabled) {
  // Arrange
  const std::vector<base::test::FeatureRefAndParams> enabled_features;
