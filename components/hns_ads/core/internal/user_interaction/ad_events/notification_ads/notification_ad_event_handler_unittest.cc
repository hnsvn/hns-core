...
class HnsAdsNotificationAdEventHandlerTest
...
TEST_F(HnsAdsNotificationAdEventHandlerTest, FireServedEvent) {
  // Arrange
...
TEST_F(HnsAdsNotificationAdEventHandlerTest, FireViewedEvent) {
  // Arrange
  const NotificationAdInfo ad = BuildAndSaveAd();
...
TEST_F(HnsAdsNotificationAdEventHandlerTest, FireClickedEvent) {
  // Arrange
  const NotificationAdInfo ad = BuildAndSaveAd();
...
TEST_F(HnsAdsNotificationAdEventHandlerTest, FireDismissedEvent) {
  // Arrange
  const NotificationAdInfo ad = BuildAndSaveAd();
...
TEST_F(HnsAdsNotificationAdEventHandlerTest, FireTimedOutEvent) {
  // Arrange
  const NotificationAdInfo ad = BuildAndSaveAd();
...
TEST_F(HnsAdsNotificationAdEventHandlerTest,
