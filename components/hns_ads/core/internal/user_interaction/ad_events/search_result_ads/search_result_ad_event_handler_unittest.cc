...
class HnsAdsSearchResultAdEventHandlerTest
...
TEST_F(HnsAdsSearchResultAdEventHandlerTest, FireServedEvent) {
  // Arrange
...
TEST_F(HnsAdsSearchResultAdEventHandlerTest, FireViewedEvent) {
  // Arrange
  const mojom::SearchResultAdInfoPtr ad_mojom =
      BuildSearchResultAdForTesting(/*should_use_random_uuids*/ true);
...
TEST_F(HnsAdsSearchResultAdEventHandlerTest, FireViewedEventWithConversion) {
  // Arrange
  const mojom::SearchResultAdInfoPtr ad_mojom =
...
TEST_F(HnsAdsSearchResultAdEventHandlerTest,
...
TEST_F(HnsAdsSearchResultAdEventHandlerTest, FireClickedEvent) {
  // Arrange
  const mojom::SearchResultAdInfoPtr ad_mojom =
      BuildSearchResultAdForTesting(/*should_use_random_uuids*/ true);
