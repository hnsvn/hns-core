...
class HnsAdsPromotedContentAdEventHandlerTest
...
TEST_F(HnsAdsPromotedContentAdEventHandlerTest, FireViewedEvent) {
  // Arrange
...
TEST_F(HnsAdsPromotedContentAdEventHandlerTest,
...
TEST_F(HnsAdsPromotedContentAdEventHandlerTest, FireClickedEvent) {
  // Arrange
  const CreativePromotedContentAdInfo creative_ad = BuildAndSaveCreativeAd();
