...
#include "hns/components/hns_ads/content/browser/search_result_ad/search_result_ad_converting_util.h"
#include "hns/components/hns_ads/content/browser/search_result_ad/search_result_ad_handler.h"
#include "hns/components/hns_ads/content/browser/search_result_ad/test_web_page_util.h"
...
constexpr char kAllowedDomain[] = "https://search.hns.com";
constexpr char kNotAllowedDomain[] = "https://hns.com";
constexpr char kSearchResultAdClickUrl[] =
    "https://search.hns.com/a/redirect?";
...
TEST_F(SearchResultAdHandlerTest, HnsAdsViewedClicked) {
...
TEST_F(SearchResultAdHandlerTest, HnsAdsTabRestored) {
  EXPECT_CALL(
      ads_service_mock_,
      TriggerSearchResultAdEvent(_, mojom::SearchResultAdEventType::kViewed, _))
      .Times(0);
