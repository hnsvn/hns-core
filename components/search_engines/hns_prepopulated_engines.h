...
#ifndef HNS_COMPONENTS_SEARCH_ENGINES_HNS_PREPOPULATED_ENGINES_H_
#define HNS_COMPONENTS_SEARCH_ENGINES_HNS_PREPOPULATED_ENGINES_H_
...
extern const int kHnsCurrentDataVersion;
extern const int kHnsFirstTrackedDataVersion;
...
enum HnsPrepopulatedEngineID : unsigned int {
  ...
  HNS_PREPOPULATED_ENGINES_START = 500,
...
#endif
extern const PrepopulatedEngine hns_ecosia;
extern const PrepopulatedEngine qwant;
extern const PrepopulatedEngine startpage;
extern const PrepopulatedEngine hns_yandex;
extern const PrepopulatedEngine hns_search;
extern const PrepopulatedEngine hns_search_tor;
extern const PrepopulatedEngine hns_bing;
...
#endif  // HNS_COMPONENTS_SEARCH_ENGINES_HNS_PREPOPULATED_ENGINES_H_
