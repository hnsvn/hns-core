...
[
  ...
  },
  {
    ...
    "exclude": [
      "https://dev-pages.hnssoftware.com/clean-urls/exempted/*"
    ],
    "params": [
      "hns_testing1",
      "hns_testing2"
...
TEST_F(URLSanitizerServiceUnitTest, ClearURLS) {
  ...
  EXPECT_EQ(SanitizeURL(GURL("https://hns.com")), GURL("https:/hns.com"));
  WaitInitialization(kTestPatterns);

  EXPECT_EQ(
      SanitizeURL(
          GURL("https://dev-pages.hnssoftware.com/clean-urls/"
               "exempted/"
               "?hns_testing1=foo&hns_testing2=bar&hns_testing3=keep&&;b&"
               "d&utm_content=removethis&e=&f=g&=end")),
      GURL("https://dev-pages.hnssoftware.com/clean-urls/"
           "exempted/?hns_testing1=foo&hns_testing2=bar&hns_"
  ...
  EXPECT_EQ(
      ...
      GURL("https://dev-pages.hnssoftware.com/clean-urls/"
           "?hns_testing3=keep&&;b&d&e=&f=g&=end"));

  WaitInitialization(R"([
    { "include": [ "*://*/*"], "params": ["query"] }
  ])");

  EXPECT_EQ(SanitizeURL(GURL("https://hns.com/?query=removethis")),
            GURL("https://hns.com/"));
