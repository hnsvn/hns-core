...
static constexpr auto kSimpleQueryStringTrackers =
    base::MakeFixedFlatSet<base::StringPiece>(
        {// https://github.com/hnsvn/hns-browser/issues/4239
         "fbclid", "gclid", "msclkid", "mc_eid",
         // https://github.com/hnsvn/hns-browser/issues/9879
         "dclid",
         // https://github.com/hnsvn/hns-browser/issues/13644
         "oly_anon_id", "oly_enc_id",
         // https://github.com/hnsvn/hns-browser/issues/11579
         "_openstat",
         // https://github.com/hnsvn/hns-browser/issues/11817
         "vero_conv", "vero_id",
         // https://github.com/hnsvn/hns-browser/issues/13647
         "wickedid",
         // https://github.com/hnsvn/hns-browser/issues/11578
         "yclid",
         // https://github.com/hnsvn/hns-browser/issues/8975
         "__s",
         // https://github.com/hnsvn/hns-browser/issues/17451
         "rb_clickid",
         // https://github.com/hnsvn/hns-browser/issues/17452
         "s_cid",
         // https://github.com/hnsvn/hns-browser/issues/17507
         "ml_subscriber", "ml_subscriber_hash",
         // https://github.com/hnsvn/hns-browser/issues/18020
         "twclid",
         // https://github.com/hnsvn/hns-browser/issues/18758
         "gbraid", "wbraid",
         // https://github.com/hnsvn/hns-browser/issues/9019
         "_hsenc", "__hssc", "__hstc", "__hsfp", "hsCtaTracking",
         // https://github.com/hnsvn/hns-browser/issues/22082
         "oft_id", "oft_k", "oft_lk", "oft_d", "oft_c", "oft_ck", "oft_ids",
         "oft_sk",
         // https://github.com/hnsvn/hns-browser/issues/24988
         "ss_email_id",
         // https://github.com/hnsvn/hns-browser/issues/25238
         "bsft_uid", "bsft_clkid",
         // https://github.com/hnsvn/hns-browser/issues/25691
         "guce_referrer", "guce_referrer_sig",
         // https://github.com/hnsvn/hns-browser/issues/31084
         "mtm_cid", "pk_cid",
         // https://github.com/hnsvn/hns-browser/issues/26295
         "vgo_ee"});

static constexpr auto kConditionalQueryStringTrackers =
    base::MakeFixedFlatMap<base::StringPiece, base::StringPiece>({
        // https://github.com/hnsvn/hns-browser/issues/9018
        {"mkt_tok", "([uU]nsubscribe|emailWebview)"},
        // https://github.com/hnsvn/hns-browser/issues/30731
        {"h_sid", "/email/"},
        {"h_slt", "/email/"},
    });
...
static constexpr auto kScopedQueryStringTrackers =
    base::MakeFixedFlatMap<base::StringPiece, base::StringPiece>({
        // https://github.com/hnsvn/hns-browser/issues/11580
        {"igshid", "instagram.com"},
        // https://github.com/hnsvn/hns-browser/issues/26966
        {"ref_src", "twitter.com"},
        {"ref_url", "twitter.com"},
    });
...
absl::optional<std::string> StripQueryParameter(const base::StringPiece& query,
  ...
  // https://github.com/hnsvn/hns-core/pull/13726#discussion_r897712350
