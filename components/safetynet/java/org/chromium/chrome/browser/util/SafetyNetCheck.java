...
public class SafetyNetCheck {
    ...
    */
    ...
    private boolean clientAttestation(String nonceData, String apiKey,
        ...
        boolean res = false;
        try {
            Activity activity = (Activity)HnsRewardsHelper.getChromeTabbedActivity();
        ...
        if (performAttestationOnClient) {
            if (tokenReceived) {
                ...
                if (tokenParts.length >= 2) {
                    ...
                    HnsLocalState.get().setString(HnsPref.SAFETYNET_STATUS,
                ...
                HnsLocalState.get().setString(
                        HnsPref.SAFETYNET_STATUS, SAFETYNET_STATUS_NOT_VERIFIED);
            }
        }
