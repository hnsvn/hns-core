...
#ifndef HNS_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
#define HNS_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
...
#endif  // HNS_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
