...
#ifndef HNS_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
#define HNS_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
...
#endif  // HNS_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
