...
#include "hns/components/signin/internal/identity_manager/hns_mutable_profile_oauth2_token_service_delegate.h"
...
HnsMutableProfileOAuth2TokenServiceDelegate::
    ~HnsMutableProfileOAuth2TokenServiceDelegate() = default;

void HnsMutableProfileOAuth2TokenServiceDelegate::LoadCredentials(
