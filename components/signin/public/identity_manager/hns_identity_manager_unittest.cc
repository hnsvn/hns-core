...
class HnsIdentityManagerTest : public testing::Test {
 protected:
  HnsIdentityManagerTest()
  ...
  ~HnsIdentityManagerTest() override {
    identity_manager_->Shutdown();
    signin_client_.Shutdown();
  }

  HnsIdentityManagerTest(const HnsIdentityManagerTest&) = delete;
  HnsIdentityManagerTest& operator=(const HnsIdentityManagerTest&) = delete;
...
TEST_F(HnsIdentityManagerTest, GetAccountsInCookieJarWithNoAccounts) {
...
TEST_F(HnsIdentityManagerTest, GetAccountsInCookieJarWithOneAccount) {
  base::RunLoop run_loop;
  identity_manager_observer()->SetOnAccountsInCookieUpdatedCallback(
      run_loop.QuitClosure());
...
TEST_F(HnsIdentityManagerTest, GetAccountsInCookieJarWithTwoAccounts) {
  base::RunLoop run_loop;
  identity_manager_observer()->SetOnAccountsInCookieUpdatedCallback(
      run_loop.QuitClosure());
