...
#include "hns/components/commands/common/accelerator_parsing.h"
...
constexpr char kAcceleratorsPrefs[] = "hns.accelerators";
constexpr char kDefaultAcceleratorsPrefs[] = "hns.default_accelerators";
