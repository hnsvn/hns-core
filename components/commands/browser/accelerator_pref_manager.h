...
#ifndef HNS_COMPONENTS_COMMANDS_BROWSER_ACCELERATOR_PREF_MANAGER_H_
#define HNS_COMPONENTS_COMMANDS_BROWSER_ACCELERATOR_PREF_MANAGER_H_
...
#endif  // HNS_COMPONENTS_COMMANDS_BROWSER_ACCELERATOR_PREF_MANAGER_H_
