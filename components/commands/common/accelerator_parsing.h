...
#ifndef HNS_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
#define HNS_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
...
#endif  // HNS_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
