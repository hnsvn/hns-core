...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_WALLET_PROVIDER_WALLET_PROVIDER_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_WALLET_PROVIDER_WALLET_PROVIDER_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_WALLET_PROVIDER_WALLET_PROVIDER_H_
