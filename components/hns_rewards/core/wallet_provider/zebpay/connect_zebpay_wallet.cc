...
#include "hns/components/hns_rewards/core/wallet_provider/zebpay/connect_zebpay_wallet.h"
...
using hns_rewards::internal::endpoints::PostConnectZebPay;
using hns_rewards::internal::endpoints::PostOAuthZebPay;
using hns_rewards::internal::endpoints::RequestFor;
using hns_rewards::internal::wallet_provider::ConnectExternalWallet;
