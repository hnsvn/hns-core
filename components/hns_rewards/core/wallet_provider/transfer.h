...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_WALLET_PROVIDER_TRANSFER_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_WALLET_PROVIDER_TRANSFER_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_WALLET_PROVIDER_TRANSFER_H_
