...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_STATIC_VALUES_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_STATIC_VALUES_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_STATIC_VALUES_H_
