...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_WALLET_INFO_PROPERTIES_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_WALLET_INFO_PROPERTIES_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_WALLET_INFO_PROPERTIES_H_
