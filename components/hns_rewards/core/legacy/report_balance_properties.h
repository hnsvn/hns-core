...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_REPORT_BALANCE_PROPERTIES_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_REPORT_BALANCE_PROPERTIES_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_REPORT_BALANCE_PROPERTIES_H_
