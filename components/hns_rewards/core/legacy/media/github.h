...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_MEDIA_GITHUB_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_MEDIA_GITHUB_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_LEGACY_MEDIA_GITHUB_H_
