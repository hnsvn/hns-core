...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_STATE_STATE_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_STATE_STATE_H_
...
#include "hns/components/hns_rewards/core/state/state_migration.h"
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_STATE_STATE_H_
