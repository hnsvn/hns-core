...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_STATE_STATE_KEYS_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_STATE_STATE_KEYS_H_
...
const char kWalletHns[] = "wallets.hns";
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_STATE_STATE_KEYS_H_
