...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_UPHOLD_UPHOLD_UTIL_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_UPHOLD_UPHOLD_UTIL_H_
...
namespace hns_rewards::internal::endpoint::uphold {
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_UPHOLD_UPHOLD_UTIL_H_
