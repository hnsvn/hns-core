...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_COMMON_LEGACY_CALLBACK_HELPERS_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_COMMON_LEGACY_CALLBACK_HELPERS_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_COMMON_LEGACY_CALLBACK_HELPERS_H_
