...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_SKU_SKU_TRANSACTION_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_SKU_SKU_TRANSACTION_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_SKU_SKU_TRANSACTION_H_
