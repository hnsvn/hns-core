...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_LOGGING_EVENT_LOG_KEYS_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_LOGGING_EVENT_LOG_KEYS_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_LOGGING_EVENT_LOG_KEYS_H_
