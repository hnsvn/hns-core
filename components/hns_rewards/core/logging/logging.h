...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_LOGGING_LOGGING_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_LOGGING_LOGGING_H_
...
#define BLOG(verbose_level, stream)                               \
  hns_rewards::internal::Log(__FILE__, __LINE__, verbose_level, \
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_LOGGING_LOGGING_H_
