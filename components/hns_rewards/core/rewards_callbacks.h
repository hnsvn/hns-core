...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_REWARDS_CALLBACKS_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_REWARDS_CALLBACKS_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_REWARDS_CALLBACKS_H_
