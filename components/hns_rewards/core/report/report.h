...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_REPORT_REPORT_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_REPORT_REPORT_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_REPORT_REPORT_H_
