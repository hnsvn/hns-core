...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_TEST_TEST_REWARDS_ENGINE_CLIENT_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_TEST_TEST_REWARDS_ENGINE_CLIENT_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_TEST_TEST_REWARDS_ENGINE_CLIENT_H_
