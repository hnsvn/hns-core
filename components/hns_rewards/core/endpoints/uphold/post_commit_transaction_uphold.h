...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_UPHOLD_POST_COMMIT_TRANSACTION_UPHOLD_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_UPHOLD_POST_COMMIT_TRANSACTION_UPHOLD_H_

#include <string>
#include <vector>

#include "hns/components/hns_rewards/common/mojom/rewards_endpoints.mojom.h"
#include "hns/components/hns_rewards/core/endpoints/common/post_commit_transaction.h"
...
//   "message": "5% transaction fee collected by Hns Software International",
//   "network": "uphold",
//   "normalized": [
//     {
//       "amount": "0.01",
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_UPHOLD_POST_COMMIT_TRANSACTION_UPHOLD_H_
