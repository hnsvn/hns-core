...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_HNS_GET_WALLET_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_HNS_GET_WALLET_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_HNS_GET_WALLET_H_
