...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_HNS_POST_CONNECT_GEMINI_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_HNS_POST_CONNECT_GEMINI_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_HNS_POST_CONNECT_GEMINI_H_
