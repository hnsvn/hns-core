...
// npm run test -- hns_unit_tests --filter=*PostConnect*
...
INSTANTIATE_TEST_SUITE_P(
  ...
  Values(
    ...
    PostConnectParamType{
      ...
      R"(
        {
          "message": "Error validating Connecting Hns Rewards to Uphold is temporarily unavailable. Please try again later",
          "code": 400
        }
      )",
