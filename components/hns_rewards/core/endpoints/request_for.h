...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_REQUEST_FOR_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_REQUEST_FOR_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINTS_REQUEST_FOR_H_
