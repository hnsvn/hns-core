...
// npm run test -- hns_unit_tests --filter=*GetRecipientIDGemini*
...
namespace hns_rewards::internal::endpoints::test {
...
INSTANTIATE_TEST_SUITE_P(
  ...
  Values(
    ...
    GetRecipientIDGeminiParamType{
      "HTTP_200_no_recipient_id_with_hns_browser_label",
      net::HTTP_OK,
      R"(
        [
          {
