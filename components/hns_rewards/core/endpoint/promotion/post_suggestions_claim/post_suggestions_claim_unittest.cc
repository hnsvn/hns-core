...
// npm run test -- hns_unit_tests --filter=PostSuggestionsClaimTest.*
...
class PostSuggestionsClaimTest : public testing::Test {
 protected:
  PostSuggestionsClaimTest() {
    ...
    redeem_.publisher_key = "hns.com";
    redeem_.type = mojom::RewardsType::ONE_TIME_TIP;
    redeem_.processor = mojom::ContributionProcessor::HNS_TOKENS;
  ...
  void SetUp() override {
    ON_CALL(*mock_engine_impl_.mock_client(),
            GetStringState(state::kWalletHns, _))
