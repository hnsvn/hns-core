...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINT_UPHOLD_GET_CARD_GET_CARD_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINT_UPHOLD_GET_CARD_GET_CARD_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_ENDPOINT_UPHOLD_GET_CARD_GET_CARD_H_
