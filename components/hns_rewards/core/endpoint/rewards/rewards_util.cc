...
const char kDevelopment[] = "https://rewards-dev.hns.software";
const char kStaging[] = "https://rewards-stg.hnssoftware.com";
const char kProduction[] = "https://rewards.hns.com";
