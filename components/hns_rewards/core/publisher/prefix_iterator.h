...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_PUBLISHER_PREFIX_ITERATOR_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_PUBLISHER_PREFIX_ITERATOR_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_PUBLISHER_PREFIX_ITERATOR_H_
