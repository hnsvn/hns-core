...
#ifndef HNS_COMPONENTS_HNS_REWARDS_CORE_DATABASE_DATABASE_CONTRIBUTION_INFO_H_
#define HNS_COMPONENTS_HNS_REWARDS_CORE_DATABASE_DATABASE_CONTRIBUTION_INFO_H_

#include <memory>
#include <string>
#include <vector>

#include "hns/components/hns_rewards/core/database/database_contribution_info_publishers.h"
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_CORE_DATABASE_DATABASE_CONTRIBUTION_INFO_H_
