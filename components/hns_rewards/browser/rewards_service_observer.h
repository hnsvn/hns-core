...
#ifndef HNS_COMPONENTS_HNS_REWARDS_BROWSER_REWARDS_SERVICE_OBSERVER_H_
#define HNS_COMPONENTS_HNS_REWARDS_BROWSER_REWARDS_SERVICE_OBSERVER_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_BROWSER_REWARDS_SERVICE_OBSERVER_H_
