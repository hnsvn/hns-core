...
const char kEnabledSourceHistogramName[] = "Hns.Rewards.EnabledSource";
const char kInlineTipTriggerHistogramName[] = "Hns.Rewards.InlineTipTrigger";
const char kToolbarButtonTriggerHistogramName[] =
    "Hns.Rewards.ToolbarButtonTrigger";
const char kTipsSentHistogramName[] = "Hns.Rewards.TipsSent.2";
const char kAutoContributionsStateHistogramName[] =
    "Hns.Rewards.AutoContributionsState.3";
const char kAdTypesEnabledHistogramName[] = "Hns.Rewards.AdTypesEnabled";
