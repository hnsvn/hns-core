...
#include "hns/components/hns_rewards/browser/test/common/rewards_browsertest_context_helper.h"
#include "hns/components/hns_rewards/browser/test/common/rewards_browsertest_context_util.h"
#include "hns/components/hns_rewards/browser/test/common/rewards_browsertest_contribution.h"
#include "hns/components/hns_rewards/browser/test/common/rewards_browsertest_network_util.h"
#include "hns/components/hns_rewards/browser/test/common/rewards_browsertest_promotion.h"
...
// npm run test -- hns_browser_tests --filter=RewardsContributionBrowserTest.*
...
IN_PROC_BROWSER_TEST_F(RewardsContributionBrowserTest,
  ...
  test_util::WaitForElementToContain(
      ...
      "This month, you've visited 1 creator supported by Hns Rewards");
}
...
IN_PROC_BROWSER_TEST_F(RewardsContributionBrowserTest, TipUnverifiedPublisher) {
  ...
  contribution_->TipPublisher(
      test_util::GetUrl(https_server_.get(), "hns.com"), false);
}
...
// TODO(https://github.com/hnsvn/hns-browser/issues/12555): This test is known
...
IN_PROC_BROWSER_TEST_F(RewardsContributionBrowserTest,
  ...
  context_helper_->VisitPublisher(
      test_util::GetUrl(https_server_.get(), "hns.com"), !verified);
