...
#include "hns/components/hns_rewards/core/uphold/uphold_util.h"
...
// npm run test -- hns_browser_tests --filter=RewardsBrowserTest.*
 ...
 public:
  ...
  double FetchBalance() {
    ...
    rewards_service_->FetchBalance(base::BindLambdaForTesting(
        [&](hns_rewards::FetchBalanceResult result) {
...
IN_PROC_BROWSER_TEST_F(RewardsBrowserTest, ResetRewards) {
  ...
  test_util::WaitForElementToContain(
      ...
      "By resetting, your current Hns Rewards profile will be deleted");
}
