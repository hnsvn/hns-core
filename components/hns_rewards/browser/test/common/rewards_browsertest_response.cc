...
#include "hns/components/hns_rewards/core/publisher/protos/channel_response.pb.h"
#include "hns/components/hns_rewards/core/publisher/protos/publisher_prefix_list.pb.h"
...
void RewardsBrowserTestResponse::Get(
  ...
  if (base::Contains(url, "/v3/wallet/hns") ||
