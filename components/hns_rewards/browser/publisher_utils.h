...
#ifndef HNS_COMPONENTS_HNS_REWARDS_BROWSER_PUBLISHER_UTILS_H_
#define HNS_COMPONENTS_HNS_REWARDS_BROWSER_PUBLISHER_UTILS_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_BROWSER_PUBLISHER_UTILS_H_
