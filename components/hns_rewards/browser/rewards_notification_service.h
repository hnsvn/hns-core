...
#ifndef HNS_COMPONENTS_HNS_REWARDS_BROWSER_REWARDS_NOTIFICATION_SERVICE_H_
#define HNS_COMPONENTS_HNS_REWARDS_BROWSER_REWARDS_NOTIFICATION_SERVICE_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_BROWSER_REWARDS_NOTIFICATION_SERVICE_H_
