...
#ifndef HNS_COMPONENTS_HNS_REWARDS_BROWSER_DIAGNOSTIC_LOG_H_
#define HNS_COMPONENTS_HNS_REWARDS_BROWSER_DIAGNOSTIC_LOG_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_BROWSER_DIAGNOSTIC_LOG_H_
