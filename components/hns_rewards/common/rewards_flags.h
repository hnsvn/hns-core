...
#ifndef HNS_COMPONENTS_HNS_REWARDS_COMMON_REWARDS_FLAGS_H_
#define HNS_COMPONENTS_HNS_REWARDS_COMMON_REWARDS_FLAGS_H_
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_COMMON_REWARDS_FLAGS_H_
