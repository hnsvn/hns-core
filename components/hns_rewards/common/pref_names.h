...
#ifndef HNS_COMPONENTS_HNS_REWARDS_COMMON_PREF_NAMES_H_
#define HNS_COMPONENTS_HNS_REWARDS_COMMON_PREF_NAMES_H_

namespace hns_rewards::prefs {
...
#endif  // HNS_COMPONENTS_HNS_REWARDS_COMMON_PREF_NAMES_H_
