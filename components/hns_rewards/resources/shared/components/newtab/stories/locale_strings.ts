...
export const localeStrings = {
  ...
  rewardsHnsRewards: 'Hns Rewards',
  rewardsClaimRewards: 'Claim Rewards',
  rewardsClaimTokens: 'Claim Tokens',
  rewardsConnectAccount: 'Connect account',
  rewardsConnectAccountNoProviders: 'To start earning BAT, you need to connect a custodial account to Hns Rewards. Unfortunately, there’s no custodian available in your region, so earning isn’t available at this time. However, you’ll still be automatically supporting creators by using Rewards.',
  ...
  rewardsEarningInfoText: 'This reflects your estimated earnings range for Hns Ads this month.',
  ...
  rewardsOptInHeader: 'Earn tokens for private ads you see in Hns',
  ...
  rewardsPublisherCountText: 'This month, you\'ve visited $1 creators supported by Hns Rewards',
  rewardsSelectCountryHeader: 'Select your country',
  rewardsSelectCountryText: 'To continue using Hns Rewards, select your country so we can show you the right options and ads for your region. $1Privacy Policy$2',
