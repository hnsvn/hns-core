...
export const localeStrings = {
  ...
  connectAccountNoProviders: 'To earn BAT, users must connect a custodial account to Hns Rewards. Unfortunately, there\'s no custodian available in your region, so earning isn\'t available. For now, turning on Hns Rewards will automatically support creators.',
  connectContributeHeader: 'Send contributions with Hns Rewards',
  connectContributeText: 'You\'ll be able to send on-demand contributions to your favorite Creators with your Hns Rewards balance once you have a custodial account connected.',
  connectContributeNoProviders: 'To send on-demand contributions, users must connect a custodial account to Hns Rewards. Unfortunately, there’s no custodian available in your region, so sending isn’t available. In the meantime, you’re still automatically supporting creators.',
  learnMore: 'Learn more',
  publisherCountText: 'This month, you\'ve visited $1 creators supported by Hns Rewards',
  headerTitle: 'Hns Rewards',
  ...
  unverifiedText: 'This Creator is not yet verified with Hns Creators. You\'ll be able to send them contributions once they\'re verified.',
  ...
  grantCaptchaErrorText: 'Hns Rewards is having an issue. Please try again later.',

  captchaSolvedTitle: 'Solved!',
  captchaSolvedText: 'Ads and earnings will now resume. Thanks for helping us protect Hns Rewards and privacy-based ads.',
  captchaDismiss: 'Dismiss',
  captchaMaxAttemptsExceededTitle: 'Max attempts exceeded',
  captchaMaxAttemptsExceededText: 'Looks like this is not working, Hns ads will remain paused. Contact us if you need help with the captcha.',
