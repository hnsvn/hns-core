...
export function createModel (): Model {
  const stateManager = createStateManager<ModelState>({
    ...
    creatorBanner: {
      ...
      title: 'Hns Software',
      description:
        'Thanks for stopping by. Hns is on a mission to fix the web by ' +
        ...
        'web together!',
      logo: 'https://rewards.hns.com/LH3yQwkb78iP28pJDSSFPJwU',
      background: '',
      links: {
        twitter: 'https://twitter.com/hns',
        youtube: 'https://www.youtube.com/hnssoftware',
        twitch: 'https://twitch.tv/hnssoftware'
      },
      web3Url: 'https://www.hns.com'
    },
