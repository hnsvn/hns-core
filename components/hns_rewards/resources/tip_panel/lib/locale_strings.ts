...
export const localeStrings = {
  ...
  feeNotice: 'Hns collects $1 of the sent amount as a processing fee.',
  ...
  verifiedTooltipText: 'This Creator has registered with Hns and can receive contributions from Hns Rewards users.',
  ...
  reconnectText: 'It looks like you\'re logged out of $1 for Hns Rewards. Log in again to continue.',
  ...
  insufficientBalanceText: 'You can only send up to $1 BAT using your Hns Rewards balance.',
  ...
  shareText: 'I earned crypto rewards with the Hns Browser, and just contributed $1 BAT of it to $2. Learn how you can support your favorite creators and sites too: https://hns.com/rewards',
