...
import hnsCreatorsBackground from '../assets/hns_creators_bg.svg'
...
function getBackgroundImage (key: PromotionKey) {
  switch (key) {
    ...
    case 'hns-creators': return hnsCreatorsBackground
...
export const promotion = styled.div`
  ...
  &.promotion-hns-creators {
    background-image: url(/${getBackgroundImage('hns-creators')});
  }
