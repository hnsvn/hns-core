...
export const localeStrings = {
  ...
  connectWalletDisclaimer: 'Custodial account providers are required to verify your identity, which may include submitting a photo ID. See the $1Hns Rewards Privacy Policy$2. See here to $3learn more about BAT$4.',
  ...
  adsSubdivisionTargetingDescription: 'This allows Hns to show you ads meant specifically for your region.',
  adsSubdivisionTargetingLearn: 'Learn More',
  adsDescription: 'Control what kinds of Hns Ads you see, and how often.',
  ...
  settings: 'Settings',
  rewardsBrowserCannotReceiveAds: 'Oops! Your browser cannot receive Hns Private Ads.',
  ...
  connectAccountNoProviders: 'To start earning BAT, you need to connect a custodial account to Hns Rewards. Unfortunately, there\'s no custodian available in your region, so earning isn\'t available at this time. However, you\'ll still be automatically supporting creators by using Rewards.',
  learnMore: 'Learn more',
  newTabAdCountLabel: 'New tab page ads',
  notificationAdCountLabel: 'Notification ads',
  newsAdCountLabel: 'Hns News ads',
  newsAdInfo: 'Hns News contains ads that cannot be independently disabled.',
  newsAdInfoDisabled: 'Hns News is currently disabled.',
