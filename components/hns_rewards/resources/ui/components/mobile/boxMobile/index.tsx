...
import Toggle from 'hns-ui/components/formControls/toggle/index'
...
export default class BoxMobile extends React.PureComponent<Props, State> {
   ...
   *
   * When user is on the index page: (hns://rewards)
   * (state) { detailView: false, settings: false }
   *
   * When user is on a detail view: (hns://rewards/ads)
   * (state) { detailView: true, settings: false }
   *
   * When user is on a settings view: (hns://rewards/ads-settings)
