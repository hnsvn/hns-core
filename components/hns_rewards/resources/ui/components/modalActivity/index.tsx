...
import { Select, ControlWrapper, Modal } from 'hns-ui/components'
import { PrintIcon } from 'hns-ui/components/icons'
...
export default class ModalActivity extends React.PureComponent<Props, State> {
  ...
  get modalTitle () {
    return (
      <StyledTitle>
        {getLocale('hnsRewards')} <StyledSubTitle>{getLocale('walletActivity')}</StyledSubTitle>
      </StyledTitle>
    )
  }
