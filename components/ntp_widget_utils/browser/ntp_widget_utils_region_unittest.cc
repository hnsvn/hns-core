...
#include "hns/components/ntp_widget_utils/browser/ntp_widget_utils_region.h"
...
// npm run test -- hns_unit_tests --filter=NTPWidgetUtilsRegionUtilTest.*
...
TEST_F(NTPWidgetUtilsRegionUtilTest, TestFindLocaleInListOne) {
...

  {
    ...
    hns_l10n::test::ScopedDefaultLocale scoped_default_locale{"ja_JP"};
...

  {
    ...
    // the provided list
    hns_l10n::test::ScopedDefaultLocale scoped_default_locale{"ar_DZ"};
    EXPECT_EQ(::ntp_widget_utils::FindLocale({"en", "fr", "ja"}, "en"), "en");
  }
}
