...
#ifndef HNS_COMPONENTS_HNS_WAYBACK_MACHINE_WAYBACK_MACHINE_URL_FETCHER_H_
#define HNS_COMPONENTS_HNS_WAYBACK_MACHINE_WAYBACK_MACHINE_URL_FETCHER_H_
...
#endif  // HNS_COMPONENTS_HNS_WAYBACK_MACHINE_WAYBACK_MACHINE_URL_FETCHER_H_
