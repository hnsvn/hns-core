...
#include "hns/components/hns_wayback_machine/url_constants.h"
#include "net/base/url_util.h"
#include "testing/gtest/include/gtest/gtest.h"
#include "url/gurl.h"

TEST(HnsWaybackMachineUtilsTest, LocalHostDisabledTest) {
  EXPECT_TRUE(
  ...
  EXPECT_FALSE(IsWaybackMachineDisabledFor(GURL("http://www.hns.com")));
  EXPECT_FALSE(
      IsWaybackMachineDisabledFor(GURL("https://archive.org/foobar.html")));
}

TEST(HnsWaybackMachineUtilsTest, FixupQueryURLTest) {
