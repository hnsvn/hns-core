...
#ifndef HNS_COMPONENTS_MISC_METRICS_MENU_METRICS_H_
#define HNS_COMPONENTS_MISC_METRICS_MENU_METRICS_H_
...
class MenuMetrics {
 public:
  ...
  // 1. Hns features (Wallet, Rewards, Sync)
...
#endif  // HNS_COMPONENTS_MISC_METRICS_MENU_METRICS_H_
