...
#include "hns/components/time_period_storage/iso_weekly_storage.h"
...
const char kWeeklyUseHistogramName[] = "Hns.Core.WeeklyUsage";
const char kProfileCountHistogramName[] = "Hns.Core.ProfileCount";
