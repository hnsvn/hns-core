...
#ifndef HNS_COMPONENTS_MISC_METRICS_PAGE_METRICS_SERVICE_H_
#define HNS_COMPONENTS_MISC_METRICS_PAGE_METRICS_SERVICE_H_
...
#endif  // HNS_COMPONENTS_MISC_METRICS_PAGE_METRICS_SERVICE_H_
