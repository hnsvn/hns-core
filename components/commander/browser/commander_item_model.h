...
#ifndef HNS_COMPONENTS_COMMANDER_BROWSER_COMMANDER_ITEM_MODEL_H_
#define HNS_COMPONENTS_COMMANDER_BROWSER_COMMANDER_ITEM_MODEL_H_
...
#endif  // HNS_COMPONENTS_COMMANDER_BROWSER_COMMANDER_ITEM_MODEL_H_
