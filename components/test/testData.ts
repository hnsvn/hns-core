...
// Initial state
import { defaultState as rewardsData } from '../../components/hns_rewards/resources/page/reducers/default_state'
import { defaultState as adblockData } from '../../components/hns_adblock_ui/storage'
...
export const mockSearchProviders = [
  {
    ...
    modelIndex: 1,
    name: 'DuckDuckGo',
    url: 'https://duckduckgo.com/?q=%s&t=hns',
    urlLocked: true
  }
]
