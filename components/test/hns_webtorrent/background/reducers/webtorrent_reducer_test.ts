...
import { webtorrentReducer } from '../../../../hns_webtorrent/extension/background/reducers/webtorrent_reducer'
import * as tabActions from '../../../../hns_webtorrent/extension/actions/tab_actions'
import { torrentObjMap } from '../../testData'

// this import seems to trigger createStore and get an undefined reducer
jest.mock('../../../../hns_webtorrent/extension/background/events/torrentEvents')
