...
import { types } from '../../../hns_webtorrent/extension/constants/webtorrent_types'
import * as actions from '../../../hns_webtorrent/extension/actions/webtorrent_actions'
...
const torrent: Torrent = {
  ...
  torrentFileBlobURL: 'https://hns.com',
  files: [],
  received: 1337,
  path: '/',
  ready: true,
