...
#ifndef HNS_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
#define HNS_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_

#include <vector>

#include "base/time/time.h"
#include "hns/components/permissions/permission_lifetime_options.h"
...
#endif  // HNS_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
