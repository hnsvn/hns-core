...
#ifndef HNS_COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
#define HNS_COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
...
#endif  // HNS_COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
