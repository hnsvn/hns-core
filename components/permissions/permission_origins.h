...
#ifndef HNS_COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
#define HNS_COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
...
#endif  // HNS_COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
