...
TEST_F(PermissionsClientUnitTest, HnsCanBypassEmbeddingOriginCheck) {
  ...
  for (size_t i = 0; i < sizeof(cases) / sizeof(cases[0]); ++i) {
    ...
    EXPECT_TRUE(client->HnsCanBypassEmbeddingOriginCheck(
    ...
    EXPECT_FALSE(client->HnsCanBypassEmbeddingOriginCheck(
