...
#ifndef HNS_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_OPTIONS_H_
#define HNS_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_OPTIONS_H_
...
#endif  // HNS_COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_OPTIONS_H_
