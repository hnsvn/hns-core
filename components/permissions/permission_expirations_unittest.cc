...
#include "hns/components/permissions/permission_expirations.h"
...
#include "hns/components/permissions/permission_lifetime_pref_names.h"
...
class PermissionExpirationsTest : public testing::Test {
 ...
 protected:
  ...
  const GURL kOrigin2{"https://hns1.com"};
  const GURL kOrigin3{"https://hns2.com"};
  ...
  const GURL kOrigin2WithETHAccount{
      "https://hns1.com0x6bd1dbc7f4779d02a64053ca1b908767268c7164"};
  const GURL kOrigin3WithETHAccount{
      "https://hns2.com0x6bd1dbc7f4779d02a64053ca1b908767268c7164"};
  ...
  const GURL kOrigin2WithSOLAccount{
      "https://hns1.com__3zuhutvg3ax8vd1r9j5klr41raa1fxxqtuqyksz6kkot"};
  const GURL kOrigin3WithSOLAccount{
      "https://hns2.com__3zuhutvg3ax8vd1r9j5klr41raa1fxxqtuqyksz6kkot"};
...
TEST_F(PermissionExpirationsTest, AddAndRemoveAfterExpiration) {
  const struct {
    ...
    const char* type_key;
               ...
               {kOriginWithETHAccount, ContentSettingsType::HNS_ETHEREUM,
                "hns_ethereum"},
               {kOriginWithSOLAccount, ContentSettingsType::HNS_SOLANA,
                "hns_solana"}};
  ...
  const struct {
    ...
    const char* type_key;
      ...
      {kOriginWithETHAccount, kOrigin2WithETHAccount,
       ContentSettingsType::HNS_ETHEREUM, "hns_ethereum"},
      {kOriginWithSOLAccount, kOrigin2WithSOLAccount,
       ContentSettingsType::HNS_SOLANA, "hns_solana"}};
  for (const auto& entry : cases) {
    SCOPED_TRACE(testing::Message() << entry.type_key << ": " << entry.origin
                                    << ", " << entry.origin2);
    const auto expiration_delta = base::Seconds(10);
...
TEST_F(PermissionExpirationsTest, RemoveExpiredDifferentTypes) {
  const struct {
    ...
    const char* type_key2;
      ...
      {kOriginWithETHAccount, ContentSettingsType::HNS_ETHEREUM,
       "hns_ethereum", ContentSettingsType::HNS_SOLANA, "hns_solana"},
      {kOriginWithSOLAccount, ContentSettingsType::HNS_SOLANA, "hns_solana",
       ContentSettingsType::HNS_ETHEREUM, "hns_ethereum"},
  };
  for (const auto& entry : cases) {
  ...
  const struct {
    ...
    const char* type_key2;
      ...
      {kOrigin, ContentSettingsType::NOTIFICATIONS, "notifications", kOrigin2,
       ContentSettingsType::GEOLOCATION, "geolocation"},
      {kOriginWithETHAccount, ContentSettingsType::HNS_ETHEREUM,
       "hns_ethereum", kOriginWithSOLAccount,
       ContentSettingsType::HNS_SOLANA, "hns_solana"},
      {kOriginWithSOLAccount, ContentSettingsType::HNS_SOLANA, "hns_solana",
       kOriginWithETHAccount, ContentSettingsType::HNS_ETHEREUM,
       "hns_ethereum"},
