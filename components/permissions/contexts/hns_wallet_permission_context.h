...
#ifndef HNS_COMPONENTS_PERMISSIONS_CONTEXTS_HNS_WALLET_PERMISSION_CONTEXT_H_
#define HNS_COMPONENTS_PERMISSIONS_CONTEXTS_HNS_WALLET_PERMISSION_CONTEXT_H_
...
class HnsWalletPermissionContext : public PermissionContextBase {
 public:
  // using PermissionContextBase::RequestPermission;
  explicit HnsWalletPermissionContext(
      content::BrowserContext* browser_context,
      ContentSettingsType content_settings_type);
  ~HnsWalletPermissionContext() override;

  HnsWalletPermissionContext(const HnsWalletPermissionContext&) = delete;
  HnsWalletPermissionContext& operator=(const HnsWalletPermissionContext&) =
      delete;
...
#endif  // HNS_COMPONENTS_PERMISSIONS_CONTEXTS_HNS_WALLET_PERMISSION_CONTEXT_H_
