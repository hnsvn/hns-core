...
class HnsPermissionDialogModel {
    ...
    private static void addLifetimeOptions(View customView, PermissionDialogDelegate delegate) {
        ...
        HnsPermissionDialogDelegate hnsDelegate =
                (HnsPermissionDialogDelegate) (Object) delegate;

        String[] lifetimeOptions = hnsDelegate.getLifetimeOptions();
        ...
        lifetimeOptionsText.setText(hnsDelegate.getLifetimeOptionsText());
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                hnsDelegate.setSelectedLifetimeOption(checkedId);
            }
        });
        radioGroup.check(0);
