...
#ifndef HNS_COMPONENTS_HNS_VPN_COMMON_WIN_RAS_RAS_CONNECTION_OBSERVER_H_
#define HNS_COMPONENTS_HNS_VPN_COMMON_WIN_RAS_RAS_CONNECTION_OBSERVER_H_
...
#endif  // HNS_COMPONENTS_HNS_VPN_COMMON_WIN_RAS_RAS_CONNECTION_OBSERVER_H_
