...
#ifndef HNS_COMPONENTS_HNS_VPN_COMMON_WIN_SCOPED_SC_HANDLE_H_
#define HNS_COMPONENTS_HNS_VPN_COMMON_WIN_SCOPED_SC_HANDLE_H_
...
#endif  // HNS_COMPONENTS_HNS_VPN_COMMON_WIN_SCOPED_SC_HANDLE_H_
