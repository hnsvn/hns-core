...
#ifndef HNS_COMPONENTS_HNS_VPN_COMMON_WIN_HNS_WINDOWS_SERVICE_WATCHER_H_
#define HNS_COMPONENTS_HNS_VPN_COMMON_WIN_HNS_WINDOWS_SERVICE_WATCHER_H_
...
#endif  // HNS_COMPONENTS_HNS_VPN_COMMON_WIN_HNS_WINDOWS_SERVICE_WATCHER_H_
