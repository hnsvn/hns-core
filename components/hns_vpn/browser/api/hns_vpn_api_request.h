...
#ifndef HNS_COMPONENTS_HNS_VPN_BROWSER_API_HNS_VPN_API_REQUEST_H_
#define HNS_COMPONENTS_HNS_VPN_BROWSER_API_HNS_VPN_API_REQUEST_H_
...
class HnsVpnAPIRequest {
 public:
  explicit HnsVpnAPIRequest(
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory);
  HnsVpnAPIRequest(const HnsVpnAPIRequest&) = delete;
  HnsVpnAPIRequest& operator=(const HnsVpnAPIRequest&) = delete;
  ~HnsVpnAPIRequest();
 ...
 private:
  ...
  base::WeakPtrFactory<HnsVpnAPIRequest> weak_ptr_factory_{this};
};

}  // namespace hns_vpn

#endif  // HNS_COMPONENTS_HNS_VPN_BROWSER_API_HNS_VPN_API_REQUEST_H_
