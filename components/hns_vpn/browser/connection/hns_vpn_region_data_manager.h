...
#ifndef HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_HNS_VPN_REGION_DATA_MANAGER_H_
#define HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_HNS_VPN_REGION_DATA_MANAGER_H_
...
class HnsVPNRegionDataManager {
 public:
  HnsVPNRegionDataManager(
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory,
      PrefService* local_prefs);
  ~HnsVPNRegionDataManager();
  HnsVPNRegionDataManager(const HnsVPNRegionDataManager&) = delete;
  HnsVPNRegionDataManager& operator=(const HnsVPNRegionDataManager&) =
      delete;
...
#endif  // HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_HNS_VPN_REGION_DATA_MANAGER_H_
