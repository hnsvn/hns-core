...
using hns_vpn::ras::CheckConnection;
using hns_vpn::ras::CheckConnectionResult;
using hns_vpn::ras::ConnectEntry;
using hns_vpn::ras::CreateEntry;
using hns_vpn::ras::DisconnectEntry;
using hns_vpn::ras::GetPhonebookPath;
using hns_vpn::ras::GetRasErrorMessage;
...
// hns_vpn::CreateEntry() can be created for the `CustomIPSecPolicies` field.
void Demo() {
...
int main(int argc, char* argv[]) {
  ...
  if (command_line->HasSwitch(kCreateCommand)) {
    ...
    hns_vpn::HnsVPNConnectionInfo info;
