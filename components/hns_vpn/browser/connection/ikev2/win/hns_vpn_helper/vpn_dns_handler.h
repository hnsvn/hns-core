...
#ifndef HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_IKEV2_WIN_HNS_VPN_HELPER_VPN_DNS_HANDLER_H_
#define HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_IKEV2_WIN_HNS_VPN_HELPER_VPN_DNS_HANDLER_H_
...
class VpnDnsHandler : public base::win::ObjectWatcher::Delegate {
 public:
  explicit VpnDnsHandler(HnsVpnDnsDelegate* delegate);
 ...
 private:
  ...
  raw_ptr<HnsVpnDnsDelegate> delegate_;
...
#endif  // HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_IKEV2_WIN_HNS_VPN_HELPER_VPN_DNS_HANDLER_H_
