...
#ifndef HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_IKEV2_WIN_HNS_VPN_HELPER_HNS_VPN_HELPER_CRASH_REPORTER_CLIENT_H_
#define HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_IKEV2_WIN_HNS_VPN_HELPER_HNS_VPN_HELPER_CRASH_REPORTER_CLIENT_H_
...
class HnsVPNHelperCrashReporterClient
    : public crash_reporter::CrashReporterClient {
 public:
  static void InitializeCrashReportingForProcess(
      const std::string& process_type);

  HnsVPNHelperCrashReporterClient();

  HnsVPNHelperCrashReporterClient(const HnsVPNHelperCrashReporterClient&) =
      delete;
  HnsVPNHelperCrashReporterClient& operator=(
      const HnsVPNHelperCrashReporterClient&) = delete;

  ~HnsVPNHelperCrashReporterClient() override;
...
#endif  // HNS_COMPONENTS_HNS_VPN_BROWSER_CONNECTION_IKEV2_WIN_HNS_VPN_HELPER_HNS_VPN_HELPER_CRASH_REPORTER_CLIENT_H_
