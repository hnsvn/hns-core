...
import * as HnsVPN from '../../api/panel_browser_api'
...
loadingState.state = HnsVPN.PurchasedState.LOADING;

HnsVPN.setPanelBrowserApiForTesting({
  pageCallbackRouter: {
  },
  panelHandler: {
    showUI: doNothing,
  ...
  serviceHandler: {
    ...
    getConnectionState: () => Promise.resolve({ state: HnsVPN.ConnectionState.CONNECTED }),
