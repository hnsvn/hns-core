  ...
  return (
    <>
      ...
      <S.StatusBox>
        ...
        <S.StatusText>
          {status === ConnectionState.CONNECTED && getLocale('hnsVpnConnected')}
          {status === ConnectionState.CONNECTING && getLocale('hnsVpnConnecting')}
          {status === ConnectionState.DISCONNECTING && getLocale('hnsVpnDisconnecting')}
          {status === ConnectionState.DISCONNECTED && getLocale('hnsVpnDisconnected')}
          {status === ConnectionState.CONNECT_NOT_ALLOWED && getLocale('hnsVpnDisconnected')}
          {status === ConnectionState.CONNECT_FAILED && getLocale('hnsVpnConnectionFailed')}
        </S.StatusText>
      </S.StatusBox>
    </>
  )
