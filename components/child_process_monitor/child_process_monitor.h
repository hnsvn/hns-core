...
#ifndef HNS_COMPONENTS_CHILD_PROCESS_MONITOR_CHILD_PROCESS_MONITOR_H_
#define HNS_COMPONENTS_CHILD_PROCESS_MONITOR_CHILD_PROCESS_MONITOR_H_
...
#endif  // HNS_COMPONENTS_CHILD_PROCESS_MONITOR_CHILD_PROCESS_MONITOR_H_
