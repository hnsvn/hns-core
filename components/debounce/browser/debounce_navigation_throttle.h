...
#ifndef HNS_COMPONENTS_DEBOUNCE_BROWSER_DEBOUNCE_NAVIGATION_THROTTLE_H_
#define HNS_COMPONENTS_DEBOUNCE_BROWSER_DEBOUNCE_NAVIGATION_THROTTLE_H_
...
#endif  // HNS_COMPONENTS_DEBOUNCE_BROWSER_DEBOUNCE_NAVIGATION_THROTTLE_H_
