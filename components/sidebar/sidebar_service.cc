...
SidebarItem::BuiltInItemType GetBuiltInItemTypeForLegacyURL(
  ...
  // need to be updated.
  if (url == "https://together.hns.com/" || url == "https://talk.hns.com/")
    return SidebarItem::BuiltInItemType::kHnsTalk;
...
void SidebarService::MigratePrefSidebarBuiltInItemsToHidden() {
  ...
  built_in_items_to_hide.push_back(
      GetBuiltInItemForType(SidebarItem::BuiltInItemType::kHnsTalk));
  built_in_items_to_hide.push_back(
...
SidebarItem SidebarService::GetBuiltInItemForType(
  ...
  switch (type) {
    case SidebarItem::BuiltInItemType::kHnsTalk:
      return SidebarItem::Create(GURL(kHnsTalkURL),
                                 hns_l10n::GetLocalizedResourceUTF16String(
                                     IDS_SIDEBAR_HNS_TALK_ITEM_TITLE),
                                 SidebarItem::Type::kTypeBuiltIn,
                                 SidebarItem::BuiltInItemType::kHnsTalk,
                                 /* open_in_panel = */ false);
    case SidebarItem::BuiltInItemType::kWallet: {
      if (hns_wallet::IsAllowed(prefs_)) {
    ...
    case SidebarItem::BuiltInItemType::kBookmarks:
      return SidebarItem::Create(hns_l10n::GetLocalizedResourceUTF16String(
    ...
    case SidebarItem::BuiltInItemType::kReadingList:
      return SidebarItem::Create(
          // TODO(petemill): Have these items created under hns/browser
    ...
    case SidebarItem::BuiltInItemType::kChatUI: {
      ...
      if (ai_chat::features::IsAIChatEnabled()) {
        return SidebarItem::Create(
            hns_l10n::GetLocalizedResourceUTF16String(IDS_CHAT_UI_TITLE),
            SidebarItem::Type::kTypeBuiltIn,
            SidebarItem::BuiltInItemType::kChatUI,
            /* open_in_panel = */ true);
      } else {
