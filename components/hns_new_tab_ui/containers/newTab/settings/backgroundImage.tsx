...
import hnsBackground from './assets/hns-background.png'
...
import { RANDOM_SOLID_COLOR_VALUE, RANDOM_GRADIENT_COLOR_VALUE, MAX_CUSTOM_IMAGE_BACKGROUNDS } from 'gen/hns/components/hns_new_tab_ui/hns_new_tab_page.mojom.m.js'
import BackgroundImageTiles from './backgroundImageTiles'

import * as mojom from '../../../../hns_rewards/resources/shared/lib/mojom'
...
class BackgroundImageSettings extends React.PureComponent<Props, State> {
  ...
  onClickHnsBackground = () => {
    this.props.setHnsBackground('')
  }
  ...
  render () {
    ...
    const usingHnsBackground = !usingCustomImageBackground && !selectedBackgroundColor
          ...
          <div>
            ...
            {showBackgroundImage && featureCustomBackgroundEnabled && (
              <StyledCustomBackgroundSettings>
                ...
                <StyledCustomBackgroundOption
                  onClick={this.onClickHnsBackground}
                >
                  <StyledSelectionBorder selected={usingHnsBackground}>
                    <StyledCustomBackgroundOptionImage image={hnsBackground} selected={usingHnsBackground}/>
                  </StyledSelectionBorder>
                  <StyledCustomBackgroundOptionLabel>
                    {getLocale('hnsBackgroundImageOptionTitle')}
                  </StyledCustomBackgroundOptionLabel>
                </StyledCustomBackgroundOption>
                <StyledCustomBackgroundOption
            ...
            {hnsRewardsSupported && !this.props.newTabData.rewardsState.isUnsupportedRegion && (
              <SettingsRow>
