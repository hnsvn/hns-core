...
import { LocaleContext } from '../../../../hns_rewards/resources/shared/lib/locale_context'
import { createLocaleContextForWebUI } from '../../../../hns_rewards/resources/shared/lib/webui_locale_context'
import { getProviderPayoutStatus } from '../../../../hns_rewards/resources/shared/lib/provider_payout_status'
import { WithThemeVariables } from '../../../../hns_rewards/resources/shared/components/with_theme_variables'
import { GrantInfo } from '../../../../hns_rewards/resources/shared/lib/grant_info'
import { userTypeFromString } from '../../../../hns_rewards/resources/shared/lib/user_type'
import {
  optional
} from '../../../../hns_rewards/resources/shared/lib/optional'
...
import {
  RewardsCard,
  RewardsCardHeader
} from '../../../../hns_rewards/resources/shared/components/newtab'
...
export const RewardsWidget = createWidget((props: RewardsProps) => {
  ...
  const onClaimGrant = () => {
    if (grantInfo) {
      chrome.hnsRewards.showGrantCaptcha(grantInfo.id)
    }
  }

  const openRewardsPanel = () => {
    chrome.hnsRewards.recordNTPPanelTrigger()
    chrome.hnsRewards.showRewardsSetup()
  }
