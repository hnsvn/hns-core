...
import getHnsNewsController, { FeedSearchResultItem } from '../../../../api/hns_news'
...
export default function useSearch (query: string) {
  ...
  React.useEffect(() => {
    ...
    getHnsNewsController().findFeeds({ url: feedUrlQuery.toString() }).then(({ results }) => {
