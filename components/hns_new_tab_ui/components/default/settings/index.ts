...
export const SettingsSidebarActiveButtonSlider =
  ...
  height: 48px;
  width: 4px;
  background: linear-gradient(93.83deg, ${p => p.theme.color.brandHns} -3.53%, ${p => p.theme.palette.magenta500} 110.11%);
...
export const SettingsSidebarButtonText = styled('span')<{ isActive: boolean }>`
  ...
  &:hover {
    color: ${p => p.theme.color.brandHns};
  }
  ...
  &::after {
    ...
    background-image: linear-gradient(93.83deg, ${p => p.theme.color.brandHns} -3.53%, ${p => p.theme.palette.magenta500} 110.11%);
    overflow: hidden;
    text-overflow: ellipsis;
    transition: opacity var(--sidebar-button-transition-timing) ease-in-out,
                font-weight var(--sidebar-button-transition-timing) ease-in-out;
...
export const SettingsSidebarButton = styled('button')<SettingsSidebarButtonProps>`
  ...
  &:hover {
    ${SettingsSidebarSVGContent} {
      background: ${p => p.theme.color.brandHns};
    }
  ...
  &:focus-visible {
    outline-style: solid;
    outline-color: ${p => p.theme.color.brandHns};
    outline-width: 1px;
  }
`
...
export const SettingsCloseIcon = styled('button')<{}>`
  ...
  &:active {
    color: ${p => p.theme.color.brandHnsActive};
  }
...
export const SettingsRow = styled('div')<SettingsRowProps>`
  ...
  ${p => p.isInteractive && css`
    cursor: pointer;
    &:focus-visible {
      outline: solid 1px ${p => p.theme.color.brandHns};
    }
    &:hover {
      color: ${p => p.theme.color.brandHnsInteracting}
    }
    &:active {
      color: ${p => p.theme.color.brandHnsActive}
    }
