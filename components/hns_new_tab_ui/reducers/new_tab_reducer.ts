  ...
  switch (action.type) {
    case types.NEW_TAB_SET_INITIAL_DATA:
      ...
      state = {
        ...
        hnsRewardsSupported: initialDataPayload.hnsRewardsSupported,
        hnsTalkSupported: initialDataPayload.hnsTalkSupported,
      ...
      if (state.brandedWallpaper && !state.brandedWallpaper.isSponsored) {
        ...
        state = {
          ...state,
          featureFlagHnsNTPSponsoredImagesWallpaper: false
        }
      }
    ...
    case types.BACKGROUND_UPDATED:
      ...
      // custom or hns default background. Branded wallpaper will
      ...
      if (!state.backgroundWallpaper && background?.hns) {
        state.backgroundWallpaper = {
          type: 'hns',
          author: background.hns.author,
          link: background.hns.link.url,
          wallpaperImageUrl: background.hns.imageUrl.url,
          random: false
        }
      }
