...
#include "hns/components/hns_shields/browser/ad_block_default_resource_provider.h"
...
#include "hns/components/hns_shields/browser/ad_block_filters_provider_manager.h"
#include "hns/components/hns_shields/browser/ad_block_localhost_filters_provider.h"
...
const char kAdBlockDefaultComponentName[] = "Hns Ad Block Updater";
...
const char kAdBlockExceptionComponentName[] =
    "Hns Ad Block First Party Filters";
...
// https://github.com/hnsvn/hns-core/pull/10994.
...
void CheckAdBlockExceptionComponentsUpdate() {
  base::SequencedTaskRunner::GetCurrentDefault()->PostDelayedTask(
      FROM_HERE, base::BindOnce([]() {
        HnsOnDemandUpdater::GetInstance()->OnDemandUpdate(
