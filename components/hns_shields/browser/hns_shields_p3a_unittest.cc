...
class HnsShieldsP3ATest : public testing::Test {
 public:
  void SetUp() override {
...
TEST_F(HnsShieldsP3ATest, RecordGlobalAdBlockSetting) {
...
TEST_F(HnsShieldsP3ATest, RecordGlobalFingerprintBlockSetting) {
  auto* map = HostContentSettingsMapFactory::GetForProfile(GetProfile());
...
TEST_F(HnsShieldsP3ATest, RecordDomainAdBlockCounts) {
  auto* map = HostContentSettingsMapFactory::GetForProfile(GetProfile());
  ...
  SetCosmeticFilteringControlType(map, ControlType::ALLOW,
                                  GURL("https://hns.com"), nullptr, prefs);
...
TEST_F(HnsShieldsP3ATest, RecordDomainFingerprintBlockCounts) {
  auto* map = HostContentSettingsMapFactory::GetForProfile(GetProfile());
  auto* prefs = GetProfile()->GetPrefs();
