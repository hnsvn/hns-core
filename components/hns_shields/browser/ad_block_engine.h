...
#ifndef HNS_COMPONENTS_HNS_SHIELDS_BROWSER_AD_BLOCK_ENGINE_H_
#define HNS_COMPONENTS_HNS_SHIELDS_BROWSER_AD_BLOCK_ENGINE_H_
...
class HnsAdBlockTPNetworkDelegateHelperTest;
...
class AdBlockEngine : public base::SupportsWeakPtr<AdBlockEngine> {
 ...
 private:
  ...
  friend class ::HnsAdBlockTPNetworkDelegateHelperTest;
...
#endif  // HNS_COMPONENTS_HNS_SHIELDS_BROWSER_AD_BLOCK_ENGINE_H_
