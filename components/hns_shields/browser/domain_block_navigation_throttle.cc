...
#include "hns/components/hns_shields/adblock/rs/src/lib.rs.h"
#include "hns/components/hns_shields/browser/ad_block_service.h"
#include "hns/components/hns_shields/browser/domain_block_controller_client.h"
#include "hns/components/hns_shields/browser/domain_block_page.h"
#include "hns/components/hns_shields/browser/domain_block_tab_storage.h"
...
std::pair<bool, std::string> ShouldBlockDomainOnTaskRunner(
  ...
  SCOPED_UMA_HISTOGRAM_TIMER("Hns.DomainBlock.ShouldBlock");
...
DomainBlockNavigationThrottle::WillStartRequest() {
  ...
  domain_blocking_type_ =
      hns_shields::GetDomainBlockingType(content_settings_, request_url);
  content::WebContents* web_contents = handle->GetWebContents();
  // Maybe don't block based on Hns Shields settings
  ...
  bool aggressive_mode =
      hns_shields::GetCosmeticFilteringControlType(
          content_settings_, request_url) == hns_shields::ControlType::BLOCK;
