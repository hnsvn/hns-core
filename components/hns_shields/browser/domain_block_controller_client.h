...
#ifndef HNS_COMPONENTS_HNS_SHIELDS_BROWSER_DOMAIN_BLOCK_CONTROLLER_CLIENT_H_
#define HNS_COMPONENTS_HNS_SHIELDS_BROWSER_DOMAIN_BLOCK_CONTROLLER_CLIENT_H_
...
#endif  // HNS_COMPONENTS_HNS_SHIELDS_BROWSER_DOMAIN_BLOCK_CONTROLLER_CLIENT_H_
