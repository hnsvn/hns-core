...
#ifndef HNS_COMPONENTS_HNS_SHIELDS_BROWSER_AD_BLOCK_PREF_SERVICE_H_
#define HNS_COMPONENTS_HNS_SHIELDS_BROWSER_AD_BLOCK_PREF_SERVICE_H_
...
#endif  // HNS_COMPONENTS_HNS_SHIELDS_BROWSER_AD_BLOCK_PREF_SERVICE_H_
