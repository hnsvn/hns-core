...
void AdBlockEngine::OnListSourceLoaded(const DATFileDataBuffer& filters,
  ...
  TRACE_EVENT_BEGIN2("hns.adblock", "MakeEngineWithRules", "size",
                     filters.size(), "is_default_engine", is_default_engine_);

  auto result = adblock::engine_with_rules(filters);

  TRACE_EVENT_END0("hns.adblock", "MakeEngineWithRules");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Hns.Adblock.MakeEngineWithRules.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Hns.Adblock.MakeEngineWithRules.Additional",
                            timer.Elapsed());
  }
...
void AdBlockEngine::OnDATLoaded(const DATFileDataBuffer& dat_buf,
  ...
  base::ElapsedTimer timer;
  TRACE_EVENT_BEGIN2("hns.adblock", "EngineDeserialize", "size",
  ...
  TRACE_EVENT_END0("hns.adblock", "EngineDeserialize");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Hns.Adblock.EngineDeserialize.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Hns.Adblock.EngineDeserialize.Additional",
                            timer.Elapsed());
  }
