...
class HTTPSEverywhereServiceTest : public ExtensionBrowserTest {
 public:
  ...
  void SetUp() override {
    feature_list_.InitAndDisableFeature(net::features::kHnsHttpsByDefault);
    SetUpCommon();
  }
  ...
  void PreRunTestOnMainThread() override {
    ...
    ASSERT_TRUE(
      g_hns_browser_process->https_everywhere_service()->IsInitialized());
  }
  ...
  void InitService() {
    hns_shields::HTTPSEverywhereService::SetIgnorePortForTest(true);
    hns_shields::SetHTTPSEverywhereComponentIdAndBase64PublicKeyForTest(
  ...
  bool InstallHTTPSEverywhereExtension() {
    ...
    g_hns_browser_process->https_everywhere_service()->InitDB(
  ...
  void WaitForHTTPSEverywhereServiceThread() {
    scoped_refptr<base::ThreadTestHelper> io_helper(new base::ThreadTestHelper(
        g_hns_browser_process->https_everywhere_service()->GetTaskRunner()));
  ...
  std::vector<std::unique_ptr<hns_shields::TestFiltersProvider>>
      source_providers_;
...
class HTTPSEverywhereServiceTest_HttpsByDefaultEnabled
 ...
 public:
  ...
  void SetUp() override {
    feature_list_.InitAndEnableFeature(net::features::kHnsHttpsByDefault);
...
IN_PROC_BROWSER_TEST_F(HTTPSEverywhereServiceTest_HttpsByDefaultEnabled,
  ...
  hns_shields::SetHttpsUpgradeControlType(
      settings_map, hns_shields::ControlType::ALLOW, GURL());
