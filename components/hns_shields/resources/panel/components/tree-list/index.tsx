    ...
    <S.Box>
        ...
        <>
          <ScriptsInfo>
            ...
            <span>{<a href="#" onClick={handleBlockAllScripts}>
                {getLocale('hnsShieldsBlockScriptsAll')}
              </a>
            }</span>
          </ScriptsInfo>
          <ScriptsList>
            {[...allowedScriptsByOrigin.keys()].map((origin, idx) => {
              return (<TreeNode
                ...
                permissionButtonTitle={getLocale('hnsShieldsBlockScript')}
              />)
            })}
          </ScriptsList>
        </>
        ...
        <ScriptsInfo>
          ...
          {props.allowedList && (<span>
            {<a href="#" onClick={handleAllowAllScripts}>
                {getLocale('hnsShieldsAllowScriptsAll')}
              </a>
            }</span>
          )}
        </ScriptsInfo>
        <ScriptsList>
          {[...blockedScriptsByOrigin.keys()].map((origin, idx) => {
            return (<TreeNode
              ...
              permissionButtonTitle={getLocale('hnsShieldsAllowScriptOnce')}
            />)
          })}
        </ScriptsList>
      </S.Scroller>
      <Footer>
        ...
        >
          ...
          <span>{getLocale('hnsShieldsStandalone')}</span>
        </Button>
      </Footer>
    </S.Box>
  )
