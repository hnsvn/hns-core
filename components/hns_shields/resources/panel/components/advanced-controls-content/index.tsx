...
const adBlockModeOptions = [
  { value: AdBlockMode.AGGRESSIVE, text: getLocale('hnsShieldsTrackersAndAdsBlockedAgg') },
  { value: AdBlockMode.STANDARD, text: getLocale('hnsShieldsTrackersAndAdsBlockedStd') },
  { value: AdBlockMode.ALLOW, text: getLocale('hnsShieldsTrackersAndAdsAllowAll') }
]

const cookieBlockModeOptions = [
  { value: CookieBlockMode.BLOCKED, text: getLocale('hnsShieldsCookiesBlockAll') },
  { value: CookieBlockMode.CROSS_SITE_BLOCKED, text: getLocale('hnsShieldsCrossCookiesBlocked') },
  { value: CookieBlockMode.ALLOW, text: getLocale('hnsShieldsCookiesAllowedAll') }
]

const fingerprintModeOptions = [
  { value: FingerprintMode.STRICT, text: getLocale('hnsShieldsFingerprintingBlockedAgg') },
  { value: FingerprintMode.STANDARD, text: getLocale('hnsShieldsFingerprintingBlockedStd') },
  { value: FingerprintMode.ALLOW, text: getLocale('hnsShieldsFingerprintingAllowAll') }
]

const httpsUpgradeModeOptions = [
  { value: HttpsUpgradeMode.STRICT, text: getLocale('hnsShieldsHttpsUpgradeModeStrict') },
  { value: HttpsUpgradeMode.STANDARD, text: getLocale('hnsShieldsHttpsUpgradeModeStandard') },
  { value: HttpsUpgradeMode.DISABLED, text: getLocale('hnsShieldsHttpsUpgradeModeDisabled') }
]
    ...
    <S.FooterActionBox>
      <div>
        ...
        >
          ...
          {getLocale('hnsShieldsCustomizeAdblockLists')}
        </button>
        <button
          ...
          {getLocale('hnsShieldsChangeDefaults')}
        </button>
      </div>
    </S.FooterActionBox>
  )
...
function AdvancedControlsContent () {
  ...
  return (
    <section
      ...
      aria-label={getLocale('hnsShieldsAdvancedCtrls')}
    >
      <S.SettingsBox>
        <S.ControlGroup>
          <div className="col-2">
            <Select
              ...
              ariaLabel={getLocale('hnsShieldsTrackersAndAds')}
              onChange={handleAdBlockModeChange}
              disabled={siteBlockInfo?.isHnsShieldsManaged}
            >
          ...
          <S.CountButton
            ...
            aria-label={getLocale('hnsShieldsTrackersAndAds')}
        ...
        {!isHttpsByDefaultEnabled && <S.ControlGroup>
          <label>
            <span>{getLocale('hnsShieldsConnectionsUpgraded')}</span>
            <Toggle
          ...
          <S.CountButton
            ...
            aria-label={getLocale('hnsShieldsConnectionsUpgraded')}
        ...
        {(isHttpsByDefaultEnabled && !isTorProfile) && <S.ControlGroup>
          <div className="col-2">
            <Select
              ...
              ariaLabel={getLocale('hnsShieldsHttpsUpgradeModeStandard')}
        ...
        <S.ControlGroup>
          <label>
            <span>{getLocale('hnsShieldsScriptsBlocked')}</span>
            <Toggle
              onChange={handleIsNoScriptEnabledChange}
              isOn={siteSettings?.isNoscriptEnabled}
              size='sm'
              accessibleLabel={getLocale('hnsShieldsScriptsBlockedEnable')}
              disabled={siteBlockInfo?.isHnsShieldsManaged}
            />
          </label>
          <S.CountButton
            title={jsListCount.toString()}
            aria-label={getLocale('hnsShieldsScriptsBlocked')}
        ...
        <S.ControlGroup>
          <div className="col-2">
            <Select
              ...
              ariaLabel={getLocale('hnsShieldsFingerprintingBlocked')}
        ...
        <S.ControlGroup>
          <div className="col-2">
            <Select
              ...
              ariaLabel={getLocale('hnsShieldsCookiesBlockAll')}
        ...
        {isForgetFirstPartyStorageEnabled && <S.ControlGroup>
          <label>
            <span>{getLocale('hnsShieldsForgetFirstPartyStorage')}</span>
            <Toggle
              onChange={handleForgetFirstPartyStorageEnabledChange}
              isOn={siteSettings?.isForgetFirstPartyStorageEnabled}
              size='sm'
              accessibleLabel={getLocale('hnsShieldsForgetFirstPartyStorage')}
              disabled={siteBlockInfo?.isHnsShieldsManaged}
            />
          </label>
        </S.ControlGroup>}
        <S.SettingsDesc>
          <p>*{getLocale('hnsShieldSettingsDescription')}</p>
        </S.SettingsDesc>
      </S.SettingsBox>
      <GlobalSettings />
  </section>
