...
#ifndef HNS_COMPONENTS_IPFS_IPFS_NAVIGATION_THROTTLE_H_
#define HNS_COMPONENTS_IPFS_IPFS_NAVIGATION_THROTTLE_H_
...
#endif  // HNS_COMPONENTS_IPFS_IPFS_NAVIGATION_THROTTLE_H_
