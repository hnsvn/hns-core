...
#ifndef HNS_COMPONENTS_IPFS_IPFS_TAB_HELPER_DELEGATE_H_
#define HNS_COMPONENTS_IPFS_IPFS_TAB_HELPER_DELEGATE_H_
...
#endif  // HNS_COMPONENTS_IPFS_IPFS_TAB_HELPER_DELEGATE_H_
