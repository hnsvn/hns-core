...
#ifndef HNS_COMPONENTS_IPFS_PIN_IPFS_BASE_PIN_SERVICE_H_
#define HNS_COMPONENTS_IPFS_PIN_IPFS_BASE_PIN_SERVICE_H_
...
#endif  // HNS_COMPONENTS_IPFS_PIN_IPFS_BASE_PIN_SERVICE_H_
