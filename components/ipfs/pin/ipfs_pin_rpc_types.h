...
#ifndef HNS_COMPONENTS_IPFS_PIN_IPFS_PIN_RPC_TYPES_H_
#define HNS_COMPONENTS_IPFS_PIN_IPFS_PIN_RPC_TYPES_H_
...
#endif  // HNS_COMPONENTS_IPFS_PIN_IPFS_PIN_RPC_TYPES_H_
