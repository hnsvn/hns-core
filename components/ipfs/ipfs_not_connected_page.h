...
#ifndef HNS_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
#define HNS_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
...
#endif  // HNS_COMPONENTS_IPFS_IPFS_NOT_CONNECTED_PAGE_H_
