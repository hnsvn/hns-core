...
#ifndef HNS_COMPONENTS_IPFS_IPFS_SERVICE_H_
#define HNS_COMPONENTS_IPFS_IPFS_SERVICE_H_
...
#include "hns/components/ipfs/ipfs_dns_resolver.h"
#include "hns/components/ipfs/ipfs_p3a.h"
...
class IpfsService : public KeyedService,
                    public HnsIpfsClientUpdater::Observer {
 public:
 ...
 private:
  ...
  raw_ptr<HnsIpfsClientUpdater> ipfs_client_updater_ = nullptr;
...
#endif  // HNS_COMPONENTS_IPFS_IPFS_SERVICE_H_
