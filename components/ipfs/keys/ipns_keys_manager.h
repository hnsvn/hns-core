...
#ifndef HNS_COMPONENTS_IPFS_KEYS_IPNS_KEYS_MANAGER_H_
#define HNS_COMPONENTS_IPFS_KEYS_IPNS_KEYS_MANAGER_H_
...
#endif  // HNS_COMPONENTS_IPFS_KEYS_IPNS_KEYS_MANAGER_H_
