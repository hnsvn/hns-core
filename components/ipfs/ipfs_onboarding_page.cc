...
#include "hns/components/ipfs/ipfs_onboarding_page.h"
...
void IPFSOnboardingPage::PopulateInterstitialStrings(
  ...
  load_time_data.Set("learnMore", hns_l10n::GetLocalizedResourceUTF16String(
  ...
  load_time_data.Set("footerText", hns_l10n::GetLocalizedResourceUTF16String(
                                       IDS_IPFS_ONBOARDING_FOOTER_TEXT));
  load_time_data.Set("settings", hns_l10n::GetLocalizedResourceUTF16String(
                                     IDS_IPFS_ONBOARDING_SETTINGS));
  load_time_data.Set("retryText", hns_l10n::GetLocalizedResourceUTF16String(
  ...
  std::u16string theme_type =
      ui::NativeTheme::GetInstanceForNativeUi()->ShouldUseDarkColors()
          ? u"dark"
          : u"light";
  load_time_data.Set("hnsTheme", theme_type);
  load_time_data.Set("os", "");
#else
  load_time_data.Set("hnsTheme", "light");
