...
#ifndef HNS_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
#define HNS_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
...
#endif  // HNS_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
