...
#ifndef HNS_COMPONENTS_IPFS_IMPORT_IPFS_IMPORT_WORKER_BASE_H_
#define HNS_COMPONENTS_IPFS_IMPORT_IPFS_IMPORT_WORKER_BASE_H_
...
#endif  // HNS_COMPONENTS_IPFS_IMPORT_IPFS_IMPORT_WORKER_BASE_H_
