...
#ifndef HNS_COMPONENTS_HNS_SYNC_NETWORK_TIME_HELPER_H_
#define HNS_COMPONENTS_HNS_SYNC_NETWORK_TIME_HELPER_H_
...
#endif  // HNS_COMPONENTS_HNS_SYNC_NETWORK_TIME_HELPER_H_
