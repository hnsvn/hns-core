...
#ifndef HNS_COMPONENTS_HNS_SYNC_TIME_LIMITED_WORDS_H_
#define HNS_COMPONENTS_HNS_SYNC_TIME_LIMITED_WORDS_H_
...
#endif  // HNS_COMPONENTS_HNS_SYNC_TIME_LIMITED_WORDS_H_
