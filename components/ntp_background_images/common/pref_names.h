...
#ifndef HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_COMMON_PREF_NAMES_H_
#define HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_COMMON_PREF_NAMES_H_
...
#endif  // HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_COMMON_PREF_NAMES_H_
