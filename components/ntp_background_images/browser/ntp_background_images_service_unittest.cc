...
constexpr char kTestSponsoredImages[] = R"(
    {
        ...
        "logo": {
          ...
          "destinationUrl": "https://www.hns.com/",
...
TEST_F(NTPBackgroundImagesServiceTest, InternalDataTest) {
  ...
  EXPECT_EQ("Hns Software", bi_data->backgrounds[0].author);
  EXPECT_EQ("https://hns.com/", bi_data->backgrounds[0].link);
  EXPECT_TRUE(observer.on_bi_updated_);
