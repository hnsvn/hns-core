...
#ifndef HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_VIEW_COUNTER_SERVICE_H_
#define HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_VIEW_COUNTER_SERVICE_H_
...
class ViewCounterService : public KeyedService,
 ...
 private:
  // Sync with themeValues in hns_appearance_page.js
  enum ThemesOption {
    DEFAULT,
    SUPER_REFERRAL,
  };
  ...
  raw_ptr<HnsNTPCustomBackgroundService> custom_bi_service_ = nullptr;
...
#endif  // HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_VIEW_COUNTER_SERVICE_H_
