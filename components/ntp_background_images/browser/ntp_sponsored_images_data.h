...
#ifndef HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_SPONSORED_IMAGES_DATA_H_
#define HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_SPONSORED_IMAGES_DATA_H_
...
struct NTPSponsoredImagesData {
  ...
  absl::optional<base::Value::Dict> GetBackgroundByAdInfo(
      const hns_ads::NewTabPageAdInfo& ad_info);
...
#endif  // HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_SPONSORED_IMAGES_DATA_H_
