...
#ifndef HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_SWITCHES_H_
#define HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_SWITCHES_H_
...
#endif  // HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_SWITCHES_H_
