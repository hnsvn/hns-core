...
#ifndef HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_CUSTOM_IMAGES_SOURCE_H_
#define HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_CUSTOM_IMAGES_SOURCE_H_
...
class NTPCustomImagesSource : public content::URLDataSource {
 public:
  explicit NTPCustomImagesSource(HnsNTPCustomBackgroundService* service);
 ...
 private:
  ...
  raw_ptr<HnsNTPCustomBackgroundService> service_ = nullptr;  // not owned
  base::WeakPtrFactory<NTPCustomImagesSource> weak_factory_;
};

}  // namespace ntp_background_images

#endif  // HNS_COMPONENTS_NTP_BACKGROUND_IMAGES_BROWSER_NTP_CUSTOM_IMAGES_SOURCE_H_
