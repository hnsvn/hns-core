...
// to hns_webtorrent2.html and have that rewrite the URL to
// hns_webtorrent.html
if (window.location.pathname === '/extension/hns_webtorrent2.html') {
  window.location.href =
    window.location.href.replace('hns_webtorrent2.html', 'hns_webtorrent.html')
}
