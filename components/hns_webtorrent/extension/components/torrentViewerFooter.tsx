...
export default function TorrentViewerFooter ({ torrent }: Props) {
  return torrent
      ? <Anchor
        ...
        target='_blank' />
      : <FooterNotice>
          <b>Privacy Warning:</b> When you click "Start Torrent" Hns will begin
          ...
          <br /><br />
          The WebTorrent extension can be disabled from Hns settings.
    </FooterNotice>
}
