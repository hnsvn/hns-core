...
#ifndef HNS_COMPONENTS_HNS_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
#define HNS_COMPONENTS_HNS_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
...
static GURL TranslateMagnetURL(const GURL& url) {
  GURL extension_page_url(
      base::StrCat({extensions::kExtensionScheme, "://",
        ...
        "/extension/hns_webtorrent.html?%s"}));
...
static bool HandleTorrentURLReverseRewrite(GURL* url,
  ...
  if (url->SchemeIs(extensions::kExtensionScheme) &&
      url->host() == hns_webtorrent_extension_id &&
      url->ExtractFileName() == "hns_webtorrent.html" &&
...
#endif  // HNS_COMPONENTS_HNS_WEBTORRENT_BROWSER_CONTENT_BROWSER_CLIENT_HELPER_H_
