...
#ifndef HNS_COMPONENTS_HNS_WEBTORRENT_BROWSER_WEBTORRENT_UTIL_H_
#define HNS_COMPONENTS_HNS_WEBTORRENT_BROWSER_WEBTORRENT_UTIL_H_
...
#endif  // HNS_COMPONENTS_HNS_WEBTORRENT_BROWSER_WEBTORRENT_UTIL_H_
