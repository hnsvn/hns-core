...
// HnsSearchProviderTest -----------------------------------------------------

class HnsSearchProviderTest : public testing::Test {
 public:
  HnsSearchProviderTest() {
  ...
  HnsSearchProviderTest(const HnsSearchProviderTest&) = delete;
  HnsSearchProviderTest& operator=(const HnsSearchProviderTest&) = delete;
  ...
  void SetUp() override {
    ...
    provider_ =
        base::MakeRefCounted<HnsSearchProvider>(client_.get(), nullptr);
  }
 ...
 protected:
  ...
  scoped_refptr<HnsSearchProvider> provider_;
...
TEST_F(HnsSearchProviderTest, SearchIncludesHistoryWhenHistoryEnabled) {
