...
class HnsHistoryURLProviderTest : public testing::Test,
                                    public AutocompleteProviderListener {
 public:
  HnsHistoryURLProviderTest() { HistoryQuickProvider::set_disabled(true); }

  ~HnsHistoryURLProviderTest() override {
    HistoryQuickProvider::set_disabled(false);
  }

  HnsHistoryURLProviderTest(const HnsHistoryURLProviderTest&) = delete;
  HnsHistoryURLProviderTest& operator=(const HnsHistoryURLProviderTest&) =
      delete;
 ...
 protected:
  ...
  [[nodiscard]] bool SetUpImpl(bool create_history_db) {
    ...
    if (!client_->GetHistoryService())
      return false;
    autocomplete_ =
        base::MakeRefCounted<HnsHistoryURLProvider>(client_.get(), this);
  ...
  scoped_refptr<HnsHistoryURLProvider> autocomplete_;
};

TEST_F(HnsHistoryURLProviderTest, NoResultsWhenHistoryDisabled) {
...
TEST_F(HnsHistoryURLProviderTest, ResultsWhenHistorySuggestionsEnabled) {
...
TEST_F(HnsHistoryURLProviderTest, URLResultsWhenHistoryDisabled) {
  client_->GetPrefs()->SetBoolean(omnibox::kHistorySuggestionsEnabled, false);
