...
#ifndef HNS_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_ACTION_H_
#define HNS_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_ACTION_H_
...
#endif  // HNS_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_ACTION_H_
