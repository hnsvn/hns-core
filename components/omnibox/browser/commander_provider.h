...
#ifndef HNS_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_PROVIDER_H_
#define HNS_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_PROVIDER_H_
...
#endif  // HNS_COMPONENTS_OMNIBOX_BROWSER_COMMANDER_PROVIDER_H_
