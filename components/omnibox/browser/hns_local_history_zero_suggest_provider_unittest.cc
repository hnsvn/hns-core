...
class HnsLocalHistoryZeroSuggestProviderTest
    : public testing::Test,
      public AutocompleteProviderListener {
 public:
  HnsLocalHistoryZeroSuggestProviderTest() {}

  ~HnsLocalHistoryZeroSuggestProviderTest() override {}

  HnsLocalHistoryZeroSuggestProviderTest(
      const HnsLocalHistoryZeroSuggestProviderTest&) = delete;
  HnsLocalHistoryZeroSuggestProviderTest& operator=(
      const HnsLocalHistoryZeroSuggestProviderTest&) = delete;
 ...
 protected:
  ...
  void SetUp() override {
    ...
    autocomplete_ = base::WrapRefCounted(
        HnsLocalHistoryZeroSuggestProvider::Create(client_.get(), this));
  ...
  scoped_refptr<HnsLocalHistoryZeroSuggestProvider> autocomplete_;
};

TEST_F(HnsLocalHistoryZeroSuggestProviderTest, NoResultsWhenHistoryDisabled) {
...
TEST_F(HnsLocalHistoryZeroSuggestProviderTest,
