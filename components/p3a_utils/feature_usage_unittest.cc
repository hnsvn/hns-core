...
constexpr char kFirstUsagePrefName[] = "hns.feature_usage.first_use";
constexpr char kLastUsagePrefName[] = "hns.feature_usage.last_use";
constexpr char kUsedSecondDayPrefName[] = "hns.feature_usage.used_second_day";
constexpr char kDaysInMonthPrefName[] = "hns.feature_usage.days_in_month";
constexpr char kDaysInWeekPrefName[] = "hns.feature_usage.days_in_week";

constexpr char kNewUserReturningHistogramName[] =
    "Hns.Feature.NewUserReturning";
constexpr char kDaysInMonthHistogramName[] = "Hns.Feature.DaysInMonth";
constexpr char kDaysInWeekHistogramName[] = "Hns.Feature.DaysInWeek";
constexpr char kLastUsageTimeHistogramName[] = "Hns.Feature.LastUsageTime";
