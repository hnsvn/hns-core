...
public class HnsPrivacySettingsTest {
    ...
    private static final int HNS_PRIVACY_SETTINGS_NUMBER_OF_ITEMS = 29;
    ...
    @Rule
    public SettingsActivityTestRule<HnsPrivacySettings> mSettingsActivityTestRule =
            new SettingsActivityTestRule<>(HnsPrivacySettings.class);
    private HnsPrivacySettings mFragment;

    @Before
    public void setUp() {
        mSettingsActivityTestRule.startSettingsActivity();
        mFragment = (HnsPrivacySettings) mSettingsActivityTestRule.getFragment();
    ...
    public void testParentItems() {
        ...
        assertEquals(HNS_PRIVACY_SETTINGS_NUMBER_OF_ITEMS, mItemsLeft);
    }
