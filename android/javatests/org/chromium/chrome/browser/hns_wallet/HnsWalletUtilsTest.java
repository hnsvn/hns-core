...
package org.chromium.chrome.browser.hns_wallet;
...
import org.chromium.hns_wallet.mojom.GasEstimation1559;
import org.chromium.hns_wallet.mojom.NetworkInfo;
import org.chromium.hns_wallet.mojom.SwapParams;
import org.chromium.hns_wallet.mojom.TxData;
import org.chromium.hns_wallet.mojom.TxData1559;
...
public class HnsWalletUtilsTest {
    @Test
    @SmallTest
    ...
    public void isJSONValidTest() {
        assertEquals(Utils.isJSONValid("{'name': 'hns'}"), true);
        assertEquals(Utils.isJSONValid("'name': 'hns'"), false);
    }

    @Test
    @SmallTest
    public void getContractAddressTest() {
        assertEquals(Utils.getContractAddress(HnsWalletConstants.GOERLI_CHAIN_ID, "USDC",
                             "0xdef1c0ded9bec7f1a1670819833240f027b25eff"),
                "0x2f3a40a3db8a7e3d09b0adfefbce4f6f81927557");
        assertEquals(Utils.getContractAddress(HnsWalletConstants.GOERLI_CHAIN_ID, "DAI",
                             "0xdef1c0ded9bec7f1a1670819833240f027b25eff"),
                "0x73967c6a0904aa032c103b4104747e88c566b1a2");
        assertEquals(Utils.getContractAddress(HnsWalletConstants.GOERLI_CHAIN_ID, "BAT",
                             "0xdef1c0ded9bec7f1a1670819833240f027b25eff"),
                "0xdef1c0ded9bec7f1a1670819833240f027b25eff");
        assertEquals(Utils.getContractAddress(HnsWalletConstants.SEPOLIA_CHAIN_ID, "USDC",
                             "0xdef1c0ded9bec7f1a1670819833240f027b25eff"),
                "0xdef1c0ded9bec7f1a1670819833240f027b25eff");
    }
    ...
    public void validateBlockchainTokenTest() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new BlockchainToken\"' inside src/hns).\n"
    ...
    public void validateSwapParamsTest() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new SwapParams\"' inside src/hns).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateTxDataTest() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new TxData\"' inside src/hns).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateGasEstimation1559Test() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new GasEstimation1559\"' inside src/hns).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateTxData1559Test() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new TxData1559\"' inside src/hns).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
    ...
    public void validateNetworkInfoTest() {
        ...
        try {
            ...
            String message = "Check that a variable with a type in the exception below is\n"
                    ...
                    + "created('git grep \"new NetworkInfo\"' inside src/hns).\n"
                    + "Initialisation of it could be safely added to the test to pass it,\n"
                    + "but only after all places where it's created are fixed.\n";
            fail(message + "\n" + getStackTrace(exc));
        }
