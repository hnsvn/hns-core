...
public class HnsReflectionUtil {
    private static String TAG = "HnsReflectionUtil";

    // NOTE: For each method for invocation add appropriate test to `testMethodsForInvocationExist`
    // method in 'hns/android/javatests/org/chromium/chrome/browser/BytecodeTest.java' file with
