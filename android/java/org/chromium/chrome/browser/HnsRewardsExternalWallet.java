...
public class HnsRewardsExternalWallet {
    //fields
    ...
    public HnsRewardsExternalWallet(String json_external_wallet) throws JSONException {
    ...
    public String toString() {
        return "HnsRewardsExternalWallet{"
    ...
    public static String WalletStatusToString(int status) {
        ...
        switch (status){
            ...
            case WalletStatus.CONNECTED:
                value = context.getResources().getString(R.string.hns_ui_wallet_button_connected);
                break;
            case WalletStatus.LOGGED_OUT:
                value = context.getResources().getString(
                        R.string.hns_ui_wallet_button_logged_out);
                break;
            default:
                break;
        }
