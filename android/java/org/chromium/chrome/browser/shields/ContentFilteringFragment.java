...
import org.chromium.chrome.browser.settings.HnsSettingsActivity;
...
public class ContentFilteringFragment extends HnsPreferenceFragment
        implements FragmentSettingsLauncher, HnsContentFilteringListener, ConnectionErrorHandler {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        mAddCustomFilterResultLauncher = registerForActivityResult(
                ...
                ((HnsSettingsActivity) requireActivity()).getActivityResultRegistry(), result -> {
