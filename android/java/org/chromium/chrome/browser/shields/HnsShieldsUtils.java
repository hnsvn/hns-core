...
public class HnsShieldsUtils {
    ...
    public interface HnsShieldsCallback {
        void hnsShieldsSubmitted();
    }
        ...
        public static class HnsShieldsWorkerTask extends AsyncTask<Void> {
            private String mDomain;
            private String mApiKey;

            public HnsShieldsWorkerTask(String domain, String apiKey) {
                mDomain = domain;
                mApiKey = apiKey;
            }
            ...
            protected Void doInBackground() {
                sendHnsShieldsFeedback(mDomain, mApiKey);
                return null;
            }
        ...
        private static void sendHnsShieldsFeedback(String domain, String apiKey) {
            assert HnsConfig.WEBCOMPAT_REPORT_ENDPOINT != null
                    && !HnsConfig.WEBCOMPAT_REPORT_ENDPOINT.isEmpty();
            ...
            try {
                URL url = new URL(HnsConfig.WEBCOMPAT_REPORT_ENDPOINT);
