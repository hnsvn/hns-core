...
import org.chromium.hns_shields.mojom.SubscriptionInfo;
...
public class ContentFilteringAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private HnsContentFilteringListener mHnsContentFileringListener;
    ...
    public ContentFilteringAdapter(
            Context context, HnsContentFilteringListener hnsContentFileringListener) {
        mContext = context;
        mHnsContentFileringListener = hnsContentFileringListener;
    }
        ...
        if (holder instanceof FilterListHeaderViewHolder) {
            ...
            if (holder.getAdapterPosition() == mCustomFilterLists.size() + ONE_ITEM_SPACE) {
                ...
                customFilterListViewHolder.toggleSwitch.setOnClickListener(view -> {
                    ...
                    mHnsContentFileringListener.onCustomFilterToggle(
                ...
                customFilterListViewHolder.deleteImageView.setOnClickListener(view -> {
                    if (mIsEdit) {
                        mHnsContentFileringListener.onCustomFilterDelete(
            ...
            customFilterListViewHolder.itemView.setOnClickListener(view -> {
                if (holder.getAdapterPosition() == mCustomFilterLists.size() + ONE_ITEM_SPACE) {
                    mHnsContentFileringListener.onAddCustomFiltering();
                }
            });
            ...
            if (filterPosition < mFilterLists.length) {
                ...
                filterListViewHolder.toggleSwitch.setOnClickListener(view -> {
                    ...
                    mHnsContentFileringListener.onDefaultFilterToggle(uuid, !isEnabled);
                });
            }
        }
    }
