...
public class HnsWebrtcPolicyPreference
    ...
    protected static final String FALLBACK_SUPPORT_URL =
            "https://support.hns.com/hc/en-us/articles/360017989132-How-do-I-change-my-Privacy-Settings-#webrtc";

    @SuppressLint("WrongConstant")
    public HnsWebrtcPolicyPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        setLayoutResource(R.layout.hns_webrtc_policy_preference);
