...
public class BackgroundImagesPreferences
        extends HnsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public static final String PREF_SHOW_HNS_STATS = "show_hns_stats";
    ...
    private ChromeSwitchPreference mShowHnsStatsPref;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mShowSponsoredImagesPref != null) {
            ...
            mShowSponsoredImagesPref.setChecked(
                    UserPrefs.get(Profile.getLastUsedRegularProfile())
                            .getBoolean(
                                    HnsPref.NEW_TAB_PAGE_SHOW_SPONSORED_IMAGES_BACKGROUND_IMAGE));
        ...
        mShowHnsStatsPref = (ChromeSwitchPreference) findPreference(PREF_SHOW_HNS_STATS);
        if (mShowHnsStatsPref != null) {
            mShowHnsStatsPref.setEnabled(true);
            mShowHnsStatsPref.setChecked(
                    ContextUtils.getAppSharedPreferences().getBoolean(PREF_SHOW_HNS_STATS, true));
            mShowHnsStatsPref.setOnPreferenceChangeListener(this);
        }
    }
    ...
    public static void setOnPreferenceValue(String preferenceName, boolean newValue) {
        if (PREF_SHOW_BACKGROUND_IMAGES.equals(preferenceName)) {
            UserPrefs.get(Profile.getLastUsedRegularProfile()).setBoolean(HnsPref.NEW_TAB_PAGE_SHOW_BACKGROUND_IMAGE, newValue);
        } else if (PREF_SHOW_SPONSORED_IMAGES.equals(preferenceName)) {
            UserPrefs.get(Profile.getLastUsedRegularProfile()).setBoolean(HnsPref.NEW_TAB_PAGE_SHOW_SPONSORED_IMAGES_BACKGROUND_IMAGE, (boolean)newValue);
        } else {
