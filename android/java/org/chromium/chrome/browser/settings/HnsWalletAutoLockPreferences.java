...
public class HnsWalletAutoLockPreferences
        extends Preference implements Preference.OnPreferenceClickListener, ConnectionErrorHandler {
    private String TAG = "HnsWalletAutoLockPreferences";

    public static final int WALLET_AUTOLOCK_DEFAULT_TIME = 5;

    private KeyringService mKeyringService;

    public HnsWalletAutoLockPreferences(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void showHnsWalletAutoLockDialog() {
        LayoutInflater inflater =
                (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.hns_wallet_autolock_layout, null);
        final EditText input = (EditText) view.findViewById(R.id.hns_wallet_autolock_edittext);
        ...
        AlertDialog alertDialog =
                alert.setTitle(R.string.hns_wallet_settings_autolock_option)
                        .setView(view)
