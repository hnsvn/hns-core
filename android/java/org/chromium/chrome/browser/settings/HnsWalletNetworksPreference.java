...
public class HnsWalletNetworksPreference extends Preference
        implements ConnectionErrorHandler, NetworkListBaseAdapter.ItemClickListener,
                   HnsWalletAddNetworksFragment.Refresher {
    ...
    private HnsWalletAddNetworksFragment.Launcher mLauncher;
    private JsonRpcService mJsonRpcService;

    public HnsWalletNetworksPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void registerActivityLauncher(HnsWalletAddNetworksFragment.Launcher launcher) {
        mLauncher = launcher;
    }
