...
public class HnsWalletPreferences
        extends HnsPreferenceFragment implements ConnectionErrorHandler {
    private static final String TAG = "WalletPreferences";
    private static final String PREF_HNS_WALLET_AUTOLOCK = "pref_hns_wallet_autolock";
    private static final String PREF_HNS_WALLET_RESET = "pref_hns_wallet_reset";
    private static final String HNS_WALLET_WEB3_NOTIFICATION_SWITCH = "web3_notifications_switch";
    private static final String HNS_WALLET_WEB3_NFT_DISCOVERY_SWITCH =
            "nft_auto_discovery_switch";
    private static final String HNS_WALLET_WEB3_NFT_DISCOVERY_LEARN_MORE =
            "nft_auto_discovery_learn_more";
    // A global preference, default state is on
    public static final String PREF_HNS_WALLET_WEB3_NOTIFICATIONS =
            "pref_hns_wallet_web3_notifications";

    private HnsWalletAutoLockPreferences mPrefAutolock;
    ...
    public static boolean getPrefWeb3NotificationsEnabled() {
        ...
        return sharedPreferences.getBoolean(PREF_HNS_WALLET_WEB3_NOTIFICATIONS, true);
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPrefAutolock = (HnsWalletAutoLockPreferences) findPreference(PREF_HNS_WALLET_AUTOLOCK);
        mWeb3NotificationsSwitch =
                (ChromeSwitchPreference) findPreference(HNS_WALLET_WEB3_NOTIFICATION_SWITCH);
    ...
    private void setUpNftDiscoveryPreference() {
        ...
        mWeb3NftDiscoverySwitch =
                (ChromeSwitchPreference) findPreference(HNS_WALLET_WEB3_NFT_DISCOVERY_SWITCH);
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        getActivity().setTitle(R.string.hns_ui_hns_wallet);
        SettingsUtils.addPreferencesFromResource(this, R.xml.hns_wallet_preferences);
    }
    ...
    public void setPrefWeb3NotificationsEnabled(boolean enabled) {
        ...
        sharedPreferencesEditor.putBoolean(PREF_HNS_WALLET_WEB3_NOTIFICATIONS, enabled);
