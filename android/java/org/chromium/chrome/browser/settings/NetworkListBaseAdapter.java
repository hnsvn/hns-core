...
public class NetworkListBaseAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View row = LayoutInflater.from(viewGroup.getContext())
                           .inflate(R.layout.hns_wallet_network_item, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        menuItems.add(buildMenuListItem(R.string.hns_wallet_add_network_set_as_active, 0, 0));
        ...
        ListMenu.Delegate delegate = (model) -> {
            ...
            } else if (textId == R.string.hns_wallet_add_network_set_as_active) {
