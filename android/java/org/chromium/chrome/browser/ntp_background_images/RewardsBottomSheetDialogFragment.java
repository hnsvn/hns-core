...
public class RewardsBottomSheetDialogFragment extends BottomSheetDialogFragment {
    ...
    private static final String HNS_TERMS_PAGE = "https://basicattentiontoken.org/user-terms-of-service/";
    private static final String HNS_REWARDS_LEARN_MORE = "https://hns.com/faq-rewards";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (learnMoreText != null) {
            learnMoreText.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    TabUtils.openUrlInSameTab(HNS_REWARDS_LEARN_MORE);
                    dismiss();
                }
            });
        }
        ...
        case SponsoredImageUtil.BR_ON_ADS_OFF:
            ...
            ForegroundColorSpan brOffForegroundSpan = new ForegroundColorSpan(getResources().getColor(R.color.hns_theme_color));
    ...
    private void reloadTab() {
        ChromeTabbedActivity chromeTabbedActivity = HnsRewardsHelper.getChromeTabbedActivity();
