...
public class HnsPlaylistSaveMediaFragment
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        ...
        SettingsUtils.addPreferencesFromResource(this, R.xml.hns_playlist_save_media_preference);
        ...
        RadioButtonGroupPlaylistAutoSavePreference radioButtonGroupPlaylistAutoSavePreference =
                (RadioButtonGroupPlaylistAutoSavePreference) findPreference(
                        HnsPlaylistPreferences.PREF_AUTO_SAVE_MEDIA_FOR_OFFLINE);
                ...
                (preference, newValue) -> {
                    ...
                    if (mPlaylistService != null) {
                        SharedPreferencesManager.getInstance().writeInt(
                                HnsPlaylistPreferences.PREF_AUTO_SAVE_MEDIA_FOR_OFFLINE, method);
                    }
                    return true;
                });
    }
