...
public class HnsPlaylistPreferences extends HnsPreferenceFragment
    ...
    private HnsPlaylistResetPreference mResetPlaylist;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mResetPlaylist = (HnsPlaylistResetPreference) findPreference(PREF_RESET_PLAYLIST);
            ...
            if (mPlaylistService != null) {
                PostTask.postTask(TaskTraits.USER_VISIBLE_MAY_BLOCK, () -> {
                    ...
                    getActivity().runOnUiThread(
                            (Runnable) () -> HnsRelaunchUtils.askForRelaunch(getActivity()));
                });
            }
            return true;
        });
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        getActivity().setTitle(R.string.hns_playlist);
        SettingsUtils.addPreferencesFromResource(this, R.xml.hns_playlist_preferences);
        initPlaylistService();
    }
