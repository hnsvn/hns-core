...
public class HnsNewsBottomSheetDialogFragment extends BottomSheetDialogFragment {
    private String mUrl;
    ...
    public static HnsNewsBottomSheetDialogFragment newInstance() {
        return new HnsNewsBottomSheetDialogFragment();
    }

    public void setController(HnsNewsController controller) {
        mHnsNewsController = controller;
    }
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.hns_news_card_menu, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        disableText.append(
                getResources().getString(R.string.hns_news_disable_content, mPublisherName));
            ...
            public void onClick(View v) {
                PostTask.postTask(TaskTraits.BEST_EFFORT, () -> {
                    if (mHnsNewsController != null) {
                        ...
                        mHnsNewsController.setPublisherPref(mPublisherId, UserEnabled.DISABLED);
                        HnsNewsUtils.disableFollowingPublisherList(mPublisherId);
                ...
                Toast.makeText(mContext,
                             getResources().getString(
                                     R.string.hns_news_disabled_content, mPublisherName),
                             Toast.LENGTH_SHORT)
                        .show();
            }
        });
