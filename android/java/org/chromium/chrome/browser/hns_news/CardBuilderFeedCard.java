...
import org.chromium.hns_news.mojom.Deal;
...
import org.chromium.hns_news.mojom.PromotedArticle;
...
public class CardBuilderFeedCard {
    ...
    public static final int CARDTYPE_HNS_RATING = 100;
    ...
    private final String HNS_OFFERS_URL = "offers.hns.com";

    public CardBuilderFeedCard(HnsNewsController hnsNewsController, RequestManager glide,
    ...
    private void createdDisplayAdCard(DisplayAd adData) {
        ...
        if (adData != null) {
            ...
            adImage.setContentDescription(mActivity.getResources().getText(R.string.hns_news_ad));
            ...
            adLogo.setText(R.string.hns_news_ad);
            ...
            adLogo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    openUrlInSameTabAndSavePosition(HnsActivity.HNS_REWARDS_SETTINGS_URL);
                }
            });
            ...
            switch (type) {
                                ...
                                if (tab != null) {
                                    ...
                                    handler.post(() -> {
                                        if (posTabAd != null) {
                                            ...
                                            mHnsNewsController.getDisplayAd(adData -> {
                                                HnsNewsUtils.putToDisplayAdsMap(position, adData);
                ...
                case CardType.DEALS:
                    ...
                    moreOffersText.setText(mActivity.getResources().getString(
                            R.string.hns_news_more_offers_title));
                    ...
                    moreOffersLayout.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            openUrlInSameTabAndSavePosition(HNS_OFFERS_URL);
                        }
                    });
                ...
                case CardType.CATEGORY_GROUP: // TOP_NEWS:
                    ...
                    mLinearLayout.setBackground(
                            makeRound(CARD_LAYOUT, R.color.card_background, 30));
                    break;
                case CARDTYPE_HNS_RATING:
                    showHnsNewsRatingUI(mLinearLayout, linearLayoutParams);
                    break;
    ...
    private void showHnsNewsRatingUI(
        ...
        View view = LayoutInflater.from(ContextUtils.getApplicationContext())
                            .inflate(R.layout.hns_rating_news_layout, null);
        view.setOnClickListener((v) -> { showHnsRateDialog(); });
    ...
    private void showHnsRateDialog() {
        if (mActivity != null && mActivity instanceof ChromeActivity) {
            HnsRateDialogFragment mRateDialogFragment = new HnsRateDialogFragment();
            mRateDialogFragment.show(((ChromeActivity) mActivity).getSupportFragmentManager(),
                    "HnsRateDialogFragment");
        }
    }
    ...
    private void openUrlInSameTabAndSavePosition(String myUrl) {
        try {
            SharedPreferencesManager.getInstance().writeInt(
                    Integer.toString(HnsActivity.getHnsActivity().getActivityTab().getId()),
                    mPosition);
    ...
    private void openUrlAndSaveEvent(DisplayAd adData) {
        if (mHnsNewsController != null) {
            mHnsNewsController.onDisplayAdVisit(adData.uuid, adData.creativeInstanceId);
    ...
    private void addElementsToSingleLayout(ViewGroup view, int index, int itemType) {
        ...
        try {
                ...
                case CardType.PROMOTED_ARTICLE:
                    ...
                    StringBuilder promotedTitle = new StringBuilder(" "
                            + mActivity.getResources().getString(
                                    R.string.hns_news_promoted_title));
                    promoted.setText(
                            mActivity.getResources().getString(R.string.hns_news_promoted_title));
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // @TODO alex refactor this with listener in HnsNewTabPageLayout
    ...
    private void showBottomSheetDialog(String urlString, String publisherId, String publisherName) {
        HnsNewsBottomSheetDialogFragment bottomSheetDialog =
                HnsNewsBottomSheetDialogFragment.newInstance();
        ...
        bottomSheetDialog.setController(mHnsNewsController);

        bottomSheetDialog.show(((ChromeActivity) mActivity).getSupportFragmentManager(),
                "hns_news_bottom_sheet_dialog_fragment");
    }
    ...
    private void setDisplayAdImage(ImageView imageView, Image adDataImage, int index) {
        ...
        if (mHnsNewsController != null) {
            mHnsNewsController.getImageData(adImageUrl, imageData -> {
                if (imageData != null) {
                    Bitmap decodedByte =
    ...
    private void setImage(ImageView imageView, String type, int index) {
        ...
        if (feedItemsCard != null) {
            ...
            if (mHnsNewsController != null) {
                mHnsNewsController.getImageData(itemImageUrl, imageData -> {
                    if (imageData != null) {
