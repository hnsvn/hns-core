...
import org.chromium.chrome.browser.crypto_wallet.observers.HnsWalletServiceObserverImpl;
import org.chromium.chrome.browser.crypto_wallet.observers.HnsWalletServiceObserverImpl.HnsWalletServiceObserverImplDelegate;
...
public class PortfolioModel implements HnsWalletServiceObserverImplDelegate {
    ...
    public void discoverAssetsOnAllSupportedChains() {
        if (mHnsWalletService == null) return;
        _mIsDiscoveringUserAssets.postValue(true);
        mHnsWalletService.discoverAssetsOnAllSupportedChains();
    }
     ...
     * @param hnsWalletBaseActivity instance for native services
    ...
    public void fetchNfts(@NonNull final Fragment fragment, List<NetworkInfo> selectedNetworks,
            HnsWalletBaseActivity hnsWalletBaseActivity,
                ...
                mJsonRpcService, mSharedData.getSupportedCryptoCoins(), allNetworks -> {
                    ...
                    mKeyringService.getAllAccounts(allAccounts -> {
                        ...
                        mPortfolioHelper = new PortfolioHelper(
                                hnsWalletBaseActivity, mAllNetworkInfos, filteredAccounts);
    ...
    private void addServiceObservers() {
        if (mHnsWalletService != null) {
            HnsWalletServiceObserverImpl walletServiceObserver =
                    new HnsWalletServiceObserverImpl(this);
            mHnsWalletService.addObserver(walletServiceObserver);
        }
    }
