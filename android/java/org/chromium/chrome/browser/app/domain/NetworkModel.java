...
import org.chromium.hns_wallet.mojom.JsonRpcServiceObserver;
...
public class NetworkModel implements JsonRpcServiceObserver {
    ...
    public NetworkModel(HnsWalletService hnsWalletService, JsonRpcService jsonRpcService,
        ...
        _mChainId.setValue(HnsWalletConstants.MAINNET_CHAIN_ID);
        mChainId = _mChainId;
    ...
    private void updateChainId() {
        ...
        if (mMode == Mode.WALLET_MODE) {
            ...
            mHnsWalletService.getNetworkForSelectedAccountOnActiveOrigin(networkInfo -> {
                if (networkInfo != null) {
                    _mChainId.postValue(networkInfo.chainId);
                }
            });
    ...
    public void resetServices(
            HnsWalletService hnsWalletService, JsonRpcService jsonRpcService) {
        synchronized (mLock) {
            mHnsWalletService = hnsWalletService;
            mJsonRpcService = jsonRpcService;
        }
    ...
    public void init() {
        synchronized (mLock) {
            ...
            for (Map.Entry<String, Integer> entry :
                ...
                if (!AndroidUtils.isDebugBuild()
                        && entry.getKey().equals(HnsWalletConstants.LOCALHOST_CHAIN_ID)) {
    ...
    public void setNetworkWithAccountCheck(NetworkInfo networkToBeSetAsSelected,
        ...
        mHnsWalletService.ensureSelectedAccountForChain(
    ...
    public void setNetworkForSelectedAccountOnActiveOrigin(
        ...
        mHnsWalletService.setNetworkForSelectedAccountOnActiveOrigin(
