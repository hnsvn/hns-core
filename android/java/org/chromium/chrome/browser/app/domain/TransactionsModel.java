...
public class TransactionsModel implements TxServiceObserverImpl.TxServiceObserverImplDelegate {
    ...
    private WeakReference<HnsWalletBaseActivity> mActivityRef;
    ...
    public void update(WeakReference<HnsWalletBaseActivity> activityRef) {
        synchronized (mLock) {
    ...
    private void parseTransactions(WeakReference<HnsWalletBaseActivity> activityRef,
            List<AssetAccountsNetworkBalance> assetAccountsNetworkBalances,
    ...
    private void updateTx(
            TransactionInfo txInfo, WeakReference<HnsWalletBaseActivity> mActivityRef) {
