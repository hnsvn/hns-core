...
public class DormantUsersEngagementDialogFragment extends HnsDialogFragment {
    ...
    private static final List<Integer> mImages = Arrays.asList(
            R.drawable.ic_rocket, R.drawable.ic_hns_battery, R.drawable.ic_hns_mobiledata);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        doneButton.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    HnsSetDefaultBrowserUtils.setDefaultBrowser(HnsActivity.getHnsActivity());
