...
public class OnboardingViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
        case 0:
            HnsRewardsOnboardingFragment hnsRewardsOnboardingFragment =
                new HnsRewardsOnboardingFragment();
            hnsRewardsOnboardingFragment.setOnViewPagerAction(onViewPagerAction);
            return hnsRewardsOnboardingFragment;
        case 1:
            HnsAdsOnboardingFragment hnsAdsOnboardingFragment =
                new HnsAdsOnboardingFragment();
            hnsAdsOnboardingFragment.setOnViewPagerAction(onViewPagerAction);
            return hnsAdsOnboardingFragment;
        case 2:
