...
public class SearchEngineOnboardingFragment extends Fragment {
    ...
    private void refreshData() {
        ...
        TemplateUrl defaultSearchEngineTemplateUrl =
                HnsSearchEngineUtils.getTemplateUrlByShortName(
                        mProfile, HnsSearchEngineUtils.getDSEShortName(mProfile, false));
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mSelectedSearchEngine == null) {
                    mSelectedSearchEngine = HnsSearchEngineUtils.getTemplateUrlByShortName(
                            mProfile, HnsSearchEngineUtils.getDSEShortName(mProfile, false));
                }
                if (mSelectedSearchEngine != null) {
                    HnsSearchEngineUtils.setDSEPrefs(mSelectedSearchEngine, mProfile);
                    HnsSearchEngineUtils.setDSEPrefs(mSelectedSearchEngine,
