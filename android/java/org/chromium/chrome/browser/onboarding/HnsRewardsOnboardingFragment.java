...
public class HnsRewardsOnboardingFragment extends Fragment {
    ...
    private static final String HNS_TERMS_PAGE =
        "https://basicattentiontoken.org/user-terms-of-service/";

    private boolean isAdsAvailable;

    public HnsRewardsOnboardingFragment() {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_hns_rewards_onboarding, container, false);
    ...
    private void setActions() {
        ...
        String hnsRewardsText = "<b>"
                + String.format(getResources().getString(R.string.earn_tokens),
                        getResources().getString(R.string.token))
                + "</b> " + getResources().getString(R.string.hns_rewards_onboarding_text);
        Spanned textToInsert = HnsRewardsHelper.spannedFromHtmlString(hnsRewardsText);
        ...
        Spanned textToAgree = HnsRewardsHelper.spannedFromHtmlString(termsText);
        SpannableString ss = new SpannableString(textToAgree.toString());

        ClickableSpan clickableSpan = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View textView) {
                CustomTabActivity.showInfoPage(getActivity(), HNS_TERMS_PAGE);
            }
            @Override
