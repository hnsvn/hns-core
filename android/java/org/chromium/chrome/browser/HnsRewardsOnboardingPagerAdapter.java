...
public class HnsRewardsOnboardingPagerAdapter extends PagerAdapter {
    ...
    private String countryCode = HnsRewardsNativeWorker.getInstance().getCountryCode();
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        if (shouldShowMoreOptions && position == (getImages().size() - 2)) {
            ...
            view = LayoutInflater.from(ContextUtils.getApplicationContext())
                           .inflate(R.layout.hns_rewards_onboarding_ac_layout, null);
            ...
            view = LayoutInflater.from(ContextUtils.getApplicationContext()).inflate(R.layout.hns_rewards_onboarding_item_layout, null);
    ...
    private List<String> getTitles(Context context) {
        ...
        headers.add(context.getResources().getString(R.string.welcome_to_hns_rewards));
    ...
    private List<String> getTexts(Context context) {
        ...
        texts.add(context.getResources().getString(R.string.welcome_to_hns_rewards_text));
    ...
    private List<Integer> getImages() {
        ...
        images.add(R.drawable.ic_onboarding_graphic_android_hns_ads);
        if (!countryCode.equals(JAPAN_COUNTRY_CODE)) {
        ...
        public void onStopTrackingTouch(Slider slider) {
            try {
                ...
                if (HnsAdsNativeHelper.nativeIsOptedInToNotificationAds(
                    ...
                    HnsRewardsNativeWorker.getInstance().SetAdsPerHour((int) slider.getValue());
                }
            } catch (Exception ex) {
