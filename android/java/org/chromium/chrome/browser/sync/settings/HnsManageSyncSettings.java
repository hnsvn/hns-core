...
/**
 * See org.hns.bytecode.HnsManageSyncSettingsClassAdapter
 */
public class HnsManageSyncSettings extends ManageSyncSettings {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        ...
        if (syncAutofill != null) {
            syncAutofill.setTitle(R.string.hns_sync_autofill);
        }
