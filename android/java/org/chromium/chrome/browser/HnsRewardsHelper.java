...
public class HnsRewardsHelper implements LargeIconBridge.LargeIconCallback {
    private static final String PREF_SHOW_HNS_REWARDS_ONBOARDING_MODAL =
            "show_hns_rewards_onboarding_modal";
    private static final String PREF_SHOW_HNS_REWARDS_ONBOARDING_ONCE =
            "show_hns_rewards_onboarding_once";
    ...
    public static boolean isRewardsEnabled() {
        HnsRewardsNativeWorker worker = HnsRewardsNativeWorker.getInstance();
    ...
    public static void resetRewards() {
        ...
        sharedPreferencesEditor.putBoolean(PREF_SHOW_HNS_REWARDS_ONBOARDING_MODAL, true);
        sharedPreferencesEditor.putBoolean(PREF_SHOW_HNS_REWARDS_ONBOARDING_ONCE, false);
    ...
    public static boolean shouldShowRewardsOnboardingModalOnDay4() {
        ...
        if (!hasRewardsOnboardingModalShown()
                ...
                && shouldShowHnsRewardsOnboardingModal() && hnsRewardsNativeWorker != null
    ...
    public static boolean shouldShowHnsRewardsOnboardingModal() {
        return ContextUtils.getAppSharedPreferences().getBoolean(
                PREF_SHOW_HNS_REWARDS_ONBOARDING_MODAL, true);
    }

    public static void setShowHnsRewardsOnboardingModal(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor =
                ContextUtils.getAppSharedPreferences().edit();
        sharedPreferencesEditor.putBoolean(PREF_SHOW_HNS_REWARDS_ONBOARDING_MODAL, enabled);
        sharedPreferencesEditor.apply();
    }

    public static boolean shouldShowHnsRewardsOnboardingOnce() {
        return ContextUtils.getAppSharedPreferences().getBoolean(
                PREF_SHOW_HNS_REWARDS_ONBOARDING_ONCE, false);
    }

    public static void setShowHnsRewardsOnboardingOnce(boolean enabled) {
        SharedPreferences.Editor sharedPreferencesEditor =
                ContextUtils.getAppSharedPreferences().edit();
        sharedPreferencesEditor.putBoolean(PREF_SHOW_HNS_REWARDS_ONBOARDING_ONCE, enabled);
        sharedPreferencesEditor.apply();
    }
    ...
    public HnsRewardsHelper(Tab tab) {
        mTab = tab;
        assert mTab != null;
    ...
    static public ChromeTabbedActivity getChromeTabbedActivity() {
      return HnsActivity.getChromeTabbedActivity();
    }

    static public HnsActivity getHnsActivity()
            throws HnsActivity.HnsActivityNotFoundException {
      return HnsActivity.getHnsActivity();
    }

  static public String getCurrentMonth(Calendar currentTime,
      Resources resources, boolean upper_case) {
    String month = resources.getString(R.string.hns_ui_month_jan);
    switch (currentTime.get(Calendar.MONTH)) {
      case Calendar.JANUARY:
        month = resources.getString(R.string.hns_ui_month_jan);
        break;
      case Calendar.FEBRUARY:
        month = resources.getString(R.string.hns_ui_month_feb);
        break;
      case Calendar.MARCH:
        month = resources.getString(R.string.hns_ui_month_mar);
        break;
      case Calendar.APRIL:
        month = resources.getString(R.string.hns_ui_month_apr);
        break;
      case Calendar.MAY:
        month = resources.getString(R.string.hns_ui_month_may);
        break;
      case Calendar.JUNE:
        month = resources.getString(R.string.hns_ui_month_jun);
        break;
      case Calendar.JULY:
        month = resources.getString(R.string.hns_ui_month_jul);
        break;
      case Calendar.AUGUST:
        month = resources.getString(R.string.hns_ui_month_aug);
        break;
      case Calendar.SEPTEMBER:
        month = resources.getString(R.string.hns_ui_month_sep);
        break;
      case Calendar.OCTOBER:
        month = resources.getString(R.string.hns_ui_month_oct);
        break;
      case Calendar.NOVEMBER:
        month = resources.getString(R.string.hns_ui_month_nov);
        break;
      case Calendar.DECEMBER:
        month = resources.getString(R.string.hns_ui_month_dec);
        break;
    }
  ...
  public static Tab currentActiveChromeTabbedActivityTab() {
      ChromeTabbedActivity activity = HnsRewardsHelper.getChromeTabbedActivity();
