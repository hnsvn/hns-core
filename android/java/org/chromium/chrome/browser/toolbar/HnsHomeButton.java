...
/**
 * Hns's extension of HomeButton.
 */
public class HnsHomeButton extends HomeButton implements TintObserver {
    private ThemeColorProvider mThemeColorProvider;

    public HnsHomeButton(Context context, AttributeSet attrs) {
        super(context, attrs);
