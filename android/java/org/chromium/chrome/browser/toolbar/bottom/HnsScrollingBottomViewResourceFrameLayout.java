...
public class HnsScrollingBottomViewResourceFrameLayout
    ...
    public HnsScrollingBottomViewResourceFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setBottomControlsCoordinatorSupplier(
        ...
        hnsBottomControlsCoordinator().getBottomToolbarVisibleSupplier().addObserver(
        ...
        hnsBottomControlsCoordinator().getTabGroupUiVisibleSupplier().addObserver(
                mCallbackController.makeCancelable((visible) -> {
                    // Only make changes if visibility changed.
    ...
    private HnsBottomControlsCoordinator hnsBottomControlsCoordinator() {
        if (mBottomControlsCoordinatorSupplier != null
                && mBottomControlsCoordinatorSupplier.get()
                                instanceof HnsBottomControlsCoordinator) {
            return (HnsBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get();
        }
        return null;
    }
