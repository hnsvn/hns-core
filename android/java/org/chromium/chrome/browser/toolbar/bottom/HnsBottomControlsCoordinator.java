...
public class HnsBottomControlsCoordinator extends BottomControlsCoordinator {
    ...
    public HnsBottomControlsCoordinator(
    ...
    public void setBottomToolbarVisible(boolean visible) {
        if (mMediator instanceof HnsBottomControlsMediator) {
            ((HnsBottomControlsMediator) mMediator).setBottomToolbarVisible(visible);
        }
        if (mBottomToolbarCoordinator != null) {
    ...
    public ObservableSupplierImpl<Boolean> getBottomToolbarVisibleSupplier() {
        if (mMediator instanceof HnsBottomControlsMediator) {
            return ((HnsBottomControlsMediator) mMediator).getBottomToolbarVisibleSupplier();
        }
    ...
    public ObservableSupplierImpl<Boolean> getTabGroupUiVisibleSupplier() {
        if (mMediator instanceof HnsBottomControlsMediator) {
            return ((HnsBottomControlsMediator) mMediator).getTabGroupUiVisibleSupplier();
        }
        assert false : "Make sure mMediator is properly patched in bytecode.";
        return null;
    }
