...
import org.chromium.chrome.browser.toolbar.HnsHomeButton;
...
public class BrowsingModeBottomToolbarCoordinator {
    ...
    private final HnsHomeButton mHnsHomeButton;
    ...
    BrowsingModeBottomToolbarCoordinator(View root, ActivityTabProvider tabProvider,
        ...
        mHnsHomeButton = mToolbarRoot.findViewById(R.id.bottom_home_button);
        mHnsHomeButton.setOnClickListener(homeButtonListener);
        ...
        if (BottomToolbarVariationManager.isHomeButtonOnBottom()) {
            mHnsHomeButton.setVisibility(View.VISIBLE);
        }
        ...
        if (mMenuButton != null) {
            ...
            HnsMenuButtonCoordinator.setupPropertyModel(mMenuButton, menuButtonStateSupplier);
    ...
    void initializeWithNative(OnClickListener newTabListener, OnClickListener tabSwitcherListener,
        ...
        if (BottomToolbarVariationManager.isHomeButtonOnBottom()) {
            mHnsHomeButton.setThemeColorProvider(themeColorProvider);
        }
     ...
     */
    HnsHomeButton getHomeButton() {
        return mHnsHomeButton;
    }
