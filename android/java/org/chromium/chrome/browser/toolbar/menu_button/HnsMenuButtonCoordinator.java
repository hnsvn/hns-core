...
public class HnsMenuButtonCoordinator extends MenuButtonCoordinator {
    private static final String HNS_IS_MENU_FROM_BOTTOM = "hns_is_menu_from_bottom";

    private Activity mActivity;

    public HnsMenuButtonCoordinator(
    ...
    private void updateMenuButtonState() {
        HnsToolbarLayoutImpl layout =
                (HnsToolbarLayoutImpl) mActivity.findViewById(R.id.toolbar);
        assert layout != null;
        if (layout != null) {
    ...
    public static void setMenuFromBottom(boolean isMenuFromBottom) {
        ...
        prefs.edit().putBoolean(HNS_IS_MENU_FROM_BOTTOM, isMenuFromBottom).apply();
    }

    public static boolean isMenuFromBottom() {
        SharedPreferences sharedPreferences = ContextUtils.getAppSharedPreferences();
        return sharedPreferences.getBoolean(HNS_IS_MENU_FROM_BOTTOM, true);
    }
