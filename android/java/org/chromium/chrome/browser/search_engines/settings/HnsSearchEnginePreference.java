...
public class HnsSearchEnginePreference extends SearchEngineSettings {
    ...
    public HnsSearchEnginePreference(boolean isPrivate) {
        mPrivate = isPrivate;
    }
    ...
    public void createAdapterIfNecessary() {
        ...
        mSearchEngineAdapter = new HnsSearchEngineAdapter(getActivity(), getProfile(mPrivate));
    }
