...
public class HnsThemePreferences extends ThemeSettingsFragment {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, String rootKey) {
        SettingsUtils.addPreferencesFromResource(this, R.xml.hns_theme_preferences);
        ...
        HnsRadioButtonGroupThemePreference radioButtonGroupThemePreference =
            (HnsRadioButtonGroupThemePreference) findPreference(PREF_UI_THEME_PREF);
