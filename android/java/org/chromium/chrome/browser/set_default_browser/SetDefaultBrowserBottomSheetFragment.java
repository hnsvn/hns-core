...
public class SetDefaultBrowserBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getActivity() != null) {
                    HnsSetDefaultBrowserUtils.setDefaultBrowser(getActivity());
                }
                dismiss();
            }
        }));
        ...
        if (hnsDefaultModalCount > 2 && !isFromMenu) {
        ...
        cancelButton.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dontAskCheckBox.isChecked()) {
                    HnsSetDefaultBrowserUtils.setHnsDefaultDontAsk();
                }
                dismiss();
            }
        }));
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        ...
        HnsSetDefaultBrowserUtils.isBottomSheetVisible = false;
    }
}
