...
/**
 * HnsRewardsNativeWorker.GetPublisherBanner json response converted to this pojo class
 * */
public class HnsRewardsBannerInfo {
    ...
    public HnsRewardsBannerInfo(String json_external_wallet) throws JSONException {
