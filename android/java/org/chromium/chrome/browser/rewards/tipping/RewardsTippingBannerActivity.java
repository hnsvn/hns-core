...
import org.chromium.chrome.browser.rewards.HnsRewardsBannerInfo;
...
public class RewardsTippingBannerActivity
        extends AsyncInitializationActivity implements HnsRewardsObserver {
    ...
    private HnsRewardsBannerInfo mBannerInfo;
    ...
    public void onPublisherBanner(String jsonBannerInfo) {
        try {
            mBannerInfo = new HnsRewardsBannerInfo(jsonBannerInfo);
            setTitle();
            setDescription();
            setLogo();
            background();
    ...
    private void openLink(String url) {
        ...
        intent.putExtra(HnsActivity.OPEN_URL, url);
    ...
    public void finishNativeInitialization() {
        ...
        mHnsRewardsNativeWorker.GetPublisherBanner(
                mHnsRewardsNativeWorker.GetPublisherId(currentTabId_));
    }
