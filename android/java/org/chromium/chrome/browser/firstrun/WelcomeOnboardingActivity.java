...
public class WelcomeOnboardingActivity extends FirstRunActivityBase {
    ...
    private static final String P3A_URL =
            "https://support.hns.com/hc/en-us/articles/9140465918093-What-is-P3A-in-Hns";
    ...
    private HnsFirstRunFlowSequencer mFirstRunFlowSequencer;
                ...
                switch (responseCode) {
                    case InstallReferrerResponse.OK:
                        try {
                            ...
                            if (referrerUrl.equals(HnsConstants.DEEPLINK_ANDROID_PLAYLIST)) {
                                SharedPreferencesManager.getInstance().writeBoolean(
                                        HnsPreferenceKeys.HNS_DEFERRED_DEEPLINK_PLAYLIST, true);
                            } else if (referrerUrl.equals(HnsConstants.DEEPLINK_ANDROID_VPN)) {
                                SharedPreferencesManager.getInstance().writeBoolean(
                                        HnsPreferenceKeys.HNS_DEFERRED_DEEPLINK_VPN, true);
                            }
    ...
    private void initViews() {
        ...
        mIvHns = findViewById(R.id.iv_hns);
    ...
    private void onClickViews() {
        if (mBtnPositive != null) {
            mBtnPositive.setOnClickListener(view -> {
                if (mCurrentStep == 1
                        && !HnsSetDefaultBrowserUtils.isHnsSetAsDefaultBrowser(this)) {
                    HnsSetDefaultBrowserUtils.setDefaultBrowser(this);
                    if (!HnsSetDefaultBrowserUtils.supportsDefaultRoleManager()) {
                        nextOnboardingStep();
                    }
                } else {
                    nextOnboardingStep();
    ...
    private void nextOnboardingStep() {
        ...
        if (mCurrentStep == 0) {
            ...
            if (mIvHns != null) {
                mIvHns.animate().scaleX(0.8f).scaleY(0.8f).setDuration(1000);
            }
            ...
            try {
                isP3aEnabled = HnsLocalState.get().getBoolean(HnsPref.P3A_ENABLED);
            } catch (Exception e) {
                ...
                mCheckboxP3a.setOnCheckedChangeListener(
                        new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(
                                    CompoundButton buttonView, boolean isChecked) {
                                try {
                                    HnsLocalState.get().setBoolean(
                                            HnsPref.P3A_ENABLED, isChecked);
                                    HnsLocalState.get().setBoolean(
                                            HnsPref.P3A_NOTICE_ACKNOWLEDGED, true);
    ...
    public void triggerLayoutInflation() {
        ...
        mFirstRunFlowSequencer = new HnsFirstRunFlowSequencer(this, getProfileSupplier()) {
            @Override
