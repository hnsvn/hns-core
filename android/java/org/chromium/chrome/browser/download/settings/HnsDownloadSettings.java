...
public class HnsDownloadSettings
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SettingsUtils.addPreferencesFromResource(this, R.xml.hns_download_preferences);
        ...
        if (locationPromptEnabledPref != null) {
            locationPromptEnabledPref.setTitle(
                    R.string.hns_download_location_prompt_enabled_title);
        }
    }
    ...
    private void updateDownloadSettings() {
        ...
        boolean downloadProgressNotificationBubble =
                ContextUtils.getAppSharedPreferences().getBoolean(
                        HnsPreferenceKeys.HNS_DOWNLOADS_DOWNLOAD_PROGRESS_NOTIFICATION_BUBBLE,
                        false);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (PREF_AUTOMATICALLY_OPEN_WHEN_POSSIBLE.equals(preference.getKey())) {
            ContextUtils.getAppSharedPreferences()
                    .edit()
                    .putBoolean(
                            HnsPreferenceKeys.HNS_DOWNLOADS_AUTOMATICALLY_OPEN_WHEN_POSSIBLE,
                            (boolean) newValue)
                    .apply();
        } else if (PREF_DOWNLOAD_PROGRESS_NOTIFICATION_BUBBLE.equals(preference.getKey())) {
            ContextUtils.getAppSharedPreferences()
                    .edit()
                    .putBoolean(HnsPreferenceKeys
                                        .HNS_DOWNLOADS_DOWNLOAD_PROGRESS_NOTIFICATION_BUBBLE,
                            (boolean) newValue)
                    .apply();
        }
