...
public class HnsTabbedRootUiCoordinator extends TabbedRootUiCoordinator {
    protected AppCompatActivity mActivity;

    public HnsTabbedRootUiCoordinator(@NonNull AppCompatActivity activity,
