...
public class RetentionNotificationUtil {
    ...
    private static final String HNS_BROWSER = "Hns Browser";
    ...
    private static Map<String, RetentionNotification> mNotificationMap = new HashMap<String, RetentionNotification>() {
        {
            put(HOUR_3,
                    new RetentionNotification(
                            3, 3 * 60, HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(HOUR_24,
                    new RetentionNotification(
                            24, 24 * 60, HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DAY_6, new RetentionNotification(6, 6 * 24 * 60, HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(EVERY_SUNDAY, new RetentionNotification(7, -1, HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DAY_10, new RetentionNotification(10, 10 * 24 * 60, HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DAY_30, new RetentionNotification(30, 30 * 24 * 60, HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DAY_35,
                    new RetentionNotification(35, 35 * 24 * 60,
                            HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DEFAULT_BROWSER_1,
                    new RetentionNotification(17, 3 * 24 * 60,
                            HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DEFAULT_BROWSER_2, new RetentionNotification(18, 6 * 24 * 60, HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DEFAULT_BROWSER_3,
                    new RetentionNotification(19, 30 * 24 * 60,
                            HnsChannelDefinitions.ChannelId.HNS_BROWSER, HNS_BROWSER));
            put(DORMANT_USERS_DAY_14,
                    new RetentionNotification(20, 14 * 24 * 60,
                            HnsChannelDefinitions.ChannelId.HNS_BROWSER,
    ...
    public static String getNotificationText(Context context, String notificationType) {
        ...
        case HOUR_24:
            if (OnboardingPrefManager.getInstance().isHnsStatsEnabled()) {
                Pair<String, String> dataSavedPair =
                        HnsStatsUtil.getHnsStatsStringFormNumberPair(
        ...
        case EVERY_SUNDAY:
            long adsTrackersCountWeekly =
                    mDatabaseHelper
                            .getAllStatsWithDate(HnsStatsUtil.getCalculatedDate("yyyy-MM-dd", -7),
        ...
        case DEFAULT_BROWSER_3:
            return context.getResources().getString(R.string.set_hns_as_your);
