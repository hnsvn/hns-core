...
import org.chromium.chrome.browser.dialogs.HnsAdsNotificationDialog;
...
public class HnsOnboardingNotification extends BroadcastReceiver {
    public Context mContext;
    private Intent mIntent;
    private static final String TAG = "OnboardingNoti";

    private static final int HNS_ONBOARDING_NOTIFICATION_ID = -2;
    public static String HNS_ONBOARDING_NOTIFICATION_TAG = "hns_onboarding_notification_tag";
    private static String HNS_ONBOARDING_ORIGIN_EN = "https://hns.com/my-first-ad/";
    private static String HNS_ONBOARDING_ORIGIN_DE = "https://hns.com/de/my-first-ad/";
    private static String HNS_ONBOARDING_ORIGIN_FR = "https://hns.com/fr/my-first-ad/";
    ...
    public static void showOnboardingDialog() {
        try {
            ...
            HnsAdsNotificationDialog.showNotificationAd(hnsActivity,
                    HNS_ONBOARDING_NOTIFICATION_TAG, getNotificationUrl(),
                    hnsActivity.getString(R.string.hns_ui_hns_rewards),
                    hnsActivity.getString(R.string.this_is_your_first_ad));
    ...
    public static void showOnboardingNotification() {
        ...
        NotificationBuilderBase notificationBuilder =
                new HnsNotificationBuilder(context)
                        .setTitle(context.getString(R.string.hns_ui_hns_rewards))
        ...
        NotificationWrapper notification = notificationBuilder.build(new NotificationMetadata(
                                              ...
                                              HNS_ONBOARDING_NOTIFICATION_TAG /* notificationTag */,
                                              HNS_ONBOARDING_NOTIFICATION_ID /* notificationId */
                                          ));
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            if (action != null && action.equals(DEEP_LINK)) {
                ...
                hnsActivity.hideRewardsOnboardingIcon();
            }
        } catch (HnsActivity.HnsActivityNotFoundException e) {
    ...
    private static String getNotificationUrl() {
        ...
        case COUNTRY_CODE_DE:
            return HNS_ONBOARDING_ORIGIN_DE;
        case COUNTRY_CODE_FR:
            return HNS_ONBOARDING_ORIGIN_FR;
        default:
            return HNS_ONBOARDING_ORIGIN_EN;
        }
    }
    ...
    public static void cancelOnboardingNotification(Context context) {
        ...
        notificationManager.cancel(
            HNS_ONBOARDING_NOTIFICATION_TAG, HNS_ONBOARDING_NOTIFICATION_ID);
    }
}
