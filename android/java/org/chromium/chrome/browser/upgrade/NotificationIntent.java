...
public class NotificationIntent {
    ...
    private static final String URL = "https://support.hns.com/hc/en-us/articles/360045401211/";
    ...
    //private static final String NOTIFICATION_TITLE = "Hns update";
    //private static final String NOTIFICATION_TEXT = "The new Hns browser is 22% faster";
    ...
    public static void fireNotificationIfNecessary(Context context) {
        ...
        intent.putExtra(HnsPreferenceKeys.HNS_UPDATE_EXTRA_PARAM, true);
    ...
    public static long GetPreferences(Context context) {
        SharedPreferences sharedPref = context.getSharedPreferences(HnsPreferenceKeys.HNS_NOTIFICATION_PREF_NAME, 0);

        return sharedPref.getLong(HnsPreferenceKeys.HNS_MILLISECONDS_NAME, 0);
    }
}
