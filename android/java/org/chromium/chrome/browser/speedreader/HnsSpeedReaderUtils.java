...
public class HnsSpeedReaderUtils {
    public static void toggleEnabledForWebContent(WebContents webContents, boolean enabled) {
        HnsSpeedReaderUtilsJni.get().toggleEnabledForWebContent(webContents, enabled);
    }

    public static boolean tabStateIsDistilled(Tab tab) {
        return HnsSpeedReaderUtilsJni.get().tabStateIsDistilled(tab);
    }

    public static boolean tabSupportsDistillation(Tab tab) {
        return HnsSpeedReaderUtilsJni.get().tabSupportsDistillation(tab);
    }

    public static void singleShotSpeedreaderForWebContent(WebContents webContents) {
        HnsSpeedReaderUtilsJni.get().singleShotSpeedreaderForWebContent(webContents);
    }

    public static boolean tabProbablyReadable(Tab tab) {
        return HnsSpeedReaderUtilsJni.get().tabProbablyReadable(tab);
    }
