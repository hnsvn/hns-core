...
public class HnsRateThanksFeedbackDialog extends BottomSheetDialogFragment {
    final public static String TAG_FRAGMENT = "hns_rate_thanks_feedback_dialog_tag";
    private static final String TAG = "RateThanksFeedback";
    private static final String SAD = "sad";

    public static HnsRateThanksFeedbackDialog newInstance() {
        return new HnsRateThanksFeedbackDialog();
    }
    ...
    public void show(@NonNull FragmentManager manager, @Nullable String tag) {
        try {
            HnsRateThanksFeedbackDialog fragment =
                    (HnsRateThanksFeedbackDialog) manager.findFragmentByTag(
                            HnsRateThanksFeedbackDialog.TAG_FRAGMENT);
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        final View view = LayoutInflater.from(getContext())
                                  .inflate(R.layout.hns_rating_thanks_feedback_dialog, null);
    ...
    public static void showHnsRateThanksFeedbackDialog(AppCompatActivity activity) {
        if (activity != null) {
            HnsRateThanksFeedbackDialog hnsAskPlayStoreRatingDialog =
                    HnsRateThanksFeedbackDialog.newInstance();
            hnsAskPlayStoreRatingDialog.show(activity.getSupportFragmentManager(), TAG_FRAGMENT);
        }
    }
