...
public class HnsRateDialogFragment extends BottomSheetDialogFragment {
    final public static String TAG_FRAGMENT = "hns_rating_dialog_tag";
    private static final String TAG = "RateDialogFragment";
    private boolean mIsFromSettings;

    public static HnsRateDialogFragment newInstance(boolean isFromSettings) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(RateUtils.FROM_SETTINGS, isFromSettings);

        HnsRateDialogFragment rateDialogFragment = new HnsRateDialogFragment();
    ...
    public void show(@NonNull FragmentManager manager, @Nullable String tag) {
        try {
            HnsRateDialogFragment fragment = (HnsRateDialogFragment) manager.findFragmentByTag(
                    HnsRateDialogFragment.TAG_FRAGMENT);
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        final View view = LayoutInflater.from(getContext())
                                  .inflate(R.layout.hns_rating_dialog_fragment, null);
    ...
    private void clickOnHappyImageView(View view) {
        ...
        happyImageView.setOnClickListener((v) -> {
            dismiss();
            HnsAskPlayStoreRatingDialog fragment =
                    HnsAskPlayStoreRatingDialog.newInstance(mIsFromSettings);
            fragment.show(((AppCompatActivity) getActivity()).getSupportFragmentManager(),
                    HnsAskPlayStoreRatingDialog.TAG_FRAGMENT);
        });
    }
    ...
    private void clickOnSadImageView(View view) {
        ...
        sadImageView.setOnClickListener((v) -> {
            dismiss();
            HnsRateThanksFeedbackDialog.showHnsRateThanksFeedbackDialog(
