...
public class HnsAskPlayStoreRatingDialog extends BottomSheetDialogFragment {
    final public static String TAG_FRAGMENT = "hns_ask_play_store_rating_dialog_tag";
    ...
    public static HnsAskPlayStoreRatingDialog newInstance(boolean isFromSettings) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(RateUtils.FROM_SETTINGS, isFromSettings);
        HnsAskPlayStoreRatingDialog fragment = new HnsAskPlayStoreRatingDialog();
    ...
    public void show(@NonNull FragmentManager manager, @Nullable String tag) {
        try {
            HnsAskPlayStoreRatingDialog fragment =
                    (HnsAskPlayStoreRatingDialog) manager.findFragmentByTag(
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        final View view = LayoutInflater.from(getContext())
                                  .inflate(R.layout.hns_ask_play_store_rating_dialog, null);
