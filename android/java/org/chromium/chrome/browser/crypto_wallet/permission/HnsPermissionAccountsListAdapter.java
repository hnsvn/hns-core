...
public class HnsPermissionAccountsListAdapter
        extends RecyclerView.Adapter<HnsPermissionAccountsListAdapter.ViewHolder> {
    ...
    public HnsPermissionAccountsListAdapter(
            AccountInfo[] accountInfo, boolean checkBoxStyle, HnsPermissionDelegate delegate) {
    ...
    public @NonNull ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.hns_wallet_accounts_list_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (mCheckBoxStyle) {
            ...
            if (CoinType.SOL == mSelectedAccount.accountId.coin) {
                connectionButtonText = hasPermission ? R.string.hns_wallet_site_permissions_revoke
                                                     : R.string.hns_wallet_site_permissions_trust;
            } else {
                if (hasPermission) {
                    if (isConnected) {
