...
public class AssetDetailActivity
        extends HnsWalletBaseActivity implements OnWalletListItemClick, ApprovedTxObserver {
    ...
    protected void triggerLayoutInflation() {
        ...
        } catch (HnsActivity.HnsActivityNotFoundException ignored) {
            finish();
            return;
        }
        ...
        if (!mIsMarketCoin && AssetUtils.isAuroraAddress(mContractAddress, mChainId)) {
            ...
            SpannableString rainBowLearnMore = Utils.createSpanForSurroundedPhrase(this,
                    R.string.hns_wallet_rainbow_bridge_learn_more,
                    (v)
                            -> TabUtils.openLinkWithFocus(
                                    this, WalletConstants.URL_RAINBOW_BRIDGE_OVERVIEW));
            rainBowLearnMore.setSpan(
                    new BulletSpan(
                            15, getResources().getColor(R.color.hns_wallet_day_night_text_color)),
            ...
            SpannableString rainBowRisksLearnMore = Utils.createSpanForSurroundedPhrase(
                    this, R.string.hns_wallet_rainbow_bridge_risks_learn_more, (v) -> {
            ...
            MaterialAlertDialogBuilder auroraDialogBuilder =
                    new MaterialAlertDialogBuilder(this, R.style.HnsWalletAlertDialogTheme);
            ...
            title.setText(getString(R.string.hns_wallet_aurora_modal_title,
                    getString(R.string.hns_wallet_rainbow_bridge)));
            learnMore.setMovementMethod(LinkMovementMethod.getInstance());
            learnMore.setText(spannableStringBuilder);
            btnOpenRainBow.setText(getString(R.string.hns_wallet_aurora_modal_open_button_text,
                    getString(R.string.hns_wallet_rainbow_bridge)));
            ...
            message.setText(getString(R.string.hns_wallet_aurora_modal_description,
                    getString(R.string.hns_wallet_rainbow_bridge)));
    ...
    private void getBlockchainToken(Runnable callback) {
        ...
        TokenUtils.getExactUserAsset(getHnsWalletService(), mAssetNetwork, mAssetNetwork.coin,
