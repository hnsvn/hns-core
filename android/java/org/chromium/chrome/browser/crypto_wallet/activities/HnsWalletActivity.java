...
/**
 * Main Hns Wallet activity
 */
public class HnsWalletActivity extends HnsWalletBaseActivity implements OnNextPage {
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_hns_wallet);
        mIsFromDapps = false;
        if (getIntent() != null) {
        ...
        mBuySendSwapButton.setOnClickListener(v -> {
            ...
            if (mWalletModel != null) {
                ethNetwork = getNetworkModel().getNetwork(HnsWalletConstants.MAINNET_CHAIN_ID);
            }
    ...
    private void setNavigationFragments(int type) {
        ...
        if (type == ONBOARDING_FIRST_PAGE_ACTION) {
            ...
            mHnsWalletP3A.reportOnboardingAction(OnboardingAction.SHOWN);
    ...
    public void gotoOnboardingPage() {
        ...
        mHnsWalletP3A.reportOnboardingAction(OnboardingAction.LEGAL_AND_PASSWORD);
    }
    ...
    public void gotoRestorePage(boolean isOnboarding) {
        ...
        if (isOnboarding) {
            mHnsWalletP3A.reportOnboardingAction(OnboardingAction.START_RESTORE);
        }
    }
