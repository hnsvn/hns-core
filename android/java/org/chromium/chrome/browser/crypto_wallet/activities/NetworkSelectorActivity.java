...
import org.chromium.chrome.browser.settings.HnsSettingsLauncherImpl;
import org.chromium.chrome.browser.settings.HnsWalletAddNetworksFragment;
...
public class NetworkSelectorActivity
        extends HnsWalletBaseActivity implements NetworkSelectorAdapter.NetworkClickListener {
    ...
    public static Intent createIntent(
        ...
        Intent hnsNetworkSelectionIntent = new Intent(context, NetworkSelectorActivity.class);
        hnsNetworkSelectionIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        // Either in global or local network selection mode
        hnsNetworkSelectionIntent.putExtra(NETWORK_SELECTOR_MODE, mode);
        // To bind selection between the caller and NetworkSelection Activity for local state of
        // network selection
        hnsNetworkSelectionIntent.putExtra(NETWORK_SELECTOR_KEY, key);
        return hnsNetworkSelectionIntent;
    }
    ...
    protected void triggerLayoutInflation() {
        ...
        mToolbar.setTitle(R.string.hns_wallet_select_network_title);
    ...
    private void initState() {
        ...
        mSettingsLauncher = new HnsSettingsLauncherImpl();
    ...
    private void launchAddNetwork() {
        ...
        Intent intent = mSettingsLauncher.createSettingsActivityIntent(
                this, HnsWalletAddNetworksFragment.class.getName(), fragmentArgs);
    ...
    private void updateNetworkUi(NetworkInfo networkInfo, Boolean isSelected) {
        if (!isSelected) {
            Toast.makeText(this,
                         getString(R.string.hns_wallet_network_selection_error,
