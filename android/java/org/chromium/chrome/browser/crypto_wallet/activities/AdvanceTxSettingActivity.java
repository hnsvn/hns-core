...
public class AdvanceTxSettingActivity extends HnsWalletBaseActivity {
    ...
    protected void triggerLayoutInflation() {
        ...
        setupHnsToolBar(R.string.hns_wallet_advanced_settings);
    ...
    private void setupHnsToolBar(@StringRes int title) {
