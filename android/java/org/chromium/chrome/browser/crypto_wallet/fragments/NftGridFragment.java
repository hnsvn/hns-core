...
public class NftGridFragment extends Fragment implements OnWalletListItemClick {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mTabLayout.addTab(mTabLayout.newTab().setText(getString(R.string.hns_wallet_nfts)));
        mTabLayout.addTab(mTabLayout.newTab().setText(getString(R.string.hns_wallet_hidden)));
        ...
        mAddAssetActivityResultLauncher =
                registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
                        ((HnsWalletBaseActivity) requireActivity()).getActivityResultRegistry(),
                        result -> {
                ...
                getViewLifecycleOwner(), networkInfo -> {
                    ...
                    MaterialAlertDialogBuilder builder =
                            new MaterialAlertDialogBuilder(
                                    requireContext(), R.style.HnsWalletAlertDialogTheme)
    ...
    private void showNftDiscoveryDialog() {
        ...
        var nftDiscoveryDesc = SpanApplier.applySpans(
                getString(R.string.hns_wallet_enable_nft_autodiscovery_modal_description),
                new SpanApplier.SpanInfo("<LINK_1>", "</LINK_1>", new UnderlineSpan()),
                new SpanApplier.SpanInfo("<LINK_2>", "</LINK_2>",
                        new NoUnderlineClickableSpan(requireContext(), R.color.hns_link,
                                result
        ...
        title.setText(R.string.hns_wallet_enable_nft_autodiscovery_modal_header);
        message.setMovementMethod(LinkMovementMethod.getInstance());
        message.setText(nftDiscoveryDesc);
        enableBtn.setText(R.string.hns_action_enable);
    ...
    private void updateNftGrid() {
        ...
        if (!(activity instanceof HnsWalletActivity)) return;
        mPortfolioModel.fetchNfts(this, mSelectedNetworkList, (HnsWalletBaseActivity) activity,
    ...
    private void recordP3AView() {
        ...
        if (activity instanceof HnsWalletActivity) {
            HnsWalletActivity walletActivity = (HnsWalletActivity) activity;
            HnsWalletP3a walletP3A = walletActivity.getHnsWalletP3A();
