...
import org.chromium.hns_wallet.mojom.AccountKind;
...
public class AccountsFragment extends Fragment implements OnWalletListItemClick {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backupBtn.setOnClickListener(
                v -> { ((HnsWalletActivity) getActivity()).showOnboardingLayout(); });

        AppCompatImageView settingsBtn = view.findViewById(R.id.accounts_settings);
        settingsBtn.setOnClickListener(v -> {
            SettingsLauncher settingsLauncher = new SettingsLauncherImpl();
            settingsLauncher.launchSettingsActivity(getContext(), HnsWalletPreferences.class);
        });
    ...
    private KeyringService getKeyringService() {
        ...
        if (activity instanceof HnsWalletActivity) {
            return ((HnsWalletActivity) activity).getKeyringService();
        }
