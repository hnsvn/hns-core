...
public class SetupWalletFragment extends CryptoOnboardingFragment {
    ...
    // https://github.com/hnsvn/hns-browser/issues/27887
    // is done.
    private void checkOnHnsActivity(boolean setupAction, boolean restoreAction) {
        try {
            HnsActivity.getHnsActivity();
        } catch (HnsActivity.HnsActivityNotFoundException e) {
            Log.e(TAG, "checkOnHnsActivity " + e);
