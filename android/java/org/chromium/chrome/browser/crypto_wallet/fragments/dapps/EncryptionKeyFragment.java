...
public class EncryptionKeyFragment extends Fragment implements View.OnClickListener {
    ...
    private HnsWalletDAppsActivity.ActivityType mActivityType;
    ...
    public static EncryptionKeyFragment newInstance(
            HnsWalletDAppsActivity.ActivityType activityType) {
    ...
    public View onCreateView(
        ...
        mActivityType = (HnsWalletDAppsActivity.ActivityType) getArguments().getSerializable(
                ACTIVITY_TYPE);
    ...
    private void initState() {
        ...
        mWalletModel.getCryptoModel().getNetworkModel().mPairChainAndNetwork.observe(
                getViewLifecycleOwner(), chainIdAndInfosPair -> {
                    ...
                    NetworkInfo network = Utils.getNetworkInfoByChainId(chainId, cryptoNetworks);
        ...
        if (mActivityType
            ...
            mWalletModel.getCryptoModel().getPublicEncryptionRequest(encryptionPublicKeyRequest -> {
                if (encryptionPublicKeyRequest != null) {
                    ...
                    String formattedeTLD = String.format(
                            getString(R.string.hns_wallet_provide_encryption_key_description),
        ...
        } else if (mActivityType == HnsWalletDAppsActivity.ActivityType.DECRYPT_REQUEST) {
            mWalletModel.getCryptoModel().getDecryptMessageRequest(decryptRequest -> {
                ...
                mTvMessage.setText(R.string.hns_wallet_read_encrypted_message_title);
                mBtProvideAllow.setText(R.string.hns_wallet_read_encrypted_message_button);
