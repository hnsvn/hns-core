...
public class Validations {
    public static class SendToAccountAddress {
        ...
        public void validate(NetworkInfo selectedNetwork, KeyringService keyringService,
                BlockchainRegistry blockchainRegistry, HnsWalletService hnsWalletService,
            ...
            if (coinType == CoinType.SOL) {
                ...
                hnsWalletService.isBase58EncodedSolanaPubkey(fromAccount.address, success -> {
                    String responseMsg = "";
                    if (!success) {
                ...
                if (mKnownContractAddresses == null) {
                    ...
                    TokenUtils.getAllTokensFiltered(hnsWalletService, blockchainRegistry,
        ...
        private boolean isValidFilAddress(@NonNull final String address) {
            if (!address.startsWith(HnsWalletConstants.FILECOIN_MAINNET)
                    && !address.startsWith(HnsWalletConstants.FILECOIN_TESTNET)) {
                return false;
            }
