...
public class KeystoreHelper {
    ...
    private static final String HNS_WALLET_ALIAS = "HNS_WALLET_ALIAS";
    ...
    public static void useBiometricOnUnlock(String text) {
        ...
        SharedPreferencesManager.getInstance().writeBoolean(
                HnsPreferenceKeys.HNS_USE_BIOMETRICS_FOR_WALLET, true);
    }
    ...
    private static void saveToSharedPref(byte[] iv, byte[] encrypted) {
        ...
        SharedPreferencesManager.getInstance().writeString(
                HnsPreferenceKeys.HNS_BIOMETRICS_FOR_WALLET_IV, ivBase64);
        SharedPreferencesManager.getInstance().writeString(
                HnsPreferenceKeys.HNS_BIOMETRICS_FOR_WALLET_ENCRYPTED, encryptedBase64);
    }

    public static boolean shouldUseBiometricOnUnlock() {
        return SharedPreferencesManager.getInstance().readBoolean(
                HnsPreferenceKeys.HNS_USE_BIOMETRICS_FOR_WALLET, false);
    }
    ...
    public static String decryptText()
        ...
        String ivBase64 = SharedPreferencesManager.getInstance().readString(
                HnsPreferenceKeys.HNS_BIOMETRICS_FOR_WALLET_IV, "");
        String encryptedBase64 = SharedPreferencesManager.getInstance().readString(
                HnsPreferenceKeys.HNS_BIOMETRICS_FOR_WALLET_ENCRYPTED, "");
        ...
        SecretKey secretKey =
                ((KeyStore.SecretKeyEntry) keyStore.getEntry(HNS_WALLET_ALIAS, null))
                        .getSecretKey();
    ...
    public static void resetBiometric() {
        ...
        manager.removeKey(HnsPreferenceKeys.HNS_USE_BIOMETRICS_FOR_WALLET);
        manager.removeKey(HnsPreferenceKeys.HNS_BIOMETRICS_FOR_WALLET_ENCRYPTED);
        manager.removeKey(HnsPreferenceKeys.HNS_BIOMETRICS_FOR_WALLET_IV);
    }
}
