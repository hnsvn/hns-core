...
import org.chromium.hns_wallet.mojom.AssetTimePrice;
...
public class PortfolioHelper {
    ...
    public PortfolioHelper(HnsWalletBaseActivity activity, List<NetworkInfo> cryptoNetworks,
    ...
    public void fetchNfts(@NonNull final Callbacks.Callback1<PortfolioHelper> callback) {
        ...
        final HnsWalletBaseActivity activity = mActivity.get();
        ...
        final HnsWalletService hnsWalletService = activity.getHnsWalletService();
        ...
        for (NetworkInfo networkInfo : mSelectedNetworks) {
            TokenUtils.getUserAndAllTokensFiltered(hnsWalletService, blockchainRegistry,
    ...
    public void calculateFiatHistory(Runnable runWhenDone) {
        ...
        historyMultiResponse.setWhenAllCompletedAction(() -> {
            ...
            // components/hns_wallet_ui/common/reducers/wallet_reducer.ts
