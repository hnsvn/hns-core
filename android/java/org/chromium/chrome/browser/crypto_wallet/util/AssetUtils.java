...
public class AssetUtils {
    ...
    public static boolean isAuroraAddress(String contractAddress, String chainId) {
        ...
        return (isEthereumBridgeAddress || isNativeAsset)
                && chainId.equals(HnsWalletConstants.MAINNET_CHAIN_ID);
    }
     ...
     *         defaults to {@link HnsWalletConstants.DEFAULT_KEYRING_ID}.
     */
    ...
    public static String mapToRampNetworkSymbol(
        ...
        if (assetSymbol.equalsIgnoreCase("bat")
                && assetChainId.equals(HnsWalletConstants.MAINNET_CHAIN_ID)) {
            // BAT is the only token on Ethereum Mainnet with a prefix on Ramp.Network
            return "ETH_BAT";
        } else if (assetChainId.equals(HnsWalletConstants.AVALANCHE_MAINNET_CHAIN_ID)
                && TextUtils.isEmpty(contractAddress)) {
    ...
    private static final Map<String, List<String>> NATIVE_TOKENS_PER_CHAIN = new HashMap<>() {
        {
            put(HnsWalletConstants.MAINNET_CHAIN_ID, Arrays.asList("eth"));
            put(HnsWalletConstants.OPTIMISM_MAINNET_CHAIN_ID, Arrays.asList("eth"));
            put(HnsWalletConstants.AURORA_MAINNET_CHAIN_ID, Arrays.asList("eth"));
            put(HnsWalletConstants.POLYGON_MAINNET_CHAIN_ID, Arrays.asList("matic"));
            put(HnsWalletConstants.FANTOM_MAINNET_CHAIN_ID, Arrays.asList("ftm"));
            put(HnsWalletConstants.CELO_MAINNET_CHAIN_ID, Arrays.asList("celo"));
            put(HnsWalletConstants.BINANCE_SMART_CHAIN_MAINNET_CHAIN_ID, Arrays.asList("bnb"));
            put(HnsWalletConstants.SOLANA_MAINNET, Arrays.asList("sol"));
            put(HnsWalletConstants.FILECOIN_MAINNET, Arrays.asList("fil"));
            put(HnsWalletConstants.AVALANCHE_MAINNET_CHAIN_ID, Arrays.asList("avax", "avaxc"));
            // Test Net
            put(HnsWalletConstants.GOERLI_CHAIN_ID, Arrays.asList("eth"));
            put(HnsWalletConstants.SEPOLIA_CHAIN_ID, Arrays.asList("eth"));
            put(HnsWalletConstants.SOLANA_TESTNET, Arrays.asList("sol"));
            put(HnsWalletConstants.SOLANA_DEVNET, Arrays.asList("sol"));
            put(HnsWalletConstants.FILECOIN_TESTNET, Arrays.asList("fil"));
        }
    };
    ...
    public static String assetRatioId(BlockchainToken token) {
        ...
        if (HnsWalletConstants.MAINNET_CHAIN_ID.equals(token.chainId)
