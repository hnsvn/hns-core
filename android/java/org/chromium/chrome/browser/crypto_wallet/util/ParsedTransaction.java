...
import org.chromium.hns_wallet.mojom.FilTxData;
 ...
 * components/hns_wallet_ui/common/hooks/transaction-parser.ts.
 */
public class ParsedTransaction extends ParsedTransactionFees {
    ...
    private static String checkForContractAddressError(BlockchainToken[] fullTokenList, String to) {
        ...
        return token != null ? "hnsWalletContractAddressError" : null;
    }
