...
import org.chromium.hns_wallet.mojom.OnRampProvider;
...
public class TokenUtils {
     ...
     * HnsWalletService.getUserAssets contains the native asset on init, but:
     ...
     * front
     *
     * See `refreshVisibleTokenInfo` in components/hns_wallet_ui/common/async/lib.ts.
     */
    ...
    public static void getVisibleUserAssetsFiltered(HnsWalletService hnsWalletService,
            NetworkInfo selectedNetwork, int coinType, TokenType tokenType,
            Callbacks.Callback1<BlockchainToken[]> callback) {
        hnsWalletService.getUserAssets(
     ...
     * @param blockchainRegistry HnsChainRegistry to retrieve all tokens from core.
     ...
     * @param hnsWalletService HnsWalletService to retrieve user asset from core.
     * @param blockchainRegistry HnsChainRegistry to retrieve all tokens from core.
     ...
     */
    public static void getAllTokensFiltered(HnsWalletService hnsWalletService,
     ...
     *
     * @param hnsWalletService HnsWalletService instance used to get the user tokens.
     ...
     */
    public static void getUserAndAllTokensFiltered(HnsWalletService hnsWalletService,
    ...
    public static void getUserOrAllTokensFiltered(HnsWalletService hnsWalletService,
            BlockchainRegistry blockchainRegistry, NetworkInfo selectedNetwork, int coinType,
        ...
        if (userAssetsOnly)
            getVisibleUserAssetsFiltered(
                    hnsWalletService, selectedNetwork, coinType, tokenType, callback);
        else
            getAllTokensFiltered(
                    hnsWalletService, blockchainRegistry, selectedNetwork, tokenType, callback);
    }
    ...
    public static void getExactUserAsset(HnsWalletService hnsWalletService,
        ...
        getVisibleUserAssetsFiltered(
                hnsWalletService, selectedNetwork, coinType, TokenType.ALL, userAssets -> {
