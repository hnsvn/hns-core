...
import org.chromium.hns_wallet.mojom.HnsWalletServiceObserver;
import org.chromium.hns_wallet.mojom.OriginInfo;
import org.chromium.mojo.system.MojoException;

import java.lang.ref.WeakReference;

public class HnsWalletServiceObserverImpl implements HnsWalletServiceObserver {
    public interface HnsWalletServiceObserverImplDelegate {
    ...
    private WeakReference<HnsWalletServiceObserverImplDelegate> mDelegate;

    public HnsWalletServiceObserverImpl(HnsWalletServiceObserverImplDelegate delegate) {
    ...
    private HnsWalletServiceObserverImplDelegate getRef() {
