...
import org.chromium.hns_wallet.mojom.SolanaAccountMeta;
import org.chromium.hns_wallet.mojom.SolanaInstruction;
import org.chromium.hns_wallet.mojom.SolanaInstructionAccountParam;
import org.chromium.hns_wallet.mojom.SolanaInstructionParam;
...
public class SolanaInstructionPresenter {
    ...
    public List<TwoLineItem> toTwoLineList(Context context) {
        ...
        var txSubType =
                context.getString(TransactionUtils.getSolTxSubType(mSolanaInstruction.programId,
                        mSolanaInstruction.decodedData != null
                                ...
                                : -1));
        if (!txSubType.equals(context.getString(R.string.hns_wallet_unknown))) {
        ...
        if (shouldShowRawData()) {
            ...
            twoLineItems.add(
                    new TwoLineItemHeader(context.getString(R.string.hns_wallet_data_text)));
            twoLineItems.addAll(solanaInstructionPresenter.dataToList());

            twoLineItems.add(
                    new TwoLineItemHeader(context.getString(R.string.hns_wallet_tx_progam_id)));
            ...
            for (SolanaAccountMeta solanaAccountMeta : getSolanaInstruction().accountMetas) {
                ...
                if (lookupTableIndex != null) {
                    twoLineItemDataSources.add(new TwoLineItemText(
                            resources.getString(
                                    R.string.hns_wallet_solana_address_lookup_table_account),
                            null));
                }
                ...
                if (lookupTableIndex != null) {
                    twoLineItemDataSources.add(new TwoLineItemText(
                            resources.getString(
                                    R.string.hns_wallet_solana_address_lookup_table_index),
