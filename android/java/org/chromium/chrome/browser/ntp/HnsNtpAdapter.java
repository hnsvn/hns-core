...
public class HnsNtpAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private OnHnsNtpListener mOnHnsNtpListener;
    ...
    private static final String TAG = "HnsNtpAdapter";

    public HnsNtpAdapter(Activity activity, OnHnsNtpListener onHnsNtpListener,
            RequestManager glide, CopyOnWriteArrayList<FeedItemsCard> newsItems,
            HnsNewsController hnsNewsController, View mvTilesContainerLayout, NTPImage ntpImage,
            ...
            int recyclerViewHeight, boolean isTopSitesEnabled, boolean isHnsStatsEnabled,
            boolean isDisplayNews, boolean isDisplayNewsOptin) {
        mActivity = activity;
        mOnHnsNtpListener = onHnsNtpListener;
        mGlide = glide;
        ...
        mIsHnsStatsEnabled = isHnsStatsEnabled;
        ...
        if (holder instanceof StatsViewHolder) {
            ...
            statsViewHolder.hideStatsImg.setOnClickListener(view -> {
                SharedPreferencesManager.getInstance().writeBoolean(
                        BackgroundImagesPreferences.PREF_SHOW_HNS_STATS, false);
            });
            List<Pair<String, String>> statsPairs = HnsStatsUtil.getStatsPairs();
            ...
            statsViewHolder.ntpStatsLayout.setOnClickListener(
                    view -> { mOnHnsNtpListener.checkForHnsStats(); });
            ...
            newContentViewHolder.newContentLayout.setOnClickListener(
                    view -> { mOnHnsNtpListener.loadNewContent(); });
            ...
            if (mNtpImage instanceof Wallpaper && NTPUtil.isReferralEnabled()
                ...
                imageCreditViewHolder.superReferralLogo.setOnClickListener(view -> {
                    ...
                    qRCodeShareDialogFragment.setQRCodeText(HnsConstants.HNS_REF_URL
                            + mNTPBackgroundImagesBridge.getSuperReferralCode());
                    qRCodeShareDialogFragment.show(
                            ((HnsActivity) mActivity).getSupportFragmentManager(),
            ...
            newsOptinViewHolder.optinClose.setOnClickListener(
                    view -> { mOnHnsNtpListener.updateNewsOptin(false); });

            newsOptinViewHolder.optinLearnMore.setOnClickListener(view -> {
                TabUtils.openUrlInSameTab(HnsConstants.HNS_NEWS_LEARN_MORE_URL);
            });

            newsOptinViewHolder.optinButton.setOnClickListener(view -> {
                mOnHnsNtpListener.updateNewsOptin(true);
                mOnHnsNtpListener.getFeed(false);
            });
            ...
            if (newsPosition < mNewsItems.size()) {
                ...
                if (mHnsNewsController != null) {
                    new CardBuilderFeedCard(mHnsNewsController, mGlide,
            ...
            noSourcesViewHolder.btnChooseContent.setOnClickListener(view -> {
                if (mActivity instanceof HnsActivity) {
                    ((HnsActivity) mActivity).openHnsNewsSettings();
                }
            });
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_STATS) {
            view = LayoutInflater.from(parent.getContext())
                           .inflate(R.layout.hns_stats_layout, parent, false);
            ...
            view = LayoutInflater.from(parent.getContext())
                           .inflate(R.layout.hns_news_load_new_content, parent, false);
            ...
            view = LayoutInflater.from(parent.getContext())
                           .inflate(R.layout.hns_news_no_sources, parent, false);
    ...
    public void setHnsStatsEnabled(boolean isHnsStatsEnabled) {
        if (mIsHnsStatsEnabled != isHnsStatsEnabled) {
            mIsHnsStatsEnabled = isHnsStatsEnabled;
            if (mIsHnsStatsEnabled) {
                notifyItemInserted(getStatsCount());
            } else {
                notifyItemRemoved(getStatsCount());
            }
    ...
    public void setHnsNewsController(HnsNewsController hnsNewsController) {
        mHnsNewsController = hnsNewsController;
        notifyItemChanged(
                getStatsCount() + getTopSitesCount() + getNewContentCount() + ONE_ITEM_SPACE);
    }
    ...
    public void setImageCreditAlpha(float alpha) {
        ...
        // here https://github.com/hnsvn/hns-browser/issues/29343
    ...
    public static class StatsViewHolder extends RecyclerView.ViewHolder {
        ...
        StatsViewHolder(View itemView) {
            ...
            this.titleLayout = (LinearLayout) itemView.findViewById(R.id.hns_stats_title_layout);
            this.hideStatsImg = (ImageView) itemView.findViewById(R.id.widget_more_option);
            this.adsBlockedCountTv =
                    (TextView) itemView.findViewById(R.id.hns_stats_text_ads_count);
            this.adsBlockedCountTextTv =
                    (TextView) itemView.findViewById(R.id.hns_stats_text_ads_count_text);
            this.dataSavedValueTv =
                    (TextView) itemView.findViewById(R.id.hns_stats_data_saved_value);
            this.dataSavedValueTextTv =
                    (TextView) itemView.findViewById(R.id.hns_stats_data_saved_value_text);
            this.estTimeSavedCountTv =
                    (TextView) itemView.findViewById(R.id.hns_stats_text_time_count);
            this.estTimeSavedCountTextTv =
                    (TextView) itemView.findViewById(R.id.hns_stats_text_time_count_text);
        }
    }
