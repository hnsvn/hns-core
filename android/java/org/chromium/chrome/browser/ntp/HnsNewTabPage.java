...
import org.chromium.chrome.browser.feed.HnsFeedSurfaceCoordinator;
...
public class HnsNewTabPage extends NewTabPage {
    ...
    public HnsNewTabPage(Activity activity,
        ...
        assert mNewTabPageLayout instanceof HnsNewTabPageLayout;
        if (mNewTabPageLayout instanceof HnsNewTabPageLayout) {
            ((HnsNewTabPageLayout) mNewTabPageLayout).setTab(tab);
            ((HnsNewTabPageLayout) mNewTabPageLayout).setTabProvider(activityTabProvider);
        }
    ...
    protected void initializeMainView(Activity activity, WindowAndroid windowAndroid,
        ...
        FeedSurfaceCoordinator feedSurfaceCoordinator = new HnsFeedSurfaceCoordinator(activity,
    ...
    public void updateSearchProviderHasLogo() {
        // Search provider logo is not used in Hns's NTP.
