...
public class HnsLocationBarCoordinator extends LocationBarCoordinator {
    /*
    ...
    public HnsLocationBarCoordinator(View locationBarLayout, View autocompleteAnchorView,
        ...
        if (mLocationBarMediator instanceof HnsLocationBarMediator) {
            mQRButton = locationBarLayout.findViewById(R.id.qr_button);
            mQRButton.setOnClickListener(
                    ((HnsLocationBarMediator) mLocationBarMediator)::qrButtonClicked);
        }
    }
