...
public class HnsLocationBarMediator extends LocationBarMediator {
    ...
    public HnsLocationBarMediator(@NonNull Context context,
    ...
    void updateQRButtonColors() {
        if (mLocationBarLayout instanceof HnsLocationBarLayout) {
            ((HnsLocationBarLayout) mLocationBarLayout)
                    .setQRButtonTint(
    ...
    private void openQRCodeDialog() {
        if (mContext != null && mContext instanceof AppCompatActivity) {
            HnsLocationBarQRDialogFragment hnsLocationBarQRDialogFragment =
                    HnsLocationBarQRDialogFragment.newInstance(this);
            hnsLocationBarQRDialogFragment.setCancelable(false);
            hnsLocationBarQRDialogFragment.show(
                    ((AppCompatActivity) mContext).getSupportFragmentManager(),
                    "HnsLocationBarQRDialogFragment");
        }
    }
