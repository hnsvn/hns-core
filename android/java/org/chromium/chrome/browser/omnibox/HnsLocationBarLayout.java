...
public class HnsLocationBarLayout extends LocationBarLayout {
    private ImageButton mQRButton;

    public HnsLocationBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mQRButton = findViewById(R.id.qr_button);
    }

    public HnsLocationBarLayout(Context context, AttributeSet attrs, int layoutId) {
