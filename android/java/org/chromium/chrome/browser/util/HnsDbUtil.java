...
public class HnsDbUtil {
    private static final String TAG = "HnsDbUtil";
    ...
    private static HnsDbUtil sInstance;

    private HnsDbUtil() {
    }

    public static HnsDbUtil getInstance() {
        if (sInstance != null)
            return sInstance;
        sInstance = new HnsDbUtil();
        return sInstance;
    }
