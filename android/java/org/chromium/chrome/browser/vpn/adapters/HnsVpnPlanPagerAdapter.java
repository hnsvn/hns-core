...
public class HnsVpnPlanPagerAdapter extends PagerAdapter {
    private final Context context;
    public HnsVpnPlanPagerAdapter(Context context) {
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_hns_vpn_plan, null);
