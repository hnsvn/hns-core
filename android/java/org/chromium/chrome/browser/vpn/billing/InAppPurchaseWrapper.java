...
public class InAppPurchaseWrapper {
    ...
    public static final String NIGHTLY_MONTHLY_SUBSCRIPTION = "nightly.hnsvpn.monthly";
    public static final String NIGHTLY_YEARLY_SUBSCRIPTION = "nightly.hnsvpn.yearly";

    public static final String RELEASE_MONTHLY_SUBSCRIPTION = "hns.vpn.monthly";
    public static final String RELEASE_YEARLY_SUBSCRIPTION = "hns.vpn.yearly";
    ...
    private void startBillingServiceConnection(
        ...
        if (!HnsVpnUtils.isVpnFeatureSupported(context)) {
            return;
        }
        ...
        if (!mBillingClient.isReady()) {
            try {
                mBillingClient.startConnection(new BillingClientStateListener() {
                    ...
                    public void onBillingSetupFinished(@NonNull BillingResult billingResult) {
                        if (billingResult.getResponseCode()
                            ...
                            HnsVpnUtils.showToast(billingResult.getDebugMessage());
                            retryBillingServiceConnection(billingClientConnectionState);
                        }
                    }
                });
                ...
                // https://github.com/hnsvn/hns-browser/issues/27751.
                ...
                if (isConnected) {
                    mBillingClient.acknowledgePurchase(acknowledgePurchaseParams, billingResult -> {
                        ...
                        if (billingResult.getResponseCode()
                            ...
                            if (activity != null) {
                                HnsVpnUtils.openHnsVpnProfileActivity(activity);
                                HnsVpnUtils.showToast(activity.getResources().getString(
