...
import org.chromium.chrome.browser.vpn.adapters.HnsVpnPlanPagerAdapter;
...
public class HnsVpnPlansActivity extends HnsVpnParentActivity {
    ...
    private void initializeViews() {
        setContentView(R.layout.activity_hns_vpn_plan);
        ...
        actionBar.setTitle(getResources().getString(R.string.hns_vpn));
        ...
        ViewPager hnsRewardsViewPager = findViewById(R.id.hns_rewards_view_pager);

        HnsVpnPlanPagerAdapter hnsVpnPlanPagerAdapter = new HnsVpnPlanPagerAdapter(this);
        hnsRewardsViewPager.setAdapter(hnsVpnPlanPagerAdapter);
        TabLayout hnsRewardsTabLayout = findViewById(R.id.hns_rewards_tab_layout);
        hnsRewardsTabLayout.setupWithViewPager(hnsRewardsViewPager, true);
    ...
    public void finishNativeInitialization() {
        ...
        HnsVpnUtils.showProgressDialog(
                HnsVpnPlansActivity.this, getResources().getString(R.string.vpn_connect_text));
                            ...
                            public void run() {
                                mMonthlySelectorLayout.setOnClickListener(v
                                        -> InAppPurchaseWrapper.getInstance().initiatePurchase(
                                                HnsVpnPlansActivity.this, monthlyProductDetails));
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                mYearlySelectorLayout.setOnClickListener(v
                                        -> InAppPurchaseWrapper.getInstance().initiatePurchase(
                                                HnsVpnPlansActivity.this, yearlyProductDetails));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_hns_vpn, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            HnsVpnUtils.openHnsVpnProfileActivity(HnsVpnPlansActivity.this);
        }
