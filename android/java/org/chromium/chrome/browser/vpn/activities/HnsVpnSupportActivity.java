...
import org.chromium.chrome.browser.firstrun.HnsFirstRunFlowSequencer;
...
public class HnsVpnSupportActivity extends AsyncInitializationActivity {
    ...
    protected void triggerLayoutInflation() {
        ...
        mFirstRunFlowSequencer = new HnsFirstRunFlowSequencer(this, mProfileSupplier) {
            @Override
    ...
    private void composeEmail(String body) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"hnsandroid@guardianapp.com"});
        intent.putExtra(Intent.EXTRA_SUBJECT, "Hns Firewall + VPN Issue");
