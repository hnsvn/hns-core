...
public class HnsStatsTable {
    public static final String TABLE_NAME = "hns_stats_table";
    ...
    public HnsStatsTable(String url, String domain, String statType, String statSite, String statSiteDomain, String timestamp) {
        mUrl = url;
        mDomain = domain;
        mStatType = statType;
        mStatSite = statSite;
