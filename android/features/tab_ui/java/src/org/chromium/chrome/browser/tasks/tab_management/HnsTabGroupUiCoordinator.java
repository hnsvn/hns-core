...
public class HnsTabGroupUiCoordinator extends TabGroupUiCoordinator {
    ...
    public HnsTabGroupUiCoordinator(@NonNull Activity activity, @NonNull ViewGroup parentView,
        ...
        if (toolbarRightButton != null) {
            toolbarRightButton.setImageResource(R.drawable.hns_new_group_tab);
        }
    }
