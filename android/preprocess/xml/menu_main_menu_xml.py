...
def _ProcessXML(root):
    ...
    '"http://schemas.android.com/apk/res/android" '\
      'android:id="@+id/hns_wallet_id" ' \
      'android:title="@string/menu_hns_wallet" ' \
    ...
    '"http://schemas.android.com/apk/res/android" '\
      'android:id="@+id/hns_playlist_id" ' \
      'android:title="@string/hns_playlist" />'
    playlist_node = ET.fromstring(playlist_node_str,
                                  parser=ET.XMLParser(encoding="utf-8"))

    parent = root.find('group/[@android:id="@+id/PAGE_MENU"]', namespaces=ns)
    child = parent.find('item/[@android:id="@+id/hns_wallet_id"]',
                        namespaces=ns)
    idx = list(parent).index(child)
    ...
    '"http://schemas.android.com/apk/res/android" '\
            'android:id="@+id/request_hns_vpn_row_menu_id" '\
            'android:title="@null"> '\
            '<menu> '\
                '<item android:id="@+id/request_hns_vpn_id" '\
                  'android:title="@string/hns_vpn" '\
                  'android:icon="@drawable/ic_vpn" /> '\
                '<item android:id="@+id/request_hns_vpn_check_id" '\
                  'android:title="@null" '\
    ...
    speedreader_node_str = '<item xmlns:android='\
            '"http://schemas.android.com/apk/res/android" '\
            'android:id="@+id/hns_speedreader_id" '\
            'android:title="@string/hns_speedreader_title" '\
