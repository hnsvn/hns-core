...
public class HnsFeedSurfaceCoordinator extends FeedSurfaceCoordinator {
    ...
    public HnsFeedSurfaceCoordinator(Activity activity, SnackbarManager snackbarManager,
