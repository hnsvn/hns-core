...
def main():
    ...
    # HNS_REPO is defined in lib/helpers.py
    repo = GitHub(os.environ.get('GITHUB_TOKEN')).repos(HNS_REPO)
...
def parse_args():
    desc = "Parse Hns Browser changelog and add markdown to release notes for tag" \
