...
def get_remote_audit_config(
        url = "https://raw.githubusercontent.com/hns/audit-config/main/config.json",
        retry = 3):
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Audit hns-core npm deps')
    parser.add_argument('input_dir', nargs='?', help='Directory to check')
    parser.add_argument('--source_root', required=True,
                        help='Full path of the src/hns directory')
