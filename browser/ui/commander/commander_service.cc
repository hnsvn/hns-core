...
#include "hns/browser/ui/commander/commander_service.h"
...
#include "hns/browser/ui/commander/hns_simple_command_source.h"
#include "hns/browser/ui/commander/ranker.h"
#include "hns/components/commander/browser/commander_frontend_delegate.h"
#include "hns/components/commander/browser/commander_item_model.h"
...
CommanderService::CommanderService(Profile* profile)
  ...
  command_sources_.push_back(std::make_unique<HnsSimpleCommandSource>());
  ...
  command_sources_.push_back(std::make_unique<HnsTabCommandSource>());
}
