...
class HnsWhatsNewBrowserTest : public InProcessBrowserTest {
 public:
  HnsWhatsNewBrowserTest() {
  ...
  ~HnsWhatsNewBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(HnsWhatsNewBrowserTest,
...
IN_PROC_BROWSER_TEST_F(HnsWhatsNewBrowserTest,
  ...
  EXPECT_EQ(GURL("https://hns.com/whats-new/"),
            tab_model()->GetActiveWebContents()->GetVisibleURL());
...
IN_PROC_BROWSER_TEST_F(HnsWhatsNewBrowserTest,
  ...
  // user.
  EXPECT_EQ(1, tab_model()->count());
  EXPECT_NE(GURL("https://hns.com/whats-new/"),
            tab_model()->GetActiveWebContents()->GetVisibleURL());
}
