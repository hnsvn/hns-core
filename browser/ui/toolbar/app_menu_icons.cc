...
const std::map<int, const gfx::VectorIcon&>& GetCommandIcons() {
  static const base::NoDestructor<std::map<int, const gfx::VectorIcon&>>
      kCommandIcons({
          ...
          {IDC_SHOW_HNS_REWARDS, kLeoProductBatOutlineIcon},
          {IDC_SHOW_HNS_WALLET, kLeoProductHnsWalletIcon},
          {IDC_HNS_VPN_MENU, kLeoProductVpnIcon},
          ...
          // The `VPN` submenu
          {IDC_TOGGLE_HNS_VPN, kLeoProductVpnIcon},
          {IDC_TOGGLE_HNS_VPN_TOOLBAR_BUTTON, kLeoEyeOnIcon},
          {IDC_SHOW_HNS_VPN_PANEL, kLeoProductVpnIcon},
          {IDC_SEND_HNS_VPN_FEEDBACK, kLeoMessageHeartIcon},
          {IDC_MANAGE_HNS_VPN_PLAN, kLeoLaunchIcon},
          {IDC_ABOUT_HNS_VPN, kLeoInfoOutlineIcon},

          // The `Bookmarks` submenu
          {IDC_BOOKMARK_THIS_TAB, kLeoBrowserBookmarkAddIcon},
          {IDC_BOOKMARK_ALL_TABS, kLeoBrowserBookmarkPluralIcon},
          {IDC_HNS_BOOKMARK_BAR_SUBMENU, kLeoProductBookmarksIcon},
          ...
          // The `Help` menu
          {IDC_ABOUT, kLeoHnsIconMonochromeIcon},
          {IDC_HELP_PAGE_VIA_MENU, kLeoHelpOutlineIcon},
          {IDC_SHOW_HNS_WEBCOMPAT_REPORTER, kLeoWarningTriangleOutlineIcon},
          ...
          {IDC_SHOW_HNS_SYNC, kLeoProductSyncIcon},
