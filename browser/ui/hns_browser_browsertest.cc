...
using HnsBrowserBrowserTest = InProcessBrowserTest;
...
IN_PROC_BROWSER_TEST_F(HnsBrowserBrowserTest, NTPFaviconTest) {
...
IN_PROC_BROWSER_TEST_F(HnsBrowserBrowserTest, LoadWebUIURLWithBadSchemeTest) {
  ASSERT_TRUE(
      ui_test_utils::NavigateToURL(browser(), GURL("http://settings/")));
}

IN_PROC_BROWSER_TEST_F(HnsBrowserBrowserTest, DisabledFeatureURLLoadTest) {
...
IN_PROC_BROWSER_TEST_F(HnsBrowserBrowserTest, OpenNewTabWhenTabStripIsEmpty) {
...
IN_PROC_BROWSER_TEST_F(HnsBrowserBrowserTest,
