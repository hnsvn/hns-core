...
#if BUILDFLAG(ENABLE_HNS_VPN) || BUILDFLAG(ENABLE_SPEEDREADER)
...
void AddHnsVpnColorMixer(ui::ColorProvider* provider,
                           const ui::ColorProviderKey& key) {
  ui::ColorMixer& mixer = provider->AddMixer();

  mixer[kColorHnsVpnButtonText] = {
      PickColorContrastingToToolbar(key, mixer, SkColorSetRGB(0x1C, 0x1E, 0x26),
                                    SkColorSetRGB(0xED, 0xEE, 0xF1))};
  mixer[kColorHnsVpnButtonTextError] = {
      PickColorContrastingToToolbar(key, mixer, SkColorSetRGB(0xDC, 0x1D, 0x3C),
                                    SkColorSetRGB(0xEB, 0x63, 0x7A))};

  mixer[kColorHnsVpnButtonBorder] = {PickSimilarColorToToolbar(
      key, mixer, SkColorSetARGB(0x14, 0x13, 0x16, 0x20),
      SkColorSetARGB(0x4D, 0x04, 0x04, 0x06))};
  mixer[kColorHnsVpnButtonErrorBorder] = {kColorHnsVpnButtonTextError};

  mixer[kColorHnsVpnButtonIconConnected] = {SkColorSetRGB(0x3F, 0xA4, 0x50)};
  mixer[kColorHnsVpnButtonIconDisconnected] = {PickColorContrastingToToolbar(
      key, mixer, SkColorSetARGB(0x99, 0x0B, 0x16, 0x41),
      SkColorSetARGB(0xCC, 0xB1, 0xB7, 0xCD))};
  mixer[kColorHnsVpnButtonIconInner] = {PickSimilarColorToToolbar(
      key, mixer, SK_ColorWHITE, SkColorSetARGB(0x33, 0x04, 0x04, 0x06))};
  mixer[kColorHnsVpnButtonIconError] = {kColorHnsVpnButtonErrorBorder};
  mixer[kColorHnsVpnButtonIconErrorInner] = {PickSimilarColorToToolbar(
      key, mixer, SK_ColorWHITE, SkColorSetRGB(0x0F, 0x17, 0x2A))};

  mixer[kColorHnsVpnButtonBackgroundNormal] = {kColorToolbar};
  mixer[kColorHnsVpnButtonBackgroundHover] = {PickSimilarColorToToolbar(
      key, mixer, SkColorSetARGB(0x14, 0x13, 0x16, 0x20),
      SkColorSetARGB(0x4D, 0x04, 0x04, 0x06))};
  mixer[kColorHnsVpnButtonErrorBackgroundNormal] = {PickSimilarColorToToolbar(
      key, mixer, SkColorSetARGB(0x31, 0xDC, 0x1D, 0x3C),
      SkColorSetARGB(0x33, 0xEB, 0x63, 0x7A))};
  mixer[kColorHnsVpnButtonErrorBackgroundHover] = {PickSimilarColorToToolbar(
...
void AddHnsSpeedreaderColorMixer(ui::ColorProvider* provider,
                                   const ui::ColorProviderKey& key) {
  ui::ColorMixer& mixer = provider->AddMixer();
...
void AddChromeLightThemeColorMixer(ui::ColorProvider* provider,
  ...
  mixer[kColorDownloadShelfButtonText] = {gfx::kHnsGrey800};
  ...
  mixer[kColorNewTabPageBackground] = {kHnsNewTabBackgroundLight};
...
void AddChromeDarkThemeColorMixer(ui::ColorProvider* provider,
  ...
  mixer[kColorNewTabButtonBackgroundFrameActive] = {ui::kColorFrameActive};
  mixer[kColorNewTabButtonBackgroundFrameInactive] = {ui::kColorFrameInactive};
  mixer[kColorNewTabPageBackground] = {kHnsNewTabBackgroundDark};
  mixer[kColorTabBackgroundActiveFrameActive] = {kColorToolbar};
  mixer[kColorTabBackgroundActiveFrameInactive] = {kColorToolbar};
  mixer[kColorTabBackgroundInactiveFrameActive] = {ui::kColorFrameActive};
  mixer[kColorTabBackgroundInactiveFrameInactive] = {ui::kColorFrameInactive};
...
void AddHnsLightThemeColorMixer(ui::ColorProvider* provider,
                                  const ui::ColorProviderKey& key) {
  ui::ColorMixer& mixer = provider->AddMixer();
  ...
  // interaction.
  mixer[kColorHnsDownloadToolbarButtonActive] = {
  ...
  if (base::FeatureList::IsEnabled(tabs::features::kHnsVerticalTabs)) {
    tabs::AddHnsVerticalTabLightThemeColorMixer(provider, key);
  }
...
void AddHnsDarkThemeColorMixer(ui::ColorProvider* provider,
                                 const ui::ColorProviderKey& key) {
  ui::ColorMixer& mixer = provider->AddMixer();
  ...
  mixer[kColorDialogDontAskAgainButtonHovered] = {
      SkColorSetRGB(0xC2, 0xC4, 0xCF)};
  mixer[kColorSidebarAddBubbleBackground] = {gfx::kHnsGrey800};
  ...
  if (base::FeatureList::IsEnabled(tabs::features::kHnsVerticalTabs)) {
    tabs::AddHnsVerticalTabDarkThemeColorMixer(provider, key);
  }
...
void AddHnsThemeColorMixer(ui::ColorProvider* provider,
                             const ui::ColorProviderKey& key) {
  key.color_mode == ui::ColorProviderKey::ColorMode::kDark
      ? AddHnsDarkThemeColorMixer(provider, key)
      : AddHnsLightThemeColorMixer(provider, key);
#if BUILDFLAG(ENABLE_HNS_VPN)
  AddHnsVpnColorMixer(provider, key);
#endif
#if BUILDFLAG(ENABLE_SPEEDREADER)
  AddHnsSpeedreaderColorMixer(provider, key);
#endif
}

void AddHnsPrivateThemeColorMixer(ui::ColorProvider* provider,
                                    const ui::ColorProviderKey& key) {
  AddHnsDarkThemeColorMixer(provider, key);

  // Add private theme specific hns colors here.
  ui::ColorMixer& mixer = provider->AddMixer();
  mixer[kColorForTest] = {kPrivateColorForTest};
}

void AddHnsTorThemeColorMixer(ui::ColorProvider* provider,
                                const ui::ColorProviderKey& key) {
  AddHnsPrivateThemeColorMixer(provider, key);
  AddChromeDarkThemeColorMixer(provider, key);

  // Add tor theme specific hns colors here.
}
...
void AddTorThemeColorMixer(ui::ColorProvider* provider,
                           const ui::ColorProviderKey& key) {
  AddHnsTorThemeColorMixer(provider, key);
