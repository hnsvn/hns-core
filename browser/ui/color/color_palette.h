...
#ifndef HNS_BROWSER_UI_COLOR_COLOR_PALETTE_H_
#define HNS_BROWSER_UI_COLOR_COLOR_PALETTE_H_

#include "third_party/skia/include/core/SkColor.h"

// Although most of colors are only used at hns_color_mixer.cc,
...
constexpr SkColor kHnsNewTabBackgroundDark = SkColorSetRGB(0x33, 0x36, 0x39);
constexpr SkColor kHnsNewTabBackgroundLight = SkColorSetRGB(0x6B, 0x70, 0x84);

#endif  // HNS_BROWSER_UI_COLOR_COLOR_PALETTE_H_
