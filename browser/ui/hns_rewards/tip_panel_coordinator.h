...
#ifndef HNS_BROWSER_UI_HNS_REWARDS_TIP_PANEL_COORDINATOR_H_
#define HNS_BROWSER_UI_HNS_REWARDS_TIP_PANEL_COORDINATOR_H_
...
#endif  // HNS_BROWSER_UI_HNS_REWARDS_TIP_PANEL_COORDINATOR_H_
