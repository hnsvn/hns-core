...
HnsIconWithBadgeImageSource::HnsIconWithBadgeImageSource(
    const gfx::Size& size,
...
// static
gfx::Size HnsIconWithBadgeImageSource::GetMaxBadgeSize() {
  return gfx::Size(kBadgeMaxWidth, kBadgeHeight);
}

void HnsIconWithBadgeImageSource::SetAllowEmptyText(bool v) {
  allow_empty_text_ = v;
}

void HnsIconWithBadgeImageSource::PaintBadge(gfx::Canvas* canvas) {
  if (!badge_) {
    return;
  }
...
void HnsIconWithBadgeImageSource::PaintBadgeWithText(gfx::Canvas* canvas) {
  ...
  // LOG(ERROR) << "HnsAction badge text size initial, "
  //            << "w:"
  //            << text_width
  //            << " h:"
  //            << text_height;
...
void HnsIconWithBadgeImageSource::PaintBadgeWithoutText(
...
gfx::Rect HnsIconWithBadgeImageSource::GetBadgeRect(
...
gfx::Rect HnsIconWithBadgeImageSource::GetIconAreaRect() const {
  return gfx::Rect(size());
}

absl::optional<int> HnsIconWithBadgeImageSource::GetCustomGraphicSize() {
  return content_image_size_;
}

absl::optional<int> HnsIconWithBadgeImageSource::GetCustomGraphicXOffset() {
  return std::floor(
      (image_left_margin_extra_ + size().width() - content_image_size_) / 2.0);
}

absl::optional<int> HnsIconWithBadgeImageSource::GetCustomGraphicYOffset() {
