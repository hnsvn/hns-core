...
class TipPanelBubbleManager : public HnsWebUIBubbleManager<TipPanelUI> {
 public:
  ...
  base::WeakPtr<WebUIBubbleDialogView> CreateWebUIBubbleDialog(
    ...
    return HnsWebUIBubbleManager::CreateWebUIBubbleDialog(anchor, arrow);
  }
};
