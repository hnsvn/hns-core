...
#ifndef HNS_BROWSER_UI_VIEWS_HNS_REWARDS_TIP_PANEL_BUBBLE_HOST_H_
#define HNS_BROWSER_UI_VIEWS_HNS_REWARDS_TIP_PANEL_BUBBLE_HOST_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_HNS_REWARDS_TIP_PANEL_BUBBLE_HOST_H_
