...
HnsContentsLayoutManager::HnsContentsLayoutManager(
...
HnsContentsLayoutManager::~HnsContentsLayoutManager() = default;

void HnsContentsLayoutManager::Layout(views::View* contents_container) {
...
int HnsContentsLayoutManager::CalculateTargetSideBarWidth() const {
  int proposed_sidebar_width =
