...
HnsBrowserFrameViewLinuxNative::HnsBrowserFrameViewLinuxNative(
    BrowserFrame* frame,
...
HnsBrowserFrameViewLinuxNative::~HnsBrowserFrameViewLinuxNative() = default;

void HnsBrowserFrameViewLinuxNative::MaybeUpdateCachedFrameButtonImages() {
...
void HnsBrowserFrameViewLinuxNative::Layout() {
...
views::Button* HnsBrowserFrameViewLinuxNative::FrameButtonToButton(
...
void HnsBrowserFrameViewLinuxNative::
    UpdateLeadingTrailingCaptionButtonWidth() {
...
BEGIN_METADATA(HnsBrowserFrameViewLinuxNative, OpaqueBrowserFrameView)
END_METADATA
