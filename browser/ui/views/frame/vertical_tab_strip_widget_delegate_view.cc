...
class VerticalTabStripRootView : public views::internal::RootView {
 public:
  ...
  bool OnMousePressed(const ui::MouseEvent& event) override {
    ...
    // https://github.com/hnsvn/hns-browser/issues/28090
    // https://github.com/hnsvn/hns-browser/issues/27812
    ...
    // https://github.com/hnsvn/hns-browser/issues/29993
...
void VerticalTabStripWidgetDelegateView::OnWidgetVisibilityChanged(
  ...
  if (widget == GetWidget()) {
    if (!tabs::utils::ShouldShowVerticalTabs(browser_view_->browser()) &&
      ...
      // https://github.com/hnsvn/hns-browser/issues/29917
      widget->Hide();
    }
  }
}
