...
#ifndef HNS_BROWSER_UI_VIEWS_TOOLBAR_BOOKMARK_BUTTON_H_
#define HNS_BROWSER_UI_VIEWS_TOOLBAR_BOOKMARK_BUTTON_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_TOOLBAR_BOOKMARK_BUTTON_H_
