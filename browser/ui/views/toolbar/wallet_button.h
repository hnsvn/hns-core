...
#ifndef HNS_BROWSER_UI_VIEWS_TOOLBAR_WALLET_BUTTON_H_
#define HNS_BROWSER_UI_VIEWS_TOOLBAR_WALLET_BUTTON_H_
...
class WalletButton : public ToolbarButton {
 ...
 private:
  ...
  std::unique_ptr<hns::WalletButtonNotificationSource> notification_source_;
...
#endif  // HNS_BROWSER_UI_VIEWS_TOOLBAR_WALLET_BUTTON_H_
