...
HnsTabGroupUnderline::HnsTabGroupUnderline(
    TabGroupViews* tab_group_views,
    const tab_groups::TabGroupId& group,
    const TabGroupStyle& style)
    : TabGroupUnderline(tab_group_views, group, style) {}

HnsTabGroupUnderline::~HnsTabGroupUnderline() = default;

void HnsTabGroupUnderline::UpdateBounds(const views::View* leading_view,
...
gfx::Insets HnsTabGroupUnderline::GetInsetsForUnderline(
...
gfx::Rect HnsTabGroupUnderline::CalculateTabGroupUnderlineBounds(
  ...
  if (trailing_bounds.height()) {
    trailing_bounds.set_height(trailing_bounds.height() +
                               HnsTabGroupHeader::kPaddingForGroup);
  }
...
bool HnsTabGroupUnderline::ShouldShowVerticalTabs() const {
