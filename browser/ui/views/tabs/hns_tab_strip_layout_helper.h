...
#ifndef HNS_BROWSER_UI_VIEWS_TABS_HNS_TAB_STRIP_LAYOUT_HELPER_H_
#define HNS_BROWSER_UI_VIEWS_TABS_HNS_TAB_STRIP_LAYOUT_HELPER_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_TABS_HNS_TAB_STRIP_LAYOUT_HELPER_H_
