...
#ifndef HNS_BROWSER_UI_VIEWS_TABS_TAB_DRAG_CONTROLLER_H_
#define HNS_BROWSER_UI_VIEWS_TABS_TAB_DRAG_CONTROLLER_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_TABS_TAB_DRAG_CONTROLLER_H_
