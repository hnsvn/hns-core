...
HnsTabGroupHeader::~HnsTabGroupHeader() = default;

void HnsTabGroupHeader::AddedToWidget() {
...
void HnsTabGroupHeader::VisualsChanged() {
...
bool HnsTabGroupHeader::ShouldShowVerticalTabs() const {
...
void HnsTabGroupHeader::LayoutTitleChip() {
  DCHECK(base::FeatureList::IsEnabled(tabs::features::kHnsVerticalTabs))
      << "This should be called only when the flag is on.";
...
BEGIN_METADATA(HnsTabGroupHeader, TabGroupHeader)
END_METADATA
