...
#ifndef HNS_BROWSER_UI_VIEWS_TABS_VERTICAL_TAB_UTILS_H_
#define HNS_BROWSER_UI_VIEWS_TABS_VERTICAL_TAB_UTILS_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_TABS_VERTICAL_TAB_UTILS_H_
