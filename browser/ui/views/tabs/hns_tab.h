...
#ifndef HNS_BROWSER_UI_VIEWS_TABS_HNS_TAB_H_
#define HNS_BROWSER_UI_VIEWS_TABS_HNS_TAB_H_
...
class HnsTab : public Tab {
 public:
  explicit HnsTab(TabSlotController* controller);
  HnsTab(const HnsTab&) = delete;
  HnsTab& operator=(const HnsTab&) = delete;
  ~HnsTab() override;
...
#endif  // HNS_BROWSER_UI_VIEWS_TABS_HNS_TAB_H_
