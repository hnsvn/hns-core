...
HnsNewsFeedsContainerView::HnsNewsFeedsContainerView(
  ...
  for (auto& feed_item : available_feeds) {
    auto* child = AddChildView(
        std::make_unique<HnsNewsFeedItemView>(feed_item, contents));
...
HnsNewsFeedsContainerView::~HnsNewsFeedsContainerView() = default;

void HnsNewsFeedsContainerView::OnThemeChanged() {
...
BEGIN_METADATA(HnsNewsFeedsContainerView, views::View)
END_METADATA
