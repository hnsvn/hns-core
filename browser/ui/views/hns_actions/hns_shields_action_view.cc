...
class HnsShieldsActionViewHighlightPathGenerator
    : public views::HighlightPathGenerator {
 public:
  HnsShieldsActionViewHighlightPathGenerator() = default;
  HnsShieldsActionViewHighlightPathGenerator(
      const HnsShieldsActionViewHighlightPathGenerator&) = delete;
  HnsShieldsActionViewHighlightPathGenerator& operator=(
      const HnsShieldsActionViewHighlightPathGenerator&) = delete;
  ~HnsShieldsActionViewHighlightPathGenerator() override = default;

  SkPath GetHighlightPath(const views::View* view) override {
    return static_cast<const HnsShieldsActionView*>(view)->GetHighlightPath();
  }
};
}  // namespace

HnsShieldsActionView::HnsShieldsActionView(Profile& profile,
                                               TabStripModel& tab_strip_model)
    : LabelButton(base::BindRepeating(&HnsShieldsActionView::ButtonPressed,
  ...
  SetAccessibleName(
      hns_l10n::GetLocalizedResourceUTF16String(IDS_HNS_SHIELDS));
  ...
  auto menu_button_controller = std::make_unique<views::MenuButtonController>(
      this,
      base::BindRepeating(&HnsShieldsActionView::ButtonPressed,
                          base::Unretained(this)),
...
HnsShieldsActionView::~HnsShieldsActionView() {
  auto* web_contents = tab_strip_model_->GetActiveWebContents();
  if (web_contents) {
    hns_shields::HnsShieldsDataController::FromWebContents(web_contents)
        ->RemoveObserver(this);
...
void HnsShieldsActionView::Init() {
  UpdateIconState();
  views::HighlightPathGenerator::Install(
      this, std::make_unique<HnsShieldsActionViewHighlightPathGenerator>());
}

SkPath HnsShieldsActionView::GetHighlightPath() const {
  ...
  auto highlight_insets =
      gfx::Insets::TLBR(0, 0, 0, -1 * kHnsActionLeftMarginExtra);
...
HnsShieldsActionView::GetImageSource() {
  ...
  std::unique_ptr<IconWithBadgeImageSource> image_source(
      new hns::HnsIconWithBadgeImageSource(
          preferred_size, std::move(get_color_provider_callback),
          kHnsActionGraphicSize, kHnsActionLeftMarginExtra));
  ...
  if (web_contents) {
    auto* shields_data_controller =
        hns_shields::HnsShieldsDataController::FromWebContents(
            web_contents);
    ...
    is_enabled = shields_data_controller->GetHnsShieldsEnabled();
...
gfx::ImageSkia HnsShieldsActionView::GetIconImage(bool is_enabled) {
  ui::ResourceBundle& rb = ui::ResourceBundle::GetSharedInstance();
  gfx::ImageSkia image;
  const SkBitmap bitmap =
      rb.GetImageNamed(is_enabled ? IDR_HNS_SHIELDS_ICON_64
                                  : IDR_HNS_SHIELDS_ICON_64_DISABLED)
          .AsBitmap();
  float scale = static_cast<float>(bitmap.width()) / kHnsActionGraphicSize;
  image.AddRepresentation(gfx::ImageSkiaRep(bitmap, scale));
  return image;
}

void HnsShieldsActionView::UpdateIconState() {
...
void HnsShieldsActionView::ButtonPressed() {
  ...
  if (!webui_bubble_manager_) {
    webui_bubble_manager_ =
        std::make_unique<HnsWebUIBubbleManager<ShieldsPanelUI>>(
            this, &*profile_, GURL(kShieldsPanelURL), IDS_HNS_SHIELDS);
  }
...
bool HnsShieldsActionView::SchemeIsLocal(GURL url) {
  return url.SchemeIs(url::kAboutScheme) || url.SchemeIs(url::kBlobScheme) ||
         ...
         url.SchemeIs(kHnsUIScheme) || url.SchemeIs(content::kChromeUIScheme);
}

std::unique_ptr<views::LabelButtonBorder>
HnsShieldsActionView::CreateDefaultBorder() const {
...
std::u16string HnsShieldsActionView::GetTooltipText(
  ...
  if (web_contents) {
    ...
    if (count > 0) {
      return l10n_util::GetStringFUTF16Int(IDS_HNS_SHIELDS_ICON_TOOLTIP,
                                           count);
    }
  }

  return hns_l10n::GetLocalizedResourceUTF16String(IDS_HNS_SHIELDS);
}

void HnsShieldsActionView::Update() {
  UpdateIconState();
}

void HnsShieldsActionView::OnResourcesChanged() {
  UpdateIconState();
}

void HnsShieldsActionView::OnShieldsEnabledChanged() {
  UpdateIconState();
}

void HnsShieldsActionView::OnTabStripModelChanged(
    TabStripModel* tab_strip_model,
