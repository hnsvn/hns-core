...
#include "hns/browser/ui/views/bookmarks/bookmark_bar_instructions_view.h"

#include <algorithm>

#include "base/strings/utf_string_conversions.h"
#include "hns/browser/ui/hns_view_ids.h"
...
BookmarkBarInstructionsView::BookmarkBarInstructionsView(Browser* browser)
    : browser_(browser) {
  SetID(HNS_VIEW_ID_BOOKMARK_IMPORT_INSTRUCTION_VIEW);
  instructions_ = new views::Label(
      hns_l10n::GetLocalizedResourceUTF16String(IDS_BOOKMARKS_NO_ITEMS),
  ...
  if (browser_defaults::kShowImportOnBookmarkBar) {
    import_link_ = new views::Link(hns_l10n::GetLocalizedResourceUTF16String(
