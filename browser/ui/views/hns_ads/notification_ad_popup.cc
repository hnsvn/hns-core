...
void NotificationAdPopup::GetAccessibleNodeData(ui::AXNodeData* node_data) {
  ...
  node_data->SetName(
      l10n_util::GetStringUTF8(IDS_HNS_ADS_NOTIFICATION_AD_ACCESSIBLE_NAME));
}
