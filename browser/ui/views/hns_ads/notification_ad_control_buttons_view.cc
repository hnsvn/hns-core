...
#include "hns/browser/ui/views/hns_ads/notification_ad_control_buttons_view.h"
...
#include "hns/browser/ui/views/hns_ads/padded_image_button.h"
...
void NotificationAdControlButtonsView::UpdateInfoButton() {
  ...
  const gfx::ImageSkia image_skia = gfx::CreateVectorIcon(
      should_use_dark_colors ? kHnsAdsDarkModeInfoButtonIcon
                             : kHnsAdsLightModeInfoButtonIcon,
...
void NotificationAdControlButtonsView::CreateCloseButton() {
  ...
  close_button_->SetAccessibleName(hns_l10n::GetLocalizedResourceUTF16String(
      IDS_HNS_ADS_NOTIFICATION_AD_CLOSE_BUTTON));
}
...
void NotificationAdControlButtonsView::UpdateCloseButton() {
  ...
  const gfx::ImageSkia image_skia = gfx::CreateVectorIcon(
      kHnsAdsCloseButtonIcon, kCloseButtonIconDipSize,
