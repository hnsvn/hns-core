...
#ifndef HNS_BROWSER_UI_VIEWS_HNS_ADS_NOTIFICATION_AD_CONTROL_BUTTONS_VIEW_H_
#define HNS_BROWSER_UI_VIEWS_HNS_ADS_NOTIFICATION_AD_CONTROL_BUTTONS_VIEW_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_HNS_ADS_NOTIFICATION_AD_CONTROL_BUTTONS_VIEW_H_
