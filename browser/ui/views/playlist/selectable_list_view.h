...
#ifndef HNS_BROWSER_UI_VIEWS_PLAYLIST_SELECTABLE_LIST_VIEW_H_
#define HNS_BROWSER_UI_VIEWS_PLAYLIST_SELECTABLE_LIST_VIEW_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_PLAYLIST_SELECTABLE_LIST_VIEW_H_
