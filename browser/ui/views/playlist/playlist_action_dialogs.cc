...
#include "hns/browser/ui/views/playlist/playlist_action_dialogs.h"
...
#include "hns/browser/ui/views/playlist/thumbnail_view.h"
 ...
 public:
  ...
  explicit TiledItemsView(
    ...
    SetBorder(views::CreateThemedRoundedRectBorder(
        /*thickness=*/1, kCornerRadius, kColorHnsPlaylistListBorder));
...
PlaylistNewPlaylistDialog::PlaylistNewPlaylistDialog(
  ...
  auto* name_field_container = AddChildView(
      create_container(this, IDS_PLAYLIST_NEW_PLAYLIST_DIALOG_NAME_TEXTFIELD,
                       kColorHnsPlaylistNewPlaylistDialogNameLabel,
  ...
  if (movable_items.size()) {
    auto* items_list_view_container = AddChildView(create_container(
        ...
        kColorHnsPlaylistNewPlaylistDialogItemsLabel,
    ...
    scroll_view->SetBorder(views::CreateThemedRoundedRectBorder(
        /*thickness=*/1,
        /*corner_radius=*/4.f, kColorHnsPlaylistListBorder));
...
void PlaylistMoveDialog::EnterChoosePlaylistMode() {
  ...
  description->SetEnabledColorId(kColorHnsPlaylistMoveDialogDescription);
...
void PlaylistMoveDialog::EnterCreatePlaylistMode() {
  ...
  title->SetEnabledColorId(
      kColorHnsPlaylistMoveDialogCreatePlaylistAndMoveTitle);
