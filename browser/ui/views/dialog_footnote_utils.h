...
#ifndef HNS_BROWSER_UI_VIEWS_DIALOG_FOOTNOTE_UTILS_H_
#define HNS_BROWSER_UI_VIEWS_DIALOG_FOOTNOTE_UTILS_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_DIALOG_FOOTNOTE_UTILS_H_
