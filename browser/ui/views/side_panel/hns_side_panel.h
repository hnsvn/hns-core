...
#ifndef HNS_BROWSER_UI_VIEWS_SIDE_PANEL_HNS_SIDE_PANEL_H_
#define HNS_BROWSER_UI_VIEWS_SIDE_PANEL_HNS_SIDE_PANEL_H_
...
// unique inset and border style compared to Hns.
// SidebarContainerView controls this panel's visibility.
class HnsSidePanel : public views::View,
 ...
 public:
  ...
  METADATA_HEADER(HnsSidePanel);
  // Same signature as chromium SidePanel
  explicit HnsSidePanel(BrowserView* browser_view,
                          HorizontalAlignment horizontal_alignment =
                              HorizontalAlignment::kHorizontalAlignLeft);
  HnsSidePanel(const HnsSidePanel&) = delete;
  HnsSidePanel& operator=(const HnsSidePanel&) = delete;
  ~HnsSidePanel() override;
...
#endif  // HNS_BROWSER_UI_VIEWS_SIDE_PANEL_HNS_SIDE_PANEL_H_
