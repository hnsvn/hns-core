...
#ifndef HNS_BROWSER_UI_VIEWS_HNS_TOOLTIPS_HNS_TOOLTIP_POPUP_H_
#define HNS_BROWSER_UI_VIEWS_HNS_TOOLTIPS_HNS_TOOLTIP_POPUP_H_
...
//       this);
//   auto popup = std::make_unique<hns_tooltips::HnsTooltipPopup>(
...
// presseses will forward to the delegate (set via the HnsTooltip
// constructor). Finally, the tooltip is closed.
class HnsTooltipPopup : public views::WidgetDelegateView,
                          public views::WidgetObserver,
                          public gfx::AnimationDelegate,
                          public display::DisplayObserver {
 public:
  METADATA_HEADER(HnsTooltipPopup);

  HnsTooltipPopup(Profile* profile, std::unique_ptr<HnsTooltip> tooltip);
  ~HnsTooltipPopup() override;

  HnsTooltipPopup(const HnsTooltipPopup&) = delete;
  HnsTooltipPopup& operator=(const HnsTooltipPopup&) = delete;
 ...
 private:
  ...
  std::unique_ptr<HnsTooltip> tooltip_;

  raw_ptr<HnsTooltipView> tooltip_view_ = nullptr;
...
#endif  // HNS_BROWSER_UI_VIEWS_HNS_TOOLTIPS_HNS_TOOLTIP_POPUP_H_
