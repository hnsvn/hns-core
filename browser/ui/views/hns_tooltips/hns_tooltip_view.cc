...
#include "hns/browser/ui/views/hns_tooltips/hns_tooltip_view.h"
...
HnsTooltipView::HnsTooltipView(
    HnsTooltipPopup* tooltip_popup,
...
HnsTooltipView::~HnsTooltipView() = default;

void HnsTooltipView::GetAccessibleNodeData(ui::AXNodeData* node_data) {
...
bool HnsTooltipView::OnMousePressed(const ui::MouseEvent& event) {
  initial_mouse_pressed_location_ = event.location();

  return true;
}

bool HnsTooltipView::OnMouseDragged(const ui::MouseEvent& event) {
...
void HnsTooltipView::OnMouseReleased(const ui::MouseEvent& event) {
  if (is_dragging_) {
    is_dragging_ = false;
    return;
  }
...
void HnsTooltipView::OnDeviceScaleFactorChanged(
...
void HnsTooltipView::OnThemeChanged() {
...
void HnsTooltipView::CreateView() {
...
views::View* HnsTooltipView::CreateHeaderView() {
...
views::ImageView* HnsTooltipView::CreateIconView() {
  views::ImageView* view = new views::ImageView();

  view->SetImage(
      gfx::CreateVectorIcon(kHnsTooltipsStopwatchIcon, kIconColor));

  return view;
}

views::Label* HnsTooltipView::CreateTitleLabel() {
...
void HnsTooltipView::UpdateTitleLabelColors() {
  if (!title_label_) {
    return;
  }
...
views::View* HnsTooltipView::CreateButtonView() {
  views::View* view = new views::View();
...
views::View* HnsTooltipView::CreateBodyView() {
  views::View* view = new views::View();
...
views::Label* HnsTooltipView::CreateBodyLabel() {
...
void HnsTooltipView::UpdateBodyLabelColors() {
  if (!body_label_) {
    return;
  }
...
HnsTooltipLabelButton* HnsTooltipView::CreateOkButton() {
  auto* button = new HnsTooltipLabelButton(
      base::BindRepeating(&HnsTooltipView::OnOkButtonPressed,
...
void HnsTooltipView::UpdateOkButtonColors() {
  if (!ok_button_) {
    return;
  }
...
void HnsTooltipView::OnOkButtonPressed() {
  if (tooltip_popup_) {
    tooltip_popup_->OnOkButtonPressed();
  }
}

HnsTooltipLabelButton* HnsTooltipView::CreateCancelButton() {
  auto* button = new HnsTooltipLabelButton(
      base::BindRepeating(&HnsTooltipView::OnCancelButtonPressed,
                          base::Unretained(this)),
...
void HnsTooltipView::UpdateCancelButtonColors() {
  if (!cancel_button_) {
    return;
  }
...
void HnsTooltipView::OnCancelButtonPressed() {
  if (tooltip_popup_) {
    tooltip_popup_->OnCancelButtonPressed();
  }
}

BEGIN_METADATA(HnsTooltipView, views::View)
END_METADATA
