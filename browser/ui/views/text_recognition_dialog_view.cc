...
#include "hns/browser/ui/views/text_recognition_dialog_view.h"
...
#include "hns/browser/ui/views/text_recognition_dialog_tracker.h"
#include "hns/components/l10n/common/localization_util.h"
#include "hns/components/text_recognition/browser/text_recognition.h"
...
void TextRecognitionDialogView::StartExtractingText(
  ...
  header_label_->SetText(hns_l10n::GetLocalizedResourceUTF16String(
