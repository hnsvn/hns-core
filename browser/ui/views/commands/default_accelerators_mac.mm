...
#include "hns/browser/ui/views/commands/default_accelerators_mac.h"
...
AcceleratorMapping ToAcceleratorMapping(NSMenuItem* item) {
  ...
  if (@available(macos 12.0, *)) {
    ...
    // https://github.com/hnsvn/hns-browser/issues/31770
  ...
  // Here we're to provide hns commands, manually add shift modifier for
