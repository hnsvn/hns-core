...
#ifndef HNS_BROWSER_UI_VIEWS_INFOBARS_WEB_DISCOVERY_INFOBAR_VIEW_H_
#define HNS_BROWSER_UI_VIEWS_INFOBARS_WEB_DISCOVERY_INFOBAR_VIEW_H_
...
#endif  // HNS_BROWSER_UI_VIEWS_INFOBARS_WEB_DISCOVERY_INFOBAR_VIEW_H_
