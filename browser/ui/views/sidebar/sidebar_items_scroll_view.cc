...
#include "hns/browser/ui/views/sidebar/sidebar_item_drag_context.h"
...
constexpr char kSidebarItemDragType[] = "hns/sidebar-item";
...
SidebarItemsScrollView::SidebarItemsScrollView(HnsBrowser* browser)
    : browser_(browser),
