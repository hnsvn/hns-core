...
void HnsProfileMenuView::BuildIdentity() {
...
void HnsProfileMenuView::BuildAutofillButtons() {}

// We don't want to show any Chromium sync info.
void HnsProfileMenuView::BuildSyncInfo() {}

// We don't want feature buttons to manage google account
void HnsProfileMenuView::BuildFeatureButtons() {
  Profile* profile = browser()->profile();
...
gfx::ImageSkia HnsProfileMenuView::GetSyncIcon() const {
