...
class HnsProfileMenuViewTest : public InProcessBrowserTest {
 public:
  HnsProfileMenuViewTest() = default;
  HnsProfileMenuViewTest(const HnsProfileMenuViewTest&) = delete;
  HnsProfileMenuViewTest& operator=(const HnsProfileMenuViewTest&) = delete;
  ~HnsProfileMenuViewTest() override = default;
...
IN_PROC_BROWSER_TEST_F(HnsProfileMenuViewTest, TestCurrentProfileView) {
  OpenProfileMenuView();
  CheckIdentity();
}
