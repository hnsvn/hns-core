...
#ifndef HNS_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
#define HNS_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
...
#endif  // HNS_BROWSER_UI_COMMANDS_ACCELERATOR_SERVICE_H_
