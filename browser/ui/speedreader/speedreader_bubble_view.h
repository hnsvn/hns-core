...
#ifndef HNS_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
#define HNS_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
...
#endif  // HNS_BROWSER_UI_SPEEDREADER_SPEEDREADER_BUBBLE_VIEW_H_
