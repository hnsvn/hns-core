...
#ifndef HNS_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
#define HNS_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
...
#endif  // HNS_BROWSER_UI_TABS_SHARED_PINNED_TAB_SERVICE_H_
