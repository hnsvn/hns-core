...
using HnsTabStripModelTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(HnsTabStripModelTest, MRUCyclingBasic) {
...
IN_PROC_BROWSER_TEST_F(HnsTabStripModelTest, TabClosingWhileMRUCycling) {
  // Activate MRU cycling
  browser()->profile()->GetPrefs()->SetBoolean(kMRUCyclingEnabled, true);
