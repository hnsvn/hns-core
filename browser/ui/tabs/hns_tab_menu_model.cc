...
HnsTabMenuModel::HnsTabMenuModel(
  ...
  auto indices = static_cast<HnsTabStripModel*>(tab_strip_model)
...
HnsTabMenuModel::~HnsTabMenuModel() = default;

int HnsTabMenuModel::GetRestoreTabCommandStringId() const {
...
std::u16string HnsTabMenuModel::GetLabelAt(size_t index) const {
  if (!is_vertical_tab_) {
...
void HnsTabMenuModel::Build(int selected_tab_count) {
