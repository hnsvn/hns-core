...
#ifndef HNS_BROWSER_UI_BOOKMARK_BOOKMARK_PREFS_SERVICE_H_
#define HNS_BROWSER_UI_BOOKMARK_BOOKMARK_PREFS_SERVICE_H_
...
#endif  // HNS_BROWSER_UI_BOOKMARK_BOOKMARK_PREFS_SERVICE_H_
