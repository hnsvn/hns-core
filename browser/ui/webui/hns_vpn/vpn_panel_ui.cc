...
#include "hns/components/hns_vpn/resources/panel/grit/hns_vpn_panel_generated_map.h"
...
VPNPanelUI::VPNPanelUI(content::WebUI* web_ui)
  ...
  hns_vpn::AddLocalizedStrings(source);
  webui::SetupWebUIDataSource(
      source,
      base::make_span(kHnsVpnPanelGenerated, kHnsVpnPanelGeneratedSize),
      IDR_VPN_PANEL_HTML);
...
bool UntrustedVPNPanelUIConfig::IsWebUIEnabled(
  ...
  return hns_vpn::IsHnsVPNEnabled(browser_context);
}
