...
#ifndef HNS_BROWSER_UI_WEBUI_HNS_WALLET_LEDGER_LEDGER_UI_H_
#define HNS_BROWSER_UI_WEBUI_HNS_WALLET_LEDGER_LEDGER_UI_H_
...
#endif  // HNS_BROWSER_UI_WEBUI_HNS_WALLET_LEDGER_LEDGER_UI_H_
