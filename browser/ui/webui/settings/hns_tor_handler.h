...
#ifndef HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_TOR_HANDLER_H_
#define HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_TOR_HANDLER_H_
...
class HnsTorHandler : public settings::SettingsPageUIHandler {
 public:
  HnsTorHandler();
  HnsTorHandler(const HnsTorHandler&) = delete;
  HnsTorHandler& operator=(const HnsTorHandler&) = delete;
  ~HnsTorHandler() override;
...
#endif  // HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_TOR_HANDLER_H_
