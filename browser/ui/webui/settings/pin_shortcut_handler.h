...
#ifndef HNS_BROWSER_UI_WEBUI_SETTINGS_PIN_SHORTCUT_HANDLER_H_
#define HNS_BROWSER_UI_WEBUI_SETTINGS_PIN_SHORTCUT_HANDLER_H_
...
#endif  // HNS_BROWSER_UI_WEBUI_SETTINGS_PIN_SHORTCUT_HANDLER_H_
