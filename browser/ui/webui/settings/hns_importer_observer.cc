...
HnsImporterObserver::HnsImporterObserver(
...
void HnsImporterObserver::ImportStarted() {
...
void HnsImporterObserver::ImportItemStarted(importer::ImportItem item) {
  base::Value::Dict data;
  data.Set("importer_name", source_profile_.importer_name);
  data.Set("importer_type", source_profile_.importer_type);
  data.Set("items_to_import", imported_items_);
...
void HnsImporterObserver::ImportItemEnded(importer::ImportItem item) {
  base::Value::Dict data;
  data.Set("importer_name", source_profile_.importer_name);
  data.Set("importer_type", source_profile_.importer_type);
  data.Set("items_to_import", imported_items_);
...
void HnsImporterObserver::ImportEnded() {
  base::Value::Dict data;
  data.Set("importer_name", source_profile_.importer_name);
  data.Set("importer_type", source_profile_.importer_type);
  data.Set("items_to_import", imported_items_);
...
HnsImporterObserver::GetImporterHostForTesting() {
