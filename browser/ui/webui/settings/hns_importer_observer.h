...
#ifndef HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_IMPORTER_OBSERVER_H_
#define HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_IMPORTER_OBSERVER_H_
...
class HnsImporterObserver : public importer::ImporterProgressObserver {
 public:
  using ReportProgressCallback = base::RepeatingCallback<void(
      const importer::SourceProfile& source_profile,
      const base::Value::Dict&)>;

  HnsImporterObserver(ExternalProcessImporterHost* host,
                        const importer::SourceProfile& source_profile,
                        uint16_t imported_items,
                        ReportProgressCallback callback);
  ~HnsImporterObserver() override;
...
#endif  // HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_IMPORTER_OBSERVER_H_
