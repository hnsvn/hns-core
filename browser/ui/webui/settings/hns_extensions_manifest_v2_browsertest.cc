...
class HnsExtensionsManifestV2BrowserTest : public InProcessBrowserTest {
 public:
  HnsExtensionsManifestV2BrowserTest() {
  ...
  ~HnsExtensionsManifestV2BrowserTest() override {
...
IN_PROC_BROWSER_TEST_F(HnsExtensionsManifestV2BrowserTest, InstallFail) {
  ASSERT_TRUE(ui_test_utils::NavigateToURL(
      browser(), GURL("hns://settings/extensions/v2")));
...
IN_PROC_BROWSER_TEST_F(HnsExtensionsManifestV2BrowserTest,
