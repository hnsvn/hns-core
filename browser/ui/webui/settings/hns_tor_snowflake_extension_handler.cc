...
HnsTorSnowflakeExtensionHandler::HnsTorSnowflakeExtensionHandler() =
    default;
HnsTorSnowflakeExtensionHandler::~HnsTorSnowflakeExtensionHandler() =
    default;

void HnsTorSnowflakeExtensionHandler::RegisterMessages() {
  web_ui()->RegisterMessageCallback(
      "hns_tor.isSnowflakeExtensionAllowed",
      base::BindRepeating(
          &HnsTorSnowflakeExtensionHandler::IsSnowflakeExtensionAllowed,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "hns_tor.isSnowflakeExtensionEnabled",
      base::BindRepeating(
          &HnsTorSnowflakeExtensionHandler::IsSnowflakeExtensionEnabled,
          base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "hns_tor.enableSnowflakeExtension",
      base::BindRepeating(
          &HnsTorSnowflakeExtensionHandler::EnableSnowflakeExtension,
          base::Unretained(this)));

  observation_.Observe(GetExtensionRegistry());
}

void HnsTorSnowflakeExtensionHandler::OnExtensionLoaded(
...
void HnsTorSnowflakeExtensionHandler::OnExtensionUnloaded(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
void HnsTorSnowflakeExtensionHandler::OnExtensionInstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
    bool is_update) {
...
void HnsTorSnowflakeExtensionHandler::OnExtensionUninstalled(
    content::BrowserContext* browser_context,
    const extensions::Extension* extension,
...
HnsTorSnowflakeExtensionHandler::GetExtensionRegistry() {
  return extensions::ExtensionRegistry::Get(
      web_ui()->GetWebContents()->GetBrowserContext());
}

bool HnsTorSnowflakeExtensionHandler::IsTorAllowedByPolicy() {
...
void HnsTorSnowflakeExtensionHandler::IsSnowflakeExtensionAllowed(
...
void HnsTorSnowflakeExtensionHandler::IsSnowflakeExtensionEnabled(
    const base::Value::List& args) {
  CHECK_EQ(args.size(), 1U);
...
void HnsTorSnowflakeExtensionHandler::EnableSnowflakeExtension(
    const base::Value::List& args) {
  ...
  if (enable) {
    if (!installed) {
      installer_ = base::MakeRefCounted<SnowflakeWebstoreInstaller>(
          ...
          base::BindOnce(
              &HnsTorSnowflakeExtensionHandler::OnSnowflakeExtensionInstalled,
...
void HnsTorSnowflakeExtensionHandler::OnSnowflakeExtensionInstalled(
