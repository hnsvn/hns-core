...
#ifndef HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_DEFAULT_EXTENSIONS_HANDLER_H_
#define HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_DEFAULT_EXTENSIONS_HANDLER_H_
...
class HnsDefaultExtensionsHandler : public settings::SettingsPageUIHandler
#if BUILDFLAG(ENABLE_IPFS)
    ,
...
{
 public:
  HnsDefaultExtensionsHandler();
  HnsDefaultExtensionsHandler(const HnsDefaultExtensionsHandler&) = delete;
  HnsDefaultExtensionsHandler& operator=(
      const HnsDefaultExtensionsHandler&) = delete;
  ~HnsDefaultExtensionsHandler() override;
 ...
 private:
  ...
  void SetHnsWalletEnabled(const base::Value::List& args);
#endif
...
#endif
  base::WeakPtrFactory<HnsDefaultExtensionsHandler> weak_ptr_factory_;
};

#endif  // HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_DEFAULT_EXTENSIONS_HANDLER_H_
