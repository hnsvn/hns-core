...
#ifndef HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_PRIVACY_HANDLER_H_
#define HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_PRIVACY_HANDLER_H_
...
class HnsPrivacyHandler : public settings::SettingsPageUIHandler {
 public:
  HnsPrivacyHandler();
  HnsPrivacyHandler(const HnsPrivacyHandler&) = delete;
  HnsPrivacyHandler& operator=(const HnsPrivacyHandler&) = delete;
  ~HnsPrivacyHandler() override;
...
#endif  // HNS_BROWSER_UI_WEBUI_SETTINGS_HNS_PRIVACY_HANDLER_H_
