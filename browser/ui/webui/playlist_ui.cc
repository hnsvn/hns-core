...
#include "hns/browser/ui/playlist/playlist_dialogs.h"
...
#include "hns/components/playlist/browser/resources/grit/playlist_generated_map.h"
...
void AddLocalizedStrings(content::WebUIDataSource* source) {
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
      {"hnsDefaultPlaylistName", IDS_PLAYLIST_DEFAULT_PLAYLIST_NAME},
      {"hnsPlaylistContextMenuEdit", IDS_PLAYLIST_CONTEXT_MENU_EDIT},
      {"hnsPlaylistContextMenuShare", IDS_PLAYLIST_CONTEXT_MENU_SHARE},
      ...
      {"hnsPlaylistContextMenuMove", IDS_PLAYLIST_CONTEXT_MENU_MOVE},
  ...
  explicit UntrustedPlayerUI(content::WebUI* web_ui)
    ...
    source->OverrideContentSecurityPolicy(
        ...
        std::string("script-src 'self' chrome-untrusted://resources "
                    "chrome-untrusted://hns-resources;"));
    source->OverrideContentSecurityPolicy(
    ...
    source->OverrideContentSecurityPolicy(
        ...
        std::string("style-src chrome-untrusted://resources "
                    "chrome-untrusted://hns-resources 'unsafe-inline';"));
    source->OverrideContentSecurityPolicy(
