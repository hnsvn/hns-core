...
#include "hns/components/hns_rewards/resources/grit/hns_rewards_internals_generated_map.h"
...
class RewardsInternalsDOMHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  void OnGetRewardsInternalsInfo(
      hns_rewards::mojom::RewardsInternalsInfoPtr info);
  ...
  void OnGetContributions(
      std::vector<hns_rewards::mojom::ContributionInfoPtr> contributions);
  void GetPromotions(const base::Value::List& args);
  void OnGetPromotions(std::vector<hns_rewards::mojom::PromotionPtr> list);
  ...
  void OnGetEventLogs(std::vector<hns_rewards::mojom::EventLogPtr> logs);
  ...
  void OnGetEnvironment(hns_rewards::mojom::Environment environment);
...
void RewardsInternalsDOMHandler::Init() {
  ...
  rewards_service_ =
      hns_rewards::RewardsServiceFactory::GetForProfile(profile_);
...
void RewardsInternalsDOMHandler::OnGetRewardsInternalsInfo(
  ...
  if (info) {
    ...
    const std::string declared_geo =
        prefs->GetString(::hns_rewards::prefs::kDeclaredGeo);
    const int wallet_creation_environment =
        prefs->GetInteger(::hns_rewards::prefs::kWalletCreationEnvironment);
  ...
  CallJavascriptFunction("hns_rewards_internals.onGetRewardsInternalsInfo",
                         info_dict);
}
...
void RewardsInternalsDOMHandler::OnGetBalance(FetchBalanceResult result) {
  ...
  CallJavascriptFunction("hns_rewards_internals.balance", std::move(data));
}
...
void RewardsInternalsDOMHandler::OnGetContributions(
  ...
  CallJavascriptFunction("hns_rewards_internals.contributions", list);
}
...
void RewardsInternalsDOMHandler::OnGetPromotions(
    std::vector<hns_rewards::mojom::PromotionPtr> list) {
  if (!IsJavascriptAllowed()) {
    return;
  }
  ...
  CallJavascriptFunction("hns_rewards_internals.promotions", promotions);
}
...
void RewardsInternalsDOMHandler::OnGetPartialLog(const std::string& log) {
  ...
  CallJavascriptFunction("hns_rewards_internals.partialLog",
                         base::Value(log));
}
...
void RewardsInternalsDOMHandler::OnGetFulllLog(const std::string& log) {
  ...
  CallJavascriptFunction("hns_rewards_internals.fullLog", base::Value(log));
}
...
void RewardsInternalsDOMHandler::OnClearLog(const bool success) {
  ...
  CallJavascriptFunction("hns_rewards_internals.partialLog", base::Value(""));
}
...
void RewardsInternalsDOMHandler::OnGetExternalWallet(
  ...
  CallJavascriptFunction("hns_rewards_internals.onGetExternalWallet", data);
}
...
void RewardsInternalsDOMHandler::OnGetEventLogs(
    std::vector<hns_rewards::mojom::EventLogPtr> logs) {
  if (!IsJavascriptAllowed()) {
    return;
  }
  ...
  CallJavascriptFunction("hns_rewards_internals.eventLogs", data);
}
...
void RewardsInternalsDOMHandler::OnGetAdDiagnostics(
  ...
  const std::string& diagnostic_id =
      prefs->GetString(hns_ads::prefs::kDiagnosticId);
  ...
  CallJavascriptFunction("hns_rewards_internals.adDiagnostics", diagnostics);
}
...
void RewardsInternalsDOMHandler::SetAdDiagnosticId(
  ...
  prefs->SetString(hns_ads::prefs::kDiagnosticId, args[0].GetString());
}
...
void RewardsInternalsDOMHandler::OnGetEnvironment(
    hns_rewards::mojom::Environment environment) {
  if (!IsJavascriptAllowed()) {
    return;
  }

  CallJavascriptFunction("hns_rewards_internals.environment",
                         base::Value(static_cast<int>(environment)));
}

}  // namespace

HnsRewardsInternalsUI::HnsRewardsInternalsUI(content::WebUI* web_ui,
                                                 const std::string& name)
    : WebUIController(web_ui) {
  CreateAndAddWebUIDataSource(web_ui, name, kHnsRewardsInternalsGenerated,
                              kHnsRewardsInternalsGeneratedSize,
                              IDR_HNS_REWARDS_INTERNALS_HTML);
...
HnsRewardsInternalsUI::~HnsRewardsInternalsUI() = default;
