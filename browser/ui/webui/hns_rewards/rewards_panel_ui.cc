...
#include "hns/components/hns_rewards/resources/grit/hns_rewards_panel_generated_map.h"
...
static constexpr webui::LocalizedString kStrings[] = {
    ...
    {"onboardingClose", IDS_HNS_REWARDS_ONBOARDING_CLOSE},
    {"onboardingDone", IDS_HNS_REWARDS_ONBOARDING_DONE},
    {"onboardingContinue", IDS_HNS_REWARDS_ONBOARDING_CONTINUE},
    {"onboardingEarnHeader", IDS_HNS_REWARDS_ONBOARDING_EARN_HEADER},
    {"onboardingEarnText", IDS_HNS_REWARDS_ONBOARDING_EARN_TEXT},
    {"onboardingHowDoesItWork", IDS_HNS_REWARDS_ONBOARDING_HOW_DOES_IT_WORK},
    {"onboardingErrorHeader", IDS_HNS_REWARDS_ONBOARDING_ERROR_HEADER},
    {"onboardingErrorHeaderDisabled",
     IDS_HNS_REWARDS_ONBOARDING_ERROR_HEADER_DISABLED},
    {"onboardingErrorText", IDS_HNS_REWARDS_ONBOARDING_ERROR_TEXT},
    {"onboardingErrorTextDeclareCountry",
     IDS_HNS_REWARDS_ONBOARDING_ERROR_TEXT_DECLARE_COUNTRY},
    {"onboardingErrorTextDisabled",
     IDS_HNS_REWARDS_ONBOARDING_ERROR_TEXT_DISABLED},
    {"onboardingGeoHeader", IDS_HNS_REWARDS_ONBOARDING_GEO_HEADER},
    {"onboardingGeoSuccessHeader",
     IDS_HNS_REWARDS_ONBOARDING_GEO_SUCCESS_HEADER},
    {"onboardingGeoSuccessText", IDS_HNS_REWARDS_ONBOARDING_GEO_SUCCESS_TEXT},
    {"onboardingGeoText", IDS_HNS_REWARDS_ONBOARDING_GEO_TEXT},
    {"onboardingSelectCountry", IDS_HNS_REWARDS_ONBOARDING_SELECT_COUNTRY},
    {"onboardingHowDoesHnsRewardsWork",
     IDS_HNS_REWARDS_ONBOARDING_HOW_DOES_HNS_REWARDS_WORK},
    {"onboardingStartUsingRewards",
     IDS_HNS_REWARDS_ONBOARDING_START_USING_REWARDS},
...
RewardsPanelUI::RewardsPanelUI(content::WebUI* web_ui)
  ...
  auto* source = content::WebUIDataSource::CreateAndAdd(
      web_ui->GetWebContents()->GetBrowserContext(), kHnsRewardsPanelHost);
  source->AddLocalizedStrings(kStrings);

  webui::SetupWebUIDataSource(source,
                              base::make_span(kHnsRewardsPanelGenerated,
                                              kHnsRewardsPanelGeneratedSize),
                              IDR_HNS_REWARDS_PANEL_HTML);
  ...
  source->OverrideContentSecurityPolicy(
      ...
      "frame-src 'self' " +
          hns_adaptive_captcha::ServerUtil::GetInstance()->GetServerUrl("/") +
          ";");
