...
#include "hns/browser/ui/webui/hns_rewards/tip_panel_handler.h"
#include "hns/components/hns_rewards/resources/grit/hns_rewards_resources.h"
#include "hns/components/hns_rewards/resources/grit/tip_panel_generated_map.h"
...
static constexpr webui::LocalizedString kStrings[] = {
    ...
    {"termsOfService", IDS_HNS_REWARDS_ONBOARDING_TERMS},
...
TipPanelUI::TipPanelUI(content::WebUI* web_ui)
  ...
  auto* source = content::WebUIDataSource::CreateAndAdd(
      web_ui->GetWebContents()->GetBrowserContext(), kHnsTipPanelHost);
