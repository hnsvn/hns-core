...
#ifndef HNS_BROWSER_UI_HNS_ADS_NOTIFICATION_AD_POPUP_HANDLER_H_
#define HNS_BROWSER_UI_HNS_ADS_NOTIFICATION_AD_POPUP_HANDLER_H_
...
#endif  // HNS_BROWSER_UI_HNS_ADS_NOTIFICATION_AD_POPUP_HANDLER_H_
