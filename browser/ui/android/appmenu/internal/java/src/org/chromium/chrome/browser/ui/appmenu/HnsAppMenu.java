...
class HnsAppMenu extends AppMenu {
    private static final String HNS_IS_MENU_FROM_BOTTOM = "hns_is_menu_from_bottom";

    HnsAppMenu(int itemRowHeight, AppMenuHandlerImpl handler, Resources res) {
    ...
    public static boolean isMenuFromBottom() {
        ...
        return sharedPreferences.getBoolean(HNS_IS_MENU_FROM_BOTTOM, false);
    }
