...
#ifndef HNS_BROWSER_UI_HNS_WALLET_WALLET_BUBBLE_MANAGER_DELEGATE_H_
#define HNS_BROWSER_UI_HNS_WALLET_WALLET_BUBBLE_MANAGER_DELEGATE_H_
...
#endif  // HNS_BROWSER_UI_HNS_WALLET_WALLET_BUBBLE_MANAGER_DELEGATE_H_
