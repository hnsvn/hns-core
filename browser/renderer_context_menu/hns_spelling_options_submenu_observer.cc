...
HnsSpellingOptionsSubMenuObserver::HnsSpellingOptionsSubMenuObserver(
...
void HnsSpellingOptionsSubMenuObserver::InitMenu(
    const content::ContextMenuParams& params) {
  // Let Chromium build the submenu.
  SpellingOptionsSubMenuObserver::InitMenu(params);

  // Assumptions:
  // 1. Use of spelling service is disabled in Hns profile preferences.
...
void HnsSpellingOptionsSubMenuObserver::SetGtestMode(
    HnsSpellingOptionsSubMenuObserver::GtestMode mode) {
  gtest_mode_ = mode;
}
