...
#ifndef HNS_BROWSER_RENDERER_CONTEXT_MENU_HNS_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
#define HNS_BROWSER_RENDERER_CONTEXT_MENU_HNS_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
...
class HnsMockRenderViewContextMenu;
class PrefService;
class Profile;
...
// MenuObserver class.
class HnsMockRenderViewContextMenu : public ui::SimpleMenuModel::Delegate,
 ...
 public:
  ...
  explicit HnsMockRenderViewContextMenu(Profile* profile);
  HnsMockRenderViewContextMenu(const HnsMockRenderViewContextMenu&) =
      delete;
  HnsMockRenderViewContextMenu& operator=(
      const HnsMockRenderViewContextMenu&) = delete;
  ~HnsMockRenderViewContextMenu() override;
...
#endif  // HNS_BROWSER_RENDERER_CONTEXT_MENU_HNS_MOCK_RENDER_VIEW_CONTEXT_MENU_H_
