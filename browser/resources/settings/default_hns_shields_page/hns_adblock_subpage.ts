...
import './components/hns_adblock_subscribe_dropdown.js';
import './components/hns_adblock_editor.js';
...
import {HnsAdblockBrowserProxyImpl} from './hns_adblock_browser_proxy.js'
import {getTemplate} from './hns_adblock_subpage.html.js'
...
class AdBlockSubpage extends AdBlockSubpageBase {
  ...
  browserProxy_ = HnsAdblockBrowserProxyImpl.getInstance()
  ...
  ready() {
    ...
    this.browserProxy_.addWebUiListener(
      'hns_adblock.onGetListSubscriptions', (value) => {
        this.subscriptionList_ = value
    })
  }
