...
export interface DefaultHnsShieldsBrowserProxy {
  /**
...
export class DefaultHnsShieldsBrowserProxyImpl implements DefaultHnsShieldsBrowserProxy {
  /** @override */
  isAdControlEnabled() {
  ...
  static getInstance(): DefaultHnsShieldsBrowserProxy {
    return instance || (instance = new DefaultHnsShieldsBrowserProxyImpl())
  }
}

let instance: DefaultHnsShieldsBrowserProxy|null = null
