...
export class HnsAddSiteDialogElement extends BaseElement {
  ...
  override ready() {
    super.ready()
    const is_hns_shields = this.category === 'hnsShields'
    const resource_id = is_hns_shields ? 'hnsShieldsExampleTemplate'
