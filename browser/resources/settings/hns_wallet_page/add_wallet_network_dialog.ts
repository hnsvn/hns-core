...
import {NetworkInfo, HnsWalletBrowserProxy, HnsWalletBrowserProxyImpl} from './hns_wallet_browser_proxy.js';
import {CrInputElement} from 'chrome://resources/cr_elements/cr_input/cr_input.js'
import {getTemplate} from './add_wallet_network_dialog.html.js'

const SettingsHnsAddWalletNetworkDialogElementBase =
...
export class SettingsHnsAddWalletNetworkDialogElement extends SettingsHnsAddWalletNetworkDialogElementBase {
  static get is() {
  ...
  browserProxy_: HnsWalletBrowserProxy = HnsWalletBrowserProxyImpl.getInstance();
...
customElements.define(
  SettingsHnsAddWalletNetworkDialogElement.is, SettingsHnsAddWalletNetworkDialogElement)
