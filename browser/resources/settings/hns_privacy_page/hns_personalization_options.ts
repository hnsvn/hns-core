...
import {getTemplate} from './hns_personalization_options.html.js'
import {HnsPrivacyBrowserProxy, HnsPrivacyBrowserProxyImpl} from './hns_privacy_page_browser_proxy.js'

const SettingsHnsPersonalizationOptionsBase =
  WebUiListenerMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & WebUiListenerMixinInterface
  }

export interface SettingsHnsPersonalizationOptions {
  $: {
...
export class SettingsHnsPersonalizationOptions extends SettingsHnsPersonalizationOptionsBase {
  static get is() {
    return 'settings-hns-personalization-options'
  }
  ...
  browserProxy_: HnsPrivacyBrowserProxy = HnsPrivacyBrowserProxyImpl.getInstance();
...
customElements.define(
  SettingsHnsPersonalizationOptions.is, SettingsHnsPersonalizationOptions)
