...
import './hns_tor_bridges_dialog.js'
import './hns_tor_snowflake_install_failed_dialog.js'
...
import {HnsTorBrowserProxyImpl} from './hns_tor_browser_proxy.js'
import {getTemplate} from './hns_tor_subpage.html.js'

const SettingHnsTorPageElementBase =
...
/**
 * 'settings-hns-tor-page' is the settings page containing
 * hns's Tor settings.
 */
class SettingsHnsTorPageElement extends SettingHnsTorPageElementBase {
  static get is() {
    return 'settings-hns-tor-subpage'
  }
  ...
  browserProxy_ = HnsTorBrowserProxyImpl.getInstance()
...
customElements.define(
  SettingsHnsTorPageElement.is, SettingsHnsTorPageElement)
