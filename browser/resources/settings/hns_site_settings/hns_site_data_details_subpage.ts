...
import {getTemplate} from './hns_site_data_details_subpage.html.js';
...
/**
 * 'hns-site-data-details-subpage' Display cookie contents.
...
export class HnsSiteDataDetailsSubpageElement extends
    SiteDataDetailsSubpageElementBase {
  static get is() {
    return 'hns-site-data-details-subpage';
  }
  ...
  override currentRouteChanged(route: Route) {
    if (route !== routes.HNS_SITE_SETTINGS_COOKIES_DETAILS) {
      return;
    }
...
declare global {
  interface HTMLElementTagNameMap {
    'hns-site-data-details-subpage': HnsSiteDataDetailsSubpageElement;
  }
}

customElements.define(
  HnsSiteDataDetailsSubpageElement.is, HnsSiteDataDetailsSubpageElement);
