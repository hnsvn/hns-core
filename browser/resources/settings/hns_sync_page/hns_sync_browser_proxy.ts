...
export interface HnsSyncStatus extends SyncStatus {
  hasSyncWordsDecryptionError: boolean
  isOsEncryptionAvailable: boolean
}

export class HnsSyncBrowserProxy {
  ...
  getDeviceList(): Promise<HnsDeviceInfo[]> {
  ...
  getSyncStatus(): Promise<HnsSyncStatus> {
  ...
  static getInstance() {
    return instance || (instance = new HnsSyncBrowserProxy())
  }
}

let instance: HnsSyncBrowserProxy|null = null
