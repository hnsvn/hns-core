...
import {getTemplate} from './hns_sync_code_dialog.html.js'

/**
 * @fileoverview
 * 'settings-hns-sync-code-dialog' contains the dialog for displaying or
...
const SettingsHnsSyncCodeDialogElementBase =
  I18nMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & I18nMixinInterface
  }

export class SettingsHnsSyncCodeDialogElement extends SettingsHnsSyncCodeDialogElementBase {
  static get is() {
    return 'settings-hns-sync-code-dialog'
  }
