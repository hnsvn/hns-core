...
import {getTemplate} from './hns_sync_delete_account_dialog.html.js'

/**
 * @fileoverview
 * 'settings-hns-sync-delete-account-dialog' contains the dialog for
...
const SettingsHnsSyncDeleteAccountDialogElementBase =
  I18nMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & I18nMixinInterface
  }

export class SettingsHnsSyncCodeDialogElement
             extends SettingsHnsSyncDeleteAccountDialogElementBase {
  static get is() {
    return 'settings-hns-sync-delete-account-dialog'
  }
  ...
  syncBrowserProxy_: HnsSyncBrowserProxy =
                                            HnsSyncBrowserProxy.getInstance();
...
customElements.define(
  SettingsHnsSyncCodeDialogElement.is, SettingsHnsSyncCodeDialogElement)
