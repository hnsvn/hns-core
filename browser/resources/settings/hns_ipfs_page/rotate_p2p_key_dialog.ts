...
const SettingsHnsRotateP2pKeyDialogElementBase =
...
export interface SettingsHnsRotateP2pKeyDialogElement {
  $: {
    key: CrInputElement,
  }
}

export class SettingsHnsRotateP2pKeyDialogElement extends SettingsHnsRotateP2pKeyDialogElementBase {
  static get is() {
...
customElements.define(
  SettingsHnsRotateP2pKeyDialogElement.is, SettingsHnsRotateP2pKeyDialogElement)
