...
export class HnsIPFSBrowserProxyImpl {
  ...
  static getInstance(): HnsIPFSBrowserProxyImpl {
    return instance || (instance = new HnsIPFSBrowserProxyImpl())
  }
}

let instance: HnsIPFSBrowserProxyImpl|null = null
