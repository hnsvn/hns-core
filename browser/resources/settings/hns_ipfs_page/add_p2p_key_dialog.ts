...
const SettingsHnsAddP2pKeyDialogElementBase =
...
export interface SettingsHnsAddP2pKeyDialogElement {
  $: {
    key: CrInputElement,
  }
}

export class SettingsHnsAddP2pKeyDialogElement extends SettingsHnsAddP2pKeyDialogElementBase {
  static get is() {
...
customElements.define(
  SettingsHnsAddP2pKeyDialogElement.is, SettingsHnsAddP2pKeyDialogElement)
