...
const SettingsHnsIpfsPeersDialogElementBase =
...
export interface SettingsHnsIpfsPeersDialogElement {
  $: {
    peer: CrInputElement,
  };
}

export class SettingsHnsIpfsPeersDialogElement extends SettingsHnsIpfsPeersDialogElementBase {
  static get is() {
...
customElements.define(
  SettingsHnsIpfsPeersDialogElement.is, SettingsHnsIpfsPeersDialogElement)
