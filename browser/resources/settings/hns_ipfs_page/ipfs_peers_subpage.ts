...
const SettingsHnsIpfsPeersSubpageElementBase =
...
export interface SettingsHnsIpfsPeersSubpageElement {
  $: {
    peersList: IronListElement,
  }
}

export class SettingsHnsIpfsPeersSubpageElement extends SettingsHnsIpfsPeersSubpageElementBase {
  static get is() {
...
customElements.define(
  SettingsHnsIpfsPeersSubpageElement.is, SettingsHnsIpfsPeersSubpageElement)
