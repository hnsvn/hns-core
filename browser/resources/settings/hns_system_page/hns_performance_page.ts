...
import {getTemplate} from './hns_performance_page.html.js'
...
/**
 * 'settings-hns-performance-page' is the settings page containing
 * hns's performance features.
 */

const SettingsHnsPerformancePageElementBase =
  WebUiListenerMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & WebUiListenerMixinInterface
  }

export class SettingsHnsPerformancePageElement
    extends SettingsHnsPerformancePageElementBase {
  static get is() {
    return 'settings-hns-performance-page'
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'settings-hns-performance-page': SettingsHnsPerformancePageElement
  }
}

customElements.define(
    SettingsHnsPerformancePageElement.is, SettingsHnsPerformancePageElement)
