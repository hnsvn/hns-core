...
import {NewTabOption, HnsNewTabBrowserProxy, HnsNewTabBrowserProxyImpl} from './hns_new_tab_browser_proxy.js'
import {getTemplate} from './hns_new_tab_page.html.js'

/**
 * 'settings-hns-new-tab-page' is the settings page containing
 * hns's new tab features.
 */

const SettingsHnsNewTabPageElementBase =
  WebUiListenerMixin(BaseMixin(PolymerElement)) as {
    new(): PolymerElement & WebUiListenerMixinInterface
  }

export class SettingsHnsNewTabPageElement extends SettingsHnsNewTabPageElementBase {
  static get is() {
    return 'settings-hns-new-tab-page'
  }
  ...
  browserProxy_: HnsNewTabBrowserProxy = HnsNewTabBrowserProxyImpl.getInstance();
...
customElements.define(
  SettingsHnsNewTabPageElement.is, SettingsHnsNewTabPageElement)
