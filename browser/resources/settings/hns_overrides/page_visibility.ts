...
function getPageVisibility () {
  ...
  // which hides most sections, and add hns sections to hide.
  if (loadTimeData.getBoolean('isGuest')) {
    // Hide appropriate hns sections as well as chromium ones
    return {
  ...
  // would like to hide.
  // See hns/browser/settings/hns_overrides/basic_page.js for hns's list,
  ...
  const staticProps = {
    ...
    // custom properties
    hnsSync: !loadTimeData.getBoolean('isSyncDisabled'),
    hnsWallet: loadTimeData.getBoolean('isHnsWalletAllowed'),
