...
RegisterPolymerTemplateModifications({
  'settings-about-page': (templateContent) => {
    ...
    if (!section.querySelector('a#release-notes')) {
      ...
      if (!version) {
        console.error('[Hns Settings Overrides] Could not find version div')
      }
      ...
      wrapper.setAttribute('href', 'https://hns.com/latest/')
    ...
    if (updateStatusMessageLink) {
      // <if expr="is_win">
      updateStatusMessageLink.href = 'https://support.hns.com/hc/en-us/articles/360042816611-Why-isn-t-Hns-updating-automatically-on-Windows-'
      // </if>

      // <if expr="not is_win">
      updateStatusMessageLink.href = 'https://community.hns.com?p=update_error'
      // </if>
    }
  }
})
