...
import "./hns_clear_browsing_data_on_exit_page.js"
...
import type {SettingsClearBrowsingDataDialogElement as HnsSettingsClearBrowsingDataDialogElement} from '../clear_browsing_data_dialog/clear_browsing_data_dialog.js'

const BaseElement = WebUiListenerMixin(SettingsClearBrowsingDataDialogElement)
export class HnsSettingsClearBrowsingDataDialogElement extends BaseElement {
  override ready() {
    super.ready()
