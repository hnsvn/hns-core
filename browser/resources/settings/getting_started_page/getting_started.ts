...
export class HnsSettingsGettingStarted extends PolymerElement {
  static get is() {
    return 'hns-settings-getting-started'
  }
...
customElements.define(HnsSettingsGettingStarted.is, HnsSettingsGettingStarted);
