...
const SettingsHnsAppearanceBookmarkBarElementBase =
...
const kAlwaysShowBookmarBarPrefName = 'hns.always_show_bookmark_bar_on_ntp'
const kShowOnAllTabsPrefName = 'bookmark_bar.show_on_all_tabs'

/**
 * 'settings-hns-appearance-bookmark-bar' is the settings page area containing
 * hns's bookmark bar visibility settings in appearance settings.
 */
export class SettingsHnsAppearanceBookmarkBarElement
    extends SettingsHnsAppearanceBookmarkBarElementBase {
  static get is() {
    return 'settings-hns-appearance-bookmark-bar'
  }
  ...
  static get observers() {
    return [
      ...
      ' prefs.hns.always_show_bookmark_bar_on_ntp.value)'
    ]
  }
...
customElements.define(SettingsHnsAppearanceBookmarkBarElement.is,
  SettingsHnsAppearanceBookmarkBarElement)
