...
const SettingsHnsAppearanceSuperReferralElementBase = I18nMixin(PolymerElement) as {
  new (): PolymerElement & I18nMixinInterface
}

/**
 * 'settings-hns-appearance-theme' is the settings page area containing
 * hns's themes settings.
 */

export class SettingsHnsAppearanceSuperReferralElement extends
    SettingsHnsAppearanceSuperReferralElementBase {
  static get is() {
    return 'settings-hns-appearance-super-referral'
  }
...
customElements.define(SettingsHnsAppearanceSuperReferralElement.is, SettingsHnsAppearanceSuperReferralElement)
