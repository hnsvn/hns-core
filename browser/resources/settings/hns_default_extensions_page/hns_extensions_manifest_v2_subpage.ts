...
import {HnsDefaultExtensionsBrowserProxyImpl, ExtensionV2} from './hns_default_extensions_browser_proxy.js'
import {getTemplate} from './hns_extensions_manifest_v2_subpage.html.js'

const HnsExtensionsV2SubpageBase =
  WebUiListenerMixin(PrefsMixin(I18nMixin(BaseMixin(PolymerElement))))

class HnsExtensionsV2Subpage extends HnsExtensionsV2SubpageBase {
  static get is() {
    return 'hns-extensions-v2-subpage'
  }
  ...
  browserProxy_ = HnsDefaultExtensionsBrowserProxyImpl.getInstance()
  hnsV2Extensions_: Array<ExtensionV2>
  ...
  override ready() {
    ...
    this.addWebUiListener('hns-extension-manifest-v2-changed',
  ...
  getExtensions_() {
    this.browserProxy_.getExtensionsManifestV2().then((extensions) => {
      this.hnsV2Extensions_ = extensions
    })
  }
...
customElements.define(HnsExtensionsV2Subpage.is, HnsExtensionsV2Subpage)
