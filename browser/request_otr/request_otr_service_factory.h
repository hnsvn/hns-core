...
#ifndef HNS_BROWSER_REQUEST_OTR_REQUEST_OTR_SERVICE_FACTORY_H_
#define HNS_BROWSER_REQUEST_OTR_REQUEST_OTR_SERVICE_FACTORY_H_
...
#endif  // HNS_BROWSER_REQUEST_OTR_REQUEST_OTR_SERVICE_FACTORY_H_
