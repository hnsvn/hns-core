...
#ifndef HNS_BROWSER_REQUEST_OTR_REQUEST_OTR_TAB_HELPER_H_
#define HNS_BROWSER_REQUEST_OTR_REQUEST_OTR_TAB_HELPER_H_
...
#endif  // HNS_BROWSER_REQUEST_OTR_REQUEST_OTR_TAB_HELPER_H_
