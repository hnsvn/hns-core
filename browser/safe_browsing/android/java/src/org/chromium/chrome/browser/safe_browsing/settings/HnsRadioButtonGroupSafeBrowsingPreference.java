...
public class HnsRadioButtonGroupSafeBrowsingPreference
        extends RadioButtonGroupSafeBrowsingPreference {
    private String noProtectionSummary;

    public HnsRadioButtonGroupSafeBrowsingPreference(Context context, AttributeSet attrs) {
        super(context, attrs);

        noProtectionSummary = context.getResources().getString(
                R.string.hns_safe_browsing_no_protection_summary);
    }
