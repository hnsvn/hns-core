...
class HnsAutofillBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(HnsAutofillBrowserTest,
                       AutofillIsNotAllowedInPrivateWindows) {
  GURL url(
      embedded_test_server()->GetURL("example.com", "/hns_scheme_load.html"));
