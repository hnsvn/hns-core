...
#include "hns/browser/hns_rewards/extension_rewards_notification_service_observer.h"

#include "hns/common/extensions/api/rewards_notifications.h"
...
void ExtensionRewardsNotificationServiceObserver::OnNotificationAdded(
  ...
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::HNS_REWARDS_NOTIFICATION_ADDED,
...
void ExtensionRewardsNotificationServiceObserver::OnNotificationDeleted(
  ...
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::HNS_REWARDS_NOTIFICATION_DELETED,
...
void ExtensionRewardsNotificationServiceObserver::
  ...
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::HNS_REWARDS_ALL_NOTIFICATIONS_DELETED,
...
void ExtensionRewardsNotificationServiceObserver::OnGetNotification(
  ...
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::HNS_REWARDS_GET_NOTIFICATION,
...
void ExtensionRewardsNotificationServiceObserver::OnGetAllNotifications(
  ...
  std::unique_ptr<extensions::Event> event(new extensions::Event(
      extensions::events::HNS_REWARDS_GET_ALL_NOTIFICATIONS,
