...
class HnsSiteHacksNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  HnsSiteHacksNetworkDelegateBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &HnsSiteHacksNetworkDelegateBrowserTest::HandleRequest,
...
IN_PROC_BROWSER_TEST_F(HnsSiteHacksNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(HnsSiteHacksNetworkDelegateBrowserTest,
  ...
  for (const auto& input : inputs) {
    ...
    hns_shields::SetHnsShieldsEnabled(content_settings(), false, dest_url);
