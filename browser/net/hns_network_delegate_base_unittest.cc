...
using hns::RemoveTrackableSecurityHeadersForThirdParty;
using hns::TrackableSecurityHeaders;
...
class HnsNetworkDelegateBaseTest : public testing::Test {
 public:
  HnsNetworkDelegateBaseTest()
      : task_environment_(content::BrowserTaskEnvironment::IO_MAINLOOP) {}
  ~HnsNetworkDelegateBaseTest() override = default;
  void SetUp() override {
...
TEST_F(HnsNetworkDelegateBaseTest, RemoveTrackableSecurityHeaders) {
...
TEST_F(HnsNetworkDelegateBaseTest, RemoveTrackableSecurityHeadersMixedCase) {
  net::TestDelegate test_delegate;
  GURL request_url(kThirdPartyDomain);
  GURL tab_url(kFirstPartyDomain);
...
TEST_F(HnsNetworkDelegateBaseTest, RetainTrackableSecurityHeaders) {
  net::TestDelegate test_delegate;
