...
class HnsAcceptHeaderBrowserTest : public InProcessBrowserTest {
 public:
  HnsAcceptHeaderBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &HnsAcceptHeaderBrowserTest::HandleRequest, base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(HnsAcceptHeaderBrowserTest,
