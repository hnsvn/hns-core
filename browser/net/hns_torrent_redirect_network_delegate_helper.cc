...
bool IsWebtorrentInitiated(std::shared_ptr<hns::HnsRequestInfo> ctx) {
  return ctx->initiator_url.scheme() == extensions::kExtensionScheme &&
      ctx->initiator_url.host() == hns_webtorrent_extension_id;
}
...
bool IsMainFrameResource(std::shared_ptr<hns::HnsRequestInfo> ctx) {
...
int OnHeadersReceived_TorrentRedirectWork(
  ...
  *override_response_headers =
  ...
  GURL url(
      ...
      "/extension/hns_webtorrent2.html?",
