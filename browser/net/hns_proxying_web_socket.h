...
#ifndef HNS_BROWSER_NET_HNS_PROXYING_WEB_SOCKET_H_
#define HNS_BROWSER_NET_HNS_PROXYING_WEB_SOCKET_H_
...
// Ensures that all web socket requests go through Hns network request
// handling framework. Cargoculted from |WebRequestProxyingWebSocket|.
class HnsProxyingWebSocket
 ...
 public:
  ...
  using DisconnectCallback =
      base::OnceCallback<void(HnsProxyingWebSocket*)>;

  HnsProxyingWebSocket(
  ...
  HnsProxyingWebSocket(const HnsProxyingWebSocket&) = delete;
  HnsProxyingWebSocket& operator=(const HnsProxyingWebSocket&) = delete;
  ~HnsProxyingWebSocket() override;

  static HnsProxyingWebSocket* ProxyWebSocket(
 ...
 private:
  ...
  base::WeakPtrFactory<HnsProxyingWebSocket> weak_factory_{this};
};

#endif  // HNS_BROWSER_NET_HNS_PROXYING_WEB_SOCKET_H_
