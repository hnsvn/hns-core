...
#ifndef HNS_BROWSER_NET_HNS_AD_BLOCK_TP_NETWORK_DELEGATE_HELPER_H_
#define HNS_BROWSER_NET_HNS_AD_BLOCK_TP_NETWORK_DELEGATE_HELPER_H_
...
#endif  // HNS_BROWSER_NET_HNS_AD_BLOCK_TP_NETWORK_DELEGATE_HELPER_H_
