...
class HnsNetworkDelegateBrowserTest : public InProcessBrowserTest {
 public:
  HnsNetworkDelegateBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &HnsNetworkDelegateBrowserTest::MonitorHTTPRequest,
  ...
  void DefaultBlockAllCookies() {
    hns_shields::SetCookieControlType(
        ...
        hns_shields::ControlType::BLOCK, GURL());
  }

  void DefaultBlockThirdPartyCookies() {
    hns_shields::SetCookieControlType(
        content_settings(), browser()->profile()->GetPrefs(),
        hns_shields::ControlType::BLOCK_THIRD_PARTY, GURL());
  }

  void DefaultAllowAllCookies() {
    hns_shields::SetCookieControlType(
        content_settings(), browser()->profile()->GetPrefs(),
        hns_shields::ControlType::ALLOW, GURL());
  }

  void AllowCookies(const GURL& url) {
    hns_shields::SetCookieControlType(content_settings(),
                                        browser()->profile()->GetPrefs(),
                                        hns_shields::ControlType::ALLOW, url);
  }

  void BlockThirdPartyCookies(const GURL& url) {
    hns_shields::SetCookieControlType(
        content_settings(), browser()->profile()->GetPrefs(),
        hns_shields::ControlType::BLOCK_THIRD_PARTY, url);
  }

  void BlockCookies(const GURL& url) {
    hns_shields::SetCookieControlType(content_settings(),
                                        browser()->profile()->GetPrefs(),
                                        hns_shields::ControlType::BLOCK, url);
  }
...
IN_PROC_BROWSER_TEST_F(HnsNetworkDelegateBrowserTest, Iframe3PCookieBlocked) {
...
IN_PROC_BROWSER_TEST_F(HnsNetworkDelegateBrowserTest, Iframe3PCookieAllowed) {
...
IN_PROC_BROWSER_TEST_F(HnsNetworkDelegateBrowserTest, Iframe3PShieldsDown) {
...
IN_PROC_BROWSER_TEST_F(HnsNetworkDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(HnsNetworkDelegateBrowserTest, DefaultCookiesBlocked) {
