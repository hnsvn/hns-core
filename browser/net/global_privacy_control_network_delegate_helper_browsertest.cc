...
using blink::features::kHnsGlobalPrivacyControl;
...
// `navigator.globalPrivacyControl` JS property, which is read-only. In Hns
...
class GlobalPrivacyControlFlagDisabledTest
 ...
 public:
  GlobalPrivacyControlFlagDisabledTest() {
    feature_list_.InitAndDisableFeature(kHnsGlobalPrivacyControl);
  }
