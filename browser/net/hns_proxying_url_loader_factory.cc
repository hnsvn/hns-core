...
#include "hns/components/hns_shields/browser/adblock_stub_response.h"
...
HnsProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    FollowRedirectParams() = default;
HnsProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    ~FollowRedirectParams() = default;

HnsProxyingURLLoaderFactory::InProgressRequest::InProgressRequest(
  ...
  target_client_.set_disconnect_handler(base::BindOnce(
      &HnsProxyingURLLoaderFactory::InProgressRequest::OnRequestError,
...
void HnsProxyingURLLoaderFactory::InProgressRequest::Restart() {
  UpdateRequestInfo();
  RestartInternal();
}

void HnsProxyingURLLoaderFactory::InProgressRequest::UpdateRequestInfo() {
  // TODO(iefremov): Update |ctx_| here and get rid of multiple spots where
  // it is refilled.
}

void HnsProxyingURLLoaderFactory::InProgressRequest::RestartInternal() {
  ...
  base::RepeatingCallback<void(int)> continuation =
      base::BindRepeating(&InProgressRequest::ContinueToBeforeSendHeaders,
                          weak_factory_.GetWeakPtr());
  redirect_url_ = GURL();
  ctx_ = hns::HnsRequestInfo::MakeCTX(request_, render_process_id_,
...
void HnsProxyingURLLoaderFactory::InProgressRequest::FollowRedirect(
...
void HnsProxyingURLLoaderFactory::InProgressRequest::SetPriority(
...
void HnsProxyingURLLoaderFactory::InProgressRequest::
...
void HnsProxyingURLLoaderFactory::InProgressRequest::OnReceiveEarlyHints(
    network::mojom::EarlyHintsPtr early_hints) {}

void HnsProxyingURLLoaderFactory::InProgressRequest::OnReceiveResponse(
...
void HnsProxyingURLLoaderFactory::InProgressRequest::OnReceiveRedirect(
...
void HnsProxyingURLLoaderFactory::InProgressRequest::OnUploadProgress(
...
void HnsProxyingURLLoaderFactory::InProgressRequest::OnTransferSizeUpdated(
    int32_t transfer_size_diff) {
  target_client_->OnTransferSizeUpdated(transfer_size_diff);
}

void HnsProxyingURLLoaderFactory::InProgressRequest::OnComplete(
    const network::URLLoaderCompletionStatus& status) {
  UMA_HISTOGRAM_TIMES("Hns.ProxyingURLLoader.TotalRequestTime",
...
void HnsProxyingURLLoaderFactory::InProgressRequest::
  ...
  if (ctx_->blocked_by != hns::kNotBlocked) {
    ...
    hns_shields::MakeStubResponse(ctx_->mock_data_url, request_, &response,
                                    &response_data);
...
void HnsProxyingURLLoaderFactory::InProgressRequest::ContinueToStartRequest(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void HnsProxyingURLLoaderFactory::InProgressRequest::ContinueToSendHeaders(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void HnsProxyingURLLoaderFactory::InProgressRequest::ContinueToBeforeRedirect(
    const net::RedirectInfo& redirect_info,
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
...
void HnsProxyingURLLoaderFactory::InProgressRequest::OnRequestError(
    const network::URLLoaderCompletionStatus& status) {
  if (!request_completed_) {
    ...
    if (base::FeatureList::IsEnabled(
        ...
        ctx_->blocked_by == hns::kAdBlocked) {
...
HnsProxyingURLLoaderFactory::HnsProxyingURLLoaderFactory(
  ...
  target_factory_.set_disconnect_handler(
      base::BindOnce(&HnsProxyingURLLoaderFactory::OnTargetFactoryError,
                     base::Unretained(this)));

  proxy_receivers_.Add(this, std::move(receiver),
                       navigation_response_task_runner_);
  proxy_receivers_.set_disconnect_handler(
      base::BindRepeating(&HnsProxyingURLLoaderFactory::OnProxyBindingError,
                          base::Unretained(this)));
}

HnsProxyingURLLoaderFactory::~HnsProxyingURLLoaderFactory() = default;

// static
bool HnsProxyingURLLoaderFactory::MaybeProxyRequest(
    content::BrowserContext* browser_context,
...
void HnsProxyingURLLoaderFactory::CreateLoaderAndStart(
    mojo::PendingReceiver<network::mojom::URLLoader> loader_receiver,
    int32_t request_id,
    uint32_t options,
    const network::ResourceRequest& request,
  ...
  const uint64_t hns_request_id = request_id_generator_->Generate();

  auto result = requests_.emplace(std::make_unique<InProgressRequest>(
      *this, hns_request_id, request_id, render_process_id_,
...
void HnsProxyingURLLoaderFactory::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> loader_receiver) {
  proxy_receivers_.Add(this, std::move(loader_receiver));
}

void HnsProxyingURLLoaderFactory::OnTargetFactoryError() {
...
void HnsProxyingURLLoaderFactory::OnProxyBindingError() {
...
void HnsProxyingURLLoaderFactory::RemoveRequest(InProgressRequest* request) {
...
void HnsProxyingURLLoaderFactory::MaybeRemoveProxy() {
