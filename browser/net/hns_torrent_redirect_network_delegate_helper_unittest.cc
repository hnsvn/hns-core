...
class HnsTorrentRedirectNetworkDelegateHelperTest : public testing::Test {
 public:
  HnsTorrentRedirectNetworkDelegateHelperTest() {
    ...
    torrent_extension_url_ = GURL(
        ...
        "hns_webtorrent2.html?https://webtorrent.io/torrents/sintel.torrent");
    ...
    non_torrent_extension_url_ = GURL(
        "chrome-extension://lgjmpdmojkpocjcopdikifhejkkjglho/extension/"
        "hns_webtorrent2.html?https://webtorrent.io/torrents/sintel");
  }
...
TEST_F(HnsTorrentRedirectNetworkDelegateHelperTest,
  ...
  auto request_info = std::make_shared<hns::HnsRequestInfo>(torrent_url());
...
TEST_F(HnsTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<hns::HnsRequestInfo>(non_torrent_url());
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
...
TEST_F(HnsTorrentRedirectNetworkDelegateHelperTest, MimeTypeNoRedirect) {
  scoped_refptr<net::HttpResponseHeaders> orig_response_headers =
      new net::HttpResponseHeaders(std::string());
...
TEST_F(HnsTorrentRedirectNetworkDelegateHelperTest,
  ...
  GURL allowed_unsafe_redirect_url;
  auto request_info =
      std::make_shared<hns::HnsRequestInfo>(torrent_viewer_url());
  request_info->initiator_url = torrent_extension_url();
  request_info->resource_type = blink::mojom::ResourceType::kMainFrame;
