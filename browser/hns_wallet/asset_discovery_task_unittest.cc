...
#include "hns/components/hns_wallet/browser/asset_discovery_task.h"
...
class TestHnsWalletServiceObserverForAssetDiscoveryTask
    : public hns_wallet::HnsWalletServiceObserverBase {
 public:
  TestHnsWalletServiceObserverForAssetDiscoveryTask() = default;
 ...
 protected:
  void SetUp() override {
    ...
    wallet_service_observer_ =
        std::make_unique<TestHnsWalletServiceObserverForAssetDiscoveryTask>();
  ...
  std::unique_ptr<TestHnsWalletServiceObserverForAssetDiscoveryTask>
      wallet_service_observer_;
