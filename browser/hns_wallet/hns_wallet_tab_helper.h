...
#ifndef HNS_BROWSER_HNS_WALLET_HNS_WALLET_TAB_HELPER_H_
#define HNS_BROWSER_HNS_WALLET_HNS_WALLET_TAB_HELPER_H_
...
class HnsWalletTabHelper
    : public content::WebContentsUserData<HnsWalletTabHelper> {
 public:
  explicit HnsWalletTabHelper(content::WebContents* web_contents);
  ~HnsWalletTabHelper() override;
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(HnsWalletTabHelperUnitTest, GetApproveBubbleURL);
  FRIEND_TEST_ALL_PREFIXES(HnsWalletTabHelperUnitTest,
                           SolanaConnectedAccount);
  friend class content::WebContentsUserData<HnsWalletTabHelper>;
...
#endif  // HNS_BROWSER_HNS_WALLET_HNS_WALLET_TAB_HELPER_H_
