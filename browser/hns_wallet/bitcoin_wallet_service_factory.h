...
#ifndef HNS_BROWSER_HNS_WALLET_BITCOIN_WALLET_SERVICE_FACTORY_H_
#define HNS_BROWSER_HNS_WALLET_BITCOIN_WALLET_SERVICE_FACTORY_H_
...
#endif  // HNS_BROWSER_HNS_WALLET_BITCOIN_WALLET_SERVICE_FACTORY_H_
