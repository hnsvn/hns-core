...
#ifndef HNS_BROWSER_HNS_WALLET_EXTERNAL_WALLETS_IMPORTER_H_
#define HNS_BROWSER_HNS_WALLET_EXTERNAL_WALLETS_IMPORTER_H_
...
// should be bound to the end of each HnsWalletServiceDelegateImpl function
// calls.
...
#endif  // HNS_BROWSER_HNS_WALLET_EXTERNAL_WALLETS_IMPORTER_H_
