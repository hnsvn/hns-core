...
#ifndef HNS_BROWSER_HNS_WALLET_SIMULATION_SERVICE_FACTORY_H_
#define HNS_BROWSER_HNS_WALLET_SIMULATION_SERVICE_FACTORY_H_
...
#endif  // HNS_BROWSER_HNS_WALLET_SIMULATION_SERVICE_FACTORY_H_
