...
#ifndef HNS_BROWSER_DEFAULT_PROTOCOL_HANDLER_UTILS_WIN_H_
#define HNS_BROWSER_DEFAULT_PROTOCOL_HANDLER_UTILS_WIN_H_
...
#endif  // HNS_BROWSER_DEFAULT_PROTOCOL_HANDLER_UTILS_WIN_H_
