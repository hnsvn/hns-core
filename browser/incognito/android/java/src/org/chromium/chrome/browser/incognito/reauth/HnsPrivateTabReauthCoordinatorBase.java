...
abstract class HnsPrivateTabReauthCoordinatorBase extends IncognitoReauthCoordinatorBase {
    ...
    public HnsPrivateTabReauthCoordinatorBase(@NonNull Context context,
