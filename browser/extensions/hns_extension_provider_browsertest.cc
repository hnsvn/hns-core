...
class HnsExtensionProviderTest : public extensions::ExtensionFunctionalTest {
 public:
...
IN_PROC_BROWSER_TEST_F(HnsExtensionProviderTest, WhitelistedExtension) {
...
IN_PROC_BROWSER_TEST_F(HnsExtensionProviderTest,
...
IN_PROC_BROWSER_TEST_F(HnsExtensionProviderTest, ExtensionsCanGetCookies) {
  base::FilePath test_data_dir;
  GetTestDataDir(&test_data_dir);
  scoped_refptr<const extensions::Extension> extension =
      InstallExtensionSilently(
...
IN_PROC_BROWSER_TEST_F(HnsExtensionProviderTest, ExtensionsCanSetCookies) {
  base::FilePath test_data_dir;
  GetTestDataDir(&test_data_dir);
  scoped_refptr<const extensions::Extension> extension =
      InstallExtensionSilently(
