...
#ifndef HNS_BROWSER_EXTENSIONS_HNS_COMPONENT_LOADER_H_
#define HNS_BROWSER_EXTENSIONS_HNS_COMPONENT_LOADER_H_
...
class HnsComponentLoader : public ComponentLoader {
 public:
  HnsComponentLoader(ExtensionSystem* extension_system,
                       Profile* browser_context);
  HnsComponentLoader(const HnsComponentLoader&) = delete;
  HnsComponentLoader& operator=(const HnsComponentLoader&) = delete;
  ~HnsComponentLoader() override;
...
#endif  // HNS_BROWSER_EXTENSIONS_HNS_COMPONENT_LOADER_H_
