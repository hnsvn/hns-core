...
class HnsWalletUnitTest : public testing::Test {
 public:
  HnsWalletUnitTest()
      : testing_profile_manager_(TestingBrowserProcess::GetGlobal()) {}
  ~HnsWalletUnitTest() override = default;
...
TEST_F(HnsWalletUnitTest, TestGetRandomNonce) {
...
TEST_F(HnsWalletUnitTest, TestSealSeed) {
  constexpr std::array<uint8_t, 32> seed = {
      48, 196, 56,  174, 243, 75,  120, 235, 37,  174, 254,
      97, 37,  205, 101, 93,  181, 23,  190, 82,  53,  180,
      51, 198, 232, 187, 188, 220, 160, 187, 212, 28};
...
TEST_F(HnsWalletUnitTest, TestOpenSeed) {
...
TEST_F(HnsWalletUnitTest, TestLoadFromPrefs) {
...
TEST_F(HnsWalletUnitTest, TestSaveToPrefs) {
  constexpr std::array<uint8_t, 12> nonce = {200, 153, 224, 40,  58,  249,
                                             156, 33,  152, 207, 177, 12};
  constexpr std::array<uint8_t, 48> cipher_seed = {
      33,  11,  185, 125, 67,  27,  92,  110, 132, 238, 255, 8,
...
TEST_F(HnsWalletUnitTest, MaybeLoadCryptoWalletsExtension) {
