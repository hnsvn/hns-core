...
class HnsCrxGenerationTest : public InProcessBrowserTest {
 public:
  HnsCrxGenerationTest() {
...
IN_PROC_BROWSER_TEST_F(HnsCrxGenerationTest,
...
IN_PROC_BROWSER_TEST_F(HnsCrxGenerationTest,
  ...
  crx_file::SetHnsPublisherKeyHashForTesting(public_key_hash);

  // Add the test key to the command line for using in crx generating process.
  base::CommandLine::ForCurrentProcess()->AppendSwitchPath(
      "hns-extension-publisher-key", publisher_test_key_path);
