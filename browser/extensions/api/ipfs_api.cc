...
#include "hns/browser/extensions/api/ipfs_api.h"
...
#include "hns/common/extensions/api/ipfs.h"
...
ExtensionFunction::ResponseAction IpfsGetResolveMethodListFunction::Run() {
  ...
  list.Append(MakeSelectValue(
      hns_l10n::GetLocalizedResourceUTF16String(IDS_IPFS_RESOLVE_OPTION_ASK),
