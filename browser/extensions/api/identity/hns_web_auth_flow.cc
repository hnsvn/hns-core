...
HnsWebAuthFlow::HnsWebAuthFlow() {}
HnsWebAuthFlow::~HnsWebAuthFlow() {}

// static
absl::optional<std::string> HnsWebAuthFlow::token_for_testing_;
// static
void HnsWebAuthFlow::SetTokenForTesting(const std::string& token) {
  token_for_testing_ = token;
}

void HnsWebAuthFlow::StartWebAuthFlow(
    Profile* profile,
...
void HnsWebAuthFlow::OnAuthFlowFailure(WebAuthFlow::Failure failure) {
...
void HnsWebAuthFlow::OnAuthFlowURLChange(const GURL& redirect_url) {
