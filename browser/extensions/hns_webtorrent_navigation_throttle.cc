...
HnsWebTorrentNavigationThrottle::HnsWebTorrentNavigationThrottle(
...
HnsWebTorrentNavigationThrottle::WillStartRequest() {
...
content::NavigationThrottle::ThrottleCheckResult
HnsWebTorrentNavigationThrottle::WillProcessResponse() {
...
// static
bool HnsWebTorrentNavigationThrottle::MaybeLoadWebtorrent(
...
content::NavigationThrottle::ThrottleCheckResult
HnsWebTorrentNavigationThrottle::CommonWillProcessRequestResponse() {
...
const char* HnsWebTorrentNavigationThrottle::GetNameForLogging() {
  return "HnsWebTorrentNavigationThrottle";
}
