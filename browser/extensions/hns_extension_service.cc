...
HnsExtensionService::HnsExtensionService(
    Profile* profile,
...
HnsExtensionService::~HnsExtensionService() = default;

void HnsExtensionService::AddComponentExtension(const Extension* extension) {
