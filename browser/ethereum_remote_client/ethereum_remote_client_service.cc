...
// See
// https://github.com/hnsvn/hns-browser/wiki/Hns-Ethereum-Remote-Client-Wallet-Seed-Information#note-on-salts
// static
std::string
EthereumRemoteClientService::GetEthereumRemoteClientSeedFromRootSeed(
    const std::string& seed) {
  base::StringPiece salt("hns-ethwallet-salt");
...
// https://github.com/hnsvn/hns-browser/wiki/Hns-Ethereum-Remote-Client-Wallet-Seed-Information
...
// The return value is passed to chrome.hnsWallet.getWalletSeed
