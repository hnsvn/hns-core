...
#include "hns/browser/browsing_data/hns_clear_browsing_data.h"
...
using content::HnsClearBrowsingData;
...
class HnsClearDataOnExitTest
    : public InProcessBrowserTest,
      public HnsClearBrowsingData::OnExitTestingCallback {
 public:
  HnsClearDataOnExitTest() = default;
  HnsClearDataOnExitTest(const HnsClearDataOnExitTest&) = delete;
  HnsClearDataOnExitTest& operator=(const HnsClearDataOnExitTest&) = delete;

  void SetUpOnMainThread() override {
    HnsClearBrowsingData::SetOnExitTestingCallback(this);
  }
  ...
  void TearDownInProcessBrowserTestFixture() override {
    ...
    HnsClearBrowsingData::SetOnExitTestingCallback(nullptr);
  }
  ...
  // HnsClearBrowsingData::OnExitTestingCallback implementation.
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTest, NoPrefsSet) {
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTest, VerifyRemovalMasks) {
...
class HnsClearDataOnExitTwoBrowsersTest : public HnsClearDataOnExitTest {
 public:
  HnsClearDataOnExitTwoBrowsersTest() { browsers_count_ = 2u; }

  HnsClearDataOnExitTwoBrowsersTest(
      const HnsClearDataOnExitTwoBrowsersTest&) = delete;
  HnsClearDataOnExitTwoBrowsersTest& operator=(
      const HnsClearDataOnExitTwoBrowsersTest&) = delete;
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTwoBrowsersTest, SameProfile) {
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTwoBrowsersTest, OneOTR) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTwoBrowsersTest, OneOTRExitsLast) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
  // OTR sessions don't count, so expect a single call.
  SetExepectedRemoveDataCallCount(1);
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTwoBrowsersTest, OneGuest) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTwoBrowsersTest, OneGuestExitsLast) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
  // Guest sessions don't count, so expect a single call.
  SetExepectedRemoveDataCallCount(1);
...
IN_PROC_BROWSER_TEST_F(HnsClearDataOnExitTwoBrowsersTest, TwoProfiles) {
  // Delete browsing history on exit.
  SetDeleteBrowsingHistoryOnExit();
