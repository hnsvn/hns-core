...
class BrowsingDataRemovalWatcher
 ...
 public:
  ...
  void ClearBrowsingDataForLoadedProfiles(
      HnsClearBrowsingData::OnExitTestingCallback* testing_callback);
...
bool BrowsingDataRemovalWatcher::GetClearBrowsingDataOnExitSettings(
  ...
  *origin_mask = 0;
  ...
  // Note: this will also delete Hns Shields site-specific settings.
...
HnsClearBrowsingData::OnExitTestingCallback*
    HnsClearBrowsingData::on_exit_testing_callback_ = nullptr;

// static
void HnsClearBrowsingData::ClearOnExit() {
  TRACE_EVENT0("browser", "HnsClearBrowsingData::ClearOnExit");
...
// static
void HnsClearBrowsingData::SetOnExitTestingCallback(
