 ...
 public:
  BlobUrlPartitionEnabledBrowserTest() {
    scoped_feature_list_.InitAndEnableFeature(
        net::features::kHnsPartitionBlobStorage);
  }
...
class BlobUrlEphemeralStorageDisabledBrowserTest
 ...
 public:
  BlobUrlEphemeralStorageDisabledBrowserTest() {
    scoped_feature_list_.InitAndDisableFeature(
        net::features::kHnsEphemeralStorage);
  }
...
// migrated from content_browsertests to hns_browser_tests.
class BlobUrlBrowserTest : public BlobUrlBrowserTestBase,
                           public testing::WithParamInterface<bool> {
 public:
  BlobUrlBrowserTest() {
    scoped_feature_list_.InitWithFeatureState(
        net::features::kHnsPartitionBlobStorage, GetParam());
  }
