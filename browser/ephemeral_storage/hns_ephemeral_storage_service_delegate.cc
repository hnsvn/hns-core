...
#include "hns/browser/ephemeral_storage/hns_ephemeral_storage_service_delegate.h"
...
HnsEphemeralStorageServiceDelegate::HnsEphemeralStorageServiceDelegate(
...
void HnsEphemeralStorageServiceDelegate::CleanupTLDEphemeralArea(
...
void HnsEphemeralStorageServiceDelegate::CleanupFirstPartyStorageArea(
