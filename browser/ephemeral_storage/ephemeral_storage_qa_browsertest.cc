...
// available on Hns's QA test pages, whose source is located at
// https://github.com/huhisoft/qa-test-pages
//
...
class EphemeralStorageTest : public InProcessBrowserTest {
 public:
  ...
  void SetupTestPage() {
    ...
    GURL tab_url = embedded_test_server()->GetURL("dev-pages.hns.software",
