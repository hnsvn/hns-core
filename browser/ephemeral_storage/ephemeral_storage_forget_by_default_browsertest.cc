...
#include "hns/browser/ephemeral_storage/ephemeral_storage_browsertest.h"
...
IN_PROC_BROWSER_TEST_F(EphemeralStorageForgetByDefaultBrowserTest,
                       ForgetFirstParty) {
  EXPECT_EQ(
      hns_shields::GetCookieControlType(
          content_settings(),
          CookieSettingsFactory::GetForProfile(browser()->profile()).get(),
          a_site_ephemeral_storage_url_),
      hns_shields::ControlType::BLOCK_THIRD_PARTY);
...
IN_PROC_BROWSER_TEST_F(EphemeralStorageForgetByDefaultBrowserTest,
  ...
  EXPECT_TRUE(hns_shields::GetForgetFirstPartyStorageEnabled(
      HostContentSettingsMapFactory::GetForProfile(
          incognito_browser->profile()),
      a_site_ephemeral_storage_url_));
...
IN_PROC_BROWSER_TEST_F(EphemeralStorageForgetByDefaultBrowserTest,
  ...
  hns_shields::SetForgetFirstPartyStorageEnabled(content_settings(), true,
 ...
 public:
  EphemeralStorageForgetByDefaultIsDefaultBrowserTest() {
    scoped_feature_list_.InitAndEnableFeatureWithParameters(
        net::features::kHnsForgetFirstPartyStorage,
        {{"HnsForgetFirstPartyStorageByDefault", "true"}});
  }
