...
/**
 * Builds a notification according to HnsAds spec.
 */
public class HnsNotificationBuilder extends StandardNotificationBuilder {
    /**
    ...
    private static Bitmap sHnsIcon;

    private final Context mContext;

    private boolean mIsHnsAdsNotification;

    public HnsNotificationBuilder(Context context) {
        super(context);
    ...
    public NotificationBuilderBase setChannelId(String channelId) {
        return super.setChannelId(
                mIsHnsAdsNotification ? HnsChannelDefinitions.ChannelId.HNS_ADS : channelId);
    }

    @Override
    public NotificationWrapper build(NotificationMetadata metadata) {
        if (!mIsHnsAdsNotification) {
        ...
        RemoteViews compactView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_hns_ads);
        RemoteViews bigView =
                new RemoteViews(mContext.getPackageName(), R.layout.web_notification_big_hns_ads);
        ...
        setChannelId(HnsChannelDefinitions.ChannelId.HNS_ADS);
        ...
        for (RemoteViews view : new RemoteViews[] {compactView, bigView}) {
            ...
            view.setImageViewBitmap(R.id.icon, getHnsIcon());
        ...
        String channelId = (ApplicationStatus.hasVisibleActivities())
                ...
                : HnsChannelDefinitions.ChannelId.HNS_ADS_BACKGROUND;
        ...
        builder.setLargeIcon(getHnsIcon());
    ...
    public void setIsHnsNotification(boolean isHnsAdsNotification) {
        mIsHnsAdsNotification = isHnsAdsNotification;
    }
}
