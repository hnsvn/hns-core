...
/**
 * Hns's super class for {@link TabGroupModelFilter}
 */
public abstract class HnsTabGroupModelFilter extends TabModelFilter {
    /**
    ...
    public HnsTabGroupModelFilter(TabModel tabModel) {
        super(tabModel);
    }
    ...
    public int getParentId(Tab tab) {
        if (linkClicked(tab.getLaunchType())
            ...
            if (parentTab != null) {
                return (int) HnsReflectionUtil.InvokeMethod(
