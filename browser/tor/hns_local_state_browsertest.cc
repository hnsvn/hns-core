...
using HnsLocalStateBrowserTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(HnsLocalStateBrowserTest, BasicTest) {
...
IN_PROC_BROWSER_TEST_F(HnsLocalStateBrowserTest, TorEnableDisable) {
...
IN_PROC_BROWSER_TEST_F(HnsLocalStateBrowserTest, ChangeBridges) {
