...
#include "hns/components/tor/tor_profile_service_impl.h"
...
KeyedService* TorProfileServiceFactory::BuildServiceInstanceFor(
  ...
  tor::HnsTorClientUpdater* tor_client_updater = nullptr;
  tor::HnsTorPluggableTransportUpdater* tor_pluggable_transport_updater =
      nullptr;
  if (g_hns_browser_process) {
    tor_client_updater = g_hns_browser_process->tor_client_updater();
