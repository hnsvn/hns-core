...
class HnsFaviconDatabaseBrowserTest : public InProcessBrowserTest {
 public:
  HnsFaviconDatabaseBrowserTest()
  ...
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestHandler(
        base::BindRepeating(&HnsFaviconDatabaseBrowserTest::HandleRequest,
                            base::Unretained(this)));
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &HnsFaviconDatabaseBrowserTest::SaveRequest, base::Unretained(this)));
...
IN_PROC_BROWSER_TEST_F(HnsFaviconDatabaseBrowserTest, SetRead1001) {
  ClearRequests();
