...
#ifndef HNS_BROWSER_PLAYLIST_PLAYLIST_SERVICE_FACTORY_H_
#define HNS_BROWSER_PLAYLIST_PLAYLIST_SERVICE_FACTORY_H_
...
#endif  // HNS_BROWSER_PLAYLIST_PLAYLIST_SERVICE_FACTORY_H_
