...
#include "hns/components/playlist/browser/pref_names.h"
#include "hns/components/playlist/browser/type_converter.h"
...
#include "hns/browser/playlist/playlist_data_source.h"
#endif
...
KeyedService* PlaylistServiceFactory::BuildServiceInstanceFor(
  ...
  auto* service = new PlaylistService(
      ...
      hns_stats::GetFirstRunTime(local_state));
