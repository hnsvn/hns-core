...
#include "hns/browser/ui/views/playlist/playlist_action_bubble_view.h"
#include "hns/browser/ui/views/playlist/playlist_action_icon_view.h"
#include "hns/browser/ui/views/side_panel/playlist/playlist_side_panel_coordinator.h"
#include "hns/components/constants/hns_paths.h"
#include "hns/components/constants/webui_url_constants.h"
#include "hns/components/playlist/browser/media_detector_component_manager.h"
#include "hns/components/playlist/browser/playlist_constants.h"
#include "hns/components/playlist/browser/playlist_download_request_manager.h"
...
IN_PROC_BROWSER_TEST_F(PlaylistBrowserTest, AddItemsToList) {
  ...
  auto* location_bar_view = views::AsViewClass<HnsLocationBarView>(
...
IN_PROC_BROWSER_TEST_F(PlaylistBrowserTest, DISABLED_RemoveItemFromList) {
  ...
  // are done https://github.com/hnsvn/hns-browser/issues/25829.
}
