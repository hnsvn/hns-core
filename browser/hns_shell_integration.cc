...
#include "hns/browser/hns_shell_integration_win.h"
#include "hns/browser/default_protocol_handler_utils_win.h"
#include "chrome/installer/util/shell_util.h"
#endif

#if BUILDFLAG(IS_MAC)
#include "hns/browser/hns_shell_integration_mac.h"
#endif
...
HnsDefaultBrowserWorker::HnsDefaultBrowserWorker() = default;
HnsDefaultBrowserWorker::~HnsDefaultBrowserWorker() = default;

void HnsDefaultBrowserWorker::SetAsDefaultImpl(
