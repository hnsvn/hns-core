...
#ifndef HNS_BROWSER_PROFILES_PROFILE_UTIL_H_
#define HNS_BROWSER_PROFILES_PROFILE_UTIL_H_
...
// Called from HnsAppearanceHandler and HnsNewTabMessageHandler
...
// browser/hns_browser_main_extra_parts.cc
void RecordInitialP3AValues(Profile* profile);

// Used for capturing the value of kHnsCurrentDataVersion so that the
...
#endif  // HNS_BROWSER_PROFILES_PROFILE_UTIL_H_
