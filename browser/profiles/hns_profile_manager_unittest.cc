...
class HnsProfileManagerTest : public testing::Test {
 public:
...
TEST_F(HnsProfileManagerTest, EnableMediaRouterOnRestartDefaultValue) {
...
TEST_F(HnsProfileManagerTest, EnableMediaRouterOnRestartNonDefaultValue) {
  ProfileManager* profile_manager = g_browser_process->profile_manager();
  ASSERT_TRUE(profile_manager);
