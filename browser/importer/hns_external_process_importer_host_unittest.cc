...
class HnsExternalProcessImporterHostUnitTest : public testing::Test {
 public:
  HnsExternalProcessImporterHostUnitTest() {}
  ...
  void SetUp() override {
    ...
    external_process_host_ = new HnsExternalProcessImporterHost();
    external_process_host()->SetInstallExtensionCallbackForTesting(
        base::BindRepeating(
            &HnsExternalProcessImporterHostUnitTest::InstallExtension,
  ...
  HnsExternalProcessImporterHost* external_process_host() {
 ...
 private:
  ...
  raw_ptr<HnsExternalProcessImporterHost> external_process_host_;
  std::unique_ptr<TestingProfile> profile_;
};

TEST_F(HnsExternalProcessImporterHostUnitTest, ImportExtensionsSettings) {
  ...
  EXPECT_EQ(
      hns::ReadStore(GetExtensionLocalSettingsPath("Hns", "id1"), "id1"),
  ...
  EXPECT_EQ(
      hns::ReadStore(GetExtensionLocalSettingsPath("Hns", "id2"), "id2"),
      base::JSONReader::Read(R"({
    "a": "b",
    "c": "d",
    "id": "id2"
  ...
  EXPECT_EQ(
      hns::ReadStore(GetExtensionLocalSettingsPath("Hns", "id3"), "id3"),
      base::JSONReader::Read(R"({
    "a": "b",
    "c": "d",
    "id": "id3"
  ...
  EXPECT_FALSE(
      hns::ReadStore(GetExtensionLocalSettingsPath("Hns", "id0"), "id0"));
}
