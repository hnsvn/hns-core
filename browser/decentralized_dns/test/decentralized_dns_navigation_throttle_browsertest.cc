...
#include "hns/components/decentralized_dns/content/decentralized_dns_opt_in_page.h"
...
using hns_wallet::EnsResolverTask;
using hns_wallet::EnsResolverTaskError;
using hns_wallet::EnsResolverTaskResult;
