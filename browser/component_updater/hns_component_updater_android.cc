...
#include "hns/browser/component_updater/hns_component_updater_android.h"

#include "base/android/jni_android.h"
#include "base/android/jni_string.h"
#include "base/json/json_writer.h"
#include "hns/build/android/jni_headers/HnsComponentUpdater_jni.h"
...
HnsComponentUpdaterAndroid::HnsComponentUpdaterAndroid(
    JNIEnv* env,
    const base::android::JavaRef<jobject>& obj)
    : weak_java_hns_sync_worker_(env, obj) {
  Java_HnsComponentUpdater_setNativePtr(env, obj,
...
void HnsComponentUpdaterAndroid::Destroy(JNIEnv* env) {
  delete this;
}

void HnsComponentUpdaterAndroid::OnEvent(Events event,
                                           const std::string& id) {
  // Notify Java code
  JNIEnv* env = base::android::AttachCurrentThread();
  Java_HnsComponentUpdater_componentStateUpdated(
      env, weak_java_hns_sync_worker_.get(env), static_cast<int>(event),
      base::android::ConvertUTF8ToJavaString(env, id));
}

base::android::ScopedJavaLocalRef<jstring>
HnsComponentUpdaterAndroid::GetUpdateState(
    JNIEnv* env,
...
static void JNI_HnsComponentUpdater_Init(
    JNIEnv* env,
    const base::android::JavaParamRef<jobject>& jcaller) {
  new HnsComponentUpdaterAndroid(env, jcaller);
}
