...
#include "hns/browser/misc_metrics/vertical_tab_metrics.h"
...
const char kVerticalOpenTabsHistogramName[] = "Hns.VerticalTabs.OpenTabs";
const char kVerticalGroupTabsHistogramName[] = "Hns.VerticalTabs.GroupTabs";
const char kVerticalPinnedTabsHistogramName[] = "Hns.VerticalTabs.PinnedTabs";
...
void VerticalTabBrowserMetrics::UpdateEnabledStatus() {
  vertical_tabs_enabled_ =
      profile_prefs_->GetBoolean(hns_tabs::kVerticalTabsEnabled);
}
