...
#ifndef HNS_BROWSER_MISC_METRICS_PAGE_METRICS_SERVICE_FACTORY_H_
#define HNS_BROWSER_MISC_METRICS_PAGE_METRICS_SERVICE_FACTORY_H_
...
#endif  // HNS_BROWSER_MISC_METRICS_PAGE_METRICS_SERVICE_FACTORY_H_
