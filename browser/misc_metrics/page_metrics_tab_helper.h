...
#ifndef HNS_BROWSER_MISC_METRICS_PAGE_METRICS_TAB_HELPER_H_
#define HNS_BROWSER_MISC_METRICS_PAGE_METRICS_TAB_HELPER_H_
...
#endif  // HNS_BROWSER_MISC_METRICS_PAGE_METRICS_TAB_HELPER_H_
