...
#ifndef HNS_BROWSER_MISC_METRICS_VERTICAL_TAB_METRICS_H_
#define HNS_BROWSER_MISC_METRICS_VERTICAL_TAB_METRICS_H_
...
#endif  // HNS_BROWSER_MISC_METRICS_VERTICAL_TAB_METRICS_H_
