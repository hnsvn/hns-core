...
#ifndef HNS_BROWSER_HNS_VPN_WIN_HNS_VPN_WIREGUARD_SERVICE_STATUS_TRAY_STATUS_TRAY_RUNNER_H_
#define HNS_BROWSER_HNS_VPN_WIN_HNS_VPN_WIREGUARD_SERVICE_STATUS_TRAY_STATUS_TRAY_RUNNER_H_
...
#include "hns/browser/hns_vpn/win/hns_vpn_wireguard_service/status_tray/wireguard/wireguard_service_observer.h"
...
class StatusTrayRunner : public TrayMenuModel::Delegate,
 ...
 public:
  ...
  void SetCurrentStateForTesting(
      absl::optional<hns_vpn::mojom::ConnectionState> state) {
 ...
 private:
  ...
  hns_vpn::mojom::ConnectionState GetConnectionState();
  void ConnectVPN();
  void DisconnectVPN();
  ...
  absl::optional<hns_vpn::mojom::ConnectionState> current_state_;
...
#endif  // HNS_BROWSER_HNS_VPN_WIN_HNS_VPN_WIREGUARD_SERVICE_STATUS_TRAY_STATUS_TRAY_RUNNER_H_
