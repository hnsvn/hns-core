...
constexpr base::FilePath::CharType kStatusTraydowName[] =
    FILE_PATH_LITERAL("HnsVpn_StatusTraydow");
constexpr base::FilePath::CharType kStatusTraydowClass[] =
    FILE_PATH_LITERAL("HnsVpn_StatusTraydowClass");

const base::FilePath::CharType kHnsVpnTaskbarMessageName[] =
...
StatusTray::StatusTray() : atom_(0), instance_(NULL) {
  ...
  // our icons.
  taskbar_created_message_ = RegisterWindowMessage(kHnsVpnTaskbarMessageName);
