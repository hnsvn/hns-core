...
#ifndef HNS_BROWSER_HNS_VPN_ANDROID_HNS_VPN_NATIVE_WORKER_H_
#define HNS_BROWSER_HNS_VPN_ANDROID_HNS_VPN_NATIVE_WORKER_H_
...
namespace chrome {
namespace android {
class HnsVpnNativeWorker {
 public:
  HnsVpnNativeWorker(JNIEnv* env, const base::android::JavaRef<jobject>& obj);
  ~HnsVpnNativeWorker();

  HnsVpnNativeWorker(const HnsVpnNativeWorker&) = delete;
  HnsVpnNativeWorker& operator=(const HnsVpnNativeWorker&) = delete;
 ...
 private:
  JavaObjectWeakGlobalRef weak_java_hns_vpn_native_worker_;
  base::WeakPtrFactory<HnsVpnNativeWorker> weak_factory_;
};
}  // namespace android
}  // namespace chrome

#endif  // HNS_BROWSER_HNS_VPN_ANDROID_HNS_VPN_NATIVE_WORKER_H_
