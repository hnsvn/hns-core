...
class HnsContentSettingsBrowserTest : public InProcessBrowserTest {
 public:
  HnsContentSettingsBrowserTest()
  ...
  ~HnsContentSettingsBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(HnsContentSettingsBrowserTest,
