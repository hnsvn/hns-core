...
class HnsContentSettingsDefaultProviderTest : public testing::Test {
 public:
  HnsContentSettingsDefaultProviderTest()
      : provider_(profile_.GetPrefs(), false, false) {}
  ~HnsContentSettingsDefaultProviderTest() override {
...
TEST_F(HnsContentSettingsDefaultProviderTest, DiscardObsoleteAutoplayAsk) {
