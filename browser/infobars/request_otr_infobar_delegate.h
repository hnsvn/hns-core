...
#ifndef HNS_BROWSER_INFOBARS_REQUEST_OTR_INFOBAR_DELEGATE_H_
#define HNS_BROWSER_INFOBARS_REQUEST_OTR_INFOBAR_DELEGATE_H_
...
#endif  // HNS_BROWSER_INFOBARS_REQUEST_OTR_INFOBAR_DELEGATE_H_
