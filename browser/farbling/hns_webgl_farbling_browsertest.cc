...
class HnsWebGLFarblingBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(HnsWebGLFarblingBrowserTest, FarbleGetParameterWebGL) {
...
IN_PROC_BROWSER_TEST_F(HnsWebGLFarblingBrowserTest,
...
IN_PROC_BROWSER_TEST_F(HnsWebGLFarblingBrowserTest, GetSupportedExtensions) {
  std::string domain = "a.com";
  GURL url =
...
IN_PROC_BROWSER_TEST_F(HnsWebGLFarblingBrowserTest, GetExtension) {
  std::string domain = "a.com";
