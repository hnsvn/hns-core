...
class HnsScreenFarblingBrowserTest : public InProcessBrowserTest {
 public:
  void SetUpOnMainThread() override {
    ...
    browser_content_client_.reset(new HnsContentBrowserClient());
...
class HnsScreenFarblingBrowserTest_EnableFlag
    : public HnsScreenFarblingBrowserTest {
 public:
  HnsScreenFarblingBrowserTest_EnableFlag() {
...
class HnsScreenFarblingBrowserTest_DisableFlag
    : public HnsScreenFarblingBrowserTest {
 public:
  HnsScreenFarblingBrowserTest_DisableFlag() {
...
IN_PROC_BROWSER_TEST_F(HnsScreenFarblingBrowserTest_EnableFlag,
                       FarbleScreenSize_EnableFlag) {
  FarbleScreenSize(parent_url(), true);
}

IN_PROC_BROWSER_TEST_F(HnsScreenFarblingBrowserTest_DisableFlag,
