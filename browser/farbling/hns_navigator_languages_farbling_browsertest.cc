...
class HnsNavigatorLanguagesFarblingBrowserTest : public InProcessBrowserTest {
 public:
  HnsNavigatorLanguagesFarblingBrowserTest()
    ...
    https_server_.RegisterRequestMonitor(base::BindRepeating(
        &HnsNavigatorLanguagesFarblingBrowserTest::MonitorHTTPRequest,
        base::Unretained(this)));
  }

  HnsNavigatorLanguagesFarblingBrowserTest(
      const HnsNavigatorLanguagesFarblingBrowserTest&) = delete;
  HnsNavigatorLanguagesFarblingBrowserTest& operator=(
      const HnsNavigatorLanguagesFarblingBrowserTest&) = delete;

  ~HnsNavigatorLanguagesFarblingBrowserTest() override = default;
  ...
  void SetUpOnMainThread() override {
    ...
    g_hns_browser_process->hns_farbling_service()
...
IN_PROC_BROWSER_TEST_F(HnsNavigatorLanguagesFarblingBrowserTest,
                       FarbleLanguages) {
