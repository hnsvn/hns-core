...
class TestContentBrowserClient : public HnsContentBrowserClient {
 public:
...
class HnsNavigatorUsbFarblingBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(HnsNavigatorUsbFarblingBrowserTest,
                       FarbleSerialNumber) {
