...
class HnsNTPCustomBackgroundServiceDelegateUnitTest : public testing::Test {
 public:
  HnsNTPCustomBackgroundServiceDelegateUnitTest() = default;
  ~HnsNTPCustomBackgroundServiceDelegateUnitTest() override = default;
  ...
  void SetUp() override {
    ...
    service_delegate_ =
        std::make_unique<HnsNTPCustomBackgroundServiceDelegate>(profile_);
  }
 ...
 protected:
  ...
  HnsNTPCustomBackgroundServiceDelegate& service_delegate() {
 ...
 private:
  ...
  std::unique_ptr<HnsNTPCustomBackgroundServiceDelegate> service_delegate_;
};

TEST_F(HnsNTPCustomBackgroundServiceDelegateUnitTest, MigrationSuccess) {
  ...
  // Get ready for old data.
  {
    ...
    ASSERT_TRUE(base::PathService::Get(hns::DIR_TEST_DATA, &test_data_dir));
...
TEST_F(HnsNTPCustomBackgroundServiceDelegateUnitTest, MigrationFail) {
  NTPBackgroundPrefs ntp_prefs(profile().GetPrefs());
  ...
  EXPECT_TRUE(ntp_prefs.IsHnsType());
