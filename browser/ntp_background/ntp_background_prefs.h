...
#ifndef HNS_BROWSER_NTP_BACKGROUND_NTP_BACKGROUND_PREFS_H_
#define HNS_BROWSER_NTP_BACKGROUND_NTP_BACKGROUND_PREFS_H_
...
//
//  kNTPBackground: {
//     type: ‘hns’ | ‘custom_image’ | 'color' | ‘solid_color’
...
//
//  Types:
//   'hns': mapped to Type::kHns. Default backgrounds provided by us.
...
class NTPBackgroundPrefs final {
 public:
  static constexpr char kDeprecatedPrefName[] =
      "hns.new_tab_page.custom_background_enabled";
  static constexpr char kPrefName[] = "hns.new_tab_page.background";

  static constexpr char kCustomImageListPrefName[] =
      "hns.new_tab_page.custom_background_image_list";

  enum class Type {
    kHns,  // Images that we supply.
    kCustomImage,
    kColor,
  };
...
#endif  // HNS_BROWSER_NTP_BACKGROUND_NTP_BACKGROUND_PREFS_H_
