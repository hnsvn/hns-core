...
#ifndef HNS_BROWSER_NTP_BACKGROUND_VIEW_COUNTER_SERVICE_FACTORY_H_
#define HNS_BROWSER_NTP_BACKGROUND_VIEW_COUNTER_SERVICE_FACTORY_H_
...
#endif  // HNS_BROWSER_NTP_BACKGROUND_VIEW_COUNTER_SERVICE_FACTORY_H_
