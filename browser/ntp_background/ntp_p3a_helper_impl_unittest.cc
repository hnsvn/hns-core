...
constexpr char kTestP3AJsonHost[] = "https://p3a-json.hns.com";
constexpr char kTestP2AJsonHost[] = "https://p2a-json.hns.com";
constexpr char kTestP3ACreativeHost[] = "https://p3a-creative.hns.com";
}  // namespace
...
class NTPP3AHelperImplTest : public testing::Test {
 ...
 protected:
  void SetUp() override {
    ...
    hns::RegisterPrefsForHnsReferralsService(local_state_.registry());
    p3a::P3AService::RegisterPrefs(local_state_.registry(),
                                   /*first_run*/ false);
    NTPP3AHelperImpl::RegisterLocalStatePrefs(local_state_.registry());

    hns_ads::AdsService::RegisterProfilePrefs(prefs_.registry());
    hns_rewards::RewardsService::RegisterProfilePrefs(prefs_.registry());
...
TEST_F(NTPP3AHelperImplTest, StopSendingAfterEnablingRewards) {
  ...
  prefs_.SetBoolean(hns_rewards::prefs::kEnabled, true);
