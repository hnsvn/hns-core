...
#ifndef HNS_BROWSER_NTP_BACKGROUND_NTP_P3A_HELPER_IMPL_H_
#define HNS_BROWSER_NTP_BACKGROUND_NTP_P3A_HELPER_IMPL_H_
...
class NTPP3AHelperImpl : public NTPP3AHelper {
 public:
  ...
  // See HnsP3AService::RegisterDynamicMetric and
  // HnsP3AService::RegisterMetricCycledCallback header comments for more
  // info.
...
#endif  // HNS_BROWSER_NTP_BACKGROUND_NTP_P3A_HELPER_IMPL_H_
