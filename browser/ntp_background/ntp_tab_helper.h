...
#ifndef HNS_BROWSER_NTP_BACKGROUND_NTP_TAB_HELPER_H_
#define HNS_BROWSER_NTP_BACKGROUND_NTP_TAB_HELPER_H_
...
#endif  //  HNS_BROWSER_NTP_BACKGROUND_NTP_TAB_HELPER_H_
