...
class HnsWindowNameBrowserTest : public InProcessBrowserTest {
 public:
  HnsWindowNameBrowserTest()
  ...
  HnsWindowNameBrowserTest(const HnsWindowNameBrowserTest&) = delete;
  HnsWindowNameBrowserTest& operator=(const HnsWindowNameBrowserTest&) =
      delete;

  ~HnsWindowNameBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(HnsWindowNameBrowserTest, SameOrigin) {
  GURL url1 =
...
IN_PROC_BROWSER_TEST_F(HnsWindowNameBrowserTest, CrossOrigin) {
...
IN_PROC_BROWSER_TEST_F(HnsWindowNameBrowserTest, CrossOriginAndBack) {
  GURL url1 = https_server_.GetURL("a.test", "/set_window_name.html");
  GURL url2 = https_server_.GetURL("b.test", "/get_window_name.html");
