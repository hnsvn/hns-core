...
class PermissionManagerBrowserTest : public InProcessBrowserTest {
 public:
  ...
  void SetUpOnMainThread() override {
    ...
    permission_manager_ = static_cast<permissions::HnsPermissionManager*>(
  ...
  HnsPermissionManager* permission_manager() { return permission_manager_; }
 ...
 protected:
  ...
  raw_ptr<HnsPermissionManager> permission_manager_ = nullptr;
...
IN_PROC_BROWSER_TEST_F(PermissionManagerBrowserTest, RequestPermissions) {
  ...
  for (size_t i = 0; i < sizeof(cases) / sizeof(cases[0]); ++i) {
    ...
    url::Origin origin;
    ASSERT_TRUE(hns_wallet::GetConcatOriginFromWalletAddresses(
    ...
    permissions::HnsWalletPermissionContext::AcceptOrCancel(
        ...
        hns_wallet::mojom::PermissionLifetimeOption::kForever,
        web_contents());
    testing::Mock::VerifyAndClearExpectations(&callback);
