...
class HnsWalletPermissionContextBrowserTest : public InProcessBrowserTest {
 public:
  HnsWalletPermissionContextBrowserTest()
      : https_server_(net::EmbeddedTestServer::TYPE_HTTPS) {
    scoped_feature_list_.InitAndEnableFeature(
        hns_wallet::features::kNativeHnsWalletFeature);
  }

  ~HnsWalletPermissionContextBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(HnsWalletPermissionContextBrowserTest,
                       GetAllowedAccounts) {
  ...
  // Fail if rfh is null.
  auto allowed_accounts = HnsWalletPermissionContext::GetAllowedAccounts(
      blink::PermissionType::HNS_ETHEREUM, nullptr /* rfh */, addresses);
  ...
  allowed_accounts = HnsWalletPermissionContext::GetAllowedAccounts(
