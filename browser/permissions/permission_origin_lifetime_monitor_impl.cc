...
#include "hns/browser/permissions/permission_origin_lifetime_monitor_impl.h"
...
PermissionOriginLifetimeMonitorImpl::PermissionOriginLifetimeMonitorImpl(
  ...
  DCHECK(base::FeatureList::IsEnabled(net::features::kHnsEphemeralStorage));
}
...
PermissionOriginLifetimeMonitorImpl::SubscribeToPermissionOriginDestruction(
  ...
  for (auto type : {RequestType::kHnsEthereum, RequestType::kHnsSolana}) {
