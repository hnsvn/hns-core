 ...
 public:
  ...
  void SetUpOnMainThread() override {
    ...
    localhost_permission_component_ =
        g_hns_browser_process->localhost_permission_component();
  ...
  void AddAdblockRule(const std::string& rule) {
    source_provider_ =
        std::make_unique<hns_shields::TestFiltersProvider>(rule, "");
  ...
  void SetCurrentStatus(ContentSetting content_setting) {
    content_settings()->SetContentSettingDefaultScope(
        embedding_url_, embedding_url_,
        ContentSettingsType::HNS_LOCALHOST_ACCESS, content_setting);
  }
