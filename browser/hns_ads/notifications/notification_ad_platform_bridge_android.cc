...
#include "hns/browser/hns_ads/android/jni_headers/HnsAdsNotificationDialog_jni.h"
...
void NotificationAdPlatformBridge::ShowNotificationAd(
  ...
  Java_HnsAdsNotificationDialog_showNotificationAd(env, j_notification_id,
                                                     j_origin, title, body);
}
...
void NotificationAdPlatformBridge::CloseNotificationAd(
  ...
  Java_HnsAdsNotificationDialog_closeNotificationAd(env, j_notification_id);
}
