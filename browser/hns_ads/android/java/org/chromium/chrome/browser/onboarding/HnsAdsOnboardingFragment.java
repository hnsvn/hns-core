...
public class HnsAdsOnboardingFragment extends Fragment implements FirstRunFragment {
    ...
    public HnsAdsOnboardingFragment() {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_hns_ads_onboarding, container, false);
    ...
    private void startCountdown() {
        HnsOnboardingNotification.cancelOnboardingNotification(getActivity());
