...
public class HnsAdsNotificationDialog {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (Math.abs(deltaXDp) > MIN_DISTANCE_FOR_DISMISS) {
                        mAdsDialog.dismiss();
                        mAdsDialog = null;
                        HnsAdsNativeHelper.nativeOnNotificationAdClosed(
    ...
    public static void showNotificationAd(Context context, final String notificationId,
        ...
        if (shouldUseDarkModeTheme()) {
            b.setView(inflater.inflate(R.layout.hns_ads_custom_notification_dark, null));
        } else {
            b.setView(inflater.inflate(R.layout.hns_ads_custom_notification, null));
        }
        mAdsDialog = b.create();

        if (mNotificationId != null) {
            HnsAdsNativeHelper.nativeOnNotificationAdShown(
        ...
        ((TextView) mAdsDialog.findViewById(R.id.hns_ads_custom_notification_header)).setText(title);
        ((TextView) mAdsDialog.findViewById(R.id.hns_ads_custom_notification_body)).setText(body);

        mNotificationId = notificationId;
        mAdsDialog.findViewById(R.id.hns_ads_custom_notification_popup)
    ...
    private static void adsDialogTapped(final String origin) {
        if (mNotificationId.equals(HnsOnboardingNotification.HNS_ONBOARDING_NOTIFICATION_TAG)) {
            mAdsDialog.dismiss();
            mAdsDialog = null;
            ...
            mAdsDialog.dismiss();
            mAdsDialog = null;
            HnsAdsNativeHelper.nativeOnNotificationAdClicked(
                    Profile.getLastUsedRegularProfile(), mNotificationId);
        }
        mNotificationId = null;
    }
    ...
    public static void showNotificationAd(final String notificationId, final String origin,
        ...
        HnsAdsNotificationDialog.showNotificationAd(
