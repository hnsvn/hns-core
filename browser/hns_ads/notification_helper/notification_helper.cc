...
#if BUILDFLAG(IS_MAC)
#include "hns/browser/hns_ads/notification_helper/notification_helper_impl_mac.h"
#endif  // BUILDFLAG(IS_MAC)

#if BUILDFLAG(IS_WIN)
#include "hns/browser/hns_ads/notification_helper/notification_helper_impl_win.h"
