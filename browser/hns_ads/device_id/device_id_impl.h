...
#ifndef HNS_BROWSER_HNS_ADS_DEVICE_ID_DEVICE_ID_IMPL_H_
#define HNS_BROWSER_HNS_ADS_DEVICE_ID_DEVICE_ID_IMPL_H_
...
#endif  // HNS_BROWSER_HNS_ADS_DEVICE_ID_DEVICE_ID_IMPL_H_
