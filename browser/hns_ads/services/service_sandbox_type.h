...
#ifndef HNS_BROWSER_HNS_ADS_SERVICES_SERVICE_SANDBOX_TYPE_H_
#define HNS_BROWSER_HNS_ADS_SERVICES_SERVICE_SANDBOX_TYPE_H_
...
#endif  // HNS_BROWSER_HNS_ADS_SERVICES_SERVICE_SANDBOX_TYPE_H_
