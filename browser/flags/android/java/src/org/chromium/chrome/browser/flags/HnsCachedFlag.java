 ...
 */
public class HnsCachedFlag extends CachedFlag {
    ...
    public HnsCachedFlag(String featureName, boolean defaultValue) {
        super(featureName, defaultValue);

        maybeOverrideDefaultValue(featureName, defaultValue);
    }

    public HnsCachedFlag(String featureName, String sharedPreferenceKey, boolean defaultValue) {
