...
namespace ui {
// This resets dark mode to os theme when user changes hns theme from
// dark or light to Same as Windows by using the value of registry because
// we changed ui::NativeTheme::dark_mode_ explicitly for using hns theme
// like a system theme.
...
void SetSystemDarkMode(HnsDarkModeType type) {
  ...
  ui::IgnoreSystemDarkModeChange(
      type != dark_mode::HnsDarkModeType::HNS_DARK_MODE_TYPE_DEFAULT);
