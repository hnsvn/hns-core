...
#ifndef HNS_BROWSER_HNS_CONTENT_BROWSER_CLIENT_H_
#define HNS_BROWSER_HNS_CONTENT_BROWSER_CLIENT_H_
...
class HnsContentBrowserClient : public ChromeContentBrowserClient {
 public:
  HnsContentBrowserClient();
  HnsContentBrowserClient(const HnsContentBrowserClient&) = delete;
  HnsContentBrowserClient& operator=(const HnsContentBrowserClient&) =
      delete;
  ~HnsContentBrowserClient() override;
  ...
  uint8_t WorkerGetHnsFarblingLevel(
      const GURL& url,
      content::BrowserContext* browser_context) override;
...
#endif  // HNS_BROWSER_HNS_CONTENT_BROWSER_CLIENT_H_
