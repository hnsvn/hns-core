...
class HnsPolicyTest : public InProcessBrowserTest {
 protected:
  HnsPolicyTest() = default;
  ~HnsPolicyTest() override = default;
...
class TorDisabledPolicyBrowserTest : public HnsPolicyTest {
 public:
  TorDisabledPolicyBrowserTest() = default;
  ~TorDisabledPolicyBrowserTest() override = default;

  void SetUpInProcessBrowserTestFixture() override {
    HnsPolicyTest::SetUpInProcessBrowserTestFixture();
...
class TorEnabledPolicyBrowserTest : public HnsPolicyTest {
 public:
...
class BrowserAddPersonPolicyTest : public HnsPolicyTest {
 public:
...
template <bool enable>
class BrowserGuestModePolicyTest : public HnsPolicyTest {
 public:
