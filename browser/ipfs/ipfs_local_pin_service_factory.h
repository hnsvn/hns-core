...
#ifndef HNS_BROWSER_IPFS_IPFS_LOCAL_PIN_SERVICE_FACTORY_H_
#define HNS_BROWSER_IPFS_IPFS_LOCAL_PIN_SERVICE_FACTORY_H_
...
#endif  // HNS_BROWSER_IPFS_IPFS_LOCAL_PIN_SERVICE_FACTORY_H_
