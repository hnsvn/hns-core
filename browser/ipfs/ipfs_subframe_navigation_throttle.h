...
#ifndef HNS_BROWSER_IPFS_IPFS_SUBFRAME_NAVIGATION_THROTTLE_H_
#define HNS_BROWSER_IPFS_IPFS_SUBFRAME_NAVIGATION_THROTTLE_H_
...
#endif  // HNS_BROWSER_IPFS_IPFS_SUBFRAME_NAVIGATION_THROTTLE_H_
