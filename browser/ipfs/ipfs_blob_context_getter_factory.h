...
#ifndef HNS_BROWSER_IPFS_IPFS_BLOB_CONTEXT_GETTER_FACTORY_H_
#define HNS_BROWSER_IPFS_IPFS_BLOB_CONTEXT_GETTER_FACTORY_H_
...
#endif  // HNS_BROWSER_IPFS_IPFS_BLOB_CONTEXT_GETTER_FACTORY_H_
