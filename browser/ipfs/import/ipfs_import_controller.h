...
#ifndef HNS_BROWSER_IPFS_IMPORT_IPFS_IMPORT_CONTROLLER_H_
#define HNS_BROWSER_IPFS_IMPORT_IPFS_IMPORT_CONTROLLER_H_
...
#endif  // HNS_BROWSER_IPFS_IMPORT_IPFS_IMPORT_CONTROLLER_H_
