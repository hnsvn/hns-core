...
#ifndef HNS_BROWSER_IPFS_IMPORT_SAVE_PACKAGE_OBSERVER_H_
#define HNS_BROWSER_IPFS_IMPORT_SAVE_PACKAGE_OBSERVER_H_
...
#endif  // HNS_BROWSER_IPFS_IMPORT_SAVE_PACKAGE_OBSERVER_H_
