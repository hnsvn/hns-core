...
class HnsRandomDeterministicTest : public testing::Test {
 public:
  HnsRandomDeterministicTest() = default;
  HnsRandomDeterministicTest(const HnsRandomDeterministicTest&) = delete;
  HnsRandomDeterministicTest& operator=(const HnsRandomDeterministicTest&) =
      delete;
  ~HnsRandomDeterministicTest() override = default;

 private:
};

TEST_F(HnsRandomDeterministicTest, Uniform_01) {
  using hns_base::random::deterministic::Uniform_01;
...
TEST_F(HnsRandomDeterministicTest, StdExponential) {
  using hns_base::random::deterministic::StdExponential;
...
TEST_F(HnsRandomDeterministicTest, Exponential) {
  using hns_base::random::deterministic::Exponential;
...
TEST_F(HnsRandomDeterministicTest, Geometric) {
  using hns_base::random::deterministic::Geometric;
