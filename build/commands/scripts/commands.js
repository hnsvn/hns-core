...
// https://github.com/hnsvn/hns-browser/issues/13724
...
program
  ...
  .option('--hns_google_api_key <hns_google_api_key>')
  .option('--hns_google_api_endpoint <hns_google_api_endpoint>')
  .option('--hns_infura_project_id <hns_infura_project_id>')
  ...
  .option('--hns_safetynet_api_key <hns_safetynet_api_key>')
...
program
  ...
  .option('--skip_signing', 'skip signing dmg/hns_installer.exe')
...
program
  ...
  .option('--disable_hns_extension', 'disable loading the Hns extension')
  .option('--disable_hns_rewards_extension', 'disable loading the Hns Rewards extension')
  ...
  .option('--enable_hns_update', 'enable hns update')
  ...
  // See https://github.com/hnsvn/hns-browser/wiki/Rewards#flags for more information
  .option('--rewards [options]', 'options for rewards')
  .option('--hns_ads_testing', 'ads testing')
  .option('--hns_ads_production', 'ads production')
  .option('--hns_ads_staging', 'ads staging')
  .option('--hns_ads_debug', 'ads debug')
  .option('--single_process', 'use a single process')
  .option('--output_path [pathname]', 'use the Hns binary located at [pathname]')
  .arguments('[build_config]')
  .action(start.bind(null, parsedArgs.unknown))

program
  .command('pull_l10n')
  .option('--extension <extension>', 'Scope this command to localize a Hns extension such as greaselion')
