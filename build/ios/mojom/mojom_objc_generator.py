...
class BaseDictionaryValueMojoTypemap(MojoTypemap):
    ...
    def DefaultObjCValue(self, default):
        return "@{}"
    def ObjCToCpp(self, accessor):
        return "hns::BaseValueDictFromNSDictionary(%s)" % accessor
    def CppToObjC(self, accessor):
        return "hns::NSDictionaryFromBaseValueDict(%s.Clone())" % accessor
...
class BaseListValueMojoTypemap(MojoTypemap):
    ...
    def DefaultObjCValue(self, default):
        return "@[]"
    def ObjCToCpp(self, accessor):
        return "hns::BaseValueFromNSArray(%s)" % accessor
    def CppToObjC(self, accessor):
        return "hns::NSArrayFromBaseValue(%s.Clone())" % accessor
...
class Generator(generator.Generator):
    ...
    def _GetJinjaExports(self):
        ...
        # other Hns imports should only be included
        hns_imports = [i for i in self.module.imports if
                         i.path.startswith('hns/')]
