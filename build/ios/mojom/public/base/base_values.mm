...
#include "hns/build/ios/mojom/public/base/base_values.h"

#include "base/json/json_reader.h"
#include "base/json/json_writer.h"
#include "base/strings/sys_string_conversions.h"
#include "hns/build/ios/mojom/public/base/base_values+private.h"
  ...
  if ((self = [super init])) {
    switch (value.type()) {
      ...
      case base::Value::Type::DICT:
        self.dictionaryValue = hns::NSDictionaryFromBaseValue(value.Clone());
        break;
      case base::Value::Type::LIST:
        self.listValue = hns::NSArrayFromBaseValue(value.Clone());
        break;
...
- (base::Value)cppObjPtr {
  switch (self.tag) {
    ...
    case MojoBaseValueTagDictionaryValue: {
      return hns::BaseValueFromNSDictionary(self.dictionaryValue);
    }
    case MojoBaseValueTagListValue: {
      return hns::BaseValueFromNSArray(self.listValue);
    }
