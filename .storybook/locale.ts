...
let locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: ' Hns Software. Hns is a registered trademark of Hns Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this Hns Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from Hns in the event of data loss on your device.',
  ads: 'Ads',
  ad: 'Ad',
  ...
  bat: 'BAT',
  hnsAdsDesc: 'No action required. Just collect tokens. Your data is safe with our Shields.',
  hnsAdsTitle: 'Hns Ads',
  hnsAdsLaunchTitle: 'Hns Ads has arrived!',
  hnsContributeDesc: 'Set budget and browse normally. Your favorite sites get paid automatically.',
  hnsContributeTitle: 'Auto-Contribute',
  hnsRewards: 'Hns Rewards',
  hnsRewardsDesc: 'Earn tokens for viewing privacy-respecting ads, and pay it forward by supporting content creators you love!',
  hnsRewardsOptInText: 'Yes, I\'m In!',
  hnsRewardsSubTitle: 'Get Rewarded for Browsing!',
  hnsRewardsTeaser: 'How it works...',
  hnsRewardsTitle: 'Hns Rewards',
  hnsVerified: 'Verified Creators',
  cancel: 'Cancel',
  ...
  disabledPanelPrivateText: 'Hns Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'Hns Rewards is',
  dismiss: 'Closed',
  ...
  enableRewards: 'Enable Hns Rewards',
  ...
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the Hns User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no Hns Ads history',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined Hns’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsWidgetHnsRewards: 'Hns Rewards',
  saveAd: 'Save',
  saved: 'Saved',
  ...
  serviceText: 'By clicking \'Enable Hns Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on Hns Rewards, you indicate that you have read and agree to the',
  ...
  turnOnRewardsDesc: 'This enables both Hns Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from Hns users.',
  ...
  walletDisconnect: 'Log out from Hns Rewards',
  ...
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your Hns Rewards wallet',
  ...
  walletVerificationNote2: 'Hns Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused Hns Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'Hns Payments is now Hns Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very Hns way to browse the web.',
  whyHnsRewards: 'Why Hns Rewards?',
  whyHnsRewardsDesc1: 'With conventional browsers, you pay to browse the web by viewing ads with your valuable attention, spending your valuable time downloading invasive ad technology, that transmits your valuable private data to advertisers — without your consent.',
  whyHnsRewardsDesc2: 'Well, you\'ve come to the right place. Hns welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
  ...
  showHnsStats: 'Show Hns Stats',
  hnsTalkWidgetTitle: 'Hns Talk',
