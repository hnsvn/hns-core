...
HnsExtensionsClient::HnsExtensionsClient() = default;

void HnsExtensionsClient::InitializeWebStoreUrls(
...
const GURL& HnsExtensionsClient::GetWebstoreUpdateURL() const {
