...
class HnsChromeImporterUtilsTest : public testing::Test {
 public:
  HnsChromeImporterUtilsTest() {}
  ...
  base::FilePath GetTestProfilePath() {
    return hns_profile_dir_.GetPath().AppendASCII("Chrome").AppendASCII(
        "Default");
  }
...
TEST_F(HnsChromeImporterUtilsTest, GetChromeExtensionsListPreferences) {
...
TEST_F(HnsChromeImporterUtilsTest, GetChromeExtensionsListSecurePreferences) {
...
TEST_F(HnsChromeImporterUtilsTest, ExtensionImportTest) {
  CopyTestFileToProfile("Secure_Preferences_for_extension_import",
                        kChromeSecurePreferencesFile);
...
TEST_F(HnsChromeImporterUtilsTest, GetChromeUserDataFolder) {
...
TEST_F(HnsChromeImporterUtilsTest, ChromeImporterCanImport) {
  CopyTestFileToProfile("Secure_Preferences_for_extension_import",
                        kChromeSecurePreferencesFile);
  CopyTestFileToProfile(kChromePreferencesFile, kChromePreferencesFile);
