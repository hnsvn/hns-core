...
#ifndef HNS_COMMON_IMPORTER_IMPORTER_CONSTANTS_H_
#define HNS_COMMON_IMPORTER_IMPORTER_CONSTANTS_H_
...
// one) make sure that hns://welcome page will identify this browser as the
// default one
...
#endif  // HNS_COMMON_IMPORTER_IMPORTER_CONSTANTS_H_
