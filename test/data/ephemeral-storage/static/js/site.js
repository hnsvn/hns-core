(async _ => {
  ...
  const hnsSoftwareOrigin = 'dev-pages.hnssoftware.com'
  const hnsSoftwareComOrigin = 'dev-pages.hns.software'

  let thisOrigin = document.location.host
  const bodyElm = document.body
  let otherOrigin

  if (thisOrigin.startsWith(hnsSoftwareOrigin)) {
      thisOrigin = hnsSoftwareOrigin
      otherOrigin = hnsSoftwareComOrigin
      bodyElm.className += ' hns-software-com'
  } else if (thisOrigin.startsWith(hnsSoftwareComOrigin)) {
      thisOrigin = hnsSoftwareComOrigin
      otherOrigin = hnsSoftwareOrigin
      bodyElm.className += ' hns-software'
  }
