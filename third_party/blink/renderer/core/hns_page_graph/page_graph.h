...
#ifndef HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_PAGE_GRAPH_H_
#define HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_PAGE_GRAPH_H_
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/blink_probe_types.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/page_graph_context.h"
...
class CORE_EXPORT PageGraph : public GarbageCollected<PageGraph>,
                              ...
                              public hns_page_graph::PageGraphContext {
 public:
  ...
  hns_page_graph::GraphItemId GetNextGraphItemId() override;
  void AddGraphItem(
      std::unique_ptr<hns_page_graph::GraphItem> graph_item) override;
 ...
 private:
#define PAGE_GRAPH_USING_DECL(type) using type = hns_page_graph::type
...
#undef PAGE_GRAPH_USING_DECL
  ...
  using FingerprintingFilterNodes ALLOW_DISCOURAGED_TYPE(
      "TODO(https://github.com/hnsvn/hns-browser/issues/28238)") =
...
#endif  // HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_PAGE_GRAPH_H_
