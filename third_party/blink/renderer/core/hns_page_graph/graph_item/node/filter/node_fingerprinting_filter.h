...
#ifndef HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_GRAPH_ITEM_NODE_FILTER_NODE_FINGERPRINTING_FILTER_H_
#define HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_GRAPH_ITEM_NODE_FILTER_NODE_FINGERPRINTING_FILTER_H_
...
template <>
struct DowncastTraits<hns_page_graph::NodeFingerprintingFilter> {
  ...
  static bool AllowFrom(const hns_page_graph::GraphNode& node) {
    return IsA<hns_page_graph::NodeFingerprintingFilter>(
...
#endif  // HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_GRAPH_ITEM_NODE_FILTER_NODE_FINGERPRINTING_FILTER_H_
