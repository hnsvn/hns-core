...
#ifndef HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_GRAPH_ITEM_NODE_STORAGE_NODE_STORAGE_ROOT_H_
#define HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_GRAPH_ITEM_NODE_STORAGE_NODE_STORAGE_ROOT_H_
...
template <>
struct DowncastTraits<hns_page_graph::NodeStorageRoot> {
  ...
  static bool AllowFrom(const hns_page_graph::GraphItem& graph_item) {
    return IsA<hns_page_graph::NodeStorageRoot>(
...
#endif  // HNS_THIRD_PARTY_BLINK_RENDERER_CORE_HNS_PAGE_GRAPH_GRAPH_ITEM_NODE_STORAGE_NODE_STORAGE_ROOT_H_
