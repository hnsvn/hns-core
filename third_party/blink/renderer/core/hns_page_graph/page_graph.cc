...
#include "hns/third_party/blink/renderer/core/hns_page_graph/page_graph.h"
...
#include "hns/components/hns_page_graph/common/features.h"
#include "hns/components/hns_shields/common/hns_shield_constants.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/attribute/edge_attribute_delete.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/attribute/edge_attribute_set.h"
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/edge_shield.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/edge_structure.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/edge_text_change.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/event_listener/edge_event_listener_add.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/event_listener/edge_event_listener_remove.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/execute/edge_execute.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/execute/edge_execute_attr.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/js/edge_js_call.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/js/edge_js_result.h"
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/node/edge_node_insert.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/node/edge_node_remove.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/request/edge_request.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/request/edge_request_complete.h"
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/storage/edge_storage_read_result.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/edge/storage/edge_storage_set.h"
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/node/filter/node_fingerprinting_filter.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/node/filter/node_tracker_filter.h"
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/node/html/node_html_text.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/node/js/node_js.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/node/js/node_js_builtin.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/node/js/node_js_webapi.h"
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/graph_item/node/storage/node_storage_cookiejar.h"
...
#include "hns/third_party/blink/renderer/core/hns_page_graph/libxml_utils.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/requests/request_tracker.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/requests/tracked_request.h"
#include "hns/third_party/blink/renderer/core/hns_page_graph/scripts/script_tracker.h"
...
using hns_page_graph::DocumentRequest;
using hns_page_graph::EdgeAttributeDelete;
using hns_page_graph::EdgeAttributeSet;
using hns_page_graph::EdgeBinding;
using hns_page_graph::EdgeBindingEvent;
using hns_page_graph::EdgeCrossDOM;
using hns_page_graph::EdgeEventListenerAdd;
using hns_page_graph::EdgeEventListenerRemove;
using hns_page_graph::EdgeExecute;
using hns_page_graph::EdgeExecuteAttr;
using hns_page_graph::EdgeFilter;
using hns_page_graph::EdgeJSCall;
using hns_page_graph::EdgeJSResult;
using hns_page_graph::EdgeNodeCreate;
using hns_page_graph::EdgeNodeInsert;
using hns_page_graph::EdgeNodeRemove;
using hns_page_graph::EdgeRequestComplete;
using hns_page_graph::EdgeRequestError;
using hns_page_graph::EdgeRequestStart;
using hns_page_graph::EdgeResourceBlock;
using hns_page_graph::EdgeShield;
using hns_page_graph::EdgeStorageBucket;
using hns_page_graph::EdgeStorageClear;
using hns_page_graph::EdgeStorageDelete;
using hns_page_graph::EdgeStorageReadCall;
using hns_page_graph::EdgeStorageReadResult;
using hns_page_graph::EdgeStorageSet;
using hns_page_graph::EdgeStructure;
using hns_page_graph::EdgeTextChange;
using hns_page_graph::GraphItem;
using hns_page_graph::GraphItemId;
using hns_page_graph::ItemName;
using hns_page_graph::NodeActor;
using hns_page_graph::NodeAdFilter;
using hns_page_graph::NodeBinding;
using hns_page_graph::NodeBindingEvent;
using hns_page_graph::NodeDOMRoot;
using hns_page_graph::NodeFingerprintingFilter;
using hns_page_graph::NodeFrameOwner;
using hns_page_graph::NodeHTML;
using hns_page_graph::NodeHTMLElement;
using hns_page_graph::NodeHTMLText;
using hns_page_graph::NodeJSBuiltin;
using hns_page_graph::NodeJSWebAPI;
using hns_page_graph::NodeResource;
using hns_page_graph::NodeScript;
using hns_page_graph::NodeStorage;
using hns_page_graph::NodeTrackerFilter;
using hns_page_graph::NormalizeUrl;
using hns_page_graph::ScriptId;
using hns_page_graph::TrackedRequest;
using hns_page_graph::XmlUtf8String;
...
constexpr char kPageGraphUrl[] =
    "https://github.com/hnsvn/hns-browser/wiki/PageGraph";
...
void PageGraph::ProvideTo(LocalFrame& frame) {
  ...
  static const bool is_enabled =
      base::FeatureList::IsEnabled(hns_page_graph::features::kPageGraph);
  if (!is_enabled) {
    return;
  }
...
PageGraph::PageGraph(LocalFrame& local_frame)
  ...
  ad_shield_node_ = AddNode<NodeShield>(hns_shields::kAds);
  tracker_shield_node_ = AddNode<NodeShield>(hns_shields::kTrackers);
  js_shield_node_ = AddNode<NodeShield>(hns_shields::kJavaScript);
  fingerprinting_shield_node_ =
      AddNode<NodeShield>(hns_shields::kFingerprintingV2);
  ...
  if (base::StartsWith(name_piece, "Document.")) {
    if (name_piece == "Document.cookie.get") {
      RegisterStorageRead(execution_context, receiver_data.at("cookie_url"),
                          *result, hns_page_graph::StorageLocation::kCookie);
      return;
      ...
      RegisterStorageWrite(execution_context, cookie_key, cookie_value,
                           hns_page_graph::StorageLocation::kCookie);
      return;
    }
...
String PageGraph::ToGraphML() const {
  ...
  for (const auto& graphml_attr : hns_page_graph::GetGraphMLAttrs()) {
