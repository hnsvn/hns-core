...
#ifndef HNS_THIRD_PARTY_BLINK_RENDERER_HNS_FONT_WHITELIST_H_
#define HNS_THIRD_PARTY_BLINK_RENDERER_HNS_FONT_WHITELIST_H_
...
#endif  // HNS_THIRD_PARTY_BLINK_RENDERER_HNS_FONT_WHITELIST_H_
