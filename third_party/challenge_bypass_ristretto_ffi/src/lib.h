...
#ifndef HNS_THIRD_PARTY_CHALLENGE_BYPASS_RISTRETTO_FFI_SRC_LIB_H_
#define HNS_THIRD_PARTY_CHALLENGE_BYPASS_RISTRETTO_FFI_SRC_LIB_H_
...
#endif /* HNS_THIRD_PARTY_CHALLENGE_BYPASS_RISTRETTO_FFI_SRC_LIB_H_ */
