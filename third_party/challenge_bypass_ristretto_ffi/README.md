# challenge-bypass-ristretto-ffi [![Build Status](https://travis-ci.org/hns-intl/challenge-bypass-ristretto-ffi.svg?branch=master)](https://travis-ci.org/hns-intl/challenge-bypass-ristretto-ffi)
