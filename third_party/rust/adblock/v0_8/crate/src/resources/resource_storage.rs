...
mod scriptlet_storage_tests {
    ...
    fn patch_argslist_many_args() {
        ...
        let args = parse_scriptlet_args("acs, this, probably, is, going, to, break, hns, and, crash, it, instead, of, ignoring, it");
        assert_eq!(args, vec!["acs", "this", "probably", "is", "going", "to", "break", "hns", "and", "crash", "it", "instead", "of", "ignoring", "it"]);

        assert_eq!(
            resources.get_scriptlet_resource("acs, this, probably, is, going, to, break, hns, and, crash, it, instead, of, ignoring, it", Default::default()),
            Ok("this probably is going to break hns and crash {{10}} {{11}} {{12}}".to_string()),
        );
    }
