...
(function() {
    ...
    fn scriptlet_permissions() {
        ...
        const HNS_PERM: PermissionMask = PermissionMask::from_bits(0b00000011);
        ...
        let resources = [
            ...
            Resource {
                name: "hns-fix.js".to_string(),
                aliases: vec![],
                kind: ResourceType::Mime(MimeType::ApplicationJavascript),
                content: base64::encode("hns-fix"),
                dependencies: vec![],
                permission: HNS_PERM,
            },
        ];
        ...
        filter_set.add_filters([
            ...
            "sub9.example.com##+js(hns-fix)"
        ], ParseOptions {
            permissions: HNS_PERM,
            ..Default::default()
        });
        ...
        assert_eq!(engine.url_cosmetic_resources("https://sub9.example.com").injected_script, wrap_try("hns-fix"));
    }
}
