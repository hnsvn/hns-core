...
class DelayedSharedDesktopPageState(shared_page_state.SharedDesktopPageState):
  """ Hns version of SharedDesktopPageState with extras.
...
class HnsLoadingDesktopStorySet(story.StorySet):
  """ Hns version of LoadingDesktopStorySet.

  See loading_desktop.py for details.
  """

  def __init__(self, cache_temperatures=None):
    super(HnsLoadingDesktopStorySet,
          self).__init__(archive_data_file='data/hns_loading_desktop.json',
    ...
    self.AddStories(['typical'],
                    [('https://example.com/', 'example.com'),
                     ('https://search.hns.com/', 'HnsSearch'),
