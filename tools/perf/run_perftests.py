...
3. Reports the results to hns-perf-dashboard.appspot.com or stores them as
   local .html files.
...
npm run perf_tests -- compare/compare_with_on_off_feature.json5
     --variations-repo-dir=~/work/hns-variations

On CI:
npm run perf_tests -- smoke-hns.json5 v1.58.45
     --working-directory=e:\work\hns\src\out\100
     --variations-repo-dir=e:\work\hns-variations
     --ci-mode
''')
