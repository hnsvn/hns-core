...
#ifndef HNS_SANDBOX_WIN_SRC_MODULE_FILE_NAME_INTERCEPTION_H_
#define HNS_SANDBOX_WIN_SRC_MODULE_FILE_NAME_INTERCEPTION_H_
...
#endif  // HNS_SANDBOX_WIN_SRC_MODULE_FILE_NAME_INTERCEPTION_H_
