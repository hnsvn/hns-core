...
using HnsMainDelegateBrowserTest = PlatformBrowserTest;
...
IN_PROC_BROWSER_TEST_F(HnsMainDelegateBrowserTest,
...
IN_PROC_BROWSER_TEST_F(HnsMainDelegateBrowserTest, OriginTrialsTest) {
  EXPECT_TRUE(base::CommandLine::ForCurrentProcess()->HasSwitch(
      embedder_support::kOriginTrialPublicKey));
  EXPECT_EQ(kHnsOriginTrialsPublicKey,
            base::CommandLine::ForCurrentProcess()->GetSwitchValueASCII(
                embedder_support::kOriginTrialPublicKey));
}

IN_PROC_BROWSER_TEST_F(HnsMainDelegateBrowserTest, DisabledFeatures) {
...
IN_PROC_BROWSER_TEST_F(HnsMainDelegateBrowserTest, EnabledFeatures) {
