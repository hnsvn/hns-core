...
HnsCommandLineHelper::HnsCommandLineHelper(base::CommandLine* command_line)
    : command_line_(*command_line) {
  Parse();
}

const std::unordered_set<std::string>&
HnsCommandLineHelper::enabled_features() const {
  return enabled_features_;
}

const std::unordered_set<std::string>&
HnsCommandLineHelper::disabled_features() const {
  return disabled_features_;
}

void HnsCommandLineHelper::ParseCSV(
...
void HnsCommandLineHelper::Parse() {
...
void HnsCommandLineHelper::AppendSwitch(const char* switch_key) {
  if (!command_line_->HasSwitch(switch_key)) {
    command_line_->AppendSwitch(switch_key);
  }
}

void HnsCommandLineHelper::AppendFeatures(
...
void HnsCommandLineHelper::AppendCSV(
...
void HnsCommandLineHelper::AppendSwitchASCII(const char* switch_key,
                                               const char* value) {
  if (!command_line_->HasSwitch(switch_key)) {
