...
TEST(HnsCommandLineHelperUnitTest, TestAppendSwitch) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
  HnsCommandLineHelper helper(&command_line);
...
TEST(HnsCommandLineHelperUnitTest, TestParseFeatures) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
...
TEST(HnsCommandLineHelperUnitTest, TestAppendFeatures) {
  base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
  HnsCommandLineHelper helper(&command_line);
