...
#ifndef HNS_APP_HNS_COMMAND_LINE_HELPER_H_
#define HNS_APP_HNS_COMMAND_LINE_HELPER_H_
...
class HnsCommandLineHelper {
 public:
  explicit HnsCommandLineHelper(base::CommandLine* command_line);
  HnsCommandLineHelper(const HnsCommandLineHelper&) = delete;
  HnsCommandLineHelper& operator=(const HnsCommandLineHelper&) = delete;
  inline ~HnsCommandLineHelper() = default;
...
#endif  // HNS_APP_HNS_COMMAND_LINE_HELPER_H_
