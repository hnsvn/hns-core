...
#include "hns/mojo/hns_ast_patcher/test_module.mojom.h"
...
TEST(HnsAstPatcherTest, OriginalTypes) {
...
TEST(HnsAstPatcherTest, NewTypes) {
...
TEST(HnsAstPatcherTest, ExtendedTypes) {
...
TEST(HnsAstPatcherTest, InterfaceInstantiations) {
