...
const HnsToolbarSearchFieldBase = CrSearchFieldMixin(PolymerElement)

class HnsToolbarSearchField extends HnsToolbarSearchFieldBase {
  static get is() {
  ...
  computeIsSpinnerShown_() {
    // TODO(petemill): Show a spinner for hns version of toolbar
...
customElements.define(
  HnsToolbarSearchField.is, HnsToolbarSearchField)
