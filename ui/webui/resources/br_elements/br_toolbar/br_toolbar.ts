...
import 'chrome://resources/hns/br_elements/br_shared_vars.css.js';
...
Polymer({
  ...
  initStrings: function() {
    ...
    this.hnsRewardsTitle = this.getLoadTimeDataString('brToolbarRewardsTitle')
  ...
  attached: function () {
    ...
    this.isHnsWalletAllowed_ =
      this.getLoadTimeDataBoolean('isHnsWalletAllowed')
