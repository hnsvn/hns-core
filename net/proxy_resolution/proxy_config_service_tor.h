...
#ifndef HNS_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
#define HNS_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
...
#endif  // HNS_NET_PROXY_RESOLUTION_PROXY_CONFIG_SERVICE_TOR_H_
